...
class UserSegment implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'included' => 'string[]',
        'excluded' => 'string[]',
        'rules' => '\Swagger\Client\Model\UserSegmentRule[]',
        'version' => 'int',
     ...
     * Gets rules
     *
     * @return \Swagger\Client\Model\UserSegmentRule[]
     */
     ...
     * Sets rules
     *
     * @param \Swagger\Client\Model\UserSegmentRule[] $rules An array of rules that can cause a user to be included in this segment.
     *
     * @return $this
     */
