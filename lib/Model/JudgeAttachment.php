...
/**
 * JudgeAttachment Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class JudgeAttachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JudgeAttachment';
    ...
    protected static $setters = [
        'judge_config_key' => 'setJudgeConfigKey',
    ...
    protected static $getters = [
        'judge_config_key' => 'getJudgeConfigKey',
    ...
    {
        $this->setIfExists('judge_config_key', $data ?? [], null);
        $this->setIfExists('sampling_rate', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['judge_config_key'] === null) {
            $invalidProperties[] = "'judge_config_key' can't be null";
        }
        if ($this->container['sampling_rate'] === null) {
            $invalidProperties[] = "'sampling_rate' can't be null";
        }
        if (($this->container['sampling_rate'] > 1)) {
            $invalidProperties[] = "invalid value for 'sampling_rate', must be smaller than or equal to 1.";
        }

        if (($this->container['sampling_rate'] < 0)) {
    ...
    /**
     * Gets judge_config_key
     *
     * @return string
     */
    public function getJudgeConfigKey()
    {
        return $this->container['judge_config_key'];
    }

    /**
     * Sets judge_config_key
     *
     * @param string $judge_config_key Key of the judge AI config
     *
     * @return self
     */
    public function setJudgeConfigKey($judge_config_key)
    {
        if (is_null($judge_config_key)) {
            throw new \InvalidArgumentException('non-nullable judge_config_key cannot be null');
        }
        $this->container['judge_config_key'] = $judge_config_key;
     ...
     * Sets sampling_rate
     *
     * @param float $sampling_rate Sampling rate for this judge attachment (0.0 to 1.0)
     *
     * @return self
     */
    public function setSamplingRate($sampling_rate)
    {
        ...
        if (($sampling_rate > 1)) {
            throw new \InvalidArgumentException('invalid value for $sampling_rate when calling JudgeAttachment., must be smaller than or equal to 1.');
        }
        if (($sampling_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $sampling_rate when calling JudgeAttachment., must be bigger than or equal to 0.');
        }
