...
/**
 * GenerateWarehouseDestinationKeyPairPostRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class GenerateWarehouseDestinationKeyPairPostRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GenerateWarehouseDestinationKeyPairPostRep';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('public_key_pkcs8', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets public_key
     *
     * @param string|null $public_key The public key used by LaunchDarkly
     *
     * @return self
     */
     ...
     *
     * @param string|null $public_key_pkcs8 The public key to assign in your Snowflake worksheet
     *
     * @return self
     */
    public function setPublicKeyPkcs8($public_key_pkcs8)
    {
        if (is_null($public_key_pkcs8)) {
            throw new \InvalidArgumentException('non-nullable public_key_pkcs8 cannot be null');
        }
