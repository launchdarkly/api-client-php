...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('private_attrs', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key The user key. This is the only mandatory user attribute.
     *
     * @return self
     */
     ...
     * Sets secondary
     *
     * @param string|null $secondary If provided, used with the user key to generate a variation in percentage rollouts
     *
     * @return self
     */
     ...
     * Sets avatar
     *
     * @param string|null $avatar An absolute URL to an avatar image.
     *
     * @return self
     */
     ...
     * Sets anonymous
     *
     * @param bool|null $anonymous Whether the user is anonymous. If true, this user does not appear on the Contexts list in the LaunchDarkly user interface.
     *
     * @return self
     */
     ...
     * Sets custom
     *
     * @param array<string,mixed>|null $custom Any other custom attributes for this user. Custom attributes contain any other user data that you would like to use to conditionally target your users.
     *
     * @return self
     */
    ...
    {
        return $this->container['private_attrs'];
    }

    /**
     * Sets private_attrs
     *
     * @param string[]|null $private_attrs A list of attribute names that are marked as private. You can use these attributes in targeting rules and segments. If you are using a server-side SDK, the SDK will not send the private attribute back to LaunchDarkly. If you are using a client-side SDK, the SDK will send the private attribute back to LaunchDarkly for evaluation. However, the SDK won't send the attribute to LaunchDarkly in events data, LaunchDarkly won't store the private attribute, and the private attribute will not appear on the Contexts list.
     *
     * @return self
     */
    public function setPrivateAttrs($private_attrs)
    {
        if (is_null($private_attrs)) {
            throw new \InvalidArgumentException('non-nullable private_attrs cannot be null');
        }
        $this->container['private_attrs'] = $private_attrs;
