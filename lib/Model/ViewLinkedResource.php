...
/**
 * ViewLinkedResource Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ViewLinkedResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViewLinkedResource';
    ...
    protected static $openAPITypes = [
        ...
        'linked_at' => 'int',
        'resource_details' => '\LaunchDarklyApi\Model\ViewLinkedResourceDetails'
    ];
    ...
    protected static $setters = [
        ...
        'resource_details' => 'setResourceDetails'
    ];
    ...
    protected static $getters = [
        ...
        'resource_details' => 'getResourceDetails'
    ];
    ...
    public const RESOURCE_TYPE_FLAG = 'flag';
    public const RESOURCE_TYPE_SEGMENT = 'segment';
    public const RESOURCE_TYPE_METRIC = 'metric';
    public const RESOURCE_TYPE_AI_CONFIG = 'aiConfig';
    ...
    {
        return [
            self::RESOURCE_TYPE_FLAG,
            self::RESOURCE_TYPE_SEGMENT,
            self::RESOURCE_TYPE_METRIC,
            self::RESOURCE_TYPE_AI_CONFIG,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('resource_details', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['linked_at'] === null) {
            $invalidProperties[] = "'linked_at' can't be null";
        }
     ...
     * Gets _links
     *
     * @return \LaunchDarklyApi\Model\ParentAndSelfLinks
     */
     ...
     * Sets _links
     *
     * @param \LaunchDarklyApi\Model\ParentAndSelfLinks $_links _links
     *
     * @return self
     */
     ...
     * Sets resource_key
     *
     * @param string $resource_key Key of the resource (flag, segment, AI config or metric)
     *
     * @return self
     */
     ...
     * Sets environment_id
     *
     * @param string|null $environment_id Environment ID of the resource (only present for segments)
     *
     * @return self
     */
     ...
     *
     * @param string|null $environment_key Environment Key of the resource (only present for segments)
     *
     * @return self
     */
    ...
    /**
     * Gets resource_details
     *
     * @return \LaunchDarklyApi\Model\ViewLinkedResourceDetails|null
     */
    public function getResourceDetails()
    {
        return $this->container['resource_details'];
    }

    /**
     * Sets resource_details
     *
     * @param \LaunchDarklyApi\Model\ViewLinkedResourceDetails|null $resource_details resource_details
     *
     * @return self
     */
    public function setResourceDetails($resource_details)
    {
        if (is_null($resource_details)) {
            throw new \InvalidArgumentException('non-nullable resource_details cannot be null');
        }
        $this->container['resource_details'] = $resource_details;
