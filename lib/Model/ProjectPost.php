 ...
 */
class ProjectPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectPost';
    ...
    protected static $openAPITypes = [
        ...
        'default_client_side_availability' => '\LaunchDarklyApi\Model\DefaultClientSideAvailabilityPost',
        'tags' => 'string[]',
        'environments' => '\LaunchDarklyApi\Model\EnvironmentPost[]',
        'naming_convention' => '\LaunchDarklyApi\Model\NamingConvention'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'default_client_side_availability' => false,
        'tags' => false,
        'environments' => false,
    ...
    protected static $setters = [
        ...
        'naming_convention' => 'setNamingConvention'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('include_in_snippet_by_default', $data ?? [], null);
        $this->setIfExists('default_client_side_availability', $data ?? [], null);
        $this->setIfExists('tags', $data ?? [], null);
        $this->setIfExists('environments', $data ?? [], null);
        $this->setIfExists('naming_convention', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets name
     *
     * @param string $name A human-friendly name for the project.
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string $key A unique key used to reference the project in your code.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $include_in_snippet_by_default Whether or not flags created in this project are made available to the client-side JavaScript SDK by default.
     *
     * @return self
     */
    public function setIncludeInSnippetByDefault($include_in_snippet_by_default)
    {
        if (is_null($include_in_snippet_by_default)) {
            throw new \InvalidArgumentException('non-nullable include_in_snippet_by_default cannot be null');
        }
     ...
     *
     * @return \LaunchDarklyApi\Model\DefaultClientSideAvailabilityPost|null
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\DefaultClientSideAvailabilityPost|null $default_client_side_availability default_client_side_availability
     *
     * @return self
     */
    public function setDefaultClientSideAvailability($default_client_side_availability)
    {
        if (is_null($default_client_side_availability)) {
            throw new \InvalidArgumentException('non-nullable default_client_side_availability cannot be null');
        }
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags for the project
     *
     * @return self
     */
     ...
     * Gets environments
     *
     * @return \LaunchDarklyApi\Model\EnvironmentPost[]|null
     */
     ...
     * Sets environments
     *
     * @param \LaunchDarklyApi\Model\EnvironmentPost[]|null $environments Creates the provided environments for this project. If omitted default environments will be created instead.
     *
     * @return self
     */
    ...
    /**
     * Gets naming_convention
     *
     * @return \LaunchDarklyApi\Model\NamingConvention|null
     */
    public function getNamingConvention()
    {
        return $this->container['naming_convention'];
    }

    /**
     * Sets naming_convention
     *
     * @param \LaunchDarklyApi\Model\NamingConvention|null $naming_convention naming_convention
     *
     * @return self
     */
    public function setNamingConvention($naming_convention)
    {
        if (is_null($naming_convention)) {
            throw new \InvalidArgumentException('non-nullable naming_convention cannot be null');
        }
        $this->container['naming_convention'] = $naming_convention;
