...
/**
 * SegmentsSummary Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class SegmentsSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SegmentsSummary';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'linked_segments' => '\LaunchDarklyApi\Model\ExpandedDirectlyLinkedSegments'
    ];
    ...
    protected static $setters = [
        'count' => 'setCount',
        'linked_segments' => 'setLinkedSegments'
    ];
    ...
    protected static $getters = [
        'count' => 'getCount',
        'linked_segments' => 'getLinkedSegments'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('linked_segments', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets linked_segments
     *
     * @return \LaunchDarklyApi\Model\ExpandedDirectlyLinkedSegments|null
     */
    public function getLinkedSegments()
    {
        return $this->container['linked_segments'];
    }

    /**
     * Sets linked_segments
     *
     * @param \LaunchDarklyApi\Model\ExpandedDirectlyLinkedSegments|null $linked_segments linked_segments
     *
     * @return self
     */
    public function setLinkedSegments($linked_segments)
    {
        if (is_null($linked_segments)) {
            throw new \InvalidArgumentException('non-nullable linked_segments cannot be null');
        }
        $this->container['linked_segments'] = $linked_segments;
