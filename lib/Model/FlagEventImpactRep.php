...
/**
 * FlagEventImpactRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagEventImpactRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagEventImpactRep';
    ...
    protected static $openAPITypes = [
        ...
        'percentage' => 'float',
        'reason' => 'string',
        'evaluations_summary' => '\LaunchDarklyApi\Model\EvaluationsSummary'
    ];
    ...
    protected static $setters = [
        ...
        'reason' => 'setReason',
        'evaluations_summary' => 'setEvaluationsSummary'
    ];
    ...
    protected static $getters = [
        ...
        'reason' => 'getReason',
        'evaluations_summary' => 'getEvaluationsSummary'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('evaluations_summary', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets size
     *
     * @param string|null $size The size of the flag event impact. Sizes are defined as: none (0%), small (0-20%), medium (20-80%), large (>80%)
     *
     * @return self
     */
     ...
     * Sets percentage
     *
     * @param float|null $percentage The percentage of the flag event impact
     *
     * @return self
     */
    ...
    /**
     * Gets evaluations_summary
     *
     * @return \LaunchDarklyApi\Model\EvaluationsSummary|null
     */
    public function getEvaluationsSummary()
    {
        return $this->container['evaluations_summary'];
    }

    /**
     * Sets evaluations_summary
     *
     * @param \LaunchDarklyApi\Model\EvaluationsSummary|null $evaluations_summary evaluations_summary
     *
     * @return self
     */
    public function setEvaluationsSummary($evaluations_summary)
    {
        if (is_null($evaluations_summary)) {
            throw new \InvalidArgumentException('non-nullable evaluations_summary cannot be null');
        }
        $this->container['evaluations_summary'] = $evaluations_summary;
