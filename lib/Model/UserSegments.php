...
/**
 * UserSegments Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class UserSegments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserSegments';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\UserSegment[]',
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\UserSegment[] $items An array of segments
     *
     * @return self
     */
