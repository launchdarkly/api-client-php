...
/**
 * FlagsSummary Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagsSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagsSummary';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'linked_flags' => '\LaunchDarklyApi\Model\ExpandedDirectlyLinkedFlags'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('linked_flags', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets linked_flags
     *
     * @return \LaunchDarklyApi\Model\ExpandedDirectlyLinkedFlags|null
     */
    public function getLinkedFlags()
    {
        return $this->container['linked_flags'];
    }

    /**
     * Sets linked_flags
     *
     * @param \LaunchDarklyApi\Model\ExpandedDirectlyLinkedFlags|null $linked_flags linked_flags
     *
     * @return self
     */
    public function setLinkedFlags($linked_flags)
    {
        if (is_null($linked_flags)) {
            throw new \InvalidArgumentException('non-nullable linked_flags cannot be null');
        }
        $this->container['linked_flags'] = $linked_flags;
