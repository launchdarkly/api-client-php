...
/**
 * ContextKindRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ContextKindRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContextKindRep';
    ...
    protected static $setters = [
        ...
        'hide_in_targeting' => 'setHideInTargeting',
    ...
    protected static $getters = [
        ...
        'hide_in_targeting' => 'getHideInTargeting',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('hide_in_targeting', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['created_from'] === null) {
            $invalidProperties[] = "'created_from' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name The context kind name
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description The context kind description
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int $version The context kind version
     *
     * @return self
     */
     ...
     * Sets created_from
     *
     * @param string $created_from created_from
     *
     * @return self
     */
    ...
    /**
     * Gets hide_in_targeting
     *
     * @return bool|null
     */
    public function getHideInTargeting()
    {
        return $this->container['hide_in_targeting'];
    }

    /**
     * Sets hide_in_targeting
     *
     * @param bool|null $hide_in_targeting Alias for archived.
     *
     * @return self
     */
    public function setHideInTargeting($hide_in_targeting)
    {
        if (is_null($hide_in_targeting)) {
            throw new \InvalidArgumentException('non-nullable hide_in_targeting cannot be null');
        }
        $this->container['hide_in_targeting'] = $hide_in_targeting;
     ...
     * Sets archived
     *
     * @param bool|null $archived Whether the context kind is archived. Archived context kinds are unavailable for targeting.
     *
     * @return self
     */
