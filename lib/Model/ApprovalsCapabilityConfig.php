...
/**
 * ApprovalsCapabilityConfig Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ApprovalsCapabilityConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApprovalsCapabilityConfig';
    ...
    protected static $openAPITypes = [
        'additional_form_variables' => '\LaunchDarklyApi\Model\FormVariable[]'
    ];
    ...
    protected static $openAPIFormats = [
        'additional_form_variables' => null
    ];
    ...
    protected static array $openAPINullables = [
        'additional_form_variables' => false
    ];
    ...
    protected static $setters = [
        'additional_form_variables' => 'setAdditionalFormVariables'
    ];
    ...
    protected static $getters = [
        'additional_form_variables' => 'getAdditionalFormVariables'
    ];
    ...
    {
        $this->setIfExists('additional_form_variables', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets additional_form_variables
     *
     * @return \LaunchDarklyApi\Model\FormVariable[]|null
     */
    public function getAdditionalFormVariables()
    {
        return $this->container['additional_form_variables'];
    }

    /**
     * Sets additional_form_variables
     *
     * @param \LaunchDarklyApi\Model\FormVariable[]|null $additional_form_variables The additional form variables for the approvals capability
     *
     * @return self
     */
    public function setAdditionalFormVariables($additional_form_variables)
    {
        if (is_null($additional_form_variables)) {
            throw new \InvalidArgumentException('non-nullable additional_form_variables cannot be null');
        }
        $this->container['additional_form_variables'] = $additional_form_variables;
