...
/**
 * UserFlagSettings Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class UserFlagSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserFlagSettings';
    ...
    protected static $openAPITypes = [
        'items' => 'array<string,\LaunchDarklyApi\Model\UserFlagSetting>',
     ...
     * Gets items
     *
     * @return array<string,\LaunchDarklyApi\Model\UserFlagSetting>
     */
     ...
     * Sets items
     *
     * @param array<string,\LaunchDarklyApi\Model\UserFlagSetting> $items An array of flag settings for the user
     *
     * @return self
     */
