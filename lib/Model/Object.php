...
class Object implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['pkg_path'] = $data['pkg_path'] ?? null;
        $this->container['pkg_name'] = $data['pkg_name'] ?? null;
        $this->container['valid_pos'] = $data['valid_pos'] ?? null;
        $this->container['shadow'] = $data['shadow'] ?? null;
    }
     ...
     * Sets pkg_path
     *
     * @param string|null $pkg_path pkg_path
     *
     * @return self
     */
     ...
     * Sets pkg_name
     *
     * @param string|null $pkg_name pkg_name
     *
     * @return self
     */
    ...
    {
        return $this->container['valid_pos'];
    }

    /**
     * Sets valid_pos
     *
     * @param bool|null $valid_pos valid_pos
     *
     * @return self
     */
    public function setValidPos($valid_pos)
    {
        $this->container['valid_pos'] = $valid_pos;
     ...
     * Sets shadow
     *
     * @param array<string,bool>|null $shadow shadow
     *
     * @return self
     */
