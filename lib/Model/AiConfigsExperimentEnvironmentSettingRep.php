...
/**
 * AiConfigsExperimentEnvironmentSettingRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AiConfigsExperimentEnvironmentSettingRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AiConfigsExperimentEnvironmentSettingRep';
    ...
    protected static $openAPITypes = [
        'start_date' => 'int',
        'stop_date' => 'int',
        'enabled_periods' => '\LaunchDarklyApi\Model\AiConfigsExperimentEnabledPeriodRep[]'
    ];
    ...
    protected static $setters = [
        ...
        'enabled_periods' => 'setEnabledPeriods'
    ];
    ...
    protected static $getters = [
        ...
        'enabled_periods' => 'getEnabledPeriods'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('stop_date', $data ?? [], null);
        $this->setIfExists('enabled_periods', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets stop_date
     *
     * @param int|null $stop_date stop_date
     *
     * @return self
     */
    public function setStopDate($stop_date)
    {
        if (is_null($stop_date)) {
            throw new \InvalidArgumentException('non-nullable stop_date cannot be null');
        }
    ...
    /**
     * Gets enabled_periods
     *
     * @return \LaunchDarklyApi\Model\AiConfigsExperimentEnabledPeriodRep[]|null
     */
    public function getEnabledPeriods()
    {
        return $this->container['enabled_periods'];
    }

    /**
     * Sets enabled_periods
     *
     * @param \LaunchDarklyApi\Model\AiConfigsExperimentEnabledPeriodRep[]|null $enabled_periods enabled_periods
     *
     * @return self
     */
    public function setEnabledPeriods($enabled_periods)
    {
        if (is_null($enabled_periods)) {
            throw new \InvalidArgumentException('non-nullable enabled_periods cannot be null');
        }
        $this->container['enabled_periods'] = $enabled_periods;
