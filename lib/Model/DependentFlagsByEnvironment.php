...
/**
 * DependentFlagsByEnvironment Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class DependentFlagsByEnvironment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DependentFlagsByEnvironment';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\DependentFlag[]',
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\DependentFlag[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\DependentFlag[] $items A list of dependent flags, which are flags that use the requested flag as a prerequisite
     *
     * @return self
     */
