...
/**
 * InsightsChartMetric Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class InsightsChartMetric implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsightsChartMetric';
    ...
    protected static $openAPITypes = [
        ...
        'unit' => 'string',
        'modifier' => 'string',
        'tiers' => '\LaunchDarklyApi\Model\InsightsMetricTierDefinition[]'
    ];
     ...
     * Sets indicator
     *
     * @param string $indicator Metric indicator tier
     *
     * @return self
     */
     ...
     * Sets modifier
     *
     * @param string $modifier Metric modifier
     *
     * @return self
     */
     ...
     * Gets tiers
     *
     * @return \LaunchDarklyApi\Model\InsightsMetricTierDefinition[]
     */
     ...
     * Sets tiers
     *
     * @param \LaunchDarklyApi\Model\InsightsMetricTierDefinition[] $tiers Metric indicator tiers
     *
     * @return self
     */
