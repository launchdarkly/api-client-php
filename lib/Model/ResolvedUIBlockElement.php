...
/**
 * ResolvedUIBlockElement Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ResolvedUIBlockElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResolvedUIBlockElement';
    ...
    {
        $this->container['is_bold'] = $data['is_bold'] ?? null;
        $this->container['text'] = $data['text'] ?? null;
        $this->container['url'] = $data['url'] ?? null;
        $this->container['is_timestamp'] = $data['is_timestamp'] ?? null;
    }
    ...
    {
        return $this->container['is_timestamp'];
    }

    /**
     * Sets is_timestamp
     *
     * @param bool|null $is_timestamp is_timestamp
     *
     * @return self
     */
    public function setIsTimestamp($is_timestamp)
    {
        $this->container['is_timestamp'] = $is_timestamp;
