 ...
 */
class Extinction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Extinction';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['proj_key'] === null) {
            $invalidProperties[] = "'proj_key' can't be null";
        }
