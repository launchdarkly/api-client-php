...
/**
 * FlagEventRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagEventRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagEventRep';
    ...
    protected static $openAPITypes = [
        ...
        'member' => '\LaunchDarklyApi\Model\FlagEventMemberRep',
        'actions' => 'string[]',
        'impact' => '\LaunchDarklyApi\Model\FlagEventImpactRep',
        'experiments' => '\LaunchDarklyApi\Model\FlagEventExperimentCollection'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('audit_log_entry_id', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The flag event ID
     *
     * @return self
     */
     ...
     * Sets environment_id
     *
     * @param string|null $environment_id The environment ID
     *
     * @return self
     */
     ...
     *
     * @param string|null $environment_key The environment key
     *
     * @return self
     */
     ...
     * Sets event_time
     *
     * @param int $event_time event_time
     *
     * @return self
     */
     ...
     *
     * @param string|null $audit_log_entry_id The audit log entry ID
     *
     * @return self
     */
    public function setAuditLogEntryId($audit_log_entry_id)
    {
        if (is_null($audit_log_entry_id)) {
            throw new \InvalidArgumentException('non-nullable audit_log_entry_id cannot be null');
        }
     ...
     * Gets member
     *
     * @return \LaunchDarklyApi\Model\FlagEventMemberRep|null
     */
     ...
     * Sets member
     *
     * @param \LaunchDarklyApi\Model\FlagEventMemberRep|null $member member
     *
     * @return self
     */
     ...
     * Sets actions
     *
     * @param string[]|null $actions The resource actions
     *
     * @return self
     */
     ...
     * Gets impact
     *
     * @return \LaunchDarklyApi\Model\FlagEventImpactRep
     */
     ...
     * Sets impact
     *
     * @param \LaunchDarklyApi\Model\FlagEventImpactRep $impact impact
     *
     * @return self
     */
     ...
     * Gets experiments
     *
     * @return \LaunchDarklyApi\Model\FlagEventExperimentCollection|null
     */
     ...
     * Sets experiments
     *
     * @param \LaunchDarklyApi\Model\FlagEventExperimentCollection|null $experiments experiments
     *
     * @return self
     */
