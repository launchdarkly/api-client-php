...
/**
 * AIConfigTargetingEnvironment Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AIConfigTargetingEnvironment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AIConfigTargetingEnvironment';
    ...
    protected static $openAPITypes = [
        'context_targets' => '\LaunchDarklyApi\Model\AIConfigTargetingEnvironmentTarget[]',
        'enabled' => 'bool',
        'fallthrough' => '\LaunchDarklyApi\Model\AIConfigTargetingEnvironmentFallthrough',
        'last_modified' => 'int',
        'off_variation' => 'int',
        'rules' => '\LaunchDarklyApi\Model\AIConfigTargetingEnvironmentRule[]',
        'targets' => '\LaunchDarklyApi\Model\AIConfigTargetingEnvironmentTarget[]',
        'track_events' => 'bool',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['context_targets'] === null) {
            $invalidProperties[] = "'context_targets' can't be null";
        }
        if ($this->container['enabled'] === null) {
            $invalidProperties[] = "'enabled' can't be null";
        }
        if ($this->container['fallthrough'] === null) {
            $invalidProperties[] = "'fallthrough' can't be null";
        }
     ...
     *
     * @return \LaunchDarklyApi\Model\AIConfigTargetingEnvironmentTarget[]
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\AIConfigTargetingEnvironmentTarget[] $context_targets context_targets
     *
     * @return self
     */
     ...
     * Gets fallthrough
     *
     * @return \LaunchDarklyApi\Model\AIConfigTargetingEnvironmentFallthrough
     */
     ...
     * Sets fallthrough
     *
     * @param \LaunchDarklyApi\Model\AIConfigTargetingEnvironmentFallthrough $fallthrough fallthrough
     *
     * @return self
     */
     ...
     * Sets off_variation
     *
     * @param int|null $off_variation off_variation
     *
     * @return self
     */
     ...
     * Gets rules
     *
     * @return \LaunchDarklyApi\Model\AIConfigTargetingEnvironmentRule[]
     */
     ...
     * Sets rules
     *
     * @param \LaunchDarklyApi\Model\AIConfigTargetingEnvironmentRule[] $rules rules
     *
     * @return self
     */
     ...
     * Sets targets
     *
     * @param \LaunchDarklyApi\Model\AIConfigTargetingEnvironmentTarget[] $targets targets
     *
     * @return self
     */
     ...
     *
     * @param bool $track_events_fallthrough track_events_fallthrough
     *
     * @return self
     */
