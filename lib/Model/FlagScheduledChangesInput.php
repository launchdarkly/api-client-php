...
/**
 * FlagScheduledChangesInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagScheduledChangesInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagScheduledChangesInput';
     ...
     * Sets comment
     *
     * @param string|null $comment Optional comment describing the update to the scheduled changes
     *
     * @return self
     */
