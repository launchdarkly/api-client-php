...
class Member implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'version' => 'int',
        'role_attributes' => 'array<string,array>'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        '_verified' => false,
        '_pending_email' => false,
        'custom_roles' => false,
        'mfa' => false,
        'excluded_dashboards' => false,
        '_last_seen' => false,
        '_last_seen_metadata' => false,
        '_integration_metadata' => false,
        'teams' => false,
    ...
    protected static $setters = [
        ...
        'version' => 'setVersion',
        'role_attributes' => 'setRoleAttributes'
    ];
    ...
    protected static $getters = [
        ...
        'version' => 'getVersion',
        'role_attributes' => 'getRoleAttributes'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_pending_invite', $data ?? [], null);
        $this->setIfExists('_verified', $data ?? [], null);
        $this->setIfExists('_pending_email', $data ?? [], null);
        $this->setIfExists('custom_roles', $data ?? [], null);
        $this->setIfExists('mfa', $data ?? [], null);
        $this->setIfExists('excluded_dashboards', $data ?? [], null);
        $this->setIfExists('_last_seen', $data ?? [], null);
        $this->setIfExists('_last_seen_metadata', $data ?? [], null);
        $this->setIfExists('_integration_metadata', $data ?? [], null);
        $this->setIfExists('teams', $data ?? [], null);
        $this->setIfExists('permission_grants', $data ?? [], null);
        $this->setIfExists('creation_date', $data ?? [], null);
        $this->setIfExists('oauth_providers', $data ?? [], null);
        $this->setIfExists('version', $data ?? [], null);
        $this->setIfExists('role_attributes', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets role
     *
     * @param string $role The member's base role. If the member has no additional roles, this role will be in effect.
     *
     * @return self
     */
    ...
    {
        if (is_null($_pending_invite)) {
            throw new \InvalidArgumentException('non-nullable _pending_invite cannot be null');
        }
    ...
    {
        if (is_null($_verified)) {
            throw new \InvalidArgumentException('non-nullable _verified cannot be null');
        }
    ...
    {
        if (is_null($_pending_email)) {
            throw new \InvalidArgumentException('non-nullable _pending_email cannot be null');
        }
     ...
     * Sets custom_roles
     *
     * @param string[] $custom_roles The set of additional roles, besides the base role, assigned to the member
     *
     * @return self
     */
    public function setCustomRoles($custom_roles)
    {
        if (is_null($custom_roles)) {
            throw new \InvalidArgumentException('non-nullable custom_roles cannot be null');
        }
    ...
    {
        if (is_null($excluded_dashboards)) {
            throw new \InvalidArgumentException('non-nullable excluded_dashboards cannot be null');
        }
    ...
    {
        if (is_null($_last_seen)) {
            throw new \InvalidArgumentException('non-nullable _last_seen cannot be null');
        }
    ...
    {
        if (is_null($_last_seen_metadata)) {
            throw new \InvalidArgumentException('non-nullable _last_seen_metadata cannot be null');
        }
    ...
    {
        if (is_null($_integration_metadata)) {
            throw new \InvalidArgumentException('non-nullable _integration_metadata cannot be null');
        }
    ...
    {
        if (is_null($permission_grants)) {
            throw new \InvalidArgumentException('non-nullable permission_grants cannot be null');
        }
    ...
    {
        if (is_null($oauth_providers)) {
            throw new \InvalidArgumentException('non-nullable oauth_providers cannot be null');
        }
     ...
     * Sets version
     *
     * @param int|null $version Version of the current configuration
     *
     * @return self
     */
    ...
    /**
     * Gets role_attributes
     *
     * @return array<string,array>|null
     */
    public function getRoleAttributes()
    {
        return $this->container['role_attributes'];
    }

    /**
     * Sets role_attributes
     *
     * @param array<string,array>|null $role_attributes role_attributes
     *
     * @return self
     */
    public function setRoleAttributes($role_attributes)
    {
        if (is_null($role_attributes)) {
            throw new \InvalidArgumentException('non-nullable role_attributes cannot be null');
        }
        $this->container['role_attributes'] = $role_attributes;
