...
class Member implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['excluded_dashboards'] === null) {
            $invalidProperties[] = "'excluded_dashboards' can't be null";
        }
     ...
     *
     * @param bool $_pending_invite Whether or not the member has a pending invitation
     *
     * @return self
     */
     ...
     * Sets _verified
     *
     * @param bool $_verified Whether or not the member's email address has been verified
     *
     * @return self
     */
     ...
     * Sets _pending_email
     *
     * @param string|null $_pending_email _pending_email
     *
     * @return self
     */
     ...
     * Sets mfa
     *
     * @param string $mfa Whether or not multi-factor authentication is enabled for this member
     *
     * @return self
     */
     ...
     *
     * @param string[] $excluded_dashboards Default dashboards that the member has chosen to ignore
     *
     * @return self
     */
     ...
     * Sets teams
     *
     * @param \LaunchDarklyApi\Model\MemberTeamSummaryRep[]|null $teams teams
     *
     * @return self
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\MemberPermissionGrantSummaryRep[]|null $permission_grants permission_grants
     *
     * @return self
     */
