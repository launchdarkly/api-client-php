...
/**
 * UnlinkResourceSuccessResponse Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class UnlinkResourceSuccessResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnlinkResourceSuccessResponse';
    ...
    */
     ...
     * Sets success_count
     *
     * @param int $success_count The number of resources successfully unlinked.
     *
     * @return self
     */
     ...
     * Sets failure_count
     *
     * @param int $failure_count The number of resources that failed to unlink.
     *
     * @return self
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\FailedResourceLink[]|null $failed_resources Details of resources that failed to unlink.
     *
     * @return self
     */
