 ...
 */
class UserSegmentRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserSegmentRule';
    ...
    protected static $setters = [
        ...
        'clauses' => 'setClauses',
        'weight' => 'setWeight',
        'rollout_context_kind' => 'setRolloutContextKind',
    ...
    protected static $getters = [
        ...
        'clauses' => 'getClauses',
        'weight' => 'getWeight',
        'rollout_context_kind' => 'getRolloutContextKind',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rollout_context_kind', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets rollout_context_kind
     *
     * @return string|null
     */
    public function getRolloutContextKind()
    {
        return $this->container['rollout_context_kind'];
    }

    /**
     * Sets rollout_context_kind
     *
     * @param string|null $rollout_context_kind rollout_context_kind
     *
     * @return self
     */
    public function setRolloutContextKind($rollout_context_kind)
    {
        if (is_null($rollout_context_kind)) {
            throw new \InvalidArgumentException('non-nullable rollout_context_kind cannot be null');
        }
        $this->container['rollout_context_kind'] = $rollout_context_kind;
