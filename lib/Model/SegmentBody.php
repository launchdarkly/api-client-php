...
class SegmentBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets unbounded
     *
     * @param bool|null $unbounded Whether to create a standard segment (false) or a Big Segment (true). Only use a Big Segment if you need to add more than 15,000 individual targets.
     *
     * @return self
     */
     ...
     *
     * @param string|null $unbounded_context_kind If unbounded is true, you can use this field to set the Big Segment's context kind
     *
     * @return self
     */
