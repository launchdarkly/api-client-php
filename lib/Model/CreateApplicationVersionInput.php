...
/**
 * CreateApplicationVersionInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateApplicationVersionInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateApplicationVersionInput';
     ...
     * Sets supported
     *
     * @param bool|null $supported Whether this version is supported. Only applicable if the application <code>kind</code> is <code>mobile</code>. Defaults to <code>true</code>.
     *
     * @return self
     */
