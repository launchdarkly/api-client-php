...
/**
 * ExperimentStatsRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExperimentStatsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExperimentStatsRep';
    ...
    protected static $setters = [
        'p_value' => 'setPValue',
        'chi2' => 'setChi2',
        'winning_variation_idx' => 'setWinningVariationIdx',
        'min_sample_size_met' => 'setMinSampleSizeMet'
    ];
    ...
    protected static $getters = [
        'p_value' => 'getPValue',
        'chi2' => 'getChi2',
        'winning_variation_idx' => 'getWinningVariationIdx',
        'min_sample_size_met' => 'getMinSampleSizeMet'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['chi2'] = $data['chi2'] ?? null;
        $this->container['winning_variation_idx'] = $data['winning_variation_idx'] ?? null;
        $this->container['min_sample_size_met'] = $data['min_sample_size_met'] ?? null;
    }
    ...
    {
        return $this->container['chi2'];
    }

    /**
     * Sets chi2
     *
     * @param float|null $chi2 chi2
     *
     * @return self
     */
    public function setChi2($chi2)
    {
        $this->container['chi2'] = $chi2;

        return $this;
    }

    /**
     * Gets winning_variation_idx
     *
     * @return int|null
     */
    public function getWinningVariationIdx()
    {
        return $this->container['winning_variation_idx'];
    }

    /**
     * Sets winning_variation_idx
     *
     * @param int|null $winning_variation_idx winning_variation_idx
     *
     * @return self
     */
    public function setWinningVariationIdx($winning_variation_idx)
    {
        $this->container['winning_variation_idx'] = $winning_variation_idx;

        return $this;
    }

    /**
     * Gets min_sample_size_met
     *
     * @return bool|null
     */
    public function getMinSampleSizeMet()
    {
        return $this->container['min_sample_size_met'];
    }

    /**
     * Sets min_sample_size_met
     *
     * @param bool|null $min_sample_size_met min_sample_size_met
     *
     * @return self
     */
    public function setMinSampleSizeMet($min_sample_size_met)
    {
        $this->container['min_sample_size_met'] = $min_sample_size_met;
