...
class ExpandableApprovalRequestResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'resource' => '\LaunchDarklyApi\Model\ExpandedResourceRep'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'applied_date' => false,
        'applied_by_member_id' => false,
        'applied_by_service_token_id' => false,
        'status' => false,
        'instructions' => false,
        'conflicts' => false,
        '_links' => false,
        ...
        'source' => false,
        'custom_workflow_metadata' => false,
        'resource_id' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('applied_by_member_id', $data ?? [], null);
        $this->setIfExists('applied_by_service_token_id', $data ?? [], null);
        ...
        $this->setIfExists('custom_workflow_metadata', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($applied_by_member_id)) {
            throw new \InvalidArgumentException('non-nullable applied_by_member_id cannot be null');
        }
    ...
    {
        if (is_null($applied_by_service_token_id)) {
            throw new \InvalidArgumentException('non-nullable applied_by_service_token_id cannot be null');
        }
    ...
    {
        if (is_null($custom_workflow_metadata)) {
            throw new \InvalidArgumentException('non-nullable custom_workflow_metadata cannot be null');
        }
     ...
     * Gets resource
     *
     * @return \LaunchDarklyApi\Model\ExpandedResourceRep|null
     */
     ...
     * Sets resource
     *
     * @param \LaunchDarklyApi\Model\ExpandedResourceRep|null $resource resource
     *
     * @return self
     */
