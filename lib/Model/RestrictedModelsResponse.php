 ...
 */
class RestrictedModelsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestrictedModelsResponse';
    ...
    protected static $openAPITypes = [
        'successes' => 'string[]',
        'errors' => '\LaunchDarklyApi\Model\RestrictedModelError[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['successes'] === null) {
            $invalidProperties[] = "'successes' can't be null";
        }
    ...
    public function setSuccesses($successes)
    {
        if (is_null($successes)) {
            throw new \InvalidArgumentException('non-nullable successes cannot be null');
        }
     ...
     * Gets errors
     *
     * @return \LaunchDarklyApi\Model\RestrictedModelError[]
     */
     ...
     * Sets errors
     *
     * @param \LaunchDarklyApi\Model\RestrictedModelError[] $errors errors
     *
     * @return self
     */
