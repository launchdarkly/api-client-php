...
class RepositoryPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['commit_url_template'] = $data['commit_url_template'] ?? null;
        $this->container['hunk_url_template'] = $data['hunk_url_template'] ?? null;
     ...
     * Sets default_branch
     *
     * @param string|null $default_branch The repository's default branch. If not specified, the default value is <code>master</code>.
     *
     * @return self
     */
