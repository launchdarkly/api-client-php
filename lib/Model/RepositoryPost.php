...
/**
 * RepositoryPost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class RepositoryPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'repositoryPost';
    ...
    protected static array $openAPINullables = [
        'name' => false,
        'source_link' => false,
        'commit_url_template' => false,
        'hunk_url_template' => false,
        'type' => false,
    ...
    protected static $setters = [
        ...
        'commit_url_template' => 'setCommitUrlTemplate',
        'hunk_url_template' => 'setHunkUrlTemplate',
        'type' => 'setType',
    ...
    protected static $getters = [
        ...
        'commit_url_template' => 'getCommitUrlTemplate',
        'hunk_url_template' => 'getHunkUrlTemplate',
        'type' => 'getType',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('commit_url_template', $data ?? [], null);
        $this->setIfExists('hunk_url_template', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets commit_url_template
     *
     * @return string|null
     */
    public function getCommitUrlTemplate()
    {
        return $this->container['commit_url_template'];
    }
     ...
     * @return self
     */
    public function setCommitUrlTemplate($commit_url_template)
    {
        if (is_null($commit_url_template)) {
            throw new \InvalidArgumentException('non-nullable commit_url_template cannot be null');
        }
        $this->container['commit_url_template'] = $commit_url_template;

        return $this;
    }

    /**
     * Gets hunk_url_template
     *
     * @return string|null
     */
    public function getHunkUrlTemplate()
    {
        return $this->container['hunk_url_template'];
    }
     ...
     * @return self
     */
    public function setHunkUrlTemplate($hunk_url_template)
    {
        if (is_null($hunk_url_template)) {
            throw new \InvalidArgumentException('non-nullable hunk_url_template cannot be null');
        }
        $this->container['hunk_url_template'] = $hunk_url_template;
     ...
     * Sets type
     *
     * @param string|null $type The type of repository. If not specified, the default value is <code>custom</code>.
     *
     * @return self
     */
     ...
     * Sets default_branch
     *
     * @param string|null $default_branch The repository's default branch. If not specified, the default value is <code>main</code>.
     *
     * @return self
     */
