...
class RepositoryPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets type
     *
     * @param string|null $type Optionally specify a repository type. The default value is <code>custom</code>
     *
     * @return self
     */
     ...
     * Sets default_branch
     *
     * @param string|null $default_branch The default branch, if not specified, is <code>master</code>
     *
     * @return self
     */
