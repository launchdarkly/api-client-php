...
/**
 * ReleasePhase Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleasePhase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleasePhase';
    ...
    protected static $setters = [
        ...
        '_completion_date' => 'setCompletionDate',
        '_completed_by' => 'setCompletedBy',
        '_audiences' => 'setAudiences',
        'status' => 'setStatus',
        'started' => 'setStarted',
        '_started_date' => 'setStartedDate',
    ...
    protected static $getters = [
        ...
        '_completion_date' => 'getCompletionDate',
        '_completed_by' => 'getCompletedBy',
        '_audiences' => 'getAudiences',
        'status' => 'getStatus',
        'started' => 'getStarted',
        '_started_date' => 'getStartedDate',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_completion_date', $data ?? [], null);
        $this->setIfExists('_completed_by', $data ?? [], null);
        $this->setIfExists('_audiences', $data ?? [], null);
        $this->setIfExists('status', $data ?? [], null);
        $this->setIfExists('started', $data ?? [], null);
        $this->setIfExists('_started_date', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_name'] === null) {
            $invalidProperties[] = "'_name' can't be null";
        }
        ...
        if ($this->container['_audiences'] === null) {
            $invalidProperties[] = "'_audiences' can't be null";
        }
     ...
     * Sets _name
     *
     * @param string $_name The release phase name
     *
     * @return self
     */
     ...
     * Sets complete
     *
     * @param bool $complete Whether this phase is complete
     *
     * @return self
     */
    ...
    /**
     * Gets _completion_date
     *
     * @return int|null
     */
    public function getCompletionDate()
    {
        return $this->container['_completion_date'];
    }

    /**
     * Sets _completion_date
     *
     * @param int|null $_completion_date _completion_date
     *
     * @return self
     */
    public function setCompletionDate($_completion_date)
    {
        if (is_null($_completion_date)) {
            throw new \InvalidArgumentException('non-nullable _completion_date cannot be null');
        }
        $this->container['_completion_date'] = $_completion_date;
     ...
     * Gets _completed_by
     *
     * @return \LaunchDarklyApi\Model\CompletedBy|null
     */
    public function getCompletedBy()
    {
        return $this->container['_completed_by'];
    }

    /**
     * Sets _completed_by
     *
     * @param \LaunchDarklyApi\Model\CompletedBy|null $_completed_by _completed_by
     *
     * @return self
     */
    public function setCompletedBy($_completed_by)
    {
        if (is_null($_completed_by)) {
            throw new \InvalidArgumentException('non-nullable _completed_by cannot be null');
        }
        $this->container['_completed_by'] = $_completed_by;
    ...
    {
        return $this->container['_audiences'];
    }
     ...
     * @return self
     */
    public function setAudiences($_audiences)
    {
        if (is_null($_audiences)) {
            throw new \InvalidArgumentException('non-nullable _audiences cannot be null');
        }
        $this->container['_audiences'] = $_audiences;
     ...
     * Sets started
     *
     * @param bool|null $started Whether or not this phase has started
     *
     * @return self
     */
    ...
    {
        return $this->container['_started_date'];
    }

    /**
     * Sets _started_date
     *
     * @param int|null $_started_date _started_date
     *
     * @return self
     */
    public function setStartedDate($_started_date)
    {
        if (is_null($_started_date)) {
            throw new \InvalidArgumentException('non-nullable _started_date cannot be null');
        }
        $this->container['_started_date'] = $_started_date;
