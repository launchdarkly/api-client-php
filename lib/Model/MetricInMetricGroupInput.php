...
/**
 * MetricInMetricGroupInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class MetricInMetricGroupInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MetricInMetricGroupInput';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['name_in_group'] === null) {
            $invalidProperties[] = "'name_in_group' can't be null";
        }
     ...
     * Sets name_in_group
     *
     * @param string $name_in_group Name of the metric when used within the associated metric group. Can be different from the original name of the metric
     *
     * @return self
     */
