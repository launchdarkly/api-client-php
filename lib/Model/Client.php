...
class Client implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        '_client_id' => 'setClientId',
        '_client_secret' => 'setClientSecret',
    ...
    protected static $getters = [
        ...
        '_client_secret' => 'getClientSecret',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_client_id', $data ?? [], null);
        $this->setIfExists('_client_secret', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_client_id'] === null) {
            $invalidProperties[] = "'_client_id' can't be null";
        }
     ...
     * Sets _account_id
     *
     * @param string $_account_id The account ID the client is registered under
     *
     * @return self
     */
    ...
    {
        return $this->container['_client_id'];
    }

    /**
     * Sets _client_id
     *
     * @param string $_client_id The client's unique ID
     *
     * @return self
     */
    public function setClientId($_client_id)
    {
        if (is_null($_client_id)) {
            throw new \InvalidArgumentException('non-nullable _client_id cannot be null');
        }
        $this->container['_client_id'] = $_client_id;
    ...
    {
        return $this->container['_client_secret'];
    }

    /**
     * Sets _client_secret
     *
     * @param string|null $_client_secret The client secret. This will only be shown upon creation.
     *
     * @return self
     */
    public function setClientSecret($_client_secret)
    {
        if (is_null($_client_secret)) {
            throw new \InvalidArgumentException('non-nullable _client_secret cannot be null');
        }
        $this->container['_client_secret'] = $_client_secret;
