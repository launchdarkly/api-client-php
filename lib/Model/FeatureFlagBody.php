 ...
 */
class FeatureFlagBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeatureFlagBody';
    ...
    protected static $openAPITypes = [
        ...
        'client_side_availability' => '\LaunchDarklyApi\Model\ClientSideAvailabilityPost',
        ...
        'initial_prerequisites' => '\LaunchDarklyApi\Model\FlagPrerequisitePost[]',
        'is_flag_on' => 'bool'
    ];
    ...
    protected static $setters = [
        ...
        'initial_prerequisites' => 'setInitialPrerequisites',
        'is_flag_on' => 'setIsFlagOn'
    ];
    ...
    protected static $getters = [
        ...
        'initial_prerequisites' => 'getInitialPrerequisites',
        'is_flag_on' => 'getIsFlagOn'
    ];
    ...
    public const PURPOSE_MIGRATION = 'migration';
    public const PURPOSE_HOLDOUT = 'holdout';
    ...
    {
        return [
            self::PURPOSE_MIGRATION,
            self::PURPOSE_HOLDOUT,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('initial_prerequisites', $data ?? [], null);
        $this->setIfExists('is_flag_on', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description Description of the feature flag. Defaults to an empty string.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $include_in_snippet Deprecated, use <code>clientSideAvailability</code>. Whether this flag should be made available to the client-side JavaScript SDK. Defaults to <code>false</code>.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @return \LaunchDarklyApi\Model\ClientSideAvailabilityPost|null
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\ClientSideAvailabilityPost|null $client_side_availability client_side_availability
     *
     * @return self
     */
     ...
     * Gets variations
     *
     * @return \LaunchDarklyApi\Model\Variation[]|null
     */
     ...
     * Sets variations
     *
     * @param \LaunchDarklyApi\Model\Variation[]|null $variations An array of possible variations for the flag. The variation values must be unique. If omitted, two boolean variations of <code>true</code> and <code>false</code> will be used.
     *
     * @return self
     */
     ...
     * Sets temporary
     *
     * @param bool|null $temporary Whether the flag is a temporary flag. Defaults to <code>true</code>.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags for the feature flag. Defaults to an empty array.
     *
     * @return self
     */
     ...
     *
     * @return array<string,\LaunchDarklyApi\Model\CustomProperty>|null
     */
     ...
     *
     * @param array<string,\LaunchDarklyApi\Model\CustomProperty>|null $custom_properties custom_properties
     *
     * @return self
     */
     ...
     * Sets purpose
     *
     * @param string|null $purpose Purpose of the flag
     *
     * @return self
     */
     ...
     *
     * @return \LaunchDarklyApi\Model\MigrationSettingsPost|null
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\MigrationSettingsPost|null $migration_settings migration_settings
     *
     * @return self
     */
    ...
    /**
     * Gets initial_prerequisites
     *
     * @return \LaunchDarklyApi\Model\FlagPrerequisitePost[]|null
     */
    public function getInitialPrerequisites()
    {
        return $this->container['initial_prerequisites'];
    }

    /**
     * Sets initial_prerequisites
     *
     * @param \LaunchDarklyApi\Model\FlagPrerequisitePost[]|null $initial_prerequisites Initial set of prerequisite flags for all environments
     *
     * @return self
     */
    public function setInitialPrerequisites($initial_prerequisites)
    {
        if (is_null($initial_prerequisites)) {
            throw new \InvalidArgumentException('non-nullable initial_prerequisites cannot be null');
        }
        $this->container['initial_prerequisites'] = $initial_prerequisites;
     ...
     * @return bool|null
     */
    public function getIsFlagOn()
    {
        return $this->container['is_flag_on'];
    }

    /**
     * Sets is_flag_on
     *
     * @param bool|null $is_flag_on Whether to automatically turn the flag on across all environments at creation. Defaults to <code>false</code>.
     *
     * @return self
     */
    public function setIsFlagOn($is_flag_on)
    {
        if (is_null($is_flag_on)) {
            throw new \InvalidArgumentException('non-nullable is_flag_on cannot be null');
        }
        $this->container['is_flag_on'] = $is_flag_on;
