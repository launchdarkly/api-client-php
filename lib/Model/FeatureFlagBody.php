...
class FeatureFlagBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets key
     *
     * @param string $key A unique key to reference the flag in your code
     *
     * @return self
     */
     ...
     * Sets variations
     *
     * @param \LaunchDarklyApi\Model\Variation[]|null $variations An array of possible variations for the flag. The variation values must be unique.
     *
     * @return self
     */
     ...
     * Sets temporary
     *
     * @param bool|null $temporary Whether or not the flag is a temporary flag
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags for the feature flag
     *
     * @return self
     */
