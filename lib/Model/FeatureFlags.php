...
/**
 * FeatureFlags Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FeatureFlags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeatureFlags';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\FeatureFlag[]',
        '_links' => 'array<string,\LaunchDarklyApi\Model\Link>',
        'total_count' => 'int',
        'total_count_with_differences' => 'int'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        '_links' => false,
        'total_count' => false,
        'total_count_with_differences' => false
    ];
    ...
    protected static $setters = [
        ...
        'total_count_with_differences' => 'setTotalCountWithDifferences'
    ];
    ...
    protected static $getters = [
        ...
        'total_count_with_differences' => 'getTotalCountWithDifferences'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('total_count_with_differences', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\FeatureFlag[] $items An array of feature flags
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int|null $total_count The total number of flags
     *
     * @return self
     */
    ...
    /**
     * Gets total_count_with_differences
     *
     * @return int|null
     */
    public function getTotalCountWithDifferences()
    {
        return $this->container['total_count_with_differences'];
    }

    /**
     * Sets total_count_with_differences
     *
     * @param int|null $total_count_with_differences The number of flags that have differences between environments. Only shown when query parameter <code>compare</code> is <code>true</code>.
     *
     * @return self
     */
    public function setTotalCountWithDifferences($total_count_with_differences)
    {
        if (is_null($total_count_with_differences)) {
            throw new \InvalidArgumentException('non-nullable total_count_with_differences cannot be null');
        }
        $this->container['total_count_with_differences'] = $total_count_with_differences;
