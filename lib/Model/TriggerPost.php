...
class TriggerPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets instructions
     *
     * @param array[]|null $instructions The action to perform when triggering. It should pass an array with a single {\"kind\": <flag_action>} object. Currently supported flag actions are \"turnFlagOn\" and \"turnFlagOff\".
     *
     * @return self
     */
