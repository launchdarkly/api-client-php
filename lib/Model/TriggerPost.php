 ...
 */
class TriggerPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'triggerPost';
    ...
    */
     ...
     * Sets comment
     *
     * @param string|null $comment Optional comment describing the trigger
     *
     * @return self
     */
     ...
     * Sets instructions
     *
     * @param array[]|null $instructions The action to perform when triggering. This should be an array with a single object that looks like <code>{\"kind\": \"flag_action\"}</code>. Supported flag actions are <code>turnFlagOn</code> and <code>turnFlagOff</code>.
     *
     * @return self
     */
     ...
     *
     * @param string $integration_key The unique identifier of the integration for your trigger. Use <code>generic-trigger</code> for integrations not explicitly supported.
     *
     * @return self
     */
