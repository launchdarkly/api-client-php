...
class TriggerPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets instructions
     *
     * @param mixed[]|null $instructions The action to perform when triggering. It should pass an array with a single {\"kind\": <flag_action>} object. Currently supported flag actions are \"turnFlagOn\" and \"turnFlagOff\".
     *
     * @return self
     */
     ...
     *
     * @param string $integration_key The unique identifier of the integration you intend to set your trigger up with. \"generic-trigger\" should be used for integrations not explicitly supported.
     *
     * @return self
     */
