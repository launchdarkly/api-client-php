...
/**
 * ReleaseProgression Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleaseProgression implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleaseProgression';
    ...
    protected static $setters = [
        ...
        '_completed_at' => 'setCompletedAt',
        'flag_key' => 'setFlagKey',
        'active_phase_id' => 'setActivePhaseId',
        '_links' => 'setLinks'
    ];
    ...
    protected static $getters = [
        ...
        '_completed_at' => 'getCompletedAt',
        'flag_key' => 'getFlagKey',
        'active_phase_id' => 'getActivePhaseId',
        '_links' => 'getLinks'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_completed_at', $data ?? [], null);
        $this->setIfExists('flag_key', $data ?? [], null);
        $this->setIfExists('active_phase_id', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['_completed_at'];
    }

    /**
     * Sets _completed_at
     *
     * @param int|null $_completed_at _completed_at
     *
     * @return self
     */
    public function setCompletedAt($_completed_at)
    {
        if (is_null($_completed_at)) {
            throw new \InvalidArgumentException('non-nullable _completed_at cannot be null');
        }
        $this->container['_completed_at'] = $_completed_at;
    ...
    /**
     * Gets active_phase_id
     *
     * @return string|null
     */
    public function getActivePhaseId()
    {
        return $this->container['active_phase_id'];
    }

    /**
     * Sets active_phase_id
     *
     * @param string|null $active_phase_id The ID of the currently active release phase
     *
     * @return self
     */
    public function setActivePhaseId($active_phase_id)
    {
        if (is_null($active_phase_id)) {
            throw new \InvalidArgumentException('non-nullable active_phase_id cannot be null');
        }
        $this->container['active_phase_id'] = $active_phase_id;
