...
/**
 * MetricGroupPost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class MetricGroupPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MetricGroupPost';
    ...
    protected static $openAPITypes = [
        ...
        'tags' => 'string[]',
        'metrics' => '\LaunchDarklyApi\Model\MetricInMetricGroupInput[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['maintainer_id'] === null) {
            $invalidProperties[] = "'maintainer_id' can't be null";
        }
     ...
     * Sets key
     *
     * @param string|null $key A unique key to reference the metric group
     *
     * @return self
     */
     ...
     * Sets maintainer_id
     *
     * @param string $maintainer_id The ID of the member who maintains this metric group
     *
     * @return self
     */
     ...
     * Gets metrics
     *
     * @return \LaunchDarklyApi\Model\MetricInMetricGroupInput[]
     */
     ...
     * Sets metrics
     *
     * @param \LaunchDarklyApi\Model\MetricInMetricGroupInput[] $metrics An ordered list of the metrics in this metric group
     *
     * @return self
     */
