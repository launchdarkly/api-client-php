...
/**
 * FlagMigrationSettingsRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagMigrationSettingsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagMigrationSettingsRep';
    ...
    */
     ...
     * Sets context_kind
     *
     * @param string|null $context_kind The context kind targeted by this migration flag. Only applicable for six-stage migrations.
     *
     * @return self
     */
     ...
     * Sets stage_count
     *
     * @param int|null $stage_count The number of stages for this migration flag
     *
     * @return self
     */
