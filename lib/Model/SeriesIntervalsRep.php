...
/**
 * SeriesIntervalsRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class SeriesIntervalsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SeriesIntervalsRep';
    ...
    protected static $openAPITypes = [
        'series' => '\LaunchDarklyApi\Model\Series[]',
     ...
     * Gets series
     *
     * @return \LaunchDarklyApi\Model\Series[]
     */
     ...
     * Sets series
     *
     * @param \LaunchDarklyApi\Model\Series[] $series An array of timestamps and values for a given meter
     *
     * @return self
     */
