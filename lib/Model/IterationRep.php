...
class IterationRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'reallocation_frequency_millis' => 'int',
        'version' => 'int',
    ...
    protected static $openAPIFormats = [
        ...
        'flags' => null,
        'reallocation_frequency_millis' => null,
        'version' => null,
        'primary_metric' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'started_at' => false,
        'ended_at' => false,
        'winning_treatment_id' => false,
        'winning_reason' => false,
        'can_reshuffle_traffic' => false,
        'flags' => false,
        'reallocation_frequency_millis' => false,
        'version' => false,
        'primary_metric' => false,
        'primary_single_metric' => false,
        'primary_funnel' => false,
    ...
    protected static $setters = [
        ...
        'flags' => 'setFlags',
        'reallocation_frequency_millis' => 'setReallocationFrequencyMillis',
        'version' => 'setVersion',
    ...
    protected static $getters = [
        ...
        'flags' => 'getFlags',
        'reallocation_frequency_millis' => 'getReallocationFrequencyMillis',
        'version' => 'getVersion',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('winning_treatment_id', $data ?? [], null);
        $this->setIfExists('winning_reason', $data ?? [], null);
        $this->setIfExists('can_reshuffle_traffic', $data ?? [], null);
        $this->setIfExists('flags', $data ?? [], null);
        $this->setIfExists('reallocation_frequency_millis', $data ?? [], null);
        $this->setIfExists('version', $data ?? [], null);
        $this->setIfExists('primary_metric', $data ?? [], null);
        $this->setIfExists('primary_single_metric', $data ?? [], null);
        $this->setIfExists('primary_funnel', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($winning_treatment_id)) {
            throw new \InvalidArgumentException('non-nullable winning_treatment_id cannot be null');
        }
    ...
    {
        if (is_null($winning_reason)) {
            throw new \InvalidArgumentException('non-nullable winning_reason cannot be null');
        }
    ...
    /**
     * Gets reallocation_frequency_millis
     *
     * @return int|null
     */
    public function getReallocationFrequencyMillis()
    {
        return $this->container['reallocation_frequency_millis'];
    }

    /**
     * Sets reallocation_frequency_millis
     *
     * @param int|null $reallocation_frequency_millis The cadence (in milliseconds) to update the allocation. Only present for multi-armed bandits.
     *
     * @return self
     */
    public function setReallocationFrequencyMillis($reallocation_frequency_millis)
    {
        if (is_null($reallocation_frequency_millis)) {
            throw new \InvalidArgumentException('non-nullable reallocation_frequency_millis cannot be null');
        }
        $this->container['reallocation_frequency_millis'] = $reallocation_frequency_millis;
     ...
     * Sets version
     *
     * @param int|null $version The current version that the iteration is on
     *
     * @return self
     */
    ...
    {
        if (is_null($primary_metric)) {
            throw new \InvalidArgumentException('non-nullable primary_metric cannot be null');
        }
    ...
    {
        if (is_null($primary_single_metric)) {
            throw new \InvalidArgumentException('non-nullable primary_single_metric cannot be null');
        }
    ...
    {
        if (is_null($primary_funnel)) {
            throw new \InvalidArgumentException('non-nullable primary_funnel cannot be null');
        }
    ...
    {
        if (is_null($secondary_metrics)) {
            throw new \InvalidArgumentException('non-nullable secondary_metrics cannot be null');
        }
