...
class IterationRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $winning_treatment_id The ID of the treatment with the probability to be best
     *
     * @return self
     */
     ...
     *
     * @param bool|null $can_reshuffle_traffic Whether the experiment is allowed to reassign users to different variations (true) or must keep users assigned to their initial variation (false).
     *
     * @return self
     */
