...
/**
 * ExpandedLinkedResourcesAIConfigs Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExpandedLinkedResourcesAIConfigs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandedLinkedResourcesAIConfigs';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\ExpandedAIConfig[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\ExpandedAIConfig[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ExpandedAIConfig[] $items items
     *
     * @return self
     */
