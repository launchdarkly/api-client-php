...
/**
 * ReleaseAudience Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleaseAudience implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleaseAudience';
    ...
    protected static $openAPITypes = [
        ...
        'environment' => '\LaunchDarklyApi\Model\EnvironmentSummary',
        'name' => 'string',
        'configuration' => '\LaunchDarklyApi\Model\AudienceConfiguration',
        'segment_keys' => 'string[]',
        'status' => 'string',
        '_rule_ids' => 'string[]'
    ];
    ...
    protected static $setters = [
        ...
        'segment_keys' => 'setSegmentKeys',
        'status' => 'setStatus',
        '_rule_ids' => 'setRuleIds'
    ];
    ...
    protected static $getters = [
        ...
        'segment_keys' => 'getSegmentKeys',
        'status' => 'getStatus',
        '_rule_ids' => 'getRuleIds'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('segment_keys', $data ?? [], null);
        $this->setIfExists('status', $data ?? [], null);
        $this->setIfExists('_rule_ids', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets _id
     *
     * @param string $_id The audience ID
     *
     * @return self
     */
     ...
     * Gets environment
     *
     * @return \LaunchDarklyApi\Model\EnvironmentSummary|null
     */
     ...
     * Sets environment
     *
     * @param \LaunchDarklyApi\Model\EnvironmentSummary|null $environment environment
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The release phase name
     *
     * @return self
     */
     ...
     * Gets configuration
     *
     * @return \LaunchDarklyApi\Model\AudienceConfiguration|null
     */
     ...
     * Sets configuration
     *
     * @param \LaunchDarklyApi\Model\AudienceConfiguration|null $configuration configuration
     *
     * @return self
     */
    ...
    {
        return $this->container['segment_keys'];
    }

    /**
     * Sets segment_keys
     *
     * @param string[]|null $segment_keys A list of segment keys
     *
     * @return self
     */
    public function setSegmentKeys($segment_keys)
    {
        if (is_null($segment_keys)) {
            throw new \InvalidArgumentException('non-nullable segment_keys cannot be null');
        }
        $this->container['segment_keys'] = $segment_keys;
    ...
    {
        return $this->container['_rule_ids'];
    }

    /**
     * Sets _rule_ids
     *
     * @param string[]|null $_rule_ids The rules IDs added or updated by this audience
     *
     * @return self
     */
    public function setRuleIds($_rule_ids)
    {
        if (is_null($_rule_ids)) {
            throw new \InvalidArgumentException('non-nullable _rule_ids cannot be null');
        }
        $this->container['_rule_ids'] = $_rule_ids;
