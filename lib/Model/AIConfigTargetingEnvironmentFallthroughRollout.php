...
/**
 * AIConfigTargetingEnvironmentFallthroughRollout Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AIConfigTargetingEnvironmentFallthroughRollout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AIConfigTargetingEnvironmentFallthroughRollout';
    ...
    protected static $openAPITypes = [
        'bucket_by' => 'string',
        'context_kind' => 'string',
        'experiment_allocation' => '\LaunchDarklyApi\Model\AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation',
        'seed' => 'int',
        'variations' => '\LaunchDarklyApi\Model\AIConfigTargetingEnvironmentFallthroughRolloutVariation[]'
    ];
    ...
    protected static $setters = [
        ...
        'experiment_allocation' => 'setExperimentAllocation',
        'seed' => 'setSeed',
    ...
    protected static $getters = [
        ...
        'experiment_allocation' => 'getExperimentAllocation',
        'seed' => 'getSeed',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('experiment_allocation', $data ?? [], null);
    ...
    */
     ...
     * Sets bucket_by
     *
     * @param string|null $bucket_by bucket_by
     *
     * @return self
     */
     ...
     * Sets context_kind
     *
     * @param string $context_kind context_kind
     *
     * @return self
     */
    ...
    /**
     * Gets experiment_allocation
     *
     * @return \LaunchDarklyApi\Model\AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation|null
     */
    public function getExperimentAllocation()
    {
        return $this->container['experiment_allocation'];
    }

    /**
     * Sets experiment_allocation
     *
     * @param \LaunchDarklyApi\Model\AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation|null $experiment_allocation experiment_allocation
     *
     * @return self
     */
    public function setExperimentAllocation($experiment_allocation)
    {
        if (is_null($experiment_allocation)) {
            throw new \InvalidArgumentException('non-nullable experiment_allocation cannot be null');
        }
        $this->container['experiment_allocation'] = $experiment_allocation;
     ...
     * Gets variations
     *
     * @return \LaunchDarklyApi\Model\AIConfigTargetingEnvironmentFallthroughRolloutVariation[]
     */
     ...
     * Sets variations
     *
     * @param \LaunchDarklyApi\Model\AIConfigTargetingEnvironmentFallthroughRolloutVariation[] $variations variations
     *
     * @return self
     */
