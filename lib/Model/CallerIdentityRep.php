...
/**
 * CallerIdentityRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CallerIdentityRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CallerIdentityRep';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('token_kind', $data ?? [], null);
    ...
    */
     ...
     * Sets auth_kind
     *
     * @param string|null $auth_kind auth_kind
     *
     * @return self
     */
    ...
    {
        return $this->container['token_kind'];
    }

    /**
     * Sets token_kind
     *
     * @param string|null $token_kind token_kind
     *
     * @return self
     */
    public function setTokenKind($token_kind)
    {
        if (is_null($token_kind)) {
            throw new \InvalidArgumentException('non-nullable token_kind cannot be null');
        }
        $this->container['token_kind'] = $token_kind;
