 ...
 */
class PutBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'putBranch';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('update_sequence_id', $data ?? [], null);
        $this->setIfExists('sync_time', $data ?? [], null);
        $this->setIfExists('references', $data ?? [], null);
        $this->setIfExists('commit_time', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets update_sequence_id
     *
     * @return int|null
     */
    public function getUpdateSequenceId()
    {
        return $this->container['update_sequence_id'];
    }

    /**
     * Sets update_sequence_id
     *
     * @param int|null $update_sequence_id An optional ID used to prevent older data from overwriting newer data. If no sequence ID is included, the newly submitted data will always be saved.
     *
     * @return self
     */
    public function setUpdateSequenceId($update_sequence_id)
    {
        if (is_null($update_sequence_id)) {
            throw new \InvalidArgumentException('non-nullable update_sequence_id cannot be null');
        }
        $this->container['update_sequence_id'] = $update_sequence_id;
    ...
    {
        if (is_null($sync_time)) {
            throw new \InvalidArgumentException('non-nullable sync_time cannot be null');
        }
     ...
     * Gets references
     *
     * @return \LaunchDarklyApi\Model\ReferenceRep[]|null
     */
    ...
    {
        if (is_null($commit_time)) {
            throw new \InvalidArgumentException('non-nullable commit_time cannot be null');
        }
