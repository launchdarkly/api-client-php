...
class EnvironmentPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets secure_mode
     *
     * @param bool|null $secure_mode Secure mode ensures that a user of the client-side SDK cannot impersonate another user.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $confirm_changes Require confirmation for all flag and segment changes via the UI in this environment.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $require_comments Require comments for all flag and segment changes via the UI in this environment.
     *
     * @return self
     */
