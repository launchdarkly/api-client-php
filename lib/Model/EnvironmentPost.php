 ...
 */
class EnvironmentPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnvironmentPost';
    ...
    protected static $openAPITypes = [
        ...
        'tags' => 'string[]',
        'source' => '\LaunchDarklyApi\Model\SourceEnv',
        'critical' => 'bool'
    ];
    ...
    */
     ...
     * Sets color
     *
     * @param string $color A color to indicate this environment in the UI
     *
     * @return self
     */
     ...
     * Sets default_ttl
     *
     * @param int|null $default_ttl The default time (in minutes) that the PHP SDK can cache feature flag rules locally
     *
     * @return self
     */
     ...
     * Sets secure_mode
     *
     * @param bool|null $secure_mode Ensures that one end user of the client-side SDK cannot inspect the variations for another end user
     *
     * @return self
     */
     ...
     *
     * @param bool|null $default_track_events Enables tracking detailed information for new flags by default
     *
     * @return self
     */
     ...
     *
     * @param bool|null $confirm_changes Requires confirmation for all flag and segment changes via the UI in this environment
     *
     * @return self
     */
     ...
     *
     * @param bool|null $require_comments Requires comments for all flag and segment changes via the UI in this environment
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags to apply to the new environment
     *
     * @return self
     */
     ...
     * Gets source
     *
     * @return \LaunchDarklyApi\Model\SourceEnv|null
     */
     ...
     * Sets source
     *
     * @param \LaunchDarklyApi\Model\SourceEnv|null $source source
     *
     * @return self
     */
     ...
     * Sets critical
     *
     * @param bool|null $critical Whether the environment is critical
     *
     * @return self
     */
