 ...
 */
class MemberInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberInput';
     ...
     * Sets id
     *
     * @param string|null $id The ID of the associated member who maintains the application
     *
     * @return self
     */
