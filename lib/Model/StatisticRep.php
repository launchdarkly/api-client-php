...
/**
 * StatisticRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class StatisticRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatisticRep';
    ...
    protected static $setters = [
        'name' => 'setName',
        'type' => 'setType',
        'source_link' => 'setSourceLink',
        'default_branch' => 'setDefaultBranch',
        'enabled' => 'setEnabled',
        'version' => 'setVersion',
        'hunk_count' => 'setHunkCount',
        'file_count' => 'setFileCount',
        '_links' => 'setLinks',
        'latest_commit_time' => 'setLatestCommitTime'
    ];
    ...
    protected static $getters = [
        ...
        'enabled' => 'getEnabled',
        'version' => 'getVersion',
        'hunk_count' => 'getHunkCount',
        'file_count' => 'getFileCount',
        '_links' => 'getLinks',
        'latest_commit_time' => 'getLatestCommitTime'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('source_link', $data ?? [], null);
        $this->setIfExists('default_branch', $data ?? [], null);
        $this->setIfExists('enabled', $data ?? [], null);
        $this->setIfExists('version', $data ?? [], null);
        $this->setIfExists('hunk_count', $data ?? [], null);
        $this->setIfExists('file_count', $data ?? [], null);
        $this->setIfExists('_links', $data ?? [], null);
        $this->setIfExists('latest_commit_time', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['source_link'] === null) {
            $invalidProperties[] = "'source_link' can't be null";
        }
        ...
        if ($this->container['hunk_count'] === null) {
            $invalidProperties[] = "'hunk_count' can't be null";
        }
    ...
    {
        return $this->container['source_link'];
    }

    /**
     * Sets source_link
     *
     * @param string $source_link A URL to access the repository
     *
     * @return self
     */
    public function setSourceLink($source_link)
    {
        if (is_null($source_link)) {
            throw new \InvalidArgumentException('non-nullable source_link cannot be null');
        }
        $this->container['source_link'] = $source_link;
     ...
     * @return int
     */
    public function getHunkCount()
    {
        return $this->container['hunk_count'];
    }

    /**
     * Sets hunk_count
     *
     * @param int $hunk_count The number of code reference hunks in which the flag appears in this repository
     *
     * @return self
     */
    public function setHunkCount($hunk_count)
    {
        if (is_null($hunk_count)) {
            throw new \InvalidArgumentException('non-nullable hunk_count cannot be null');
        }
        $this->container['hunk_count'] = $hunk_count;
     ...
     * Sets file_count
     *
     * @param int $file_count The number of files in which the flag appears in this repository
     *
     * @return self
     */
    ...
    /**
     * Gets latest_commit_time
     *
     * @return int|null
     */
    public function getLatestCommitTime()
    {
        return $this->container['latest_commit_time'];
    }

    /**
     * Sets latest_commit_time
     *
     * @param int|null $latest_commit_time latest_commit_time
     *
     * @return self
     */
    public function setLatestCommitTime($latest_commit_time)
    {
        if (is_null($latest_commit_time)) {
            throw new \InvalidArgumentException('non-nullable latest_commit_time cannot be null');
        }
        $this->container['latest_commit_time'] = $latest_commit_time;
