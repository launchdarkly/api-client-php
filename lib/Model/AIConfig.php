 ...
 */
class AIConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AIConfig';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'key' => 'string',
        '_maintainer' => '\LaunchDarklyApi\Model\AIConfigMaintainer',
        'mode' => 'string',
        'name' => 'string',
        'tags' => 'string[]',
        'version' => 'int',
    ...
    */
     ...
     * Gets _maintainer
     *
     * @return \LaunchDarklyApi\Model\AIConfigMaintainer|null
     */
     ...
     * Sets _maintainer
     *
     * @param \LaunchDarklyApi\Model\AIConfigMaintainer|null $_maintainer _maintainer
     *
     * @return self
     */
     ...
     * Gets variations
     *
     * @return \LaunchDarklyApi\Model\AIConfigVariation[]
     */
     ...
     * Sets variations
     *
     * @param \LaunchDarklyApi\Model\AIConfigVariation[] $variations variations
     *
     * @return self
     */
