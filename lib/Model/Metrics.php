...
class Metrics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'generation_success_count' => false,
        'generation_error_count' => false,
        'thumbs_up' => false,
        'thumbs_down' => false,
        'duration_ms' => false,
    ...
    protected static $setters = [
        ...
        'generation_count' => 'setGenerationCount',
        'generation_success_count' => 'setGenerationSuccessCount',
        'generation_error_count' => 'setGenerationErrorCount',
        'thumbs_up' => 'setThumbsUp',
        'thumbs_down' => 'setThumbsDown',
    ...
    protected static $getters = [
        ...
        'generation_success_count' => 'getGenerationSuccessCount',
        'generation_error_count' => 'getGenerationErrorCount',
        'thumbs_up' => 'getThumbsUp',
        'thumbs_down' => 'getThumbsDown',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('generation_count', $data ?? [], null);
        $this->setIfExists('generation_success_count', $data ?? [], null);
        $this->setIfExists('generation_error_count', $data ?? [], null);
        $this->setIfExists('thumbs_up', $data ?? [], null);
        $this->setIfExists('thumbs_down', $data ?? [], null);
        $this->setIfExists('duration_ms', $data ?? [], null);
        $this->setIfExists('time_to_first_token_ms', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['satisfaction_rating']) && ($this->container['satisfaction_rating'] > 1)) {
            $invalidProperties[] = "invalid value for 'satisfaction_rating', must be smaller than or equal to 1.";
        }
    ...
    {
        return $this->container['generation_count'];
    }

    /**
     * Sets generation_count
     *
     * @param int|null $generation_count Number of attempted generations
     *
     * @return self
     * @deprecated
     */
    public function setGenerationCount($generation_count)
    {
        if (is_null($generation_count)) {
            throw new \InvalidArgumentException('non-nullable generation_count cannot be null');
        }
        $this->container['generation_count'] = $generation_count;

        return $this;
    }

    /**
     * Gets generation_success_count
     *
     * @return int|null
     */
    public function getGenerationSuccessCount()
    {
        return $this->container['generation_success_count'];
    }

    /**
     * Sets generation_success_count
     *
     * @param int|null $generation_success_count Number of successful generations
     *
     * @return self
     */
    public function setGenerationSuccessCount($generation_success_count)
    {
        if (is_null($generation_success_count)) {
            throw new \InvalidArgumentException('non-nullable generation_success_count cannot be null');
        }
        $this->container['generation_success_count'] = $generation_success_count;

        return $this;
    }

    /**
     * Gets generation_error_count
     *
     * @return int|null
     */
    public function getGenerationErrorCount()
    {
        return $this->container['generation_error_count'];
    }

    /**
     * Sets generation_error_count
     *
     * @param int|null $generation_error_count Number of generations with errors
     *
     * @return self
     */
    public function setGenerationErrorCount($generation_error_count)
    {
        if (is_null($generation_error_count)) {
            throw new \InvalidArgumentException('non-nullable generation_error_count cannot be null');
        }
        $this->container['generation_error_count'] = $generation_error_count;
    ...
    {
        return $this->container['thumbs_up'];
    }

    /**
     * Sets thumbs_up
     *
     * @param int|null $thumbs_up thumbs_up
     *
     * @return self
     */
    public function setThumbsUp($thumbs_up)
    {
        if (is_null($thumbs_up)) {
            throw new \InvalidArgumentException('non-nullable thumbs_up cannot be null');
        }
        $this->container['thumbs_up'] = $thumbs_up;
    ...
    {
        return $this->container['thumbs_down'];
    }

    /**
     * Sets thumbs_down
     *
     * @param int|null $thumbs_down thumbs_down
     *
     * @return self
     */
    public function setThumbsDown($thumbs_down)
    {
        if (is_null($thumbs_down)) {
            throw new \InvalidArgumentException('non-nullable thumbs_down cannot be null');
        }
        $this->container['thumbs_down'] = $thumbs_down;
    ...
    /**
     * Gets time_to_first_token_ms
     *
     * @return int|null
     */
    public function getTimeToFirstTokenMs()
    {
        return $this->container['time_to_first_token_ms'];
    }

    /**
     * Sets time_to_first_token_ms
     *
     * @param int|null $time_to_first_token_ms time_to_first_token_ms
     *
     * @return self
     */
    public function setTimeToFirstTokenMs($time_to_first_token_ms)
    {
        if (is_null($time_to_first_token_ms)) {
            throw new \InvalidArgumentException('non-nullable time_to_first_token_ms cannot be null');
        }
        $this->container['time_to_first_token_ms'] = $time_to_first_token_ms;

        return $this;
    }

    /**
     * Gets satisfaction_rating
     *
     * @return float|null
     */
    public function getSatisfactionRating()
    {
        return $this->container['satisfaction_rating'];
    }

    /**
     * Sets satisfaction_rating
     *
     * @param float|null $satisfaction_rating A value between 0 and 1 representing satisfaction rating
     *
     * @return self
     */
    public function setSatisfactionRating($satisfaction_rating)
    {
        if (is_null($satisfaction_rating)) {
            throw new \InvalidArgumentException('non-nullable satisfaction_rating cannot be null');
        }

        if (($satisfaction_rating > 1)) {
            throw new \InvalidArgumentException('invalid value for $satisfaction_rating when calling Metrics., must be smaller than or equal to 1.');
        }
        if (($satisfaction_rating < 0)) {
            throw new \InvalidArgumentException('invalid value for $satisfaction_rating when calling Metrics., must be bigger than or equal to 0.');
        }

        $this->container['satisfaction_rating'] = $satisfaction_rating;
    ...
    {
        return $this->container['input_cost'];
    }

    /**
     * Sets input_cost
     *
     * @param float|null $input_cost Cost of input tokens in USD
     *
     * @return self
     */
    public function setInputCost($input_cost)
    {
        if (is_null($input_cost)) {
            throw new \InvalidArgumentException('non-nullable input_cost cannot be null');
        }
        $this->container['input_cost'] = $input_cost;
    ...
    {
        return $this->container['output_cost'];
    }

    /**
     * Sets output_cost
     *
     * @param float|null $output_cost Cost of output tokens in USD
     *
     * @return self
     */
    public function setOutputCost($output_cost)
    {
        if (is_null($output_cost)) {
