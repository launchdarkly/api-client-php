...
/**
 * ExpandedLinkedResourcesSegments Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExpandedLinkedResourcesSegments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandedLinkedResourcesSegments';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\ExpandedSegment[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\ExpandedSegment[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ExpandedSegment[] $items items
     *
     * @return self
     */
