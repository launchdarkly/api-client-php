...
/**
 * FlagPrerequisitePost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagPrerequisitePost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagPrerequisitePost';
     ...
     * Sets key
     *
     * @param string $key Flag key of the prerequisite flag
     *
     * @return self
     */
     ...
     * Sets variation_id
     *
     * @param string $variation_id ID of a variation of the prerequisite flag
     *
     * @return self
     */
