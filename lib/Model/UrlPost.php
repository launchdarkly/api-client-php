 ...
 */
class UrlPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UrlPost';
    ...
    public const KIND_CANONICAL = 'canonical';
    public const KIND_SUBSTRING = 'substring';
