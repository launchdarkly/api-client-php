...
/**
 * FlagFollowersByProjEnvGetRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagFollowersByProjEnvGetRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagFollowersByProjEnvGetRep';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\LaunchDarklyApi\Model\FollowersPerFlag[]'
    ];
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\FollowersPerFlag[]|null
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\FollowersPerFlag[]|null $items An array of flags and their followers
     *
     * @return self
     */
