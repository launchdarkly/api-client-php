...
/**
 * ExpandedAIConfig Class Doc Comment
 *
 * @category Class
 ...
 */
class ExpandedAIConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandedAIConfig';
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key A unique key used to reference the AI config
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name A human-friendly name for the AI config
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags for the AI config
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the AI config
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int|null $version Version of the AI config
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param int|null $created_at Creation date in milliseconds
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param int|null $updated_at Last modification date in milliseconds
     *
     * @return self
     */
     ...
     * Sets flag_key
     *
     * @param string|null $flag_key Key of the flag that this AI config is attached to
     *
     * @return self
     */
