...
class BigSegmentTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets included
     *
     * @param bool $included Indicates whether the user is included.<br />Included users are always segment members, regardless of segment rules.
     *
     * @return self
     */
     ...
     * Sets excluded
     *
     * @param bool $excluded Indicates whether the user is excluded.<br />Segment rules bypass excluded users, so they will never be included based on rules. Excluded users may still be included explicitly.
     *
     * @return self
     */
