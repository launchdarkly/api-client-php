...
/**
 * BigSegmentTarget Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class BigSegmentTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BigSegmentTarget';
     ...
     * Sets user_key
     *
     * @param string $user_key The target key
     *
     * @return self
     */
     ...
     * Sets included
     *
     * @param bool $included Indicates whether the target is included.<br />Included targets are always segment members, regardless of segment rules.
     *
     * @return self
     */
     ...
     * Sets excluded
     *
     * @param bool $excluded Indicates whether the target is excluded.<br />Segment rules bypass excluded targets, so they will never be included based on rules. Excluded targets may still be included explicitly.
     *
     * @return self
     */
