...
class UserSegment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets included
     *
     * @param string[]|null $included Included users are always segment members, regardless of segment rules. For Big Segments this array is either empty or omitted entirely.
     *
     * @return self
     */
     ...
     * Sets excluded
     *
     * @param string[]|null $excluded Segment rules bypass excluded users, so they will never be included based on rules. Excluded users may still be included explicitly. This value is omitted for Big Segments.
     *
     * @return self
     */
     ...
     * Sets rules
     *
     * @param \LaunchDarklyApi\Model\UserSegmentRule[] $rules rules
     *
     * @return self
     */
     ...
     * Sets unbounded
     *
     * @param bool|null $unbounded unbounded
     *
     * @return self
     */
     ...
     * Sets _external
     *
     * @param string|null $_external _external
     *
     * @return self
     */
     ...
     * Sets _external_link
     *
     * @param string|null $_external_link _external_link
     *
     * @return self
     */
