...
class UserSegment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets included
     *
     * @param string[]|null $included An array of user keys for included users. Included users are always segment members, regardless of segment rules. For Big Segments this array is either empty or omitted.
     *
     * @return self
     */
     ...
     * Sets excluded
     *
     * @param string[]|null $excluded An array of user keys for excluded users. Segment rules bypass excluded users, so they will never be included based on rules. Excluded users may still be included explicitly. This value is omitted for Big Segments.
     *
     * @return self
     */
