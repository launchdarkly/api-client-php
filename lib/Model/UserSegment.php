...
class UserSegment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets included
     *
     * @param string[]|null $included An array of keys for included targets. Included individual targets are always segment members, regardless of segment rules. For Big Segments this array is either empty or omitted.
     *
     * @return self
     */
     ...
     * Sets excluded
     *
     * @param string[]|null $excluded An array of keys for excluded targets. Segment rules bypass individual excluded targets, so they will never be included based on rules. Excluded targets may still be included explicitly. This value is omitted for Big Segments.
     *
     * @return self
     */
     ...
     * Sets _flags
     *
     * @param \LaunchDarklyApi\Model\FlagListingRep[]|null $_flags _flags
     *
     * @return self
     */
     ...
     * Sets unbounded
     *
     * @param bool|null $unbounded Whether this is a standard segment (<code>false</code>) or a Big Segment (<code>true</code>). If omitted, the segment is a standard segment.
     *
     * @return self
     */
     ...
     *
     * @param string|null $unbounded_context_kind unbounded_context_kind
     *
     * @return self
     */
     ...
     * Sets _external
     *
     * @param string|null $_external The external data store backing this segment. Only applies to Big Segments.
     *
     * @return self
     */
     ...
     * Sets _external_link
     *
     * @param string|null $_external_link The URL for the external data store backing this segment. Only applies to Big Segments.
     *
     * @return self
     */
