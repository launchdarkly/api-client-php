...
class UserSegment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets description
     *
     * @param string|null $description A description of the segment's purpose
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[] $tags Tags for the segment
     *
     * @return self
     */
     ...
     * Sets _links
     *
     * @param array<string,\LaunchDarklyApi\Model\Link> $_links Links to other resources within the API. Includes the URL and content type of those resources.
     *
     * @return self
     */
     ...
     * Sets unbounded
     *
     * @param bool|null $unbounded Whether this is a standard segment (false) or a Big Segment (true)
     *
     * @return self
     */
