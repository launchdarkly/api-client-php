 ...
 */
class ViewLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViewLinkRequest';
    ...
    */
     ...
     * Sets keys
     *
     * @param string[] $keys Keys of the resources (flags, segments, AI configs) to link/unlink
     *
     * @return self
     */
