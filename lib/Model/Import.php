...
class Import implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'mode' => 'string',
        'status' => 'string',
        'files' => '\LaunchDarklyApi\Model\FileRep[]',
    ...
    */
     ...
     * Sets mode
     *
     * @param string $mode The import mode used, either <code>merge</code> or <code>replace</code>
     *
     * @return self
     */
     ...
     * Gets files
     *
     * @return \LaunchDarklyApi\Model\FileRep[]|null
     */
     ...
     * Sets files
     *
     * @param \LaunchDarklyApi\Model\FileRep[]|null $files The imported files and their status
     *
     * @return self
     */
