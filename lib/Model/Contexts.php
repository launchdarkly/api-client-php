 ...
 */
class Contexts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\LaunchDarklyApi\Model\ContextRecord[]'
    ];
    ...
    */
     ...
     * Sets total_count
     *
     * @param int|null $total_count The number of contexts
     *
     * @return self
     */
     ...
     *
     * @param string $_environment_id The environment ID where the context was evaluated
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\ContextRecord[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ContextRecord[] $items A collection of contexts. Can include multiple versions of contexts that have the same <code>kind</code> and <code>key</code>, but different <code>applicationId</code>s.
     *
     * @return self
     */
