...
class UpsertContextKindPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param bool|null $hide_in_targeting Whether the context kind is hidden. Hidden context kinds are unavailable for targeting. If not specified when the context kind is created, defaults to false.
     *
     * @return self
     */
