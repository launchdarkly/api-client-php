...
/**
 * UpsertContextKindPayload Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class UpsertContextKindPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpsertContextKindPayload';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description The context kind description
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int|null $version The context kind version. If not specified when the context kind is created, defaults to 1.
     *
     * @return self
     */
