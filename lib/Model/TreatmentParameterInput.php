...
/**
 * TreatmentParameterInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class TreatmentParameterInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TreatmentParameterInput';
     ...
     * Sets variation_id
     *
     * @param string $variation_id The ID of the flag variation
     *
     * @return self
     */
