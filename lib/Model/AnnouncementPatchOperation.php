...
/**
 * AnnouncementPatchOperation Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AnnouncementPatchOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnnouncementPatchOperation';
     ...
     * Sets path
     *
     * @param string $path A JSON Pointer string specifying the part of the document to operate on
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param mixed|null $value A JSON value used in \"add\", \"replace\", and \"test\" operations
     *
     * @return self
     */
