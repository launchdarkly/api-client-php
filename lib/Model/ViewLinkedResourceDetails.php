...
/**
 * ViewLinkedResourceDetails Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ViewLinkedResourceDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViewLinkedResourceDetails';
    ...
    protected static $openAPITypes = [
        'view' => '\LaunchDarklyApi\Model\View',
        'flag' => '\LaunchDarklyApi\Model\ExpandedFlag',
        'segment' => '\LaunchDarklyApi\Model\ExpandedSegment',
        'ai_config' => '\LaunchDarklyApi\Model\ExpandedAIConfig',
        'metric' => '\LaunchDarklyApi\Model\ExpandedMetric'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ai_config', $data ?? [], null);
    ...
    */
     ...
     * Gets view
     *
     * @return \LaunchDarklyApi\Model\View|null
     */
     ...
     * Sets view
     *
     * @param \LaunchDarklyApi\Model\View|null $view view
     *
     * @return self
     */
     ...
     * Gets flag
     *
     * @return \LaunchDarklyApi\Model\ExpandedFlag|null
     */
     ...
     * Sets flag
     *
     * @param \LaunchDarklyApi\Model\ExpandedFlag|null $flag flag
     *
     * @return self
     */
     ...
     * Gets segment
     *
     * @return \LaunchDarklyApi\Model\ExpandedSegment|null
     */
     ...
     * Sets segment
     *
     * @param \LaunchDarklyApi\Model\ExpandedSegment|null $segment segment
     *
     * @return self
     */
     ...
     * Gets ai_config
     *
     * @return \LaunchDarklyApi\Model\ExpandedAIConfig|null
     */
    public function getAiConfig()
    {
        return $this->container['ai_config'];
    }

    /**
     * Sets ai_config
     *
     * @param \LaunchDarklyApi\Model\ExpandedAIConfig|null $ai_config ai_config
     *
     * @return self
     */
    public function setAiConfig($ai_config)
    {
        if (is_null($ai_config)) {
            throw new \InvalidArgumentException('non-nullable ai_config cannot be null');
        }
        $this->container['ai_config'] = $ai_config;
     ...
     * Gets metric
     *
     * @return \LaunchDarklyApi\Model\ExpandedMetric|null
     */
     ...
     * Sets metric
     *
     * @param \LaunchDarklyApi\Model\ExpandedMetric|null $metric metric
     *
     * @return self
     */
