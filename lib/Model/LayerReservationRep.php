...
/**
 * LayerReservationRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class LayerReservationRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LayerReservationRep';
    ...
    protected static $setters = [
        'experiment_key' => 'setExperimentKey',
        'flag_key' => 'setFlagKey',
    ...
    protected static $getters = [
        'experiment_key' => 'getExperimentKey',
        'flag_key' => 'getFlagKey',
    ...
    {
        $this->setIfExists('experiment_key', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['experiment_key'] === null) {
            $invalidProperties[] = "'experiment_key' can't be null";
        }
     ...
     * @return string
     */
    public function getExperimentKey()
    {
        return $this->container['experiment_key'];
    }

    /**
     * Sets experiment_key
     *
     * @param string $experiment_key The key of the experiment
     *
     * @return self
     */
    public function setExperimentKey($experiment_key)
    {
        if (is_null($experiment_key)) {
            throw new \InvalidArgumentException('non-nullable experiment_key cannot be null');
        }
        $this->container['experiment_key'] = $experiment_key;
     ...
     * Sets flag_key
     *
     * @param string $flag_key The key of the flag
     *
     * @return self
     */
     ...
     *
     * @param int $reservation_percent The percentage of traffic reserved for the experiment
     *
     * @return self
     */
