...
/**
 * FlagConfigApprovalRequestsResponse Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagConfigApprovalRequestsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagConfigApprovalRequestsResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\FlagConfigApprovalRequestResponse[]',
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\FlagConfigApprovalRequestResponse[] $items An array of approval requests
     *
     * @return self
     */
