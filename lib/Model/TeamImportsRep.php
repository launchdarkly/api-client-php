...
class TeamImportsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\MemberImportItemRep[]'
    ];
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\MemberImportItemRep[]|null
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\MemberImportItemRep[]|null $items items
     *
     * @return self
     */
