...
class TeamProjects implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ProjectSummary[]|null $items Details on each project where team members have write privileges on at least one custom role action
     *
     * @return self
     */
