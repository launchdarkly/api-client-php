...
/**
 * PhaseConfiguration Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class PhaseConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhaseConfiguration';
    ...
    protected static $setters = [
        'bake_time_duration_ms' => 'setBakeTimeDurationMs'
    ];
    ...
    protected static $getters = [
        'bake_time_duration_ms' => 'getBakeTimeDurationMs'
    ];
    ...
    {
        $this->container['bake_time_duration_ms'] = $data['bake_time_duration_ms'] ?? null;
    }
    ...
    /**
     * Gets bake_time_duration_ms
     *
     * @return int|null
     */
    public function getBakeTimeDurationMs()
    {
        return $this->container['bake_time_duration_ms'];
    }

    /**
     * Sets bake_time_duration_ms
     *
     * @param int|null $bake_time_duration_ms The bake time duration in milliseconds
     *
     * @return self
     */
    public function setBakeTimeDurationMs($bake_time_duration_ms)
    {
        $this->container['bake_time_duration_ms'] = $bake_time_duration_ms;
