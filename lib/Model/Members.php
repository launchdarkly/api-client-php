 ...
 */
class Members implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Members';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\Member[]',
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\Member[] $items An array of members
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int|null $total_count The number of members returned
     *
     * @return self
     */
