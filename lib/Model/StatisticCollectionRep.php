...
/**
 * StatisticCollectionRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class StatisticCollectionRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatisticCollectionRep';
     ...
     * Gets flags
     *
     * @return array<string,\LaunchDarklyApi\Model\StatisticRep[]>
     */
     ...
     * Sets flags
     *
     * @param array<string,\LaunchDarklyApi\Model\StatisticRep[]> $flags A map of flag keys to a list of code reference statistics for each code repository in which the flag key appears
     *
     * @return self
     */
