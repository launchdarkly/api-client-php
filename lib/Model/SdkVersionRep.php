...
/**
 * SdkVersionRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class SdkVersionRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SdkVersionRep';
    ...
    */
     ...
     * Sets sdk
     *
     * @param string $sdk The SDK name, or \"Unknown\"
     *
     * @return self
     */
    ...
    {
        if (is_null($sdk)) {
            throw new \InvalidArgumentException('non-nullable sdk cannot be null');
        }
     ...
     * Sets version
     *
     * @param string $version The version number, or \"Unknown\"
     *
     * @return self
     */
