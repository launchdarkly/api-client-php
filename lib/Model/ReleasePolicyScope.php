...
/**
 * ReleasePolicyScope Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleasePolicyScope implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleasePolicyScope';
    ...
    */
    ...
    /**
     * Gets environment_keys
     *
     * @return string[]|null
     */
    public function getEnvironmentKeys()
    {
        return $this->container['environment_keys'];
    }

    /**
     * Sets environment_keys
     *
     * @param string[]|null $environment_keys List of environment keys this policy applies to
     *
     * @return self
     */
    public function setEnvironmentKeys($environment_keys)
    {
        if (is_null($environment_keys)) {
