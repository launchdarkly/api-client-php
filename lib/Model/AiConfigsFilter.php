...
/**
 * AiConfigsFilter Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AiConfigsFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AiConfigsFilter';
    ...
    public const TYPE_CONTEXT_ATTRIBUTE = 'contextAttribute';
    public const TYPE_EVENT_PROPERTY = 'eventProperty';
    ...
    public function getTypeAllowableValues()
    {
        return [
            self::TYPE_GROUP,
            self::TYPE_CONTEXT_ATTRIBUTE,
            self::TYPE_EVENT_PROPERTY,
        ];
    }
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Filter type. One of [contextAttribute, eventProperty, group]
     *
     * @return self
     */
     ...
     * Sets attribute
     *
     * @param string|null $attribute If not a group node, the context attribute name or event property name to filter on
     *
     * @return self
     */
     ...
     * Sets values
     *
     * @param mixed[] $values The context attribute / event property values or group member nodes
     *
     * @return self
     */
     ...
     * Sets context_kind
     *
     * @param string|null $context_kind For context attribute filters, the context kind.
     *
     * @return self
     */
     ...
     * Sets negate
     *
     * @param bool $negate If set, then take the inverse of the operator. 'in' becomes 'not in'.
     *
     * @return self
     */
