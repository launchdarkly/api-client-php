...
/**
 * TeamPostInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class TeamPostInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'teamPostInput';
    ...
    protected static $openAPITypes = [
        ...
        'member_ids' => 'string[]',
        'name' => 'string',
        'permission_grants' => '\LaunchDarklyApi\Model\PermissionGrantInput[]',
    ...
    {
        $this->setIfExists('custom_role_keys', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($custom_role_keys)) {
            throw new \InvalidArgumentException('non-nullable custom_role_keys cannot be null');
        }
     ...
     *
     * @return \LaunchDarklyApi\Model\PermissionGrantInput[]|null
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\PermissionGrantInput[]|null $permission_grants A list of permission grants. Permission grants allow access to a specific action, without having to create or update a custom role.
     *
     * @return self
     */
