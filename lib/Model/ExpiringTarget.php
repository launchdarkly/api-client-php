...
/**
 * ExpiringTarget Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExpiringTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpiringTarget';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_resource_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_resource_id'] === null) {
            $invalidProperties[] = "'_resource_id' can't be null";
        }
     ...
     * Sets _id
     *
     * @param string $_id The ID of this expiring target
     *
     * @return self
     */
     ...
     * Sets _version
     *
     * @param int $_version The version of this expiring target
     *
     * @return self
     */
     ...
     *
     * @param int $expiration_date expiration_date
     *
     * @return self
     */
     ...
     * Sets context_kind
     *
     * @param string $context_kind The context kind of the context to be removed
     *
     * @return self
     */
     ...
     * Sets context_key
     *
     * @param string $context_key A unique key used to represent the context to be removed
     *
     * @return self
     */
     ...
     * Sets target_type
     *
     * @param string|null $target_type A segment's target type, <code>included</code> or <code>excluded</code>. Included when expiring targets are updated on a segment.
     *
     * @return self
     */
     ...
     * Sets variation_id
     *
     * @param string|null $variation_id A unique ID used to represent the flag variation. Included when expiring targets are updated on a feature flag.
     *
     * @return self
     */
     ...
     * Gets _resource_id
     *
     * @return \LaunchDarklyApi\Model\ResourceId
     */
     ...
     * Sets _resource_id
     *
     * @param \LaunchDarklyApi\Model\ResourceId $_resource_id _resource_id
     *
     * @return self
     */
    public function setResourceId($_resource_id)
    {
        if (is_null($_resource_id)) {
            throw new \InvalidArgumentException('non-nullable _resource_id cannot be null');
        }
