 ...
 */
class SdkListRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SdkListRep';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sdks', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sdks'] === null) {
            $invalidProperties[] = "'sdks' can't be null";
        }
    ...
    {
        return $this->container['sdks'];
    }

    /**
     * Sets sdks
     *
     * @param string[] $sdks The list of SDK names
     *
     * @return self
     */
    ...
    {
        if (is_null($sdks)) {
            throw new \InvalidArgumentException('non-nullable sdks cannot be null');
        }
        $this->container['sdks'] = $sdks;
