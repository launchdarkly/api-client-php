 ...
 */
class ModelConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModelConfig';
    ...
    protected static array $openAPINullables = [
        ...
        'tags' => false,
        'version' => false,
        'cost_per_input_token' => false,
        'cost_per_output_token' => false,
        'is_restricted' => false
    ];
    ...
    protected static $setters = [
        ...
        'tags' => 'setTags',
        'version' => 'setVersion',
        'cost_per_input_token' => 'setCostPerInputToken',
        'cost_per_output_token' => 'setCostPerOutputToken',
    ...
    protected static $getters = [
        ...
        'tags' => 'getTags',
        'version' => 'getVersion',
        'cost_per_input_token' => 'getCostPerInputToken',
        'cost_per_output_token' => 'getCostPerOutputToken',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cost_per_input_token', $data ?? [], null);
        $this->setIfExists('cost_per_output_token', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Human readable name of the model
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Identifier for the model, for use with third party providers
     *
     * @return self
     */
     ...
     * Sets icon
     *
     * @param string|null $icon Icon for the model
     *
     * @return self
     */
     ...
     * Sets provider
     *
     * @param string|null $provider Provider for the model
     *
     * @return self
     */
     ...
     * Sets global
     *
     * @param bool $global Whether the model is global
     *
     * @return self
     */
    ...
    /**
     * Gets cost_per_input_token
     *
     * @return float|null
     */
    public function getCostPerInputToken()
    {
        return $this->container['cost_per_input_token'];
    }

    /**
     * Sets cost_per_input_token
     *
     * @param float|null $cost_per_input_token Cost per input token in USD
     *
     * @return self
     */
    public function setCostPerInputToken($cost_per_input_token)
    {
        if (is_null($cost_per_input_token)) {
            throw new \InvalidArgumentException('non-nullable cost_per_input_token cannot be null');
        }
        $this->container['cost_per_input_token'] = $cost_per_input_token;

        return $this;
    }

    /**
     * Gets cost_per_output_token
     *
     * @return float|null
     */
    public function getCostPerOutputToken()
    {
        return $this->container['cost_per_output_token'];
    }

    /**
     * Sets cost_per_output_token
     *
     * @param float|null $cost_per_output_token Cost per output token in USD
     *
     * @return self
     */
    public function setCostPerOutputToken($cost_per_output_token)
    {
        if (is_null($cost_per_output_token)) {
            throw new \InvalidArgumentException('non-nullable cost_per_output_token cannot be null');
        }
        $this->container['cost_per_output_token'] = $cost_per_output_token;
     ...
     * Sets is_restricted
     *
     * @param bool $is_restricted Whether the model is restricted
     *
     * @return self
     */
