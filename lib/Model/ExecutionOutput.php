...
/**
 * ExecutionOutput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExecutionOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExecutionOutput';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status The status of the execution of this workflow stage
     *
     * @return self
     */
