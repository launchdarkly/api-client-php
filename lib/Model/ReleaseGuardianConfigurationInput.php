...
/**
 * ReleaseGuardianConfigurationInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleaseGuardianConfigurationInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleaseGuardianConfigurationInput';
    ...
    */
     ...
     *
     * @param int|null $monitoring_window_milliseconds The monitoring window in milliseconds
     *
     * @return self
     */
     ...
     * Sets rollout_weight
     *
     * @param int|null $rollout_weight The rollout weight
     *
     * @return self
     */
     ...
     *
     * @param bool|null $rollback_on_regression Whether or not to rollback on regression
     *
     * @return self
     */
