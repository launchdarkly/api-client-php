...
/**
 * InsightGroupCollection Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class InsightGroupCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsightGroupCollection';
    ...
    protected static $openAPITypes = [
        'total_count' => 'int',
        'items' => '\LaunchDarklyApi\Model\InsightGroup[]',
        '_links' => 'array<string,\LaunchDarklyApi\Model\Link>',
        'metadata' => '\LaunchDarklyApi\Model\InsightGroupCollectionMetadata',
        'score_metadata' => '\LaunchDarklyApi\Model\InsightGroupCollectionScoreMetadata'
    ];
    ...
    protected static $setters = [
        ...
        'score_metadata' => 'setScoreMetadata'
    ];
    ...
    protected static $getters = [
        ...
        'score_metadata' => 'getScoreMetadata'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('score_metadata', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets total_count
     *
     * @param int $total_count The total number of insight groups
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\InsightGroup[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\InsightGroup[] $items A list of insight groups
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \LaunchDarklyApi\Model\InsightGroupCollectionMetadata|null
     */
     ...
     * Sets metadata
     *
     * @param \LaunchDarklyApi\Model\InsightGroupCollectionMetadata|null $metadata metadata
     *
     * @return self
     */
     ...
     * Gets score_metadata
     *
     * @return \LaunchDarklyApi\Model\InsightGroupCollectionScoreMetadata|null
     */
    public function getScoreMetadata()
    {
        return $this->container['score_metadata'];
    }

    /**
     * Sets score_metadata
     *
     * @param \LaunchDarklyApi\Model\InsightGroupCollectionScoreMetadata|null $score_metadata score_metadata
     *
     * @return self
     */
    public function setScoreMetadata($score_metadata)
    {
        if (is_null($score_metadata)) {
            throw new \InvalidArgumentException('non-nullable score_metadata cannot be null');
        }
        $this->container['score_metadata'] = $score_metadata;
