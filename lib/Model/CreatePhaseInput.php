...
/**
 * CreatePhaseInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CreatePhaseInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePhaseInput';
    ...
    protected static $openAPITypes = [
        'audiences' => '\LaunchDarklyApi\Model\AudiencePost[]',
        'name' => 'string',
     ...
     * Gets audiences
     *
     * @return \LaunchDarklyApi\Model\AudiencePost[]
     */
     ...
     * Sets audiences
     *
     * @param \LaunchDarklyApi\Model\AudiencePost[] $audiences An ordered list of the audiences for this release phase. Each audience corresponds to a LaunchDarkly environment.
     *
     * @return self
     */
