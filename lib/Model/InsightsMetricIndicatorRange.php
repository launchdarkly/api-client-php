...
/**
 * InsightsMetricIndicatorRange Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class InsightsMetricIndicatorRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsightsMetricIndicatorRange';
     ...
     * Sets min
     *
     * @param int $min The minimum value for the indicator range
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param int $max The maximum value for the indicator range
     *
     * @return self
     */
