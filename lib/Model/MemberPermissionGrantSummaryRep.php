...
/**
 * MemberPermissionGrantSummaryRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class MemberPermissionGrantSummaryRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberPermissionGrantSummaryRep';
    ...
    */
     ...
     * Sets action_set
     *
     * @param string|null $action_set The name of the group of related actions to allow. A permission grant may have either an <code>actionSet</code> or a list of <code>actions</code> but not both at the same time.
     *
     * @return self
     */
     ...
     * Sets actions
     *
     * @param string[]|null $actions A list of actions to allow. A permission grant may have either an <code>actionSet</code> or a list of <code>actions</code> but not both at the same time.
     *
     * @return self
     */
     ...
     * Sets resource
     *
     * @param string $resource The resource for which the actions are allowed
     *
     * @return self
     */
