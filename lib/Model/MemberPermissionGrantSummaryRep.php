...
class MemberPermissionGrantSummaryRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['action_set'] === null) {
            $invalidProperties[] = "'action_set' can't be null";
        }
     ...
     * Sets action_set
     *
     * @param string $action_set The name of the a group of related actions to allow. A permission grant may have either an <code>actionSet</code> or a list of <code>actions</code> but not both at the same time.
     *
     * @return self
     */
     ...
     * Sets actions
     *
     * @param string[] $actions A list of actions to allow
     *
     * @return self
     */
     ...
     * Sets resource
     *
     * @param string $resource The resource for which the <code>actions</code> are allowed
     *
     * @return self
     */
