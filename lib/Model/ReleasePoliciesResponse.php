...
/**
 * ReleasePoliciesResponse Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleasePoliciesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleasePoliciesResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\ReleasePolicy[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\ReleasePolicy[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ReleasePolicy[] $items List of release policies
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int $total_count Total number of release policies
     *
     * @return self
     */
