...
/**
 * ExpandedFlagRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExpandedFlagRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandedFlagRep';
    ...
    */
     ...
     * Sets maintainer_id
     *
     * @param string|null $maintainer_id The ID of the member who maintains the flag
     *
     * @return self
     */
