...
/**
 * ConditionOutput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ConditionOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConditionOutput';
    ...
    protected static $openAPITypes = [
        ...
        'all_reviews' => '\LaunchDarklyApi\Model\ReviewOutput[]',
        'review_status' => 'string',
        'applied_date' => 'int',
        'creation_config' => 'array<string,mixed>'
    ];
    ...
    protected static $setters = [
        ...
        'creation_config' => 'setCreationConfig'
    ];
    ...
    protected static $getters = [
        ...
        'creation_config' => 'getCreationConfig'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_execution', $data ?? [], null);
        ...
        $this->setIfExists('all_reviews', $data ?? [], null);
        $this->setIfExists('review_status', $data ?? [], null);
        $this->setIfExists('applied_date', $data ?? [], null);
        $this->setIfExists('creation_config', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_execution'] === null) {
            $invalidProperties[] = "'_execution' can't be null";
        }
     ...
     * Gets _execution
     *
     * @return \LaunchDarklyApi\Model\ExecutionOutput
     */
    public function getExecution()
    {
        return $this->container['_execution'];
    }

    /**
     * Sets _execution
     *
     * @param \LaunchDarklyApi\Model\ExecutionOutput $_execution _execution
     *
     * @return self
     */
    public function setExecution($_execution)
    {
        if (is_null($_execution)) {
            throw new \InvalidArgumentException('non-nullable _execution cannot be null');
        }
        $this->container['_execution'] = $_execution;
     ...
     * Sets wait_duration
     *
     * @param int|null $wait_duration wait_duration
     *
     * @return self
     */
     ...
     * Gets all_reviews
     *
     * @return \LaunchDarklyApi\Model\ReviewOutput[]
     */
     ...
     * Sets all_reviews
     *
     * @param \LaunchDarklyApi\Model\ReviewOutput[] $all_reviews all_reviews
     *
     * @return self
     */
    public function setAllReviews($all_reviews)
    {
        if (is_null($all_reviews)) {
            throw new \InvalidArgumentException('non-nullable all_reviews cannot be null');
        }
    ...
    /**
     * Gets creation_config
     *
     * @return array<string,mixed>|null
     */
    public function getCreationConfig()
    {
        return $this->container['creation_config'];
    }

    /**
     * Sets creation_config
     *
     * @param array<string,mixed>|null $creation_config creation_config
     *
     * @return self
     */
    public function setCreationConfig($creation_config)
    {
        if (is_null($creation_config)) {
            throw new \InvalidArgumentException('non-nullable creation_config cannot be null');
        }
        $this->container['creation_config'] = $creation_config;
