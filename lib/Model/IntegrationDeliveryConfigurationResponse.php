...
/**
 * IntegrationDeliveryConfigurationResponse Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationDeliveryConfigurationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationDeliveryConfigurationResponse';
     ...
     * Sets status_code
     *
     * @param int|null $status_code The status code returned by the validation
     *
     * @return self
     */
     ...
     * Sets response_body
     *
     * @param string|null $response_body JSON response to the validation request
     *
     * @return self
     */
