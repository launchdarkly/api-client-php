...
/**
 * FlagReferenceRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagReferenceRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagReferenceRep';
    ...
    protected static $openAPIFormats = [
        'project_key' => null,
        'flag_key' => null,
        'references_added' => null,
        'references_removed' => null
    ];
    ...
    protected static $setters = [
        ...
        'flag_key' => 'setFlagKey',
        'references_added' => 'setReferencesAdded',
        'references_removed' => 'setReferencesRemoved'
    ];
    ...
    protected static $getters = [
        ...
        'flag_key' => 'getFlagKey',
        'references_added' => 'getReferencesAdded',
        'references_removed' => 'getReferencesRemoved'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('references_added', $data ?? [], null);
        $this->setIfExists('references_removed', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['references_added'] === null) {
            $invalidProperties[] = "'references_added' can't be null";
        }
        if ($this->container['references_removed'] === null) {
            $invalidProperties[] = "'references_removed' can't be null";
        }
    ...
    /**
     * Gets references_added
     *
     * @return int
     */
    public function getReferencesAdded()
    {
        return $this->container['references_added'];
    }

    /**
     * Sets references_added
     *
     * @param int $references_added The number of references added
     *
     * @return self
     */
    public function setReferencesAdded($references_added)
    {
        if (is_null($references_added)) {
            throw new \InvalidArgumentException('non-nullable references_added cannot be null');
        }
        $this->container['references_added'] = $references_added;

        return $this;
    }

    /**
     * Gets references_removed
     *
     * @return int
     */
    public function getReferencesRemoved()
    {
        return $this->container['references_removed'];
    }

    /**
     * Sets references_removed
     *
     * @param int $references_removed The number of references removed
     *
     * @return self
     */
    public function setReferencesRemoved($references_removed)
    {
        if (is_null($references_removed)) {
            throw new \InvalidArgumentException('non-nullable references_removed cannot be null');
        }
        $this->container['references_removed'] = $references_removed;
