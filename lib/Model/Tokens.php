...
class Tokens implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\Token[]',
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\Token[]|null
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\Token[]|null $items An array of access tokens
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int|null $total_count The number of access tokens returned
     *
     * @return self
     */
