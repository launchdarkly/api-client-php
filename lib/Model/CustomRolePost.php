...
/**
 * CustomRolePost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CustomRolePost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomRolePost';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name A human-friendly name for the custom role
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string $key The custom role key
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of custom role
     *
     * @return self
     */
     ...
     * Gets policy
     *
     * @return \LaunchDarklyApi\Model\StatementPost[]
     */
     ...
     * Sets policy
     *
     * @param \LaunchDarklyApi\Model\StatementPost[] $policy policy
     *
     * @return self
     */
