 ...
 */
class ProjectRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectRep';
    ...
    protected static array $openAPINullables = [
        ...
        '_access' => false,
        'tags' => false,
        'default_release_pipeline_key' => false,
        'environments' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('default_release_pipeline_key', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['include_in_snippet_by_default'] === null) {
            $invalidProperties[] = "'include_in_snippet_by_default' can't be null";
        }
     ...
     * Sets _id
     *
     * @param string $_id The ID of this project
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string $key The key of this project
     *
     * @return self
     */
     ...
     *
     * @param bool $include_in_snippet_by_default Whether or not flags created in this project are made available to the client-side JavaScript SDK by default
     *
     * @return self
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\ClientSideAvailability|null $default_client_side_availability default_client_side_availability
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[] $tags A list of tags for the project
     *
     * @return self
     */
    ...
    /**
     * Gets default_release_pipeline_key
     *
     * @return string|null
     */
    public function getDefaultReleasePipelineKey()
    {
        return $this->container['default_release_pipeline_key'];
    }

    /**
     * Sets default_release_pipeline_key
     *
     * @param string|null $default_release_pipeline_key The key of the default release pipeline for this project
     *
     * @return self
     */
    public function setDefaultReleasePipelineKey($default_release_pipeline_key)
    {
        if (is_null($default_release_pipeline_key)) {
            throw new \InvalidArgumentException('non-nullable default_release_pipeline_key cannot be null');
        }
        $this->container['default_release_pipeline_key'] = $default_release_pipeline_key;
     ...
     * Sets environments
     *
     * @param \LaunchDarklyApi\Model\Environment[] $environments A list of environments for the project
     *
     * @return self
     */
