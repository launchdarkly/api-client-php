 ...
 */
class FeatureFlagScheduledChange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeatureFlagScheduledChange';
    ...
    */
     ...
     * Sets _maintainer_id
     *
     * @param string $_maintainer_id The ID of the scheduled change maintainer
     *
     * @return self
     */
     ...
     * Sets _version
     *
     * @param int $_version Version of the scheduled change
     *
     * @return self
     */
     ...
     * Sets conflicts
     *
     * @param mixed|null $conflicts Details on any conflicting scheduled changes
     *
     * @return self
     */
