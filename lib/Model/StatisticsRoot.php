...
/**
 * StatisticsRoot Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class StatisticsRoot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatisticsRoot';
    ...
    protected static $openAPITypes = [
        'projects' => '\LaunchDarklyApi\Model\Link[]',
     ...
     * Sets projects
     *
     * @param \LaunchDarklyApi\Model\Link[]|null $projects The location and content type of all projects that have code references
     *
     * @return self
     */
     ...
     * Sets self
     *
     * @param \LaunchDarklyApi\Model\Link|null $self self
     *
     * @return self
     */
