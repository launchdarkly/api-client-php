...
/**
 * ExperimentationSettingsRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExperimentationSettingsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExperimentationSettingsRep';
    ...
    {
        $this->container['_project_id'] = $data['_project_id'] ?? null;
        $this->container['_project_key'] = $data['_project_key'] ?? null;
