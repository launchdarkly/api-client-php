 ...
 */
class ViewPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViewPost';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('generate_sdk_keys', $data ?? [], false);
