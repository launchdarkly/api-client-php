...
/**
 * ConflictOutput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ConflictOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConflictOutput';
     ...
     * Sets message
     *
     * @param string $message Message about the conflict
     *
     * @return self
     */
