...
/**
 * FailedResourceLink Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FailedResourceLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FailedResourceLink';
    ...
    */
     ...
     * Sets resource_key
     *
     * @param string $resource_key The key of the resource that failed to link.
     *
     * @return self
     */
     ...
     * Sets resource_type
     *
     * @param string $resource_type The type of the resource that failed to link.
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string $error_message The reason why linking this resource failed.
     *
     * @return self
     */
