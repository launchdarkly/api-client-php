...
/**
 * AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation';
    ...
    {
        $this->setIfExists('can_reshuffle', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['can_reshuffle'] === null) {
            $invalidProperties[] = "'can_reshuffle' can't be null";
        }
        if ($this->container['default_variation'] === null) {
            $invalidProperties[] = "'default_variation' can't be null";
        }
     ...
     * @return bool
     */
    public function getCanReshuffle()
    {
        return $this->container['can_reshuffle'];
    }

    /**
     * Sets can_reshuffle
     *
     * @param bool $can_reshuffle can_reshuffle
     *
     * @return self
     */
    public function setCanReshuffle($can_reshuffle)
    {
        if (is_null($can_reshuffle)) {
            throw new \InvalidArgumentException('non-nullable can_reshuffle cannot be null');
        }
        $this->container['can_reshuffle'] = $can_reshuffle;
     ...
     *
     * @param int $default_variation default_variation
     *
     * @return self
     */
