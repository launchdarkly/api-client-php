...
class FlagCopyConfigPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const INCLUDED_ACTIONS_UPDATE_ON = 'updateOn';
    const INCLUDED_ACTIONS_UPDATE_RULES = 'updateRules';
    const INCLUDED_ACTIONS_UPDATE_FALLTHROUGH = 'updateFallthrough';
    const INCLUDED_ACTIONS_UPDATE_OFF_VARIATION = 'updateOffVariation';
    const INCLUDED_ACTIONS_UPDATE_PREREQUISITES = 'updatePrerequisites';
    const INCLUDED_ACTIONS_UPDATE_TARGETS = 'updateTargets';
    const EXCLUDED_ACTIONS_UPDATE_ON = 'updateOn';
    const EXCLUDED_ACTIONS_UPDATE_RULES = 'updateRules';
    const EXCLUDED_ACTIONS_UPDATE_FALLTHROUGH = 'updateFallthrough';
    const EXCLUDED_ACTIONS_UPDATE_OFF_VARIATION = 'updateOffVariation';
    const EXCLUDED_ACTIONS_UPDATE_PREREQUISITES = 'updatePrerequisites';
    const EXCLUDED_ACTIONS_UPDATE_TARGETS = 'updateTargets';
     ...
     *
     * @param string[]|null $included_actions included_actions
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $excluded_actions excluded_actions
     *
     * @return self
     */
