...
/**
 * ExpandableApprovalRequestsResponse Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExpandableApprovalRequestsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandableApprovalRequestsResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\ExpandableApprovalRequestResponse[]',
        'total_count' => 'int',
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\ExpandableApprovalRequestResponse[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ExpandableApprovalRequestResponse[] $items An array of approval requests
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int $total_count Total number of approval requests
     *
     * @return self
     */
