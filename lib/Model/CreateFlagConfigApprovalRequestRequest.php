...
/**
 * CreateFlagConfigApprovalRequestRequest Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateFlagConfigApprovalRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createFlagConfigApprovalRequestRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('operating_on_id', $data ?? [], null);
    ...
    */
     ...
     * Sets description
     *
     * @param string $description A brief description of the changes you're requesting
     *
     * @return self
     */
     ...
     *
     * @param string|null $operating_on_id The ID of a scheduled change. Include this if your <code>instructions</code> include editing or deleting a scheduled change.
     *
     * @return self
     */
    public function setOperatingOnId($operating_on_id)
    {
        if (is_null($operating_on_id)) {
            throw new \InvalidArgumentException('non-nullable operating_on_id cannot be null');
        }
