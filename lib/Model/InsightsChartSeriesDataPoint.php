...
/**
 * InsightsChartSeriesDataPoint Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class InsightsChartSeriesDataPoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsightsChartSeriesDataPoint';
     ...
     * Sets values
     *
     * @param array<string,mixed>|null $values Additional values for the data point
     *
     * @return self
     */
