...
/**
 * IntegrationConfigurationPost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationConfigurationPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationConfigurationPost';
    ...
    protected static $openAPITypes = [
        ...
        'capability_config' => '\LaunchDarklyApi\Model\CapabilityConfigPost'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['config_values'] === null) {
            $invalidProperties[] = "'config_values' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name The name of the integration configuration
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Whether the integration configuration is enabled. If omitted, defaults to true
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags for the integration
     *
     * @return self
     */
     ...
     * Sets config_values
     *
     * @param array<string,mixed> $config_values The unique set of fields required to configure the integration. Refer to the <code>formVariables</code> field in the corresponding <code>manifest.json</code> at https://github.com/launchdarkly/integration-framework/tree/main/integrations for a full list of fields for the integration you wish to configure.
     *
     * @return self
     */
     ...
     *
     * @return \LaunchDarklyApi\Model\CapabilityConfigPost|null
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\CapabilityConfigPost|null $capability_config capability_config
     *
     * @return self
     */
