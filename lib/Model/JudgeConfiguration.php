...
/**
 * JudgeConfiguration Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class JudgeConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JudgeConfiguration';
    ...
    protected static $openAPITypes = [
        'judges' => '\LaunchDarklyApi\Model\JudgeAttachment[]'
    ];
    ...
    {
        $this->setIfExists('judges', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets judges
     *
     * @return \LaunchDarklyApi\Model\JudgeAttachment[]|null
     */
    public function getJudges()
    {
        return $this->container['judges'];
    }

    /**
     * Sets judges
     *
     * @param \LaunchDarklyApi\Model\JudgeAttachment[]|null $judges List of judges for this variation. When updating, this replaces all existing judge attachments, and if empty, removes all judge attachments.
     *
     * @return self
     */
    ...
    {
        if (is_null($judges)) {
            throw new \InvalidArgumentException('non-nullable judges cannot be null');
        }
        $this->container['judges'] = $judges;
