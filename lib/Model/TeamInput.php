 ...
 */
class TeamInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TeamInput';
     ...
     * Sets key
     *
     * @param string|null $key The key of the associated team that maintains the application
     *
     * @return self
     */
