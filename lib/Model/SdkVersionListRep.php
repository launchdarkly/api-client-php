...
/**
 * SdkVersionListRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class SdkVersionListRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SdkVersionListRep';
    ...
    protected static $openAPITypes = [
        ...
        'sdk_versions' => '\LaunchDarklyApi\Model\SdkVersionRep[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sdk_versions', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sdk_versions'] === null) {
            $invalidProperties[] = "'sdk_versions' can't be null";
        }
     ...
     * Gets sdk_versions
     *
     * @return \LaunchDarklyApi\Model\SdkVersionRep[]
     */
    public function getSdkVersions()
    {
        return $this->container['sdk_versions'];
    }

    /**
     * Sets sdk_versions
     *
     * @param \LaunchDarklyApi\Model\SdkVersionRep[] $sdk_versions The list of SDK names and versions
     *
     * @return self
     */
    public function setSdkVersions($sdk_versions)
    {
        if (is_null($sdk_versions)) {
            throw new \InvalidArgumentException('non-nullable sdk_versions cannot be null');
        }
        $this->container['sdk_versions'] = $sdk_versions;
