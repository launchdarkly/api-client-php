...
class Webhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets _id
     *
     * @param string $_id The ID of this webhook
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name A human-readable name for this webhook
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url The URL to which LaunchDarkly sends an HTTP POST payload for this webhook
     *
     * @return self
     */
     ...
     * Sets secret
     *
     * @param string|null $secret The secret for this webhook
     *
     * @return self
     */
     ...
     * Sets statements
     *
     * @param \LaunchDarklyApi\Model\Statement[]|null $statements Represents a Custom role policy, defining a resource kinds filter the webhook responds to.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[] $tags List of tags for this webhook
     *
     * @return self
     */
