...
/**
 * MetricByVariation Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class MetricByVariation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MetricByVariation';
    ...
    protected static $openAPITypes = [
        ...
        'metrics' => '\LaunchDarklyApi\Model\Metrics'
    ];
    ...
    {
        $this->setIfExists('variation_key', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['variation_key'];
    }

    /**
     * Sets variation_key
     *
     * @param string|null $variation_key variation_key
     *
     * @return self
     */
    public function setVariationKey($variation_key)
    {
        if (is_null($variation_key)) {
            throw new \InvalidArgumentException('non-nullable variation_key cannot be null');
        }
        $this->container['variation_key'] = $variation_key;
     ...
     * Gets metrics
     *
     * @return \LaunchDarklyApi\Model\Metrics|null
     */
     ...
     * Sets metrics
     *
     * @param \LaunchDarklyApi\Model\Metrics|null $metrics metrics
     *
     * @return self
     */
