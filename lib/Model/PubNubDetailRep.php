...
/**
 * PubNubDetailRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class PubNubDetailRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PubNubDetailRep';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cipher_key'] = $data['cipher_key'] ?? null;
    }
    ...
    {
        return $this->container['cipher_key'];
    }

    /**
     * Sets cipher_key
     *
     * @param string|null $cipher_key cipher_key
     *
     * @return self
     */
    public function setCipherKey($cipher_key)
    {
        $this->container['cipher_key'] = $cipher_key;
