 ...
 */
class ClientCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientCollection';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\LaunchDarklyApi\Model\Client[]'
    ];
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\Client[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\Client[] $items List of client objects
     *
     * @return self
     */
