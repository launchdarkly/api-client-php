 ...
 */
class LayerPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LayerPost';
     ...
     * Sets description
     *
     * @param string $description The checkout flow for the application
     *
     * @return self
     */
