...
/**
 * MemberDataRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class MemberDataRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberDataRep';
     ...
     * Sets _id
     *
     * @param string|null $_id The member ID
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string|null $first_name The member first name
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name The member last name
     *
     * @return self
     */
