 ...
 */
class StageInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StageInput';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'execute_conditions_in_sequence' => 'bool',
        'conditions' => '\LaunchDarklyApi\Model\ConditionInput[]',
        'action' => '\LaunchDarklyApi\Model\ActionInput'
    ];
    ...
    protected static array $openAPINullables = [
        'name' => false,
        'execute_conditions_in_sequence' => false,
        'conditions' => false,
        'action' => false
    ];
    ...
    protected static $setters = [
        'name' => 'setName',
        'execute_conditions_in_sequence' => 'setExecuteConditionsInSequence',
    ...
    protected static $getters = [
        'name' => 'getName',
        'execute_conditions_in_sequence' => 'getExecuteConditionsInSequence',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('execute_conditions_in_sequence', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The stage name
     *
     * @return self
     */
    ...
    /**
     * Gets execute_conditions_in_sequence
     *
     * @return bool|null
     */
    public function getExecuteConditionsInSequence()
    {
        return $this->container['execute_conditions_in_sequence'];
    }

    /**
     * Sets execute_conditions_in_sequence
     *
     * @param bool|null $execute_conditions_in_sequence Whether to execute the conditions in sequence for the given stage
     *
     * @return self
     */
    public function setExecuteConditionsInSequence($execute_conditions_in_sequence)
    {
        if (is_null($execute_conditions_in_sequence)) {
            throw new \InvalidArgumentException('non-nullable execute_conditions_in_sequence cannot be null');
        }
        $this->container['execute_conditions_in_sequence'] = $execute_conditions_in_sequence;
     ...
     * Gets conditions
     *
     * @return \LaunchDarklyApi\Model\ConditionInput[]|null
     */
     ...
     * Sets conditions
     *
     * @param \LaunchDarklyApi\Model\ConditionInput[]|null $conditions An array of conditions for the stage
     *
     * @return self
     */
     ...
     * Gets action
     *
     * @return \LaunchDarklyApi\Model\ActionInput|null
     */
     ...
     * Sets action
     *
     * @param \LaunchDarklyApi\Model\ActionInput|null $action action
     *
     * @return self
     */
