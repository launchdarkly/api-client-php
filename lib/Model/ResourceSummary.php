...
class ResourceSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'metric_count' => 'setMetricCount',
        'ai_config_count' => 'setAiConfigCount',
    ...
    protected static $getters = [
        ...
        'ai_config_count' => 'getAiConfigCount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('metric_count', $data ?? [], null);
        $this->setIfExists('ai_config_count', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['flag_count'] === null) {
            $invalidProperties[] = "'flag_count' can't be null";
        }
     ...
     * Sets flag_count
     *
     * @param int $flag_count flag_count
     *
     * @return self
     */
    ...
    {
        return $this->container['metric_count'];
    }

    /**
     * Sets metric_count
     *
     * @param int|null $metric_count metric_count
     *
     * @return self
     */
    public function setMetricCount($metric_count)
    {
        if (is_null($metric_count)) {
            throw new \InvalidArgumentException('non-nullable metric_count cannot be null');
        }
        $this->container['metric_count'] = $metric_count;

        return $this;
    }

    /**
     * Gets ai_config_count
     *
     * @return int|null
     */
    public function getAiConfigCount()
    {
        return $this->container['ai_config_count'];
    }

    /**
     * Sets ai_config_count
     *
     * @param int|null $ai_config_count ai_config_count
     *
     * @return self
     */
    public function setAiConfigCount($ai_config_count)
    {
        if (is_null($ai_config_count)) {
            throw new \InvalidArgumentException('non-nullable ai_config_count cannot be null');
        }
        $this->container['ai_config_count'] = $ai_config_count;
