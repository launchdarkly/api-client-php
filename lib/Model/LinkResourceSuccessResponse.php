...
/**
 * LinkResourceSuccessResponse Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class LinkResourceSuccessResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinkResourceSuccessResponse';
    ...
    protected static $openAPITypes = [
        'success_count' => 'int',
        'failure_count' => 'int',
        'linked_resources' => '\LaunchDarklyApi\Model\ViewLinkedResources',
        'failed_resources' => '\LaunchDarklyApi\Model\FailedResourceLink[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('linked_resources', $data ?? [], null);
        $this->setIfExists('failed_resources', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets success_count
     *
     * @param int $success_count The number of resources successfully linked.
     *
     * @return self
     */
     ...
     * Sets failure_count
     *
     * @param int $failure_count The number of resources that failed to link.
     *
     * @return self
     */
     ...
     *
     * @return \LaunchDarklyApi\Model\ViewLinkedResources|null
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\ViewLinkedResources|null $linked_resources linked_resources
     *
     * @return self
     */
    public function setLinkedResources($linked_resources)
    {
        if (is_null($linked_resources)) {
            throw new \InvalidArgumentException('non-nullable linked_resources cannot be null');
        }
     ...
     *
     * @return \LaunchDarklyApi\Model\FailedResourceLink[]|null
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\FailedResourceLink[]|null $failed_resources Details of resources that failed to link.
     *
     * @return self
     */
    public function setFailedResources($failed_resources)
    {
        if (is_null($failed_resources)) {
            throw new \InvalidArgumentException('non-nullable failed_resources cannot be null');
        }
