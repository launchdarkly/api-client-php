...
class RelayAutoConfigPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets policy
     *
     * @param \LaunchDarklyApi\Model\Statement[] $policy A description of what environments and projects the Relay Proxy should include or exclude. To learn more, read [Write an inline policy](https://docs.launchdarkly.com/sdk/relay-proxy/automatic-configuration#write-an-inline-policy).
     *
     * @return self
     */
