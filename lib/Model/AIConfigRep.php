 ...
 */
class AIConfigRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AIConfigRep';
    ...
    */
     ...
     * Sets key
     *
     * @param string $key The key of the AI Config
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The name of the AI Config
     *
     * @return self
     */
