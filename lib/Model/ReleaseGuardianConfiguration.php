...
/**
 * ReleaseGuardianConfiguration Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleaseGuardianConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleaseGuardianConfiguration';
    ...
    protected static $openAPITypes = [
        'monitoring_window_milliseconds' => 'int',
        'rollout_weight' => 'int',
    ...
    protected static $openAPIFormats = [
        'monitoring_window_milliseconds' => 'int64',
        'rollout_weight' => null,
    ...
    protected static array $openAPINullables = [
        'monitoring_window_milliseconds' => false,
        'rollout_weight' => false,
    ...
    protected static $setters = [
        'monitoring_window_milliseconds' => 'setMonitoringWindowMilliseconds',
        'rollout_weight' => 'setRolloutWeight',
    ...
    protected static $getters = [
        'monitoring_window_milliseconds' => 'getMonitoringWindowMilliseconds',
        'rollout_weight' => 'getRolloutWeight',
    ...
    {
        $this->setIfExists('monitoring_window_milliseconds', $data ?? [], null);
        $this->setIfExists('rollout_weight', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['monitoring_window_milliseconds'] === null) {
            $invalidProperties[] = "'monitoring_window_milliseconds' can't be null";
        }
        if ($this->container['rollout_weight'] === null) {
            $invalidProperties[] = "'rollout_weight' can't be null";
        }
        if ($this->container['rollback_on_regression'] === null) {
            $invalidProperties[] = "'rollback_on_regression' can't be null";
        }
    ...
    /**
     * Gets monitoring_window_milliseconds
     *
     * @return int
     */
    public function getMonitoringWindowMilliseconds()
    {
        return $this->container['monitoring_window_milliseconds'];
    }

    /**
     * Sets monitoring_window_milliseconds
     *
     * @param int $monitoring_window_milliseconds The monitoring window in milliseconds
     *
     * @return self
     */
    public function setMonitoringWindowMilliseconds($monitoring_window_milliseconds)
    {
        if (is_null($monitoring_window_milliseconds)) {
            throw new \InvalidArgumentException('non-nullable monitoring_window_milliseconds cannot be null');
        }
        $this->container['monitoring_window_milliseconds'] = $monitoring_window_milliseconds;
     ...
     * @return int
     */
    public function getRolloutWeight()
    {
        return $this->container['rollout_weight'];
    }

    /**
     * Sets rollout_weight
     *
     * @param int $rollout_weight The rollout weight percentage
     *
     * @return self
     */
    public function setRolloutWeight($rollout_weight)
    {
        if (is_null($rollout_weight)) {
            throw new \InvalidArgumentException('non-nullable rollout_weight cannot be null');
        }
        $this->container['rollout_weight'] = $rollout_weight;
     ...
     *
     * @param bool $rollback_on_regression Whether or not to roll back on regression
     *
     * @return self
     */
     ...
     *
     * @param string|null $randomization_unit The randomization unit for the measured rollout
     *
     * @return self
     */
