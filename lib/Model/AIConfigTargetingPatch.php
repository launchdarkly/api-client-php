...
/**
 * AIConfigTargetingPatch Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AIConfigTargetingPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AIConfigTargetingPatch';
    ...
    */
     ...
     * Sets instructions
     *
     * @param array<string,mixed>[] $instructions instructions
     *
     * @return self
     */
