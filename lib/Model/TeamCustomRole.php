...
/**
 * TeamCustomRole Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class TeamCustomRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TeamCustomRole';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('applied_on', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key The key of the custom role
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the custom role
     *
     * @return self
     */
     ...
     * Sets applied_on
     *
     * @param int|null $applied_on applied_on
     *
     * @return self
     */
    public function setAppliedOn($applied_on)
    {
        if (is_null($applied_on)) {
            throw new \InvalidArgumentException('non-nullable applied_on cannot be null');
        }
