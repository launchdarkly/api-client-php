...
/**
 * ParameterDefault Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ParameterDefault implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParameterDefault';
    ...
    protected static $openAPITypes = [
        'value' => 'mixed',
        'boolean_variation_value' => 'bool',
        'rule_clause' => '\LaunchDarklyApi\Model\RuleClause'
    ];
    ...
    protected static $setters = [
        'value' => 'setValue',
        'boolean_variation_value' => 'setBooleanVariationValue',
    ...
    protected static $getters = [
        'value' => 'getValue',
        'boolean_variation_value' => 'getBooleanVariationValue',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('boolean_variation_value', $data ?? [], null);
    ...
    */
     ...
     * Sets value
     *
     * @param mixed|null $value The default value for the given parameter
     *
     * @return self
     */
    ...
    /**
     * Gets boolean_variation_value
     *
     * @return bool|null
     */
    public function getBooleanVariationValue()
    {
        return $this->container['boolean_variation_value'];
    }

    /**
     * Sets boolean_variation_value
     *
     * @param bool|null $boolean_variation_value Variation value for boolean flags. Not applicable for non-boolean flags.
     *
     * @return self
     */
    public function setBooleanVariationValue($boolean_variation_value)
    {
        if (is_null($boolean_variation_value)) {
            throw new \InvalidArgumentException('non-nullable boolean_variation_value cannot be null');
        }
        $this->container['boolean_variation_value'] = $boolean_variation_value;
     ...
     * Gets rule_clause
     *
     * @return \LaunchDarklyApi\Model\RuleClause|null
     */
     ...
     * Sets rule_clause
     *
     * @param \LaunchDarklyApi\Model\RuleClause|null $rule_clause rule_clause
     *
     * @return self
     */
