 ...
 */
class Phase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Phase';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'audiences' => '\LaunchDarklyApi\Model\Audience[]',
        'name' => 'string',
     ...
     * Sets audiences
     *
     * @param \LaunchDarklyApi\Model\Audience[] $audiences audiences
     *
     * @return self
     */
