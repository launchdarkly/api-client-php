 ...
 */
class IpList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ipList';
    ...
    protected static $setters = [
        ...
        'outbound_addresses' => 'setOutboundAddresses'
    ];
    ...
    protected static $getters = [
        ...
        'outbound_addresses' => 'getOutboundAddresses'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('outbound_addresses', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['outbound_addresses'] === null) {
            $invalidProperties[] = "'outbound_addresses' can't be null";
        }
     ...
     * Sets addresses
     *
     * @param string[] $addresses A list of the IP addresses LaunchDarkly's service uses
     *
     * @return self
     */
    ...
    /**
     * Gets outbound_addresses
     *
     * @return string[]
     */
    public function getOutboundAddresses()
    {
        return $this->container['outbound_addresses'];
    }

    /**
     * Sets outbound_addresses
     *
     * @param string[] $outbound_addresses A list of the IP addresses outgoing webhook notifications use
     *
     * @return self
     */
    public function setOutboundAddresses($outbound_addresses)
    {
        if (is_null($outbound_addresses)) {
            throw new \InvalidArgumentException('non-nullable outbound_addresses cannot be null');
        }
        $this->container['outbound_addresses'] = $outbound_addresses;
