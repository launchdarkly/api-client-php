...
class PermissionGrantInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets actions
     *
     * @param string[]|null $actions A list of actions to allow. Specify either <code>actionSet</code> or <code>actions</code>. To learn more, read [Role actions](https://docs.launchdarkly.com/home/members/role-actions).
     *
     * @return self
     */
