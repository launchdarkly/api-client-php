...
/**
 * PermissionGrantInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class PermissionGrantInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'permissionGrantInput';
    ...
    public const ACTION_SET_MAINTAIN_TEAM = 'maintainTeam';
     ...
     * @return string[]
     */
    public function getActionSetAllowableValues()
    {
        return [
            self::ACTION_SET_MAINTAIN_TEAM,
        ];
    }
    ...
    {
        $this->setIfExists('action_set', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getActionSetAllowableValues();
        if (!is_null($this->container['action_set']) && !in_array($this->container['action_set'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'action_set', must be one of '%s'",
                $this->container['action_set'],
     ...
     * Sets action_set
     *
     * @param string|null $action_set A group of related actions to allow. Specify either <code>actionSet</code> or <code>actions</code>. Use <code>maintainTeam</code> to add team maintainers.
     *
     * @return self
     */
    public function setActionSet($action_set)
    {
        if (is_null($action_set)) {
            throw new \InvalidArgumentException('non-nullable action_set cannot be null');
        }
        $allowedValues = $this->getActionSetAllowableValues();
        if (!in_array($action_set, $allowedValues, true)) {
     ...
     * Sets actions
     *
     * @param string[]|null $actions A list of actions to allow. Specify either <code>actionSet</code> or <code>actions</code>. To learn more, read [Role actions](https://launchdarkly.com/docs/ld-docs/home/account/role-actions).
     *
     * @return self
     */
     ...
     * Sets member_ids
     *
     * @param string[]|null $member_ids A list of member IDs who receive the permission grant.
     *
     * @return self
     */
