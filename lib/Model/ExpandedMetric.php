...
/**
 * ExpandedMetric Class Doc Comment
 *
 * @category Class
 ...
 */
class ExpandedMetric implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandedMetric';
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key A unique key used to reference the metric
     *
     * @return self
     */
     ...
     * Sets last_modified
     *
     * @param int|null $last_modified Last modification date in milliseconds
     *
     * @return self
     */
     ...
     * Sets event_key
     *
     * @param string|null $event_key Event key for the metric
     *
     * @return self
     */
     ...
     * Sets _id
     *
     * @param string|null $_id ID of the metric
     *
     * @return self
     */
     ...
     * Sets _version_id
     *
     * @param string|null $_version_id Version ID of the metric
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string|null $kind Kind of the Metric
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param string|null $category Category of the Metric
     *
     * @return self
     */
     ...
     * Sets last_seen
     *
     * @param int|null $last_seen Last seen date in milliseconds
     *
     * @return self
     */
