...
/**
 * TeamCollectionRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class TeamCollectionRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TeamCollectionRep';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\TeamRep[]',
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\TeamRep[]|null
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\TeamRep[]|null $items items
     *
     * @return self
     */
