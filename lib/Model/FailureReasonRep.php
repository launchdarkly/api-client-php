...
/**
 * FailureReasonRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FailureReasonRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FailureReasonRep';
     ...
     * Sets reason
     *
     * @param string $reason The reason the attribute failed validation
     *
     * @return self
     */
