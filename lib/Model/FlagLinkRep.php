 ...
 */
class FlagLinkRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagLinkRep';
    ...
    protected static $openAPITypes = [
        ...
        'title' => 'string',
        'description' => 'string',
        '_metadata' => 'array<string,string>',
        '_created_at' => 'int',
        '_member' => '\LaunchDarklyApi\Model\FlagLinkMember'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_key', $data ?? [], null);
        $this->setIfExists('_integration_key', $data ?? [], null);
        $this->setIfExists('_id', $data ?? [], null);
        $this->setIfExists('_deep_link', $data ?? [], null);
        $this->setIfExists('_timestamp', $data ?? [], null);
        $this->setIfExists('title', $data ?? [], null);
        $this->setIfExists('description', $data ?? [], null);
        $this->setIfExists('_metadata', $data ?? [], null);
        $this->setIfExists('_created_at', $data ?? [], null);
        $this->setIfExists('_member', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_deep_link'] === null) {
            $invalidProperties[] = "'_deep_link' can't be null";
        }
        if ($this->container['_timestamp'] === null) {
            $invalidProperties[] = "'_timestamp' can't be null";
        }
        if ($this->container['_created_at'] === null) {
            $invalidProperties[] = "'_created_at' can't be null";
        }
     ...
     * Sets _key
     *
     * @param string|null $_key The flag link key
     *
     * @return self
     */
    ...
    {
        if (is_null($_key)) {
            throw new \InvalidArgumentException('non-nullable _key cannot be null');
        }
     ...
     *
     * @param string|null $_integration_key The integration key for an integration whose <code>manifest.json</code> includes the <code>flagLink</code> capability, if this is a flag link for an existing integration
     *
     * @return self
     */
     ...
     * Sets _id
     *
     * @param string $_id The ID of this flag link
     *
     * @return self
     */
    ...
    {
        return $this->container['_deep_link'];
    }

    /**
     * Sets _deep_link
     *
     * @param string $_deep_link The URL for the external resource the flag is linked to
     *
     * @return self
     */
    public function setDeepLink($_deep_link)
    {
        if (is_null($_deep_link)) {
            throw new \InvalidArgumentException('non-nullable _deep_link cannot be null');
        }
        $this->container['_deep_link'] = $_deep_link;
     ...
     * Gets _timestamp
     *
     * @return \LaunchDarklyApi\Model\TimestampRep
     */
    public function getTimestamp()
    {
        return $this->container['_timestamp'];
    }

    /**
     * Sets _timestamp
     *
     * @param \LaunchDarklyApi\Model\TimestampRep $_timestamp _timestamp
     *
     * @return self
     */
    public function setTimestamp($_timestamp)
    {
        if (is_null($_timestamp)) {
            throw new \InvalidArgumentException('non-nullable _timestamp cannot be null');
        }
        $this->container['_timestamp'] = $_timestamp;
     ...
     * Sets title
     *
     * @param string|null $title The title of the flag link
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description of the flag link
     *
     * @return self
     */
     ...
     * Sets _metadata
     *
     * @param array<string,string>|null $_metadata The metadata required by this integration in order to create a flag link, if this is a flag link for an existing integration. Defined in the integration's <code>manifest.json</code> file under <code>flagLink</code>.
     *
     * @return self
     */
     ...
     * Sets _created_at
     *
     * @param int $_created_at _created_at
     *
     * @return self
     */
     ...
     * Gets _member
     *
     * @return \LaunchDarklyApi\Model\FlagLinkMember|null
     */
     ...
     * Sets _member
     *
     * @param \LaunchDarklyApi\Model\FlagLinkMember|null $_member _member
     *
     * @return self
     */
    ...
    {
        if (is_null($_member)) {
            throw new \InvalidArgumentException('non-nullable _member cannot be null');
        }
