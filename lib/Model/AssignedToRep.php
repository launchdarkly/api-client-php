...
/**
 * AssignedToRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AssignedToRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssignedToRep';
    ...
    {
        $this->container['members_count'] = $data['members_count'] ?? null;
        $this->container['teams_count'] = $data['teams_count'] ?? null;
    }
     ...
     * Sets members_count
     *
     * @param int|null $members_count The number of individual members this role is assigned to
     *
     * @return self
     */
     ...
     * Sets teams_count
     *
     * @param int|null $teams_count The number of teams this role is assigned to
     *
     * @return self
     */
