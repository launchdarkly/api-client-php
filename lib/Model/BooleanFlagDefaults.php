...
class BooleanFlagDefaults implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string $true_display_name true_display_name
     *
     * @return self
     */
     ...
     *
     * @param string $false_display_name false_display_name
     *
     * @return self
     */
     ...
     *
     * @param string $true_description true_description
     *
     * @return self
     */
     ...
     *
     * @param string $false_description false_description
     *
     * @return self
     */
     ...
     * Sets on_variation
     *
     * @param int $on_variation on_variation
     *
     * @return self
     */
