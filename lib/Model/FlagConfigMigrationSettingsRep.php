...
/**
 * FlagConfigMigrationSettingsRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagConfigMigrationSettingsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagConfigMigrationSettingsRep';
    ...
    {
        $this->setIfExists('check_ratio', $data ?? [], null);
    }
    ...
    */
     ...
     * @return int|null
     */
    public function getCheckRatio()
    {
        return $this->container['check_ratio'];
    }

    /**
     * Sets check_ratio
     *
     * @param int|null $check_ratio check_ratio
     *
     * @return self
     */
    public function setCheckRatio($check_ratio)
    {
        if (is_null($check_ratio)) {
            throw new \InvalidArgumentException('non-nullable check_ratio cannot be null');
        }
        $this->container['check_ratio'] = $check_ratio;
