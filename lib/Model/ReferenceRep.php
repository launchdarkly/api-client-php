...
/**
 * ReferenceRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReferenceRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReferenceRep';
    ...
    protected static $openAPITypes = [
        'path' => 'string',
        'hint' => 'string',
        'hunks' => '\LaunchDarklyApi\Model\HunkRep[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('hunks', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setHunks($hunks)
    {
        if (is_null($hunks)) {
            throw new \InvalidArgumentException('non-nullable hunks cannot be null');
        }
        $this->container['hunks'] = $hunks;
