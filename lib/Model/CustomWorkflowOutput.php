...
/**
 * CustomWorkflowOutput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CustomWorkflowOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomWorkflowOutput';
    ...
    protected static $openAPITypes = [
        '_id' => 'string',
        '_version' => 'int',
        '_conflicts' => '\LaunchDarklyApi\Model\ConflictOutput[]',
        '_creation_date' => 'int',
        ...
        'description' => 'string',
        'kind' => 'string',
        'stages' => '\LaunchDarklyApi\Model\StageOutput[]',
        '_execution' => '\LaunchDarklyApi\Model\ExecutionOutput',
        'meta' => '\LaunchDarklyApi\Model\WorkflowTemplateMetadata',
        'template_key' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_conflicts', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_conflicts'] === null) {
            $invalidProperties[] = "'_conflicts' can't be null";
        }
     ...
     * Sets _id
     *
     * @param string $_id The ID of the workflow
     *
     * @return self
     */
     ...
     * Sets _version
     *
     * @param int $_version The version of the workflow
     *
     * @return self
     */
     ...
     * Gets _conflicts
     *
     * @return \LaunchDarklyApi\Model\ConflictOutput[]
     */
    public function getConflicts()
    {
        return $this->container['_conflicts'];
    }

    /**
     * Sets _conflicts
     *
     * @param \LaunchDarklyApi\Model\ConflictOutput[] $_conflicts Any conflicts that are present in the workflow stages
     *
     * @return self
     */
    public function setConflicts($_conflicts)
    {
        if (is_null($_conflicts)) {
            throw new \InvalidArgumentException('non-nullable _conflicts cannot be null');
        }
        $this->container['_conflicts'] = $_conflicts;
     ...
     * Sets _maintainer_id
     *
     * @param string $_maintainer_id The member ID of the maintainer of the workflow. Defaults to the workflow creator.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A brief description of the workflow
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string|null $kind The kind of workflow
     *
     * @return self
     */
     ...
     * Gets stages
     *
     * @return \LaunchDarklyApi\Model\StageOutput[]|null
     */
     ...
     * Sets stages
     *
     * @param \LaunchDarklyApi\Model\StageOutput[]|null $stages The stages that make up the workflow. Each stage contains conditions and actions.
     *
     * @return self
     */
     ...
     * Gets meta
     *
     * @return \LaunchDarklyApi\Model\WorkflowTemplateMetadata|null
     */
     ...
     * Sets meta
     *
     * @param \LaunchDarklyApi\Model\WorkflowTemplateMetadata|null $meta meta
     *
     * @return self
     */
     ...
     * Sets template_key
     *
     * @param string|null $template_key For workflows being created from a workflow template, this value is the template's key
     *
     * @return self
     */
