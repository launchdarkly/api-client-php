...
class IntegrationMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'external_id' => 'string',
        'external_status' => '\LaunchDarklyApi\Model\IntegrationStatus',
        'external_url' => 'string',
        'last_checked' => 'int'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('external_status', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['external_status'] === null) {
            $invalidProperties[] = "'external_status' can't be null";
        }
     ...
     *
     * @return \LaunchDarklyApi\Model\IntegrationStatus
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\IntegrationStatus $external_status external_status
     *
     * @return self
     */
    public function setExternalStatus($external_status)
    {
        if (is_null($external_status)) {
            throw new \InvalidArgumentException('non-nullable external_status cannot be null');
        }
     ...
     * Sets last_checked
     *
     * @param int $last_checked last_checked
     *
     * @return self
     */
