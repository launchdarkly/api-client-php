...
class BooleanDefaults implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $true_display_name true_display_name
     *
     * @return self
     */
     ...
     *
     * @param string|null $false_display_name false_display_name
     *
     * @return self
     */
     ...
     *
     * @param string|null $true_description true_description
     *
     * @return self
     */
     ...
     *
     * @param string|null $false_description false_description
     *
     * @return self
     */
     ...
     * Sets on_variation
     *
     * @param int|null $on_variation on_variation
     *
     * @return self
     */
