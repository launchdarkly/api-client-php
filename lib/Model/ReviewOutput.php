...
/**
 * ReviewOutput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReviewOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReviewOutput';
    ...
    */
     ...
     *
     * @param string|null $service_token_id service_token_id
     *
     * @return self
     */
