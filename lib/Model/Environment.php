...
class Environment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['mobile_key'] = $data['mobile_key'] ?? null;
        $this->container['color'] = $data['color'] ?? null;
        $this->container['default_ttl'] = $data['default_ttl'] ?? null;
        $this->container['secure_mode'] = $data['secure_mode'] ?? null;
        $this->container['default_track_events'] = $data['default_track_events'] ?? null;
        $this->container['require_comments'] = $data['require_comments'] ?? null;
        $this->container['confirm_changes'] = $data['confirm_changes'] ?? null;
        $this->container['tags'] = $data['tags'] ?? null;
        $this->container['approval_settings'] = $data['approval_settings'] ?? null;
        $this->container['resource_approval_settings'] = $data['resource_approval_settings'] ?? null;
