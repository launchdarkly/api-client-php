...
class Environment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'resource_approval_settings' => 'array<string,\LaunchDarklyApi\Model\ApprovalSettings>',
        'critical' => 'bool'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'tags' => false,
        'approval_settings' => false,
        'resource_approval_settings' => false,
        'critical' => false
    ];
    ...
    protected static $setters = [
        ...
        'resource_approval_settings' => 'setResourceApprovalSettings',
    ...
    protected static $getters = [
        ...
        'resource_approval_settings' => 'getResourceApprovalSettings',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mobile_key', $data ?? [], null);
        ...
        $this->setIfExists('approval_settings', $data ?? [], null);
        $this->setIfExists('resource_approval_settings', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mobile_key'] === null) {
            $invalidProperties[] = "'mobile_key' can't be null";
        }
        ...
        if ($this->container['secure_mode'] === null) {
            $invalidProperties[] = "'secure_mode' can't be null";
        }
        if ($this->container['default_track_events'] === null) {
            $invalidProperties[] = "'default_track_events' can't be null";
        }
        if ($this->container['require_comments'] === null) {
            $invalidProperties[] = "'require_comments' can't be null";
        }
        if ($this->container['confirm_changes'] === null) {
            $invalidProperties[] = "'confirm_changes' can't be null";
        }
     ...
     * Sets _id
     *
     * @param string $_id The ID for the environment. Use this as the client-side ID for authorization in some client-side SDKs, and to associate LaunchDarkly environments with CDN integrations in edge SDKs.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name A human-friendly name for the new environment
     *
     * @return self
     */
     ...
     * Sets api_key
     *
     * @param string $api_key The SDK key for the environment. Use this for authorization in server-side SDKs.
     *
     * @return self
     */
     ...
     * Sets mobile_key
     *
     * @param string $mobile_key The mobile key for the environment. Use this for authorization in mobile SDKs.
     *
     * @return self
     */
    public function setMobileKey($mobile_key)
    {
        if (is_null($mobile_key)) {
            throw new \InvalidArgumentException('non-nullable mobile_key cannot be null');
        }
     ...
     * Sets color
     *
     * @param string $color The color used to indicate this environment in the UI
     *
     * @return self
     */
     ...
     * Sets default_ttl
     *
     * @param int $default_ttl The default time (in minutes) that the PHP SDK can cache feature flag rules locally
     *
     * @return self
     */
     ...
     * Sets secure_mode
     *
     * @param bool $secure_mode Ensures that one end user of the client-side SDK cannot inspect the variations for another end user
     *
     * @return self
     */
    public function setSecureMode($secure_mode)
    {
        if (is_null($secure_mode)) {
     ...
     *
     * @param bool $default_track_events Enables tracking detailed information for new flags by default
     *
     * @return self
     */
    public function setDefaultTrackEvents($default_track_events)
    {
        if (is_null($default_track_events)) {
            throw new \InvalidArgumentException('non-nullable default_track_events cannot be null');
        }
     ...
     *
     * @param bool $require_comments Whether members who modify flags and segments through the LaunchDarkly user interface are required to add a comment
     *
     * @return self
     */
     ...
     *
     * @param bool $confirm_changes Whether members who modify flags and segments through the LaunchDarkly user interface are required to confirm those changes
     *
     * @return self
     */
    public function setConfirmChanges($confirm_changes)
    {
        if (is_null($confirm_changes)) {
            throw new \InvalidArgumentException('non-nullable confirm_changes cannot be null');
        }
     ...
     * Sets tags
     *
     * @param string[] $tags A list of tags for this environment
     *
     * @return self
     */
    ...
    {
        if (is_null($approval_settings)) {
            throw new \InvalidArgumentException('non-nullable approval_settings cannot be null');
        }
    ...
    /**
     * Gets resource_approval_settings
     *
     * @return array<string,\LaunchDarklyApi\Model\ApprovalSettings>|null
     */
    public function getResourceApprovalSettings()
    {
        return $this->container['resource_approval_settings'];
    }

    /**
     * Sets resource_approval_settings
     *
     * @param array<string,\LaunchDarklyApi\Model\ApprovalSettings>|null $resource_approval_settings Details on the approval settings for this environment for each resource kind
     *
     * @return self
     */
    public function setResourceApprovalSettings($resource_approval_settings)
    {
        if (is_null($resource_approval_settings)) {
            throw new \InvalidArgumentException('non-nullable resource_approval_settings cannot be null');
        }
        $this->container['resource_approval_settings'] = $resource_approval_settings;
     ...
     * Sets critical
     *
     * @param bool $critical Whether the environment is critical
     *
     * @return self
     */
