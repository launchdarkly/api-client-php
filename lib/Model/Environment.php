...
class Environment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets secure_mode
     *
     * @param bool $secure_mode Secure mode ensures that a user of the client-side SDK cannot impersonate another user.
     *
     * @return self
     */
     ...
     *
     * @param bool $require_comments Whether members who modify flags and user segments through the LaunchDarkly user interface are required to add a comment
     *
     * @return self
     */
     ...
     *
     * @param bool $confirm_changes Whether members who modify flags and user segments through the LaunchDarkly user interface are required to confirm those changes
     *
     * @return self
     */
