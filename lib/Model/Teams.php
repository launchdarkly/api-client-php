...
class Teams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\Team[]',
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\Team[]|null
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\Team[]|null $items An array of teams
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int|null $total_count The number of teams
     *
     * @return self
     */
