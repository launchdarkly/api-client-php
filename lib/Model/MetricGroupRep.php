...
/**
 * MetricGroupRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class MetricGroupRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MetricGroupRep';
    ...
    public const KIND_FUNNEL = 'funnel';
    public const KIND_STANDARD = 'standard';
    public const KIND_GUARDRAIL = 'guardrail';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_last_modified'] === null) {
            $invalidProperties[] = "'_last_modified' can't be null";
        }
        if ($this->container['maintainer'] === null) {
            $invalidProperties[] = "'maintainer' can't be null";
        }
     ...
     * Sets _id
     *
     * @param string $_id The ID of this metric group
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string $key A unique key to reference the metric group
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name A human-friendly name for the metric group
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string $kind The type of the metric group
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the metric group
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[] $tags Tags for the metric group
     *
     * @return self
     */
     ...
     * Sets _last_modified
     *
     * @param int $_last_modified _last_modified
     *
     * @return self
     */
     ...
     * Gets maintainer
     *
     * @return \LaunchDarklyApi\Model\MaintainerRep
     */
     ...
     * Sets maintainer
     *
     * @param \LaunchDarklyApi\Model\MaintainerRep $maintainer maintainer
     *
     * @return self
     */
     ...
     * Gets metrics
     *
     * @return \LaunchDarklyApi\Model\MetricInGroupRep[]
     */
     ...
     * Sets metrics
     *
     * @param \LaunchDarklyApi\Model\MetricInGroupRep[] $metrics An ordered list of the metrics in this metric group
     *
     * @return self
     */
     ...
     * Sets _version
     *
     * @param int $_version The version of this metric group
     *
     * @return self
     */
     ...
     *
     * @param int|null $experiment_count The number of experiments using this metric group
     *
     * @return self
     */
