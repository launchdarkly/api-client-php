...
/**
 * ConditionInputRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ConditionInputRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConditionInputRep';
     ...
     *
     * @param string[]|null $notify_member_ids notify_member_ids
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $notify_team_keys notify_team_keys
     *
     * @return self
     */
