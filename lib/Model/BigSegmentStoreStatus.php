...
/**
 * BigSegmentStoreStatus Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class BigSegmentStoreStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BigSegmentStoreStatus';
    ...
    protected static $openAPITypes = [
        ...
        'last_sync' => 'int',
        'last_error' => 'int',
        'errors' => '\LaunchDarklyApi\Model\StoreIntegrationError[]'
    ];
    ...
    protected static $setters = [
        ...
        'potentially_stale' => 'setPotentiallyStale',
    ...
    protected static $getters = [
        ...
        'potentially_stale' => 'getPotentiallyStale',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('potentially_stale', $data ?? [], null);
    ...
    */
     ...
     * Sets available
     *
     * @param bool|null $available Whether the persistent store integration is fully synchronized with the LaunchDarkly environment, and the <code>lastSync</code> occurred within a few minutes
     *
     * @return self
     */
    ...
    /**
     * Gets potentially_stale
     *
     * @return bool|null
     */
    public function getPotentiallyStale()
    {
        return $this->container['potentially_stale'];
    }

    /**
     * Sets potentially_stale
     *
     * @param bool|null $potentially_stale Whether the persistent store integration may not be fully synchronized with the LaunchDarkly environment. <code>true</code> if the integration could be stale.
     *
     * @return self
     */
    public function setPotentiallyStale($potentially_stale)
    {
        if (is_null($potentially_stale)) {
            throw new \InvalidArgumentException('non-nullable potentially_stale cannot be null');
        }
        $this->container['potentially_stale'] = $potentially_stale;
     ...
     * Sets last_error
     *
     * @param int|null $last_error last_error
     *
     * @return self
     */
     ...
     * Gets errors
     *
     * @return \LaunchDarklyApi\Model\StoreIntegrationError[]|null
     */
     ...
     * Sets errors
     *
     * @param \LaunchDarklyApi\Model\StoreIntegrationError[]|null $errors errors
     *
     * @return self
     */
