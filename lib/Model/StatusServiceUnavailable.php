...
/**
 * StatusServiceUnavailable Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class StatusServiceUnavailable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatusServiceUnavailable';
     ...
     * Sets code
     *
     * @param string|null $code Specific error code encountered
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Description of the error
     *
     * @return self
     */
