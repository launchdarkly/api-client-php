 ...
 */
class AgentGraph implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AgentGraph';
    ...
    */
     ...
     *
     * @param string|null $root_config_key The AI Config key of the root node
     *
     * @return self
     */
     ...
     * Sets edges
     *
     * @param \LaunchDarklyApi\Model\AgentGraphEdge[]|null $edges The edges in the graph
     *
     * @return self
     */
