 ...
 */
class UserFlagSetting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserFlagSetting';
    ...
    protected static $openAPITypes = [
        ...
        '_value' => 'mixed',
        'setting' => 'mixed',
        'reason' => '\LaunchDarklyApi\Model\EvaluationReason'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_value', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_value'] === null) {
            $invalidProperties[] = "'_value' can't be null";
        }
     ...
     * Sets _value
     *
     * @param mixed $_value The value of the flag variation that the user receives. If there is no defined default rule, this is null.
     *
     * @return self
     */
    ...
    {
        if (is_null($_value)) {
            array_push($this->openAPINullablesSetToNull, '_value');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('_value', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets setting
     *
     * @param mixed $setting Whether the user is explicitly targeted to receive a particular variation. The setting is false if you have turned off a feature flag for a user. It is null if you haven't assigned that user to a specific variation.
     *
     * @return self
     */
     ...
     * Gets reason
     *
     * @return \LaunchDarklyApi\Model\EvaluationReason|null
     */
     ...
     * Sets reason
     *
     * @param \LaunchDarklyApi\Model\EvaluationReason|null $reason reason
     *
     * @return self
     */
