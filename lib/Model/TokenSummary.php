...
/**
 * TokenSummary Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class TokenSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TokenSummary';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ending', $data ?? [], null);
    ...
    */
     ...
     * Sets ending
     *
     * @param string|null $ending The last few characters of the token
     *
     * @return self
     */
    ...
    {
        if (is_null($ending)) {
            throw new \InvalidArgumentException('non-nullable ending cannot be null');
        }
     ...
     * Sets service_token
     *
     * @param bool|null $service_token Whether this is a service token
     *
     * @return self
     */
