...
/**
 * ContextRecord Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ContextRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContextRecord';
    ...
    protected static $setters = [
        ...
        '_links' => 'setLinks',
        '_access' => 'setAccess',
        'associated_contexts' => 'setAssociatedContexts'
    ];
    ...
    protected static $getters = [
        ...
        '_links' => 'getLinks',
        '_access' => 'getAccess',
        'associated_contexts' => 'getAssociatedContexts'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('associated_contexts', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets last_seen
     *
     * @param \DateTime|null $last_seen Timestamp of the last time an evaluation occurred for this context
     *
     * @return self
     */
     ...
     * Sets application_id
     *
     * @param string|null $application_id An identifier representing the application where the LaunchDarkly SDK is running
     *
     * @return self
     */
     ...
     * Sets context
     *
     * @param mixed $context The context, including its kind and attributes
     *
     * @return self
     */
    ...
    /**
     * Gets associated_contexts
     *
     * @return int|null
     */
    public function getAssociatedContexts()
    {
        return $this->container['associated_contexts'];
    }

    /**
     * Sets associated_contexts
     *
     * @param int|null $associated_contexts The total number of associated contexts. Associated contexts are contexts that have appeared in the same context instance, that is, they were part of the same flag evaluation.
     *
     * @return self
     */
    public function setAssociatedContexts($associated_contexts)
    {
        if (is_null($associated_contexts)) {
            throw new \InvalidArgumentException('non-nullable associated_contexts cannot be null');
        }
        $this->container['associated_contexts'] = $associated_contexts;
