...
/**
 * AuthorizedAppDataRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AuthorizedAppDataRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorizedAppDataRep';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_scim'] = $data['is_scim'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['maintainer_name'] = $data['maintainer_name'] ?? null;
    }
     ...
     * Sets _id
     *
     * @param string|null $_id The ID of the authorized application
     *
     * @return self
     */
     ...
     * Sets is_scim
     *
     * @param bool|null $is_scim Whether the application is authorized through SCIM
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The authorized application name
     *
     * @return self
     */
     ...
     *
     * @param string|null $maintainer_name The name of the maintainer for this authorized application
     *
     * @return self
     */
