 ...
 */
class AITools implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AITools';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\LaunchDarklyApi\Model\AITool[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\AITool[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\AITool[] $items items
     *
     * @return self
     */
