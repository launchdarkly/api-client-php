...
/**
 * ResolvedImage Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ResolvedImage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResolvedImage';
    ...
    {
        $this->container['is_avatar'] = $data['is_avatar'] ?? null;
        $this->container['is_icon'] = $data['is_icon'] ?? null;
    ...
    {
        return $this->container['is_avatar'];
    }

    /**
     * Sets is_avatar
     *
     * @param bool|null $is_avatar is_avatar
     *
     * @return self
     */
    public function setIsAvatar($is_avatar)
    {
        $this->container['is_avatar'] = $is_avatar;
    ...
    {
        return $this->container['is_icon'];
    }

    /**
     * Sets is_icon
     *
     * @param bool|null $is_icon is_icon
     *
     * @return self
     */
    public function setIsIcon($is_icon)
    {
        $this->container['is_icon'] = $is_icon;
