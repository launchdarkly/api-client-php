...
/**
 * DependentMetricOrMetricGroupRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class DependentMetricOrMetricGroupRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DependentMetricOrMetricGroupRep';
    ...
    */
     ...
     * Sets key
     *
     * @param string $key A unique key to reference the metric or metric group
     *
     * @return self
     */
     ...
     * Sets _version_id
     *
     * @param string $_version_id The version ID of the metric or metric group
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name A human-friendly name for the metric or metric group
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string $kind If this is a metric, then it represents the kind of event the metric tracks. If this is a metric group, then it represents the group type
     *
     * @return self
     */
     ...
     * Sets is_group
     *
     * @param bool $is_group Whether this is a metric group or a metric
     *
     * @return self
     */
     ...
     * Gets metrics
     *
     * @return \LaunchDarklyApi\Model\MetricInGroupRep[]|null
     */
     ...
     * Sets metrics
     *
     * @param \LaunchDarklyApi\Model\MetricInGroupRep[]|null $metrics An ordered list of the metrics in this metric group
     *
     * @return self
     */
