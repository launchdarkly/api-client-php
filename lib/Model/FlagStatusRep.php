...
/**
 * FlagStatusRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagStatusRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagStatusRep';
    ...
    public const NAME_INACTIVE = 'inactive';
    public const NAME_ACTIVE = 'active';
    public const NAME_LAUNCHED = 'launched';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['last_requested'] = $data['last_requested'] ?? null;
     ...
     * Sets name
     *
     * @param string $name Status of the flag
     *
     * @return self
     */
     ...
     * Sets last_requested
     *
     * @param \DateTime|null $last_requested Timestamp of last time flag was requested
     *
     * @return self
     */
     ...
     * Sets default
     *
     * @param mixed|null $default Default value seen from code
     *
     * @return self
     */
