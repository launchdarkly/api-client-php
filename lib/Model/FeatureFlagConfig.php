...
class FeatureFlagConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['prerequisites'] === null) {
            $invalidProperties[] = "'prerequisites' can't be null";
        }
     ...
     * Gets fallthrough
     *
     * @return \LaunchDarklyApi\Model\VariationOrRolloutRep
     */
     ...
     * Sets fallthrough
     *
     * @param \LaunchDarklyApi\Model\VariationOrRolloutRep $fallthrough fallthrough
     *
     * @return self
     */
