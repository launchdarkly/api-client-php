 ...
 */
class FeatureFlagConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeatureFlagConfig';
    ...
    protected static $openAPITypes = [
        ...
        'context_targets' => '\LaunchDarklyApi\Model\Target[]',
        'rules' => '\LaunchDarklyApi\Model\Rule[]',
        'fallthrough' => '\LaunchDarklyApi\Model\VariationOrRolloutRep',
        'off_variation' => 'int',
        ...
        '_debug_events_until_date' => 'int',
        '_summary' => '\LaunchDarklyApi\Model\FlagSummary',
        'evaluation' => '\LaunchDarklyApi\Model\FlagConfigEvaluation',
        'migration_settings' => '\LaunchDarklyApi\Model\FlagConfigMigrationSettingsRep'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        '_debug_events_until_date' => 'int64',
        '_summary' => null,
        'evaluation' => null,
    ...
    protected static array $openAPINullables = [
        ...
        '_site' => false,
        '_access' => false,
        '_environment_name' => false,
        'track_events' => false,
        'track_events_fallthrough' => false,
        '_debug_events_until_date' => false,
        '_summary' => false,
        'evaluation' => false,
        'migration_settings' => false
    ];
    ...
    protected static $setters = [
        ...
        'version' => 'setVersion',
        'targets' => 'setTargets',
        'context_targets' => 'setContextTargets',
        'rules' => 'setRules',
        ...
        '_debug_events_until_date' => 'setDebugEventsUntilDate',
        '_summary' => 'setSummary',
    ...
    protected static $getters = [
        ...
        'version' => 'getVersion',
        'targets' => 'getTargets',
        'context_targets' => 'getContextTargets',
        'rules' => 'getRules',
        ...
        '_debug_events_until_date' => 'getDebugEventsUntilDate',
        '_summary' => 'getSummary',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sel', $data ?? [], null);
        $this->setIfExists('last_modified', $data ?? [], null);
        $this->setIfExists('version', $data ?? [], null);
        $this->setIfExists('targets', $data ?? [], null);
        $this->setIfExists('context_targets', $data ?? [], null);
        $this->setIfExists('rules', $data ?? [], null);
        $this->setIfExists('fallthrough', $data ?? [], null);
        $this->setIfExists('off_variation', $data ?? [], null);
        $this->setIfExists('prerequisites', $data ?? [], null);
        $this->setIfExists('_site', $data ?? [], null);
        $this->setIfExists('_access', $data ?? [], null);
        $this->setIfExists('_environment_name', $data ?? [], null);
        $this->setIfExists('track_events', $data ?? [], null);
        $this->setIfExists('track_events_fallthrough', $data ?? [], null);
        $this->setIfExists('_debug_events_until_date', $data ?? [], null);
        $this->setIfExists('_summary', $data ?? [], null);
        $this->setIfExists('evaluation', $data ?? [], null);
        $this->setIfExists('migration_settings', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sel'] === null) {
            $invalidProperties[] = "'sel' can't be null";
        }
        ...
        if ($this->container['_site'] === null) {
            $invalidProperties[] = "'_site' can't be null";
        }
        if ($this->container['_environment_name'] === null) {
            $invalidProperties[] = "'_environment_name' can't be null";
        }
        if ($this->container['track_events'] === null) {
            $invalidProperties[] = "'track_events' can't be null";
        }
        if ($this->container['track_events_fallthrough'] === null) {
            $invalidProperties[] = "'track_events_fallthrough' can't be null";
        }
     ...
     * Sets on
     *
     * @param bool $on Whether the flag is on
     *
     * @return self
     */
     ...
     * Sets archived
     *
     * @param bool $archived Boolean indicating if the feature flag is archived
     *
     * @return self
     */
    ...
    {
        if (is_null($sel)) {
            throw new \InvalidArgumentException('non-nullable sel cannot be null');
        }
     ...
     * Sets version
     *
     * @param int $version Version of the feature flag
     *
     * @return self
     */
     ...
     * Gets targets
     *
     * @return \LaunchDarklyApi\Model\Target[]|null
     */
     ...
     * Sets targets
     *
     * @param \LaunchDarklyApi\Model\Target[]|null $targets An array of the individual targets that will receive a specific variation based on their key. Individual targets with a context kind of 'user' are included here.
     *
     * @return self
     */
    ...
    /**
     * Gets context_targets
     *
     * @return \LaunchDarklyApi\Model\Target[]|null
     */
    public function getContextTargets()
    {
        return $this->container['context_targets'];
    }

    /**
     * Sets context_targets
     *
     * @param \LaunchDarklyApi\Model\Target[]|null $context_targets An array of the individual targets that will receive a specific variation based on their key. Individual targets with context kinds other than 'user' are included here.
     *
     * @return self
     */
    public function setContextTargets($context_targets)
    {
        if (is_null($context_targets)) {
            throw new \InvalidArgumentException('non-nullable context_targets cannot be null');
        }
        $this->container['context_targets'] = $context_targets;
     ...
     * Gets rules
     *
     * @return \LaunchDarklyApi\Model\Rule[]|null
     */
     ...
     * Sets rules
     *
     * @param \LaunchDarklyApi\Model\Rule[]|null $rules An array of the rules for how to serve a variation to specific targets based on their attributes
     *
     * @return self
     */
     ...
     * Gets fallthrough
     *
     * @return \LaunchDarklyApi\Model\VariationOrRolloutRep|null
     */
     ...
     * Sets fallthrough
     *
     * @param \LaunchDarklyApi\Model\VariationOrRolloutRep|null $fallthrough fallthrough
     *
     * @return self
     */
    public function setFallthrough($fallthrough)
    {
        if (is_null($fallthrough)) {
            throw new \InvalidArgumentException('non-nullable fallthrough cannot be null');
        }
     ...
     * Sets off_variation
     *
     * @param int|null $off_variation The ID of the variation to serve when the flag is off
     *
     * @return self
     */
    public function setOffVariation($off_variation)
    {
        if (is_null($off_variation)) {
            throw new \InvalidArgumentException('non-nullable off_variation cannot be null');
        }
     ...
     * Gets prerequisites
     *
     * @return \LaunchDarklyApi\Model\Prerequisite[]|null
     */
     ...
     * Sets prerequisites
     *
     * @param \LaunchDarklyApi\Model\Prerequisite[]|null $prerequisites An array of the prerequisite flags and their variations that are required before this flag takes effect
     *
     * @return self
     */
     ...
     * Sets _site
     *
     * @param \LaunchDarklyApi\Model\Link $_site _site
     *
     * @return self
     */
     ...
     *
     * @param string $_environment_name The environment name
     *
     * @return self
     */
    public function setEnvironmentName($_environment_name)
    {
        if (is_null($_environment_name)) {
            throw new \InvalidArgumentException('non-nullable _environment_name cannot be null');
        }
     ...
     * Sets track_events
     *
     * @param bool $track_events Whether LaunchDarkly tracks events for the feature flag, for all rules
     *
     * @return self
     */
    public function setTrackEvents($track_events)
    {
        if (is_null($track_events)) {
            throw new \InvalidArgumentException('non-nullable track_events cannot be null');
        }
     ...
     *
     * @param bool $track_events_fallthrough Whether LaunchDarkly tracks events for the feature flag, for the default rule
     *
     * @return self
     */
    public function setTrackEventsFallthrough($track_events_fallthrough)
    {
        if (is_null($track_events_fallthrough)) {
            throw new \InvalidArgumentException('non-nullable track_events_fallthrough cannot be null');
        }
    ...
    /**
     * Gets _debug_events_until_date
     *
     * @return int|null
     */
    public function getDebugEventsUntilDate()
    {
        return $this->container['_debug_events_until_date'];
    }

    /**
     * Sets _debug_events_until_date
     *
     * @param int|null $_debug_events_until_date _debug_events_until_date
     *
     * @return self
     */
    public function setDebugEventsUntilDate($_debug_events_until_date)
    {
        if (is_null($_debug_events_until_date)) {
            throw new \InvalidArgumentException('non-nullable _debug_events_until_date cannot be null');
        }
        $this->container['_debug_events_until_date'] = $_debug_events_until_date;
     ...
     * Gets _summary
     *
     * @return \LaunchDarklyApi\Model\FlagSummary|null
     */
     ...
     * Sets _summary
     *
     * @param \LaunchDarklyApi\Model\FlagSummary|null $_summary _summary
     *
     * @return self
     */
     ...
     * Gets evaluation
     *
     * @return \LaunchDarklyApi\Model\FlagConfigEvaluation|null
     */
     ...
     * Sets evaluation
     *
     * @param \LaunchDarklyApi\Model\FlagConfigEvaluation|null $evaluation evaluation
     *
     * @return self
     */
    ...
    /**
     * Gets migration_settings
     *
     * @return \LaunchDarklyApi\Model\FlagConfigMigrationSettingsRep|null
     */
    public function getMigrationSettings()
    {
        return $this->container['migration_settings'];
    }

    /**
     * Sets migration_settings
     *
     * @param \LaunchDarklyApi\Model\FlagConfigMigrationSettingsRep|null $migration_settings migration_settings
     *
     * @return self
     */
    public function setMigrationSettings($migration_settings)
    {
        if (is_null($migration_settings)) {
            throw new \InvalidArgumentException('non-nullable migration_settings cannot be null');
        }
