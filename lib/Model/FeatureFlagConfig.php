...
class FeatureFlagConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets targets
     *
     * @param \LaunchDarklyApi\Model\Target[]|null $targets An array of the individual targets that will receive a specific variation based on their key
     *
     * @return self
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\Target[]|null $context_targets context_targets
     *
     * @return self
     */
