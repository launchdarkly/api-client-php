...
/**
 * ReviewResponse Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReviewResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReviewResponse';
    ...
    protected static $setters = [
        ...
        'service_token_id' => 'setServiceTokenId'
    ];
    ...
    protected static $getters = [
        ...
        'service_token_id' => 'getServiceTokenId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('service_token_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets _id
     *
     * @param string $_id The approval request ID
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string $kind The type of review action to take
     *
     * @return self
     */
     ...
     * Sets comment
     *
     * @param string|null $comment A comment describing the approval response
     *
     * @return self
     */
     ...
     * Sets member_id
     *
     * @param string|null $member_id ID of account member that reviewed request
     *
     * @return self
     */
    ...
    /**
     * Gets service_token_id
     *
     * @return string|null
     */
    public function getServiceTokenId()
    {
        return $this->container['service_token_id'];
    }

    /**
     * Sets service_token_id
     *
     * @param string|null $service_token_id ID of account service token that reviewed request
     *
     * @return self
     */
    public function setServiceTokenId($service_token_id)
    {
        if (is_null($service_token_id)) {
            throw new \InvalidArgumentException('non-nullable service_token_id cannot be null');
        }
        $this->container['service_token_id'] = $service_token_id;
