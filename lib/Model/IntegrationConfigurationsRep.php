...
/**
 * IntegrationConfigurationsRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationConfigurationsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationConfigurationsRep';
    ...
    protected static $openAPITypes = [
        ...
        'config_values' => 'array<string,mixed>',
        'capability_config' => '\LaunchDarklyApi\Model\CapabilityConfigRep'
    ];
    ...
    protected static $setters = [
        ...
        'capability_config' => 'setCapabilityConfig'
    ];
    ...
    protected static $getters = [
        ...
        'capability_config' => 'getCapabilityConfig'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('config_values', $data ?? [], null);
        $this->setIfExists('capability_config', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets _id
     *
     * @param string $_id The unique identifier for this integration configuration
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name A human-friendly name for the integration
     *
     * @return self
     */
     ...
     *
     * @param string|null $_integration_key The type of integration
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags An array of tags for this integration
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Whether the integration is currently active
     *
     * @return self
     */
     ...
     * Sets config_values
     *
     * @param array<string,mixed>|null $config_values Details on configuration for an integration of this type. Refer to the <code>formVariables</code> field in the corresponding <code>manifest.json</code> for a full list of fields for each integration.
     *
     * @return self
     */
    public function setConfigValues($config_values)
    {
        if (is_null($config_values)) {
            throw new \InvalidArgumentException('non-nullable config_values cannot be null');
        }
    ...
    /**
     * Gets capability_config
     *
     * @return \LaunchDarklyApi\Model\CapabilityConfigRep|null
     */
    public function getCapabilityConfig()
    {
        return $this->container['capability_config'];
    }

    /**
     * Sets capability_config
     *
     * @param \LaunchDarklyApi\Model\CapabilityConfigRep|null $capability_config capability_config
     *
     * @return self
     */
    public function setCapabilityConfig($capability_config)
    {
        if (is_null($capability_config)) {
            throw new \InvalidArgumentException('non-nullable capability_config cannot be null');
        }
        $this->container['capability_config'] = $capability_config;
