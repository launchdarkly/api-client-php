...
/**
 * MetricGroupResultsRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class MetricGroupResultsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MetricGroupResultsRep';
    ...
    protected static $openAPITypes = [
        ...
        'metrics' => '\LaunchDarklyApi\Model\MetricInGroupResultsRep[]'
    ];
     ...
     * Gets metrics
     *
     * @return \LaunchDarklyApi\Model\MetricInGroupResultsRep[]
     */
     ...
     * Sets metrics
     *
     * @param \LaunchDarklyApi\Model\MetricInGroupResultsRep[] $metrics An ordered list of the metrics in this metric group, and each of their results
     *
     * @return self
     */
