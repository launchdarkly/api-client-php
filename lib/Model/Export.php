...
class Export implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'size_bytes' => 'int',
        'size' => 'string',
        'initiator' => '\LaunchDarklyApi\Model\InitiatorRep',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('segment_key', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['segment_key'] === null) {
            $invalidProperties[] = "'segment_key' can't be null";
        }
     ...
     * Sets segment_key
     *
     * @param string $segment_key The segment key
     *
     * @return self
     */
    public function setSegmentKey($segment_key)
    {
        if (is_null($segment_key)) {
            throw new \InvalidArgumentException('non-nullable segment_key cannot be null');
        }
     ...
     * Sets size_bytes
     *
     * @param int $size_bytes The export size, in bytes
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param string $size The export size, with units
     *
     * @return self
     */
     ...
     * Gets initiator
     *
     * @return \LaunchDarklyApi\Model\InitiatorRep
     */
     ...
     * Sets initiator
     *
     * @param \LaunchDarklyApi\Model\InitiatorRep $initiator initiator
     *
     * @return self
     */
     ...
     * Sets _links
     *
     * @param array<string,\LaunchDarklyApi\Model\Link> $_links The location and content type of related resources, including the location of the exported file
     *
     * @return self
     */
