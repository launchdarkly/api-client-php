...
/**
 * BigSegmentStoreIntegration Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class BigSegmentStoreIntegration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BigSegmentStoreIntegration';
    ...
    public const INTEGRATION_KEY_REDIS = 'redis';
    public const INTEGRATION_KEY_DYNAMODB = 'dynamodb';
     ...
     * @return string[]
     */
    public function getIntegrationKeyAllowableValues()
    {
        return [
            self::INTEGRATION_KEY_REDIS,
            self::INTEGRATION_KEY_DYNAMODB,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['integration_key'] === null) {
            $invalidProperties[] = "'integration_key' can't be null";
        }
        $allowedValues = $this->getIntegrationKeyAllowableValues();
        if (!is_null($this->container['integration_key']) && !in_array($this->container['integration_key'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'integration_key', must be one of '%s'",
                $this->container['integration_key'],
     ...
     * Gets _links
     *
     * @return \LaunchDarklyApi\Model\BigSegmentStoreIntegrationLinks
     */
     ...
     * Sets _links
     *
     * @param \LaunchDarklyApi\Model\BigSegmentStoreIntegrationLinks $_links _links
     *
     * @return self
     */
     ...
     * Sets _id
     *
     * @param string $_id The integration ID
     *
     * @return self
     */
    ...
    public function setIntegrationKey($integration_key)
    {
        if (is_null($integration_key)) {
            throw new \InvalidArgumentException('non-nullable integration_key cannot be null');
        }
        $allowedValues = $this->getIntegrationKeyAllowableValues();
        if (!in_array($integration_key, $allowedValues, true)) {
     ...
     * Sets on
     *
     * @param bool $on Whether the configuration is turned on
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[] $tags List of tags for this configuration
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int $version Version of the current configuration
     *
     * @return self
     */
     ...
     * Gets _status
     *
     * @return \LaunchDarklyApi\Model\BigSegmentStoreStatus
     */
     ...
     * Sets _status
     *
     * @param \LaunchDarklyApi\Model\BigSegmentStoreStatus $_status _status
     *
     * @return self
     */
