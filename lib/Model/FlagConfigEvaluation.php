...
/**
 * FlagConfigEvaluation Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagConfigEvaluation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagConfigEvaluation';
    ...
    {
        $this->setIfExists('context_kinds', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string[]|null
     */
    public function getContextKinds()
    {
        return $this->container['context_kinds'];
    }

    /**
     * Sets context_kinds
     *
     * @param string[]|null $context_kinds context_kinds
     *
     * @return self
     */
    public function setContextKinds($context_kinds)
    {
        if (is_null($context_kinds)) {
            throw new \InvalidArgumentException('non-nullable context_kinds cannot be null');
        }
        $this->container['context_kinds'] = $context_kinds;
