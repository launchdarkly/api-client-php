...
/**
 * ExpandedSegment Class Doc Comment
 *
 * @category Class
 ...
 */
class ExpandedSegment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandedSegment';
    ...
    */
     ...
     * Sets environment_id
     *
     * @param string|null $environment_id Environment ID of the segment
     *
     * @return self
     */
     ...
     *
     * @param string|null $environment_key Environment key of the segment
     *
     * @return self
     */
     ...
     * Sets creation_date
     *
     * @param int|null $creation_date Creation date in milliseconds
     *
     * @return self
     */
     ...
     *
     * @param int|null $last_modified_date Last modification date in milliseconds
     *
     * @return self
     */
     ...
     * Sets deleted
     *
     * @param bool|null $deleted Whether the segment is deleted
     *
     * @return self
     */
     ...
     * Sets unbounded
     *
     * @param bool|null $unbounded Whether the segment is unbounded
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int|null $version Version of the segment
     *
     * @return self
     */
     ...
     * Sets generation
     *
     * @param int|null $generation Generation of the segment
     *
     * @return self
     */
