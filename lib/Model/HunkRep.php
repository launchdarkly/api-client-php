 ...
 */
class HunkRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HunkRep';
    ...
    protected static $setters = [
        'starting_line_number' => 'setStartingLineNumber',
        'lines' => 'setLines',
        'proj_key' => 'setProjKey',
        'flag_key' => 'setFlagKey',
        'aliases' => 'setAliases'
    ...
    protected static $getters = [
        'starting_line_number' => 'getStartingLineNumber',
        'lines' => 'getLines',
        'proj_key' => 'getProjKey',
        'flag_key' => 'getFlagKey',
        'aliases' => 'getAliases'
    ...
    {
        $this->setIfExists('starting_line_number', $data ?? [], null);
        $this->setIfExists('lines', $data ?? [], null);
        $this->setIfExists('proj_key', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['starting_line_number'];
    }
     ...
     * @return self
     */
    public function setStartingLineNumber($starting_line_number)
    {
        if (is_null($starting_line_number)) {
            throw new \InvalidArgumentException('non-nullable starting_line_number cannot be null');
        }
        $this->container['starting_line_number'] = $starting_line_number;
    ...
    {
        return $this->container['proj_key'];
    }
     ...
     * @return self
     */
    public function setProjKey($proj_key)
    {
        if (is_null($proj_key)) {
            throw new \InvalidArgumentException('non-nullable proj_key cannot be null');
        }
        $this->container['proj_key'] = $proj_key;
