...
class PatchSegmentInstruction implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets target_type
     *
     * @param string $target_type A segment's target type. Must be either <code>included</code> or <code>excluded</code>
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param int|null $value Schedule user target expiration on a segment by including a timestamp
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int|null $version Required if <code>kind</code> is <code>updateExpireUserTargetDate</code>
     *
     * @return self
     */
