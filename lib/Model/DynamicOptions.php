...
/**
 * DynamicOptions Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class DynamicOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DynamicOptions';
    ...
    protected static $openAPITypes = [
        'endpoint' => '\LaunchDarklyApi\Model\Endpoint',
        'parser' => '\LaunchDarklyApi\Model\DynamicOptionsParser'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('parser', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets endpoint
     *
     * @return \LaunchDarklyApi\Model\Endpoint|null
     */
     ...
     * Sets endpoint
     *
     * @param \LaunchDarklyApi\Model\Endpoint|null $endpoint endpoint
     *
     * @return self
     */
     ...
     * Gets parser
     *
     * @return \LaunchDarklyApi\Model\DynamicOptionsParser|null
     */
     ...
     * Sets parser
     *
     * @param \LaunchDarklyApi\Model\DynamicOptionsParser|null $parser parser
     *
     * @return self
     */
    ...
    {
        if (is_null($parser)) {
            throw new \InvalidArgumentException('non-nullable parser cannot be null');
        }
