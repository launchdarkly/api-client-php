...
/**
 * ParameterDefaultInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ParameterDefaultInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParameterDefaultInput';
     ...
     *
     * @param bool|null $boolean_variation_value boolean_variation_value
     *
     * @return self
     */
