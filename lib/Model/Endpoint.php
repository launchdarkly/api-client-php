...
class Endpoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'headers' => '\LaunchDarklyApi\Model\HeaderItems[]',
        'hmac_signature' => '\LaunchDarklyApi\Model\HMACSignature',
        'method' => 'string',
        'url' => 'string'
    ];
    ...
    protected static $setters = [
        'headers' => 'setHeaders',
        'hmac_signature' => 'setHmacSignature',
        'method' => 'setMethod',
        'url' => 'setUrl'
    ];
    ...
    protected static $getters = [
        'headers' => 'getHeaders',
        'hmac_signature' => 'getHmacSignature',
        'method' => 'getMethod',
        'url' => 'getUrl'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('hmac_signature', $data ?? [], null);
    ...
    */
     ...
     * Gets headers
     *
     * @return \LaunchDarklyApi\Model\HeaderItems[]|null
     */
     ...
     * Sets headers
     *
     * @param \LaunchDarklyApi\Model\HeaderItems[]|null $headers headers
     *
     * @return self
     */
     ...
     * Gets hmac_signature
     *
     * @return \LaunchDarklyApi\Model\HMACSignature|null
     */
    public function getHmacSignature()
    {
        return $this->container['hmac_signature'];
    }

    /**
     * Sets hmac_signature
     *
     * @param \LaunchDarklyApi\Model\HMACSignature|null $hmac_signature hmac_signature
     *
     * @return self
     */
    public function setHmacSignature($hmac_signature)
    {
        if (is_null($hmac_signature)) {
            throw new \InvalidArgumentException('non-nullable hmac_signature cannot be null');
        }
        $this->container['hmac_signature'] = $hmac_signature;
