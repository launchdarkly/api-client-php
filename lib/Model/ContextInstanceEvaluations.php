...
/**
 * ContextInstanceEvaluations Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ContextInstanceEvaluations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContextInstanceEvaluations';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\ContextInstanceEvaluation[]',
        'total_count' => 'int',
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\ContextInstanceEvaluation[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ContextInstanceEvaluation[] $items Details on the flag evaluations for this context instance
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int|null $total_count The number of flags
     *
     * @return self
     */
