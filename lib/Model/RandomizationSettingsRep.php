...
/**
 * RandomizationSettingsRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class RandomizationSettingsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RandomizationSettingsRep';
    ...
    protected static $openAPITypes = [
        '_project_id' => 'string',
        '_project_key' => 'string',
        'randomization_units' => '\LaunchDarklyApi\Model\RandomizationUnitRep[]',
        '_creation_date' => 'int',
    ...
    protected static $setters = [
        '_project_id' => 'setProjectId',
        '_project_key' => 'setProjectKey',
    ...
    protected static $getters = [
        '_project_id' => 'getProjectId',
        '_project_key' => 'getProjectKey',
    ...
    {
        $this->setIfExists('_project_id', $data ?? [], null);
        $this->setIfExists('_project_key', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['_project_id'];
    }

    /**
     * Sets _project_id
     *
     * @param string|null $_project_id The project ID
     *
     * @return self
     */
    public function setProjectId($_project_id)
    {
        if (is_null($_project_id)) {
            throw new \InvalidArgumentException('non-nullable _project_id cannot be null');
        }
        $this->container['_project_id'] = $_project_id;
    ...
    {
        return $this->container['_project_key'];
    }

    /**
     * Sets _project_key
     *
     * @param string|null $_project_key The project key
     *
     * @return self
     */
    public function setProjectKey($_project_key)
    {
        if (is_null($_project_key)) {
            throw new \InvalidArgumentException('non-nullable _project_key cannot be null');
        }
        $this->container['_project_key'] = $_project_key;
     ...
     *
     * @return \LaunchDarklyApi\Model\RandomizationUnitRep[]|null
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\RandomizationUnitRep[]|null $randomization_units An array of the randomization units in this project
     *
     * @return self
     */
