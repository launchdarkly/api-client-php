...
/**
 * ApprovalRequestSettingWithEnvs Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ApprovalRequestSettingWithEnvs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApprovalRequestSettingWithEnvs';
    ...
    protected static $openAPITypes = [
        'environments' => 'array<string,\LaunchDarklyApi\Model\ApprovalRequestSetting>',
        '_default' => '\LaunchDarklyApi\Model\ApprovalRequestSetting',
        '_strict' => '\LaunchDarklyApi\Model\ApprovalRequestSetting'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_default', $data ?? [], null);
        $this->setIfExists('_strict', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets environments
     *
     * @return array<string,\LaunchDarklyApi\Model\ApprovalRequestSetting>|null
     */
     ...
     * Sets environments
     *
     * @param array<string,\LaunchDarklyApi\Model\ApprovalRequestSetting>|null $environments Environment-specific overrides.
     *
     * @return self
     */
     ...
     * Gets _default
     *
     * @return \LaunchDarklyApi\Model\ApprovalRequestSetting|null
     */
    public function getDefault()
    {
        return $this->container['_default'];
    }

    /**
     * Sets _default
     *
     * @param \LaunchDarklyApi\Model\ApprovalRequestSetting|null $_default _default
     *
     * @return self
     */
    ...
    {
        if (is_null($_default)) {
            throw new \InvalidArgumentException('non-nullable _default cannot be null');
        }
        $this->container['_default'] = $_default;
    ...
    {
        return $this->container['_strict'];
    }

    /**
     * Sets _strict
     *
     * @param \LaunchDarklyApi\Model\ApprovalRequestSetting|null $_strict _strict
     *
     * @return self
     */
    ...
    {
        if (is_null($_strict)) {
            throw new \InvalidArgumentException('non-nullable _strict cannot be null');
        }
        $this->container['_strict'] = $_strict;
