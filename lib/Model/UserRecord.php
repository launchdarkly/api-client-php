 ...
 */
class UserRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserRecord';
    ...
    {
        $this->container['last_ping'] = $data['last_ping'] ?? null;
     ...
     * Sets last_ping
     *
     * @param \DateTime|null $last_ping Timestamp of the last time this user was seen
     *
     * @return self
     */
     ...
     * Gets user
     *
     * @return \LaunchDarklyApi\Model\User|null
     */
     ...
     * Sets user
     *
     * @param \LaunchDarklyApi\Model\User|null $user user
     *
     * @return self
     */
     ...
     * Sets sort_value
     *
     * @param mixed|null $sort_value If this record is returned as part of a list, the value used to sort the list. This is only included when the <code>sort</code> query parameter is specified. It is a time, in Unix milliseconds, if the sort is by <code>lastSeen</code>. It is a user key if the sort is by <code>userKey</code>.
     *
     * @return self
     */
