...
class InstructionUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets version
     *
     * @param int|null $version The version of the flag variation to update. You can retrieve this by making a GET request for the flag. Required if <code>kind</code> is <code>updateExpireUserTargetDate</code>.
     *
     * @return self
     */
