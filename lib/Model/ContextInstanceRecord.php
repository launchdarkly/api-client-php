...
/**
 * ContextInstanceRecord Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ContextInstanceRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContextInstanceRecord';
    ...
    protected static $setters = [
        ...
        'anonymous_kinds' => 'setAnonymousKinds',
        'context' => 'setContext',
        '_links' => 'setLinks',
        '_access' => 'setAccess'
    ];
    ...
    protected static $getters = [
        ...
        'anonymous_kinds' => 'getAnonymousKinds',
        'context' => 'getContext',
        '_links' => 'getLinks',
        '_access' => 'getAccess'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('anonymous_kinds', $data ?? [], null);
    ...
    */
     ...
     * Sets last_seen
     *
     * @param \DateTime|null $last_seen Timestamp of the last time an evaluation occurred for this context instance
     *
     * @return self
     */
    ...
    /**
     * Gets anonymous_kinds
     *
     * @return string[]|null
     */
    public function getAnonymousKinds()
    {
        return $this->container['anonymous_kinds'];
    }

    /**
     * Sets anonymous_kinds
     *
     * @param string[]|null $anonymous_kinds A list of the context kinds this context was associated with that the SDK removed because they were marked as anonymous at flag evaluation
     *
     * @return self
     */
    public function setAnonymousKinds($anonymous_kinds)
    {
        if (is_null($anonymous_kinds)) {
            throw new \InvalidArgumentException('non-nullable anonymous_kinds cannot be null');
        }
        $this->container['anonymous_kinds'] = $anonymous_kinds;
