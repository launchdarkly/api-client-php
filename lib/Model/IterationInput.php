...
/**
 * IterationInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class IterationInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IterationInput';
    ...
    protected static $openAPIFormats = [
        ...
        'metrics' => null,
        'primary_single_metric_key' => null,
        'primary_funnel_key' => null,
        'treatments' => null,
        'flags' => null,
    ...
    protected static array $openAPINullables = [
        'hypothesis' => false,
        'can_reshuffle_traffic' => false,
        'metrics' => false,
        'primary_single_metric_key' => false,
        'primary_funnel_key' => false,
        'treatments' => false,
        'flags' => false,
    ...
    protected static $setters = [
        ...
        'metrics' => 'setMetrics',
        'primary_single_metric_key' => 'setPrimarySingleMetricKey',
        'primary_funnel_key' => 'setPrimaryFunnelKey',
    ...
    protected static $getters = [
        ...
        'metrics' => 'getMetrics',
        'primary_single_metric_key' => 'getPrimarySingleMetricKey',
        'primary_funnel_key' => 'getPrimaryFunnelKey',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('can_reshuffle_traffic', $data ?? [], null);
        $this->setIfExists('metrics', $data ?? [], null);
        $this->setIfExists('primary_single_metric_key', $data ?? [], null);
        $this->setIfExists('primary_funnel_key', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['treatments'] === null) {
            $invalidProperties[] = "'treatments' can't be null";
        }
     ...
     *
     * @param bool|null $can_reshuffle_traffic Whether to allow the experiment to reassign traffic to different variations when you increase or decrease the traffic in your experiment audience (true) or keep all traffic assigned to its initial variation (false). Defaults to true.
     *
     * @return self
     */
    public function setCanReshuffleTraffic($can_reshuffle_traffic)
    {
        if (is_null($can_reshuffle_traffic)) {
            throw new \InvalidArgumentException('non-nullable can_reshuffle_traffic cannot be null');
        }
     ...
     * Gets metrics
     *
     * @return \LaunchDarklyApi\Model\MetricInput[]
     */
     ...
     * Sets metrics
     *
     * @param \LaunchDarklyApi\Model\MetricInput[] $metrics metrics
     *
     * @return self
     */
    ...
    /**
     * Gets primary_single_metric_key
     *
     * @return string|null
     */
    public function getPrimarySingleMetricKey()
    {
        return $this->container['primary_single_metric_key'];
    }

    /**
     * Sets primary_single_metric_key
     *
     * @param string|null $primary_single_metric_key The key of the primary metric for this experiment. Either <code>primarySingleMetricKey</code> or <code>primaryFunnelKey</code> must be present.
     *
     * @return self
     */
    public function setPrimarySingleMetricKey($primary_single_metric_key)
    {
        if (is_null($primary_single_metric_key)) {
            throw new \InvalidArgumentException('non-nullable primary_single_metric_key cannot be null');
        }
        $this->container['primary_single_metric_key'] = $primary_single_metric_key;

        return $this;
    }

    /**
     * Gets primary_funnel_key
     *
     * @return string|null
     */
    public function getPrimaryFunnelKey()
    {
        return $this->container['primary_funnel_key'];
    }

    /**
     * Sets primary_funnel_key
     *
     * @param string|null $primary_funnel_key The key of the primary funnel group for this experiment. Either <code>primarySingleMetricKey</code> or <code>primaryFunnelKey</code> must be present.
     *
     * @return self
     */
    public function setPrimaryFunnelKey($primary_funnel_key)
    {
        if (is_null($primary_funnel_key)) {
            throw new \InvalidArgumentException('non-nullable primary_funnel_key cannot be null');
        }
        $this->container['primary_funnel_key'] = $primary_funnel_key;
     ...
     * Gets treatments
     *
     * @return \LaunchDarklyApi\Model\TreatmentInput[]
     */
     ...
     * Sets treatments
     *
     * @param \LaunchDarklyApi\Model\TreatmentInput[] $treatments treatments
     *
     * @return self
     */
    public function setTreatments($treatments)
    {
        if (is_null($treatments)) {
            throw new \InvalidArgumentException('non-nullable treatments cannot be null');
        }
     ...
     * Gets flags
     *
     * @return array<string,\LaunchDarklyApi\Model\FlagInput>
     */
     ...
     * Sets flags
     *
     * @param array<string,\LaunchDarklyApi\Model\FlagInput> $flags flags
     *
     * @return self
     */
     ...
     *
     * @param string|null $randomization_unit The unit of randomization for this iteration. Defaults to user.
     *
     * @return self
     */
    public function setRandomizationUnit($randomization_unit)
    {
        if (is_null($randomization_unit)) {
     ...
     * Sets attributes
     *
     * @param string[]|null $attributes The attributes that this iteration's results can be sliced by
     *
     * @return self
     */
