...
class IterationInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param bool|null $can_reshuffle_traffic Whether to allow the experiment to reassign users to different variations (true) or keep users assigned to their initial variation (false). Defaults to true.
     *
     * @return self
     */
