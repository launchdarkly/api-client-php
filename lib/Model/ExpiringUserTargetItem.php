...
/**
 * ExpiringUserTargetItem Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExpiringUserTargetItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpiringUserTargetItem';
    ...
    protected static $openAPITypes = [
        ...
        'target_type' => 'string',
        'variation_id' => 'string',
        '_resource_id' => '\LaunchDarklyApi\Model\ResourceIDResponse'
    ];
    ...
    */
     ...
     * Sets _id
     *
     * @param string $_id The ID of this expiring user target
     *
     * @return self
     */
     ...
     * Sets _version
     *
     * @param int $_version The version of this expiring user target
     *
     * @return self
     */
     ...
     * Sets user_key
     *
     * @param string $user_key A unique key used to represent the user
     *
     * @return self
     */
     ...
     * Sets target_type
     *
     * @param string|null $target_type A segment's target type. Included when expiring user targets are updated on a segment.
     *
     * @return self
     */
     ...
     * Sets variation_id
     *
     * @param string|null $variation_id A unique key used to represent the flag variation. Included when expiring user targets are updated on a feature flag.
     *
     * @return self
     */
     ...
     * Gets _resource_id
     *
     * @return \LaunchDarklyApi\Model\ResourceIDResponse
     */
     ...
     * Sets _resource_id
     *
     * @param \LaunchDarklyApi\Model\ResourceIDResponse $_resource_id _resource_id
     *
     * @return self
     */
