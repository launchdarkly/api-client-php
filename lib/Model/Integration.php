...
class Integration implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets _links
     *
     * @param array<string,\LaunchDarklyApi\Model\Link>|null $_links Links to other resources within the API. Includes the URL and content type of those resources.
     *
     * @return self
     */
