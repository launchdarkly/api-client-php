...
class Integration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        '_status' => '\LaunchDarklyApi\Model\IntegrationSubscriptionStatusRep',
        'url' => 'string',
        'api_key' => 'string'
    ];
    ...
    */
     ...
     * Sets _id
     *
     * @param string|null $_id The ID for this integration audit log subscription
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string|null $kind The type of integration
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name A human-friendly name for the integration
     *
     * @return self
     */
     ...
     * Sets config
     *
     * @param array<string,mixed>|null $config Details on configuration for an integration of this type. Refer to the <code>formVariables</code> field in the corresponding <code>manifest.json</code> for a full list of fields for each integration.
     *
     * @return self
     */
     ...
     * Sets statements
     *
     * @param \LaunchDarklyApi\Model\Statement[]|null $statements Represents a Custom role policy, defining a resource kinds filter the integration audit log subscription responds to.
     *
     * @return self
     */
     ...
     * Sets on
     *
     * @param bool|null $on Whether the integration is currently active
     *
     * @return self
     */
     ...
     * Gets _status
     *
     * @return \LaunchDarklyApi\Model\IntegrationSubscriptionStatusRep|null
     */
     ...
     * Sets _status
     *
     * @param \LaunchDarklyApi\Model\IntegrationSubscriptionStatusRep|null $_status _status
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Slack webhook receiver URL. Only used for legacy Slack webhook integrations.
     *
     * @return self
     */
     ...
     * Sets api_key
     *
     * @param string|null $api_key Datadog API key. Only used for legacy Datadog webhook integrations.
     *
     * @return self
     */
