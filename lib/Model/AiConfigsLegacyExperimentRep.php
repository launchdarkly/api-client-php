...
/**
 * AiConfigsLegacyExperimentRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AiConfigsLegacyExperimentRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AiConfigsLegacyExperimentRep';
    ...
    protected static $openAPITypes = [
        'metric_key' => 'string',
        '_metric' => '\LaunchDarklyApi\Model\AiConfigsMetricListingRep',
        'environments' => 'string[]',
        '_environment_settings' => 'array<string,\LaunchDarklyApi\Model\AiConfigsExperimentEnvironmentSettingRep>'
    ];
    ...
    {
        $this->setIfExists('metric_key', $data ?? [], null);
        $this->setIfExists('_metric', $data ?? [], null);
        $this->setIfExists('environments', $data ?? [], null);
        $this->setIfExists('_environment_settings', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($metric_key)) {
            throw new \InvalidArgumentException('non-nullable metric_key cannot be null');
        }
     ...
     * Gets _metric
     *
     * @return \LaunchDarklyApi\Model\AiConfigsMetricListingRep|null
     */
     ...
     * Sets _metric
     *
     * @param \LaunchDarklyApi\Model\AiConfigsMetricListingRep|null $_metric _metric
     *
     * @return self
     */
    ...
    {
        if (is_null($_metric)) {
            throw new \InvalidArgumentException('non-nullable _metric cannot be null');
        }
     ...
     *
     * @return array<string,\LaunchDarklyApi\Model\AiConfigsExperimentEnvironmentSettingRep>|null
     */
     ...
     *
     * @param array<string,\LaunchDarklyApi\Model\AiConfigsExperimentEnvironmentSettingRep>|null $_environment_settings _environment_settings
     *
     * @return self
     */
    public function setEnvironmentSettings($_environment_settings)
    {
        if (is_null($_environment_settings)) {
            throw new \InvalidArgumentException('non-nullable _environment_settings cannot be null');
        }
