...
/**
 * PatchSegmentExpiringTargetInstruction Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class PatchSegmentExpiringTargetInstruction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchSegmentExpiringTargetInstruction';
    ...
    protected static $setters = [
        'kind' => 'setKind',
        'context_key' => 'setContextKey',
        'context_kind' => 'setContextKind',
    ...
    protected static $getters = [
        'kind' => 'getKind',
        'context_key' => 'getContextKey',
        'context_kind' => 'getContextKind',
    ...
    public const KIND_ADD_EXPIRING_TARGET = 'addExpiringTarget';
    public const KIND_UPDATE_EXPIRING_TARGET = 'updateExpiringTarget';
    public const KIND_REMOVE_EXPIRING_TARGET = 'removeExpiringTarget';
    public const TARGET_TYPE_INCLUDED = 'included';
    public const TARGET_TYPE_EXCLUDED = 'excluded';
    ...
    {
        return [
            self::KIND_ADD_EXPIRING_TARGET,
            self::KIND_UPDATE_EXPIRING_TARGET,
            self::KIND_REMOVE_EXPIRING_TARGET,
        ];
    }
    ...
    {
        return [
            self::TARGET_TYPE_INCLUDED,
            self::TARGET_TYPE_EXCLUDED,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('context_key', $data ?? [], null);
        $this->setIfExists('context_kind', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['context_key'] === null) {
            $invalidProperties[] = "'context_key' can't be null";
        }
        if ($this->container['context_kind'] === null) {
            $invalidProperties[] = "'context_kind' can't be null";
        }
     ...
     * Sets kind
     *
     * @param string $kind The type of change to make to the context's removal date from this segment
     *
     * @return self
     */
    ...
    {
        return $this->container['context_key'];
    }

    /**
     * Sets context_key
     *
     * @param string $context_key A unique key used to represent the context
     *
     * @return self
     */
    public function setContextKey($context_key)
    {
        if (is_null($context_key)) {
            throw new \InvalidArgumentException('non-nullable context_key cannot be null');
        }
        $this->container['context_key'] = $context_key;
     ...
     * @return string
     */
    public function getContextKind()
    {
        return $this->container['context_kind'];
    }

    /**
     * Sets context_kind
     *
     * @param string $context_kind The kind of context
     *
     * @return self
     */
    public function setContextKind($context_kind)
    {
        if (is_null($context_kind)) {
            throw new \InvalidArgumentException('non-nullable context_kind cannot be null');
        }
        $this->container['context_kind'] = $context_kind;
     ...
     * Sets target_type
     *
     * @param string $target_type The segment's target type
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param int|null $value The time, in Unix milliseconds, when the context should be removed from this segment. Required if <code>kind</code> is <code>addExpiringTarget</code> or <code>updateExpiringTarget</code>.
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int|null $version The version of the expiring target to update. Optional and only used if <code>kind</code> is <code>updateExpiringTarget</code>. If included, update will fail if version doesn't match current version of the expiring target.
     *
     * @return self
     */
