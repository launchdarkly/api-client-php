...
class PostDeploymentEventInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'application_kind' => false,
        'version' => false,
        'version_name' => false,
        'event_type' => false,
        'event_time' => false,
        'event_metadata' => false,
        'deployment_metadata' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('application_kind', $data ?? [], null);
        ...
        $this->setIfExists('deployment_metadata', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($application_kind)) {
            throw new \InvalidArgumentException('non-nullable application_kind cannot be null');
        }
        $allowedValues = $this->getApplicationKindAllowableValues();
        if (!in_array($application_kind, $allowedValues, true)) {
    ...
    {
        if (is_null($deployment_metadata)) {
            throw new \InvalidArgumentException('non-nullable deployment_metadata cannot be null');
        }
