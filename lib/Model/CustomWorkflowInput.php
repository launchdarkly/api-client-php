...
/**
 * CustomWorkflowInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CustomWorkflowInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomWorkflowInput';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'stages' => '\LaunchDarklyApi\Model\StageInput[]',
        'template_key' => 'string'
    ];
     ...
     * Sets description
     *
     * @param string|null $description The workflow description
     *
     * @return self
     */
     ...
     * Gets stages
     *
     * @return \LaunchDarklyApi\Model\StageInput[]|null
     */
     ...
     * Sets stages
     *
     * @param \LaunchDarklyApi\Model\StageInput[]|null $stages A list of the workflow stages
     *
     * @return self
     */
     ...
     * Sets template_key
     *
     * @param string|null $template_key The template key
     *
     * @return self
     */
