...
/**
 * ExperimentationSettingsPut Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExperimentationSettingsPut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExperimentationSettingsPut';
    ...
    protected static $openAPITypes = [
        'randomization_units' => '\LaunchDarklyApi\Model\RandomizationUnitInput[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['randomization_units'] === null) {
            $invalidProperties[] = "'randomization_units' can't be null";
        }
     ...
     *
     * @return \LaunchDarklyApi\Model\RandomizationUnitInput[]
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\RandomizationUnitInput[] $randomization_units An array of randomization units allowed for this project.
     *
     * @return self
     */
