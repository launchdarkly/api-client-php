...
class RelayAutoConfigRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        '_id' => 'string',
        '_creator' => '\LaunchDarklyApi\Model\MemberSummaryRep',
        '_access' => '\LaunchDarklyApi\Model\AccessRep',
        'name' => 'string',
        'policy' => '\LaunchDarklyApi\Model\StatementRep[]',
        'full_key' => 'string',
        'display_key' => 'string',
        'creation_date' => 'int',
        'last_modified' => 'int'
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_creator'] = $data['_creator'] ?? null;
        $this->container['_access'] = $data['_access'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['policy'] = $data['policy'] ?? null;
        $this->container['full_key'] = $data['full_key'] ?? null;
        $this->container['display_key'] = $data['display_key'] ?? null;
     ...
     * Sets _creator
     *
     * @param \LaunchDarklyApi\Model\MemberSummaryRep|null $_creator _creator
     *
     * @return self
     */
     ...
     * Gets policy
     *
     * @return \LaunchDarklyApi\Model\StatementRep[]
     */
     ...
     * Sets policy
     *
     * @param \LaunchDarklyApi\Model\StatementRep[] $policy policy
     *
     * @return self
     */
     ...
     * Sets full_key
     *
     * @param string $full_key full_key
     *
     * @return self
     */
     ...
     * Sets display_key
     *
     * @param string $display_key display_key
     *
     * @return self
     */
