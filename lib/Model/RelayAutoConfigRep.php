...
/**
 * RelayAutoConfigRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class RelayAutoConfigRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RelayAutoConfigRep';
    ...
    protected static $openAPITypes = [
        '_id' => 'string',
        '_creator' => '\LaunchDarklyApi\Model\MemberSummary',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_creator', $data ?? [], null);
        $this->setIfExists('_access', $data ?? [], null);
        $this->setIfExists('name', $data ?? [], null);
        $this->setIfExists('policy', $data ?? [], null);
        $this->setIfExists('full_key', $data ?? [], null);
        $this->setIfExists('display_key', $data ?? [], null);
    ...
    */
     ...
     * Sets _creator
     *
     * @param \LaunchDarklyApi\Model\MemberSummary|null $_creator _creator
     *
     * @return self
     */
    ...
    {
        if (is_null($_creator)) {
            throw new \InvalidArgumentException('non-nullable _creator cannot be null');
        }
     ...
     * Sets policy
     *
     * @param \LaunchDarklyApi\Model\Statement[] $policy A description of what environments and projects the Relay Proxy should include or exclude
     *
     * @return self
     */
    ...
    {
        if (is_null($full_key)) {
            throw new \InvalidArgumentException('non-nullable full_key cannot be null');
        }
     ...
     * Sets display_key
     *
     * @param string $display_key The last few characters of the Relay Proxy configuration key, displayed in the LaunchDarkly UI
     *
     * @return self
     */
    public function setDisplayKey($display_key)
    {
        if (is_null($display_key)) {
            throw new \InvalidArgumentException('non-nullable display_key cannot be null');
        }
