...
/**
 * MetricInGroupRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class MetricInGroupRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MetricInGroupRep';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('name_in_group', $data ?? [], null);
    ...
    */
     ...
     * Sets _version_id
     *
     * @param string|null $_version_id The version ID of the metric
     *
     * @return self
     */
     ...
     *
     * @param string|null $unit_aggregation_type The type of unit aggregation to use for the metric
     *
     * @return self
     */
     ...
     * Sets event_key
     *
     * @param string|null $event_key The event key sent with the metric. Only relevant for custom metrics.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getNameInGroup()
    {
        return $this->container['name_in_group'];
    }

    /**
     * Sets name_in_group
     *
     * @param string|null $name_in_group Name of the metric when used within the associated metric group. Can be different from the original name of the metric. Required if and only if the metric group is a <code>funnel</code>.
     *
     * @return self
     */
    public function setNameInGroup($name_in_group)
    {
        if (is_null($name_in_group)) {
            throw new \InvalidArgumentException('non-nullable name_in_group cannot be null');
        }
        $this->container['name_in_group'] = $name_in_group;
     ...
     *
     * @param string[]|null $randomization_units The randomization units for the metric
     *
     * @return self
     */
