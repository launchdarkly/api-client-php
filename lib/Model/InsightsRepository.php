...
/**
 * InsightsRepository Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class InsightsRepository implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsightsRepository';
    ...
    protected static $openAPITypes = [
        ...
        'url' => 'string',
        'main_branch' => 'string',
        'projects' => '\LaunchDarklyApi\Model\ProjectSummaryCollection'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('main_branch', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['main_branch'] === null) {
            $invalidProperties[] = "'main_branch' can't be null";
        }
     ...
     * Sets _id
     *
     * @param string $_id The repository ID
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int $version The repository version
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string $key The repository key
     *
     * @return self
     */
    ...
    {
        return $this->container['main_branch'];
    }

    /**
     * Sets main_branch
     *
     * @param string $main_branch The repository main branch
     *
     * @return self
     */
    public function setMainBranch($main_branch)
    {
        if (is_null($main_branch)) {
            throw new \InvalidArgumentException('non-nullable main_branch cannot be null');
        }
        $this->container['main_branch'] = $main_branch;
     ...
     * Gets projects
     *
     * @return \LaunchDarklyApi\Model\ProjectSummaryCollection|null
     */
     ...
     * Sets projects
     *
     * @param \LaunchDarklyApi\Model\ProjectSummaryCollection|null $projects projects
     *
     * @return self
     */
