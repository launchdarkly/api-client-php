...
class Rule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets _id
     *
     * @param string|null $_id The flag rule ID
     *
     * @return self
     */
     ...
     * Sets variation
     *
     * @param int|null $variation The index of the variation, from the array of variations for this flag
     *
     * @return self
     */
     ...
     * Gets rollout
     *
     * @return \LaunchDarklyApi\Model\Rollout|null
     */
     ...
     * Sets rollout
     *
     * @param \LaunchDarklyApi\Model\Rollout|null $rollout rollout
     *
     * @return self
     */
     ...
     * Sets clauses
     *
     * @param \LaunchDarklyApi\Model\Clause[] $clauses An array of clauses used for individual targeting based on attributes
     *
     * @return self
     */
     ...
     * Sets track_events
     *
     * @param bool $track_events Whether LaunchDarkly tracks events for this rule
     *
     * @return self
     */
