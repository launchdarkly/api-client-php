...
class Token implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'owner_id' => 'string',
        'member_id' => 'string',
        '_member' => '\LaunchDarklyApi\Model\MemberSummary',
        'name' => 'string',
        'description' => 'string',
        'creation_date' => 'int',
        'last_modified' => 'int',
    ...
    protected static array $openAPINullables = [
        ...
        'creation_date' => false,
        'last_modified' => false,
        'custom_role_ids' => false,
        'inline_role' => false,
        'role' => false,
        'token' => false,
        'service_token' => false,
        '_links' => false,
        'default_api_version' => false,
        'last_used' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('custom_role_ids', $data ?? [], null);
        $this->setIfExists('inline_role', $data ?? [], null);
        $this->setIfExists('role', $data ?? [], null);
        $this->setIfExists('token', $data ?? [], null);
        $this->setIfExists('service_token', $data ?? [], null);
        $this->setIfExists('_links', $data ?? [], null);
        $this->setIfExists('default_api_version', $data ?? [], null);
    ...
    */
     ...
     * Sets _member
     *
     * @param \LaunchDarklyApi\Model\MemberSummary|null $_member _member
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name A human-friendly name for the access token
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description for the access token
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $custom_role_ids A list of custom role IDs to use as access limits for the access token
     *
     * @return self
     */
    public function setCustomRoleIds($custom_role_ids)
    {
        if (is_null($custom_role_ids)) {
            throw new \InvalidArgumentException('non-nullable custom_role_ids cannot be null');
        }
     ...
     * Sets inline_role
     *
     * @param \LaunchDarklyApi\Model\Statement[]|null $inline_role An array of policy statements, with three attributes: effect, resources, actions. May be used in place of a role.
     *
     * @return self
     */
    public function setInlineRole($inline_role)
    {
        if (is_null($inline_role)) {
            throw new \InvalidArgumentException('non-nullable inline_role cannot be null');
        }
     ...
     * Sets role
     *
     * @param string|null $role Base role for the token
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token The token value. When creating or resetting, contains the entire token value. Otherwise, contains the last four characters.
     *
     * @return self
     */
     ...
     * Sets service_token
     *
     * @param bool|null $service_token Whether this is a service token or a personal token
     *
     * @return self
     */
    public function setServiceToken($service_token)
    {
        if (is_null($service_token)) {
            throw new \InvalidArgumentException('non-nullable service_token cannot be null');
        }
     ...
     *
     * @param int|null $default_api_version The default API version for this token
     *
     * @return self
     */
    public function setDefaultApiVersion($default_api_version)
    {
        if (is_null($default_api_version)) {
            throw new \InvalidArgumentException('non-nullable default_api_version cannot be null');
        }
     ...
     * Sets last_used
     *
     * @param int|null $last_used last_used
     *
     * @return self
     */
