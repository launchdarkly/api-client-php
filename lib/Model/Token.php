...
class Token implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['custom_role_ids'] = $data['custom_role_ids'] ?? null;
        $this->container['inline_role'] = $data['inline_role'] ?? null;
        $this->container['role'] = $data['role'] ?? null;
        $this->container['token'] = $data['token'] ?? null;
        $this->container['service_token'] = $data['service_token'] ?? null;
        $this->container['_links'] = $data['_links'] ?? null;
        $this->container['default_api_version'] = $data['default_api_version'] ?? null;
     ...
     * Sets inline_role
     *
     * @param \LaunchDarklyApi\Model\Statement[]|null $inline_role An array of policy statements, with three attributes: effect, resources, actions. May be used in place of a built-in or custom role.
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string|null $role Built-in role for the token
     *
     * @return self
     */
