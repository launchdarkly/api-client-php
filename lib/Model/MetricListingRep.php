...
class MetricListingRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets is_numeric
     *
     * @param bool|null $is_numeric For custom metrics, whether to track numeric changes in value against a baseline (<code>true</code>) or to track a conversion when users taken an action (<code>false</code>).
     *
     * @return self
     */
     ...
     *
     * @param string|null $success_criteria For numeric custom metrics, the success criteria
     *
     * @return self
     */
     ...
     * Sets event_key
     *
     * @param string|null $event_key For custom metrics, the event name to use in your code
     *
     * @return self
     */
