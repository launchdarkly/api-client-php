...
/**
 * InsightsChartMetadata Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class InsightsChartMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsightsChartMetadata';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'metrics' => 'array<string,\LaunchDarklyApi\Model\InsightsChartMetric>',
        'x_axis' => '\LaunchDarklyApi\Model\InsightsChartSeriesMetadataAxis',
        'y_axis' => '\LaunchDarklyApi\Model\InsightsChartSeriesMetadataAxis'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('x_axis', $data ?? [], null);
        $this->setIfExists('y_axis', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['x_axis'] === null) {
            $invalidProperties[] = "'x_axis' can't be null";
        }
        if ($this->container['y_axis'] === null) {
            $invalidProperties[] = "'y_axis' can't be null";
        }
     ...
     * Sets name
     *
     * @param string|null $name Name of the chart
     *
     * @return self
     */
     ...
     * Gets metrics
     *
     * @return array<string,\LaunchDarklyApi\Model\InsightsChartMetric>|null
     */
     ...
     * Sets metrics
     *
     * @param array<string,\LaunchDarklyApi\Model\InsightsChartMetric>|null $metrics metrics
     *
     * @return self
     */
     ...
     * Gets x_axis
     *
     * @return \LaunchDarklyApi\Model\InsightsChartSeriesMetadataAxis
     */
     ...
     * Sets x_axis
     *
     * @param \LaunchDarklyApi\Model\InsightsChartSeriesMetadataAxis $x_axis x_axis
     *
     * @return self
     */
    ...
    {
        if (is_null($x_axis)) {
            throw new \InvalidArgumentException('non-nullable x_axis cannot be null');
        }
     ...
     * Sets y_axis
     *
     * @param \LaunchDarklyApi\Model\InsightsChartSeriesMetadataAxis $y_axis y_axis
     *
     * @return self
     */
    ...
    {
        if (is_null($y_axis)) {
            throw new \InvalidArgumentException('non-nullable y_axis cannot be null');
        }
