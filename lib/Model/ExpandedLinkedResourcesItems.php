...
/**
 * ExpandedLinkedResourcesItems Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExpandedLinkedResourcesItems implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandedLinkedResourcesItems';
    ...
    protected static $openAPITypes = [
        'flags' => '\LaunchDarklyApi\Model\ExpandedLinkedResourcesFlags',
        'segments' => '\LaunchDarklyApi\Model\ExpandedLinkedResourcesSegments',
        'ai_configs' => '\LaunchDarklyApi\Model\ExpandedLinkedResourcesAIConfigs',
        'metrics' => '\LaunchDarklyApi\Model\ExpandedLinkedResourcesMetrics'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ai_configs', $data ?? [], null);
    ...
    */
     ...
     * Gets flags
     *
     * @return \LaunchDarklyApi\Model\ExpandedLinkedResourcesFlags
     */
     ...
     * Sets flags
     *
     * @param \LaunchDarklyApi\Model\ExpandedLinkedResourcesFlags $flags flags
     *
     * @return self
     */
     ...
     * Gets segments
     *
     * @return \LaunchDarklyApi\Model\ExpandedLinkedResourcesSegments|null
     */
     ...
     * Sets segments
     *
     * @param \LaunchDarklyApi\Model\ExpandedLinkedResourcesSegments|null $segments segments
     *
     * @return self
     */
     ...
     * Gets ai_configs
     *
     * @return \LaunchDarklyApi\Model\ExpandedLinkedResourcesAIConfigs|null
     */
    public function getAiConfigs()
    {
        return $this->container['ai_configs'];
    }

    /**
     * Sets ai_configs
     *
     * @param \LaunchDarklyApi\Model\ExpandedLinkedResourcesAIConfigs|null $ai_configs ai_configs
     *
     * @return self
     */
    public function setAiConfigs($ai_configs)
    {
        if (is_null($ai_configs)) {
            throw new \InvalidArgumentException('non-nullable ai_configs cannot be null');
        }
        $this->container['ai_configs'] = $ai_configs;
     ...
     * Gets metrics
     *
     * @return \LaunchDarklyApi\Model\ExpandedLinkedResourcesMetrics|null
     */
     ...
     * Sets metrics
     *
     * @param \LaunchDarklyApi\Model\ExpandedLinkedResourcesMetrics|null $metrics metrics
     *
     * @return self
     */
