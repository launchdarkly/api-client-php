 ...
 */
class NullDecimal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NullDecimal';
    ...
    protected static $openAPITypes = [
        'decimal' => '\LaunchDarklyApi\Model\Decimal',
        'valid' => 'bool'
    ];
     ...
     * Gets decimal
     *
     * @return \LaunchDarklyApi\Model\Decimal|null
     */
     ...
     * Sets decimal
     *
     * @param \LaunchDarklyApi\Model\Decimal|null $decimal decimal
     *
     * @return self
     */
