...
/**
 * DependentMetricGroupRepWithMetrics Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class DependentMetricGroupRepWithMetrics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DependentMetricGroupRepWithMetrics';
    ...
    */
     ...
     * Sets metrics
     *
     * @param \LaunchDarklyApi\Model\MetricInGroupRep[]|null $metrics The metrics in the metric group
     *
     * @return self
     */
