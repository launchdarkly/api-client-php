...
/**
 * AIConfigTargetingEnvironmentFallthroughRolloutVariation Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AIConfigTargetingEnvironmentFallthroughRolloutVariation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AIConfigTargetingEnvironmentFallthroughRolloutVariation';
    ...
    {
        $this->setIfExists('_untracked', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['_untracked'];
    }

    /**
     * Sets _untracked
     *
     * @param bool|null $_untracked _untracked
     *
     * @return self
     */
    public function setUntracked($_untracked)
    {
        if (is_null($_untracked)) {
            throw new \InvalidArgumentException('non-nullable _untracked cannot be null');
        }
        $this->container['_untracked'] = $_untracked;
