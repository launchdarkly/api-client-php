...
class RandomizationUnitInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'default' => false,
        'standard_randomization_unit' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('standard_randomization_unit', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $standard_randomization_unit (deprecated) This field is deprecated and will be removed. Use randomizationUnit instead.
     *
     * @return self
     */
    public function setStandardRandomizationUnit($standard_randomization_unit)
    {
        if (is_null($standard_randomization_unit)) {
            throw new \InvalidArgumentException('non-nullable standard_randomization_unit cannot be null');
        }
