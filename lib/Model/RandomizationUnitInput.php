...
class RandomizationUnitInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets default
     *
     * @param bool $default If true, any experiment iterations created within this project will default to using this randomization unit. A project can only have one default randomization unit.
     *
     * @return self
     */
