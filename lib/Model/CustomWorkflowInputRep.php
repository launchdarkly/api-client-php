...
/**
 * CustomWorkflowInputRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CustomWorkflowInputRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomWorkflowInputRep';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'stages' => '\LaunchDarklyApi\Model\StageInputRep[]',
        'template_key' => 'string'
    ];
     ...
     * Gets stages
     *
     * @return \LaunchDarklyApi\Model\StageInputRep[]|null
     */
     ...
     * Sets stages
     *
     * @param \LaunchDarklyApi\Model\StageInputRep[]|null $stages stages
     *
     * @return self
     */
