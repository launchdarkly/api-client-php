...
/**
 * ExpiringTargetError Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExpiringTargetError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpiringTargetError';
    ...
    protected static $setters = [
        'instruction_index' => 'setInstructionIndex',
        'message' => 'setMessage'
    ];
    ...
    protected static $getters = [
        'instruction_index' => 'getInstructionIndex',
        'message' => 'getMessage'
    ];
    ...
    {
        $this->setIfExists('instruction_index', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instruction_index'] === null) {
            $invalidProperties[] = "'instruction_index' can't be null";
        }
    ...
    /**
     * Gets instruction_index
     *
     * @return int
     */
    public function getInstructionIndex()
    {
        return $this->container['instruction_index'];
    }

    /**
     * Sets instruction_index
     *
     * @param int $instruction_index The index of the PATCH instruction where the error occurred
     *
     * @return self
     */
    public function setInstructionIndex($instruction_index)
    {
        if (is_null($instruction_index)) {
            throw new \InvalidArgumentException('non-nullable instruction_index cannot be null');
        }
        $this->container['instruction_index'] = $instruction_index;
     ...
     * Sets message
     *
     * @param string $message The error message related to a failed PATCH instruction
     *
     * @return self
     */
