...
/**
 * DynamicOptionsParser Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class DynamicOptionsParser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DynamicOptionsParser';
    ...
    protected static $openAPITypes = [
        'options_items' => '\LaunchDarklyApi\Model\OptionsArray',
        'options_path' => 'string'
    ];
    ...
    protected static $setters = [
        'options_items' => 'setOptionsItems',
        'options_path' => 'setOptionsPath'
    ];
    ...
    protected static $getters = [
        'options_items' => 'getOptionsItems',
        'options_path' => 'getOptionsPath'
    ];
    ...
    {
        $this->setIfExists('options_items', $data ?? [], null);
        $this->setIfExists('options_path', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets options_items
     *
     * @return \LaunchDarklyApi\Model\OptionsArray|null
     */
    public function getOptionsItems()
    {
        return $this->container['options_items'];
    }

    /**
     * Sets options_items
     *
     * @param \LaunchDarklyApi\Model\OptionsArray|null $options_items options_items
     *
     * @return self
     */
    public function setOptionsItems($options_items)
    {
        if (is_null($options_items)) {
            throw new \InvalidArgumentException('non-nullable options_items cannot be null');
        }
        $this->container['options_items'] = $options_items;
    ...
    {
        return $this->container['options_path'];
    }

    /**
     * Sets options_path
     *
     * @param string|null $options_path options_path
     *
     * @return self
     */
    public function setOptionsPath($options_path)
    {
        if (is_null($options_path)) {
            throw new \InvalidArgumentException('non-nullable options_path cannot be null');
        }
        $this->container['options_path'] = $options_path;
