...
/**
 * FlagImportStatus Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagImportStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagImportStatus';
    ...
    protected static $openAPITypes = [
        ...
        'last_import' => 'int',
        'last_error' => 'int',
        'errors' => '\LaunchDarklyApi\Model\StatusResponse[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('last_import', $data ?? [], null);
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status The current status of the import integrations related import job
     *
     * @return self
     */
    ...
    {
        return $this->container['last_import'];
    }

    /**
     * Sets last_import
     *
     * @param int|null $last_import last_import
     *
     * @return self
     */
    public function setLastImport($last_import)
    {
        if (is_null($last_import)) {
            throw new \InvalidArgumentException('non-nullable last_import cannot be null');
        }
        $this->container['last_import'] = $last_import;
     ...
     * Gets errors
     *
     * @return \LaunchDarklyApi\Model\StatusResponse[]|null
     */
     ...
     * Sets errors
     *
     * @param \LaunchDarklyApi\Model\StatusResponse[]|null $errors errors
     *
     * @return self
     */
