...
/**
 * InsightGroupsCountByIndicator Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class InsightGroupsCountByIndicator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsightGroupsCountByIndicator';
    ...
    protected static $setters = [
        ...
        'not_calculated' => 'setNotCalculated',
        'unknown' => 'setUnknown',
        'total' => 'setTotal'
    ];
    ...
    protected static $getters = [
        ...
        'not_calculated' => 'getNotCalculated',
        'unknown' => 'getUnknown',
        'total' => 'getTotal'
    ];
    ...
    {
        $this->setIfExists('excellent', $data ?? [], null);
        $this->setIfExists('good', $data ?? [], null);
        $this->setIfExists('fair', $data ?? [], null);
        $this->setIfExists('needs_attention', $data ?? [], null);
        $this->setIfExists('not_calculated', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['excellent'] === null) {
            $invalidProperties[] = "'excellent' can't be null";
        }
        if ($this->container['good'] === null) {
            $invalidProperties[] = "'good' can't be null";
        }
        if ($this->container['fair'] === null) {
            $invalidProperties[] = "'fair' can't be null";
        }
        if ($this->container['needs_attention'] === null) {
            $invalidProperties[] = "'needs_attention' can't be null";
        }
        if ($this->container['not_calculated'] === null) {
            $invalidProperties[] = "'not_calculated' can't be null";
        }
    ...
    {
        return $this->container['excellent'];
    }

    /**
     * Sets excellent
     *
     * @param int $excellent The number of insight groups with an excellent indicator
     *
     * @return self
     */
    public function setExcellent($excellent)
    {
        if (is_null($excellent)) {
            throw new \InvalidArgumentException('non-nullable excellent cannot be null');
        }
        $this->container['excellent'] = $excellent;
     ...
     * Sets good
     *
     * @param int $good The number of insight groups with a good indicator
     *
     * @return self
     */
    ...
    {
        return $this->container['fair'];
    }

    /**
     * Sets fair
     *
     * @param int $fair The number of insight groups with a fair indicator
     *
     * @return self
     */
    ...
    {
        if (is_null($fair)) {
            throw new \InvalidArgumentException('non-nullable fair cannot be null');
        }
        $this->container['fair'] = $fair;
     ...
     *
     * @param int $needs_attention The number of insight groups with a needs attention indicator
     *
     * @return self
     */
    public function setNeedsAttention($needs_attention)
    {
        if (is_null($needs_attention)) {
            throw new \InvalidArgumentException('non-nullable needs_attention cannot be null');
        }
     ...
     * @return int
     */
    public function getNotCalculated()
    {
        return $this->container['not_calculated'];
    }

    /**
     * Sets not_calculated
     *
     * @param int $not_calculated The number of insight groups with a not calculated indicator
     *
     * @return self
     */
    public function setNotCalculated($not_calculated)
    {
        if (is_null($not_calculated)) {
            throw new \InvalidArgumentException('non-nullable not_calculated cannot be null');
        }
        $this->container['not_calculated'] = $not_calculated;
     ...
     * Sets unknown
     *
     * @param int $unknown The number of insight groups with an unknown indicator
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int $total The total number of insight groups
     *
     * @return self
     */
