...
/**
 * AudiencePost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AudiencePost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AudiencePost';
    ...
    */
     ...
     *
     * @param string $environment_key A project-unique key for the environment.
     *
     * @return self
     */
     ...
     * Sets segment_keys
     *
     * @param string[]|null $segment_keys Segments targeted by this audience.
     *
     * @return self
     */
