...
/**
 * CapabilityConfigPost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CapabilityConfigPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CapabilityConfigPost';
    ...
    protected static $openAPITypes = [
        'approvals' => '\LaunchDarklyApi\Model\ApprovalsCapabilityConfig',
        'audit_log_events_hook' => '\LaunchDarklyApi\Model\AuditLogEventsHookCapabilityConfigPost'
    ];
    ...
    protected static $setters = [
        ...
        'audit_log_events_hook' => 'setAuditLogEventsHook'
    ];
    ...
    protected static $getters = [
        ...
        'audit_log_events_hook' => 'getAuditLogEventsHook'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('audit_log_events_hook', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets approvals
     *
     * @return \LaunchDarklyApi\Model\ApprovalsCapabilityConfig|null
     */
     ...
     * Sets approvals
     *
     * @param \LaunchDarklyApi\Model\ApprovalsCapabilityConfig|null $approvals approvals
     *
     * @return self
     */
    ...
    /**
     * Gets audit_log_events_hook
     *
     * @return \LaunchDarklyApi\Model\AuditLogEventsHookCapabilityConfigPost|null
     */
    public function getAuditLogEventsHook()
    {
        return $this->container['audit_log_events_hook'];
    }

    /**
     * Sets audit_log_events_hook
     *
     * @param \LaunchDarklyApi\Model\AuditLogEventsHookCapabilityConfigPost|null $audit_log_events_hook audit_log_events_hook
     *
     * @return self
     */
    public function setAuditLogEventsHook($audit_log_events_hook)
    {
        if (is_null($audit_log_events_hook)) {
            throw new \InvalidArgumentException('non-nullable audit_log_events_hook cannot be null');
        }
        $this->container['audit_log_events_hook'] = $audit_log_events_hook;
