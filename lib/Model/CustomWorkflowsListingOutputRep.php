...
/**
 * CustomWorkflowsListingOutputRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CustomWorkflowsListingOutputRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomWorkflowsListingOutputRep';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\CustomWorkflowOutputRep[]'
    ];
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\CustomWorkflowOutputRep[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\CustomWorkflowOutputRep[] $items items
     *
     * @return self
     */
