...
/**
 * ReleasePoliciesAccessAllowedReason Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleasePoliciesAccessAllowedReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleasePoliciesAccessAllowedReason';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('not_resources', $data ?? [], null);
        $this->setIfExists('actions', $data ?? [], null);
        $this->setIfExists('not_actions', $data ?? [], null);
    ...
    */
     ...
     * Sets not_resources
     *
     * @param string[]|null $not_resources Targeted resources are the resources NOT in this list. The <code>resources</code> and <code>notActions</code> fields must be empty to use this field.
     *
     * @return self
     */
    public function setNotResources($not_resources)
    {
        if (is_null($not_resources)) {
            throw new \InvalidArgumentException('non-nullable not_resources cannot be null');
        }
     ...
     * Sets not_actions
     *
     * @param string[]|null $not_actions Targeted actions are the actions NOT in this list. The <code>actions</code> and <code>notResources</code> fields must be empty to use this field.
     *
     * @return self
     */
    public function setNotActions($not_actions)
    {
        if (is_null($not_actions)) {
            throw new \InvalidArgumentException('non-nullable not_actions cannot be null');
        }
     ...
     * Sets effect
     *
     * @param string $effect Whether this statement should allow or deny actions on the resources.
     *
     * @return self
     */
