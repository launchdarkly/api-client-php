...
/**
 * Environments Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class Environments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Environments';
    ...
    protected static $openAPITypes = [
        ...
        'total_count' => 'int',
        'items' => '\LaunchDarklyApi\Model\Environment[]'
    ];
     ...
     * Sets total_count
     *
     * @param int|null $total_count The number of environments returned
     *
     * @return self
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\Environment[]|null $items An array of environments
     *
     * @return self
     */
