...
class Destination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const KIND_GOOGLE_PUBSUB = 'google-pubsub';
    public const KIND_KINESIS = 'kinesis';
    public const KIND_MPARTICLE = 'mparticle';
    public const KIND_SEGMENT = 'segment';
    public const KIND_AZURE_EVENT_HUBS = 'azure-event-hubs';
     ...
     * Sets _id
     *
     * @param string|null $_id The ID of this Data Export destination
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name A human-readable name for your Data Export destination
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string|null $kind The type of Data Export destination
     *
     * @return self
     */
     ...
     * Sets config
     *
     * @param mixed|null $config An object with the configuration parameters required for the destination type
     *
     * @return self
     */
     ...
     * Sets on
     *
     * @param bool|null $on Whether the export is on, that is, the status of the integration
     *
     * @return self
     */
