...
/**
 * StageOutputRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class StageOutputRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StageOutputRep';
    ...
    protected static $openAPITypes = [
        '_id' => 'string',
        'name' => 'string',
        'conditions' => '\LaunchDarklyApi\Model\ConditionOutputRep[]',
        'action' => '\LaunchDarklyApi\Model\ActionOutputRep',
     ...
     * Gets conditions
     *
     * @return \LaunchDarklyApi\Model\ConditionOutputRep[]
     */
     ...
     * Sets conditions
     *
     * @param \LaunchDarklyApi\Model\ConditionOutputRep[] $conditions conditions
     *
     * @return self
     */
     ...
     * Gets action
     *
     * @return \LaunchDarklyApi\Model\ActionOutputRep
     */
     ...
     * Sets action
     *
     * @param \LaunchDarklyApi\Model\ActionOutputRep $action action
     *
     * @return self
     */
