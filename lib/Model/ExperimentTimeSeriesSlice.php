...
/**
 * ExperimentTimeSeriesSlice Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExperimentTimeSeriesSlice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExperimentTimeSeriesSlice';
    ...
    protected static $openAPITypes = [
        'time' => 'int',
        'variation_data' => '\LaunchDarklyApi\Model\ExperimentTimeSeriesVariationSlice[]'
    ];
    ...
    protected static $setters = [
        'time' => 'setTime',
        'variation_data' => 'setVariationData'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['variation_data'] = $data['variation_data'] ?? null;
    }
     ...
     * Gets variation_data
     *
     * @return \LaunchDarklyApi\Model\ExperimentTimeSeriesVariationSlice[]|null
     */
    public function getVariationData()
    {
        return $this->container['variation_data'];
    }

    /**
     * Sets variation_data
     *
     * @param \LaunchDarklyApi\Model\ExperimentTimeSeriesVariationSlice[]|null $variation_data variation_data
     *
     * @return self
     */
    public function setVariationData($variation_data)
    {
        $this->container['variation_data'] = $variation_data;
