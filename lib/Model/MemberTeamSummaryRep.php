...
/**
 * MemberTeamSummaryRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class MemberTeamSummaryRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberTeamSummaryRep';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['custom_role_keys'] === null) {
            $invalidProperties[] = "'custom_role_keys' can't be null";
        }
     ...
     *
     * @param string[] $custom_role_keys A list of keys of the custom roles this team has access to
     *
     * @return self
     */
