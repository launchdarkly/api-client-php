...
/**
 * VariationToolPost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class VariationToolPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariationToolPost';
    ...
    */
     ...
     * Sets key
     *
     * @param string $key The key of the tool to use.
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int $version The version of the tool.
     *
     * @return self
     */
