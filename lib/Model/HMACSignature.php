...
/**
 * HMACSignature Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class HMACSignature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HMACSignature';
    ...
    protected static array $openAPINullables = [
        'header_name' => false,
        'hmac_secret_form_variable_key' => false
    ];
    ...
    protected static $setters = [
        ...
        'hmac_secret_form_variable_key' => 'setHmacSecretFormVariableKey'
    ];
    ...
    protected static $getters = [
        ...
        'hmac_secret_form_variable_key' => 'getHmacSecretFormVariableKey'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('hmac_secret_form_variable_key', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets hmac_secret_form_variable_key
     *
     * @return string|null
     */
    public function getHmacSecretFormVariableKey()
    {
        return $this->container['hmac_secret_form_variable_key'];
    }

    /**
     * Sets hmac_secret_form_variable_key
     *
     * @param string|null $hmac_secret_form_variable_key hmac_secret_form_variable_key
     *
     * @return self
     */
    public function setHmacSecretFormVariableKey($hmac_secret_form_variable_key)
    {
        if (is_null($hmac_secret_form_variable_key)) {
            throw new \InvalidArgumentException('non-nullable hmac_secret_form_variable_key cannot be null');
        }
        $this->container['hmac_secret_form_variable_key'] = $hmac_secret_form_variable_key;
