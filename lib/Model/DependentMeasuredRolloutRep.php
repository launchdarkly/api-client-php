...
/**
 * DependentMeasuredRolloutRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class DependentMeasuredRolloutRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DependentMeasuredRolloutRep';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('flag_name', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['flag_name'] === null) {
            $invalidProperties[] = "'flag_name' can't be null";
        }
     ...
     * Sets _id
     *
     * @param string $_id The guarded rollout measured rollout Id
     *
     * @return self
     */
     ...
     * Sets flag_key
     *
     * @param string $flag_key The guarded rollout flag key
     *
     * @return self
     */
     ...
     * Sets flag_name
     *
     * @param string $flag_name The guarded rollout flag name
     *
     * @return self
     */
    public function setFlagName($flag_name)
    {
        if (is_null($flag_name)) {
            throw new \InvalidArgumentException('non-nullable flag_name cannot be null');
        }
     ...
     *
     * @param string $environment_key The guarded rollout environment key
     *
     * @return self
     */
     ...
     *
     * @param string $environment_name The guarded rollout environment name
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status The guarded rollout status
     *
     * @return self
     */
