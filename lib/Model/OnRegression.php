...
/**
 * OnRegression Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class OnRegression implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OnRegression';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rollback'] = $data['rollback'] ?? null;
    }
