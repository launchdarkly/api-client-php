...
class AccessTokenPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets inline_role
     *
     * @param \LaunchDarklyApi\Model\StatementPost[]|null $inline_role A JSON array of statements represented as JSON objects with three attributes: effect, resources, actions. May be used in place of a built-in or custom role.
     *
     * @return self
     */
     ...
     * Sets service_token
     *
     * @param bool|null $service_token Whether the token is a service token https://docs.launchdarkly.com/home/account-security/api-access-tokens#service-tokens
     *
     * @return self
     */
