...
/**
 * AccessTokenPost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AccessTokenPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccessTokenPost';
    ...
    protected static $openAPITypes = [
        ...
        'inline_role' => '\LaunchDarklyApi\Model\StatementPost[]',
        'service_token' => 'bool',
    ...
    */
     ...
     * Gets inline_role
     *
     * @return \LaunchDarklyApi\Model\StatementPost[]|null
     */
     ...
     * Sets inline_role
     *
     * @param \LaunchDarklyApi\Model\StatementPost[]|null $inline_role A JSON array of statements represented as JSON objects with three attributes: effect, resources, actions. May be used in place of a role.
     *
     * @return self
     */
     ...
     * Sets service_token
     *
     * @param bool|null $service_token Whether the token is a service token
     *
     * @return self
     */
