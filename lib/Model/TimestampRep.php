...
/**
 * TimestampRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class TimestampRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimestampRep';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('rfc3339', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['rfc3339'];
    }

    /**
     * Sets rfc3339
     *
     * @param string|null $rfc3339 rfc3339
     *
     * @return self
     */
    public function setRfc3339($rfc3339)
    {
        if (is_null($rfc3339)) {
            throw new \InvalidArgumentException('non-nullable rfc3339 cannot be null');
        }
        $this->container['rfc3339'] = $rfc3339;
     ...
     * Sets simple
     *
     * @param string|null $simple simple
     *
     * @return self
     */
