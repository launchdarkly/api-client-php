...
/**
 * AccessDeniedRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AccessDeniedRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccessDeniedRep';
    ...
    protected static $openAPITypes = [
        'action' => 'string',
        'reason' => '\LaunchDarklyApi\Model\AccessDeniedReasonRep'
    ];
     ...
     * Gets reason
     *
     * @return \LaunchDarklyApi\Model\AccessDeniedReasonRep
     */
     ...
     * Sets reason
     *
     * @param \LaunchDarklyApi\Model\AccessDeniedReasonRep $reason reason
     *
     * @return self
     */
