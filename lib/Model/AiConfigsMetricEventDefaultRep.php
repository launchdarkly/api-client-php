...
/**
 * AiConfigsMetricEventDefaultRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AiConfigsMetricEventDefaultRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AiConfigsMetricEventDefaultRep';
    ...
    */
     ...
     * Sets disabled
     *
     * @param bool|null $disabled Whether to disable defaulting missing unit events when calculating results. Defaults to false
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param float|null $value The default value applied to missing unit events. Set to 0 when <code>disabled</code> is false. No other values are currently supported.
     *
     * @return self
     */
