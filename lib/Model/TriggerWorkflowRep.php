...
/**
 * TriggerWorkflowRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class TriggerWorkflowRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TriggerWorkflowRep';
    ...
    protected static $openAPITypes = [
        ...
        'instructions' => 'array[]',
        '_last_triggered_at' => 'int',
        '_recent_trigger_bodies' => '\LaunchDarklyApi\Model\RecentTriggerBody[]',
        '_trigger_count' => 'int',
        'trigger_url' => 'string',
    ...
    protected static array $openAPINullables = [
        ...
        '_maintainer_id' => false,
        '_maintainer' => false,
        'enabled' => false,
        '_integration_key' => false,
        'instructions' => false,
        '_last_triggered_at' => false,
        '_recent_trigger_bodies' => false,
    ...
    protected static $setters = [
        ...
        '_last_triggered_at' => 'setLastTriggeredAt',
        '_recent_trigger_bodies' => 'setRecentTriggerBodies',
        '_trigger_count' => 'setTriggerCount',
    ...
    protected static $getters = [
        ...
        '_last_triggered_at' => 'getLastTriggeredAt',
        '_recent_trigger_bodies' => 'getRecentTriggerBodies',
        '_trigger_count' => 'getTriggerCount',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_maintainer_id', $data ?? [], null);
        ...
        $this->setIfExists('_last_triggered_at', $data ?? [], null);
        $this->setIfExists('_recent_trigger_bodies', $data ?? [], null);
        $this->setIfExists('_trigger_count', $data ?? [], null);
        $this->setIfExists('trigger_url', $data ?? [], null);
    ...
    */
     ...
     * Sets _version
     *
     * @param int|null $_version The flag trigger version
     *
     * @return self
     */
     ...
     * Sets _creation_date
     *
     * @param int|null $_creation_date _creation_date
     *
     * @return self
     */
     ...
     * Sets _maintainer_id
     *
     * @param string|null $_maintainer_id The ID of the flag trigger maintainer
     *
     * @return self
     */
    public function setMaintainerId($_maintainer_id)
    {
        if (is_null($_maintainer_id)) {
            throw new \InvalidArgumentException('non-nullable _maintainer_id cannot be null');
        }
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Whether the flag trigger is currently enabled
     *
     * @return self
     */
     ...
     *
     * @param string|null $_integration_key The unique identifier of the integration for your trigger
     *
     * @return self
     */
     ...
     * Sets instructions
     *
     * @param array[]|null $instructions instructions
     *
     * @return self
     */
    ...
    /**
     * Gets _last_triggered_at
     *
     * @return int|null
     */
    public function getLastTriggeredAt()
    {
        return $this->container['_last_triggered_at'];
    }

    /**
     * Sets _last_triggered_at
     *
     * @param int|null $_last_triggered_at _last_triggered_at
     *
     * @return self
     */
    public function setLastTriggeredAt($_last_triggered_at)
    {
        if (is_null($_last_triggered_at)) {
            throw new \InvalidArgumentException('non-nullable _last_triggered_at cannot be null');
        }
        $this->container['_last_triggered_at'] = $_last_triggered_at;

        return $this;
    }

    /**
     * Gets _recent_trigger_bodies
     *
     * @return \LaunchDarklyApi\Model\RecentTriggerBody[]|null
     */
    public function getRecentTriggerBodies()
    {
        return $this->container['_recent_trigger_bodies'];
    }

    /**
     * Sets _recent_trigger_bodies
     *
     * @param \LaunchDarklyApi\Model\RecentTriggerBody[]|null $_recent_trigger_bodies Details on recent flag trigger requests.
     *
     * @return self
     */
    public function setRecentTriggerBodies($_recent_trigger_bodies)
    {
        if (is_null($_recent_trigger_bodies)) {
            throw new \InvalidArgumentException('non-nullable _recent_trigger_bodies cannot be null');
        }
        $this->container['_recent_trigger_bodies'] = $_recent_trigger_bodies;
    ...
    {
        return $this->container['_trigger_count'];
    }

    /**
     * Sets _trigger_count
     *
     * @param int|null $_trigger_count Number of times the trigger has been executed
     *
     * @return self
     */
    public function setTriggerCount($_trigger_count)
    {
        if (is_null($_trigger_count)) {
            throw new \InvalidArgumentException('non-nullable _trigger_count cannot be null');
        }
        $this->container['_trigger_count'] = $_trigger_count;
     ...
     * Sets trigger_url
     *
     * @param string|null $trigger_url The unguessable URL for this flag trigger
     *
     * @return self
     */
    public function setTriggerUrl($trigger_url)
    {
        if (is_null($trigger_url)) {
            throw new \InvalidArgumentException('non-nullable trigger_url cannot be null');
        }
