...
/**
 * ReleasePipeline Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleasePipeline implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleasePipeline';
    ...
    protected static $openAPITypes = [
        ...
        'key' => 'string',
        'name' => 'string',
        'phases' => '\LaunchDarklyApi\Model\Phase[]',
        'tags' => 'string[]',
        '_version' => 'int',
    ...
    protected static $setters = [
        ...
        '_version' => 'setVersion',
        '_access' => 'setAccess',
        'is_project_default' => 'setIsProjectDefault',
        '_is_legacy' => 'setIsLegacy'
    ];
    ...
    protected static $getters = [
        ...
        '_version' => 'getVersion',
        '_access' => 'getAccess',
        'is_project_default' => 'getIsProjectDefault',
        '_is_legacy' => 'getIsLegacy'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_project_default', $data ?? [], null);
        $this->setIfExists('_is_legacy', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Timestamp of when the release pipeline was created
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The release pipeline description
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string $key The release pipeline key
     *
     * @return self
     */
     ...
     * Gets phases
     *
     * @return \LaunchDarklyApi\Model\Phase[]
     */
     ...
     * Sets phases
     *
     * @param \LaunchDarklyApi\Model\Phase[] $phases An ordered list of the release pipeline phases. Each phase is a logical grouping of one or more environments that share attributes for rolling out changes.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags A list of the release pipeline's tags
     *
     * @return self
     */
     ...
     * Sets _version
     *
     * @param int|null $_version The release pipeline version
     *
     * @return self
     */
    ...
    /**
     * Gets is_project_default
     *
     * @return bool|null
     */
    public function getIsProjectDefault()
    {
        return $this->container['is_project_default'];
    }

    /**
     * Sets is_project_default
     *
     * @param bool|null $is_project_default Whether this release pipeline is the default pipeline for the project
     *
     * @return self
     */
    public function setIsProjectDefault($is_project_default)
    {
        if (is_null($is_project_default)) {
            throw new \InvalidArgumentException('non-nullable is_project_default cannot be null');
        }
        $this->container['is_project_default'] = $is_project_default;
    ...
    {
        return $this->container['_is_legacy'];
    }

    /**
     * Sets _is_legacy
     *
     * @param bool|null $_is_legacy Whether this release pipeline is a legacy pipeline
     *
     * @return self
     */
    public function setIsLegacy($_is_legacy)
    {
        if (is_null($_is_legacy)) {
            throw new \InvalidArgumentException('non-nullable _is_legacy cannot be null');
        }
        $this->container['_is_legacy'] = $_is_legacy;
