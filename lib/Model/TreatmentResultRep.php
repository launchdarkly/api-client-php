...
class TreatmentResultRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets p_best
     *
     * @param float|null $p_best The likelihood that this variation has the biggest effect on the primary metric. Of all the variations in the experiment, the one with highest probability is likely the best option to choose.
     *
     * @return self
     */
     ...
     * Sets units
     *
     * @param int|null $units The number of experiment users for this variation
     *
     * @return self
     */
