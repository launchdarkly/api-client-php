...
class TreatmentResultRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets treatment_id
     *
     * @param string|null $treatment_id treatment_id
     *
     * @return self
     */
     ...
     * Sets treatment_name
     *
     * @param string|null $treatment_name treatment_name
     *
     * @return self
     */
     ...
     * Sets p_best
     *
     * @param float|null $p_best p_best
     *
     * @return self
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\RelativeDifferenceRep[]|null $relative_differences relative_differences
     *
     * @return self
     */
