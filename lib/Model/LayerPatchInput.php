...
/**
 * LayerPatchInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class LayerPatchInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LayerPatchInput';
     ...
     * Sets comment
     *
     * @param string|null $comment Optional comment describing the update
     *
     * @return self
     */
     ...
     *
     * @param string|null $environment_key The environment key used for making environment specific updates. For example, updating the reservation of an experiment
     *
     * @return self
     */
