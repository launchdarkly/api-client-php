...
/**
 * ApplicationVersionRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationVersionRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationVersionRep';
    ...
    */
     ...
     * Sets _version
     *
     * @param int|null $_version Version of the application version
     *
     * @return self
     */
     ...
     * Sets auto_added
     *
     * @param bool $auto_added Whether the application version was automatically created, because it was included in a context when a LaunchDarkly SDK evaluated a feature flag, or if the application version was created through the LaunchDarkly UI or REST API.
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string $key The unique identifier of this application version
     *
     * @return self
     */
     ...
     * Sets supported
     *
     * @param bool|null $supported Whether this version is supported. Only applicable if the application <code>kind</code> is <code>mobile</code>.
     *
     * @return self
     */
