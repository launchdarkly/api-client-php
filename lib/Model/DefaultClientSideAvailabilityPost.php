...
/**
 * DefaultClientSideAvailabilityPost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class DefaultClientSideAvailabilityPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DefaultClientSideAvailabilityPost';
    ...
    */
     ...
     *
     * @param bool $using_environment_id Whether to enable availability for client-side SDKs.
     *
     * @return self
     */
     ...
     *
     * @param bool $using_mobile_key Whether to enable availability for mobile SDKs.
     *
     * @return self
     */
