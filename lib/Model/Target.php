...
class Target implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets values
     *
     * @param string[] $values A list of the keys for targets that will receive this variation because of individual targeting
     *
     * @return self
     */
     ...
     * Sets variation
     *
     * @param int $variation The index, from the array of variations for this flag, of the variation to serve this list of targets
     *
     * @return self
     */
     ...
     * Sets context_kind
     *
     * @param string|null $context_kind The context kind of the individual target
     *
     * @return self
     */
