...
class RandomizationUnitRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $randomization_unit randomization_unit
     *
     * @return self
     */
     ...
     *
     * @param string|null $standard_randomization_unit standard_randomization_unit
     *
     * @return self
     */
     ...
     * Sets _display_name
     *
     * @param string|null $_display_name _display_name
     *
     * @return self
     */
