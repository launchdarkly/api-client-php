...
/**
 * SeriesListRepFloat Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class SeriesListRepFloat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SeriesListRepFloat';
    ...
    */
     ...
     * Sets metadata
     *
     * @param array[] $metadata Metadata about each series
     *
     * @return self
     */
     ...
     * Sets series
     *
     * @param array[] $series An array of data points with timestamps. Each element of the array is an object with a 'time' field, whose value is the timestamp, and one or more key fields. If there are multiple key fields, they are labeled '0', '1', and so on, and are explained in the <code>metadata</code>.
     *
     * @return self
     */
