...
/**
 * ProjectSummaryCollection Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ProjectSummaryCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectSummaryCollection';
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\ProjectSummary[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ProjectSummary[] $items items
     *
     * @return self
     */
