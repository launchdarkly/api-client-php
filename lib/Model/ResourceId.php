...
class ResourceId implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets flag_key
     *
     * @param string|null $flag_key Deprecated, use <code>key</code> instead
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets key
     *
     * @param string|null $key The key of the flag or segment
     *
     * @return self
     */
     ...
     * Sets project_key
     *
     * @param string|null $project_key The project key
     *
     * @return self
     */
