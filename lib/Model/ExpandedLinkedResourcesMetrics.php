...
/**
 * ExpandedLinkedResourcesMetrics Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExpandedLinkedResourcesMetrics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandedLinkedResourcesMetrics';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\ExpandedMetric[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\ExpandedMetric[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ExpandedMetric[] $items items
     *
     * @return self
     */
