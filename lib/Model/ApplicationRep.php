...
/**
 * ApplicationRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationRep';
    ...
    protected static $openAPITypes = [
        'flags' => '\LaunchDarklyApi\Model\ApplicationFlagCollectionRep',
        ...
        'key' => 'string',
        'kind' => 'string',
        '_maintainer' => '\LaunchDarklyApi\Model\MaintainerRep',
        'name' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('auto_added', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['auto_added'] === null) {
            $invalidProperties[] = "'auto_added' can't be null";
        }
     ...
     * Gets flags
     *
     * @return \LaunchDarklyApi\Model\ApplicationFlagCollectionRep|null
     */
     ...
     * Sets flags
     *
     * @param \LaunchDarklyApi\Model\ApplicationFlagCollectionRep|null $flags flags
     *
     * @return self
     */
     ...
     * Sets _version
     *
     * @param int|null $_version Version of the application
     *
     * @return self
     */
    ...
    {
        return $this->container['auto_added'];
    }

    /**
     * Sets auto_added
     *
     * @param bool $auto_added Whether the application was automatically created because it was included in a context when a LaunchDarkly SDK evaluated a feature flag, or was created through the LaunchDarkly UI or REST API.
     *
     * @return self
     */
    public function setAutoAdded($auto_added)
    {
        if (is_null($auto_added)) {
            throw new \InvalidArgumentException('non-nullable auto_added cannot be null');
        }
        $this->container['auto_added'] = $auto_added;
     ...
     * Sets key
     *
     * @param string $key The unique identifier of this application
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string $kind To distinguish the kind of application
     *
     * @return self
     */
     ...
     * Gets _maintainer
     *
     * @return \LaunchDarklyApi\Model\MaintainerRep|null
     */
     ...
     * Sets _maintainer
     *
     * @param \LaunchDarklyApi\Model\MaintainerRep|null $_maintainer _maintainer
     *
     * @return self
     */
