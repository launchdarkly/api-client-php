...
class Defaults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets on_variation
     *
     * @param int $on_variation The index, from the array of variations for this flag, of the variation to serve by default when targeting is on.
     *
     * @return self
     */
     ...
     * Sets off_variation
     *
     * @param int $off_variation The index, from the array of variations for this flag, of the variation to serve by default when targeting is off.
     *
     * @return self
     */
