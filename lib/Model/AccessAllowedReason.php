...
class AccessAllowedReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets not_resources
     *
     * @param string[]|null $not_resources Targeted resources are the resources NOT in this list. The \"resources\" and \"notActions\" fields must be empty to use this field.
     *
     * @return self
     */
     ...
     * Sets not_actions
     *
     * @param string[]|null $not_actions Targeted actions are the actions NOT in this list. The \"actions\" and \"notResources\" fields must be empty to use this field.
     *
     * @return self
     */
