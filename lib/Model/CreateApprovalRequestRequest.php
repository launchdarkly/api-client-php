...
/**
 * CreateApprovalRequestRequest Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateApprovalRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateApprovalRequestRequest';
    ...
    */
     ...
     * Sets resource_id
     *
     * @param string $resource_id String representation of the resource specifier
     *
     * @return self
     */
