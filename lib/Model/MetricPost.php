...
class MetricPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets is_numeric
     *
     * @param bool|null $is_numeric Whether to track numeric changes in value against a baseline (<code>true</code>) or to track a conversion when users taken an action (<code>false</code>). Required for custom metrics.
     *
     * @return self
     */
