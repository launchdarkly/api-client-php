...
class MetricPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets selector
     *
     * @param string|null $selector One or more CSS selectors. Required for click metrics.
     *
     * @return self
     */
     ...
     * Sets urls
     *
     * @param \LaunchDarklyApi\Model\UrlPost[]|null $urls One or more target URLs. Required for click and pageview metrics.
     *
     * @return self
     */
     ...
     * Sets is_active
     *
     * @param bool|null $is_active Whether to track a conversion when users take an action. Required for custom metrics. Either <code>isActive</code> or <code>isNumeric</code> may be true, but not both.
     *
     * @return self
     */
     ...
     * Sets is_numeric
     *
     * @param bool|null $is_numeric Whether to track numeric changes in value against a baseline. Required for custom metrics. Either <code>isActive</code> or <code>isNumeric</code> may be true, but not both.
     *
     * @return self
     */
     ...
     * Sets unit
     *
     * @param string|null $unit The unit of measure. Only for numeric custom metrics.
     *
     * @return self
     */
     ...
     * Sets event_key
     *
     * @param string|null $event_key The event name to use in your code. Required for custom metrics.
     *
     * @return self
     */
     ...
     *
     * @param string|null $success_criteria Success criteria. Required for numeric custom metrics.
     *
     * @return self
     */
