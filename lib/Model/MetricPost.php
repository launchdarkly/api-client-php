...
class MetricPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets selector
     *
     * @param string|null $selector Required for click metrics
     *
     * @return self
     */
     ...
     * Sets urls
     *
     * @param \LaunchDarklyApi\Model\UrlPost[]|null $urls Required for click and pageview metrics
     *
     * @return self
     */
     ...
     * Sets event_key
     *
     * @param string|null $event_key Required for custom metrics
     *
     * @return self
     */
