 ...
 */
class MetricPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MetricPost';
    ...
    protected static $openAPITypes = [
        ...
        'kind' => 'string',
        'selector' => 'string',
        'urls' => '\LaunchDarklyApi\Model\UrlPost[]',
        'is_numeric' => 'bool',
        'unit' => 'string',
        'event_key' => 'string',
        ...
        'filters' => '\LaunchDarklyApi\Model\EventFilter'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name A human-friendly name for the metric
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string $kind The kind of event your metric will track
     *
     * @return self
     */
     ...
     * Sets selector
     *
     * @param string|null $selector One or more CSS selectors. Required for click metrics only.
     *
     * @return self
     */
     ...
     * Gets urls
     *
     * @return \LaunchDarklyApi\Model\UrlPost[]|null
     */
     ...
     * Sets urls
     *
     * @param \LaunchDarklyApi\Model\UrlPost[]|null $urls One or more target URLs. Required for click and pageview metrics only.
     *
     * @return self
     */
     ...
     * Sets is_numeric
     *
     * @param bool|null $is_numeric Whether to track numeric changes in value against a baseline (<code>true</code>) or to track a conversion when an end user takes an action (<code>false</code>). Required for custom metrics only.
     *
     * @return self
     */
     ...
     * Sets unit
     *
     * @param string|null $unit The unit of measure. Applicable for numeric custom metrics only.
     *
     * @return self
     */
     ...
     * Sets event_key
     *
     * @param string|null $event_key The event key to use in your code. Required for custom conversion/binary and custom numeric metrics only.
     *
     * @return self
     */
     ...
     *
     * @param string|null $success_criteria Success criteria. Required for custom numeric metrics, optional for custom conversion metrics.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags for the metric
     *
     * @return self
     */
     ...
     * Gets filters
     *
     * @return \LaunchDarklyApi\Model\EventFilter|null
     */
     ...
     * Sets filters
     *
     * @param \LaunchDarklyApi\Model\EventFilter|null $filters filters
     *
     * @return self
     */
