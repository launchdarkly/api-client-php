...
/**
 * SegmentMetadata Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class SegmentMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SegmentMetadata';
    ...
    protected static array $openAPINullables = [
        ...
        'segment_id' => false,
        'version' => false,
        'included_count' => false,
        'excluded_count' => false,
        'last_modified' => false,
        'deleted' => false
    ];
    ...
    protected static $setters = [
        ...
        'version' => 'setVersion',
        'included_count' => 'setIncludedCount',
        'excluded_count' => 'setExcludedCount',
    ...
    protected static $getters = [
        ...
        'version' => 'getVersion',
        'included_count' => 'getIncludedCount',
        'excluded_count' => 'getExcludedCount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('included_count', $data ?? [], null);
        $this->setIfExists('excluded_count', $data ?? [], null);
    ...
    */
     ...
     * @return int|null
     */
    public function getIncludedCount()
    {
        return $this->container['included_count'];
    }

    /**
     * Sets included_count
     *
     * @param int|null $included_count included_count
     *
     * @return self
     */
    public function setIncludedCount($included_count)
    {
        if (is_null($included_count)) {
            throw new \InvalidArgumentException('non-nullable included_count cannot be null');
        }
        $this->container['included_count'] = $included_count;
    ...
    {
        return $this->container['excluded_count'];
    }

    /**
     * Sets excluded_count
     *
     * @param int|null $excluded_count excluded_count
     *
     * @return self
     */
    public function setExcludedCount($excluded_count)
    {
        if (is_null($excluded_count)) {
            throw new \InvalidArgumentException('non-nullable excluded_count cannot be null');
        }
        $this->container['excluded_count'] = $excluded_count;
