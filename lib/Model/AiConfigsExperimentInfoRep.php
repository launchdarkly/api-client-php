...
/**
 * AiConfigsExperimentInfoRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AiConfigsExperimentInfoRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AiConfigsExperimentInfoRep';
    ...
    protected static $openAPITypes = [
        'baseline_idx' => 'int',
        'items' => '\LaunchDarklyApi\Model\AiConfigsLegacyExperimentRep[]'
    ];
    ...
    {
        $this->setIfExists('baseline_idx', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($baseline_idx)) {
            throw new \InvalidArgumentException('non-nullable baseline_idx cannot be null');
        }
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\AiConfigsLegacyExperimentRep[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\AiConfigsLegacyExperimentRep[] $items items
     *
     * @return self
     */
