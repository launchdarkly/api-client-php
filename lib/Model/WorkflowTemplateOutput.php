...
/**
 * WorkflowTemplateOutput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class WorkflowTemplateOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkflowTemplateOutput';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_owner_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_key'] === null) {
            $invalidProperties[] = "'_key' can't be null";
        }
        if ($this->container['_creation_date'] === null) {
            $invalidProperties[] = "'_creation_date' can't be null";
        }
        if ($this->container['_owner_id'] === null) {
            $invalidProperties[] = "'_owner_id' can't be null";
        }
    ...
    {
        return $this->container['_owner_id'];
    }

    /**
     * Sets _owner_id
     *
     * @param string $_owner_id _owner_id
     *
     * @return self
     */
    public function setOwnerId($_owner_id)
    {
        if (is_null($_owner_id)) {
            throw new \InvalidArgumentException('non-nullable _owner_id cannot be null');
        }
        $this->container['_owner_id'] = $_owner_id;
     ...
     * Sets stages
     *
     * @param \LaunchDarklyApi\Model\StageOutput[]|null $stages stages
     *
     * @return self
     */
