...
/**
 * AnnouncementResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class AnnouncementResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnnouncementResponse';
    ...
    protected static $openAPITypes = [
        ...
        'severity' => 'string',
        '_status' => 'string',
        '_access' => '\LaunchDarklyApi\Model\AnnouncementAccessRep',
    ...
    public const _STATUS_ACTIVE = 'active';
    public const _STATUS_INACTIVE = 'inactive';
    public const _STATUS_SCHEDULED = 'scheduled';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('_status', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_dismissible'] === null) {
            $invalidProperties[] = "'is_dismissible' can't be null";
        }
        ...
        if ($this->container['_status'] === null) {
            $invalidProperties[] = "'_status' can't be null";
        }
        $allowedValues = $this->getStatusAllowableValues();
        if (!is_null($this->container['_status']) && !in_array($this->container['_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for '_status', must be one of '%s'",
                $this->container['_status'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets _id
     *
     * @param string $_id The ID of the announcement
     *
     * @return self
     */
     ...
     * Sets is_dismissible
     *
     * @param bool $is_dismissible true if the announcement is dismissible
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string $message The message of the announcement
     *
     * @return self
     */
     ...
     * Sets start_time
     *
     * @param int $start_time The start time of the announcement. This is a Unix timestamp in milliseconds.
     *
     * @return self
     */
     ...
     * Sets end_time
     *
     * @param int|null $end_time The end time of the announcement. This is a Unix timestamp in milliseconds.
     *
     * @return self
     */
     ...
     * Sets severity
     *
     * @param string $severity The severity of the announcement
     *
     * @return self
     */
     ...
     * Sets _status
     *
     * @param string $_status The status of the announcement
     *
     * @return self
     */
    ...
    {
        if (is_null($_status)) {
            throw new \InvalidArgumentException('non-nullable _status cannot be null');
        }
        $allowedValues = $this->getStatusAllowableValues();
        if (!in_array($_status, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for '_status', must be one of '%s'",
                    $_status,
     ...
     * Gets _access
     *
     * @return \LaunchDarklyApi\Model\AnnouncementAccessRep|null
     */
     ...
     * Sets _access
     *
     * @param \LaunchDarklyApi\Model\AnnouncementAccessRep|null $_access _access
     *
     * @return self
     */
     ...
     * Gets _links
     *
     * @return \LaunchDarklyApi\Model\AnnouncementResponseLinks
     */
     ...
     * Sets _links
     *
     * @param \LaunchDarklyApi\Model\AnnouncementResponseLinks $_links _links
     *
     * @return self
     */
