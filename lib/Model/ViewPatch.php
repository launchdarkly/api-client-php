 ...
 */
class ViewPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViewPatch';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Human-readable name for the view
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Optional detailed description of the view
     *
     * @return self
     */
     ...
     *
     * @param bool|null $generate_sdk_keys Whether to generate SDK keys for this view
     *
     * @return self
     */
     ...
     * Sets maintainer_id
     *
     * @param string|null $maintainer_id Member ID of the maintainer for this view. Only one of `maintainerId` or `maintainerTeamKey` can be specified.
     *
     * @return self
     */
     ...
     *
     * @param string|null $maintainer_team_key Key of the maintainer team for this view. Only one of `maintainerId` or `maintainerTeamKey` can be specified.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags associated with this view
     *
     * @return self
     */
     ...
     * Sets archived
     *
     * @param bool|null $archived Whether or not the view is archived
     *
     * @return self
     */
