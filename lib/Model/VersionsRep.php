 ...
 */
class VersionsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VersionsRep';
    ...
    protected static $setters = [
        'valid_versions' => 'setValidVersions',
    ...
    protected static $getters = [
        'valid_versions' => 'getValidVersions',
    ...
    {
        $this->setIfExists('valid_versions', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['valid_versions'] === null) {
            $invalidProperties[] = "'valid_versions' can't be null";
        }
    ...
    {
        return $this->container['valid_versions'];
    }

    /**
     * Sets valid_versions
     *
     * @param int[] $valid_versions A list of all valid API versions. To learn more about our versioning, read [Versioning](https://launchdarkly.com/docs/api#versioning).
     *
     * @return self
     */
    public function setValidVersions($valid_versions)
    {
        if (is_null($valid_versions)) {
            throw new \InvalidArgumentException('non-nullable valid_versions cannot be null');
        }
        $this->container['valid_versions'] = $valid_versions;
     ...
     * Sets latest_version
     *
     * @param int $latest_version latest_version
     *
     * @return self
     */
     ...
     *
     * @param int $current_version current_version
     *
     * @return self
     */
     ...
     * Sets beta
     *
     * @param bool|null $beta Whether the version of the API currently is use is a beta version. This is always <code>true</code> if you add the <code>LD-API-Version: beta</code> header to your request.
     *
     * @return self
     */
