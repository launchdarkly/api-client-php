...
class VersionsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['valid_versions'] = $data['valid_versions'] ?? null;
     ...
     * Sets valid_versions
     *
     * @param int[] $valid_versions A list of all valid API versions. To learn more about our versioning, read [Versioning](https://apidocs.launchdarkly.com/#section/Overview/Versioning).
     *
     * @return self
     */
