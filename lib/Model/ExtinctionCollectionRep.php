...
/**
 * ExtinctionCollectionRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExtinctionCollectionRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtinctionCollectionRep';
    ...
    protected static $openAPITypes = [
        ...
        'items' => 'array<string,\LaunchDarklyApi\Model\Extinction[]>'
    ];
     ...
     * Gets items
     *
     * @return array<string,\LaunchDarklyApi\Model\Extinction[]>
     */
     ...
     * Sets items
     *
     * @param array<string,\LaunchDarklyApi\Model\Extinction[]> $items An array of extinction events
     *
     * @return self
     */
