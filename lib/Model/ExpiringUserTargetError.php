...
/**
 * ExpiringUserTargetError Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExpiringUserTargetError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpiringUserTargetError';
     ...
     *
     * @param int $instruction_index instruction_index
     *
     * @return self
     */
