...
/**
 * ExpandedLinkedResourcesFlags Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExpandedLinkedResourcesFlags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandedLinkedResourcesFlags';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\ExpandedFlag[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\ExpandedFlag[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ExpandedFlag[] $items items
     *
     * @return self
     */
