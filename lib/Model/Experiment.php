...
class Experiment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'draft_iteration' => false,
        'previous_iterations' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('draft_iteration', $data ?? [], null);
        $this->setIfExists('previous_iterations', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets _id
     *
     * @param string|null $_id The experiment ID
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The experiment description
     *
     * @return self
     */
     ...
     * Sets _maintainer_id
     *
     * @param string $_maintainer_id The ID of the member who maintains this experiment.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getHoldoutId()
    {
        return $this->container['holdout_id'];
    }

    /**
     * Sets holdout_id
     *
     * @param string|null $holdout_id The holdout ID
     *
     * @return self
     */
    public function setHoldoutId($holdout_id)
    {
        if (is_null($holdout_id)) {
    ...
    {
        if (is_null($draft_iteration)) {
            throw new \InvalidArgumentException('non-nullable draft_iteration cannot be null');
        }
     ...
     *
     * @param \LaunchDarklyApi\Model\IterationRep[]|null $previous_iterations Details on the previous iterations for this experiment.
     *
     * @return self
     */
    public function setPreviousIterations($previous_iterations)
    {
        if (is_null($previous_iterations)) {
            throw new \InvalidArgumentException('non-nullable previous_iterations cannot be null');
        }
