...
/**
 * RecentTriggerBody Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class RecentTriggerBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecentTriggerBody';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('json_body', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets json_body
     *
     * @param array<string,mixed>|null $json_body The marshalled JSON request body for the incoming trigger webhook. If this is empty or contains invalid JSON, the timestamp is recorded but this field will be empty.
     *
     * @return self
     */
    public function setJsonBody($json_body)
    {
        if (is_null($json_body)) {
            throw new \InvalidArgumentException('non-nullable json_body cannot be null');
        }
