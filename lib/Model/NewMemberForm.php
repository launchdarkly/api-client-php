...
/**
 * NewMemberForm Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class NewMemberForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewMemberForm';
    ...
    public const ROLE_NO_ACCESS = 'no_access';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('team_keys', $data ?? [], null);
    ...
    */
     ...
     * Sets password
     *
     * @param string|null $password The member's password
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string|null $role The member's initial role, if you are using a base role for the initial role
     *
     * @return self
     */
     ...
     * Sets custom_roles
     *
     * @param string[]|null $custom_roles An array of the member's initial roles, if you are using custom roles or preset roles provided by LaunchDarkly
     *
     * @return self
     */
     ...
     * Sets team_keys
     *
     * @param string[]|null $team_keys An array of the member's teams
     *
     * @return self
     */
    public function setTeamKeys($team_keys)
    {
        if (is_null($team_keys)) {
            throw new \InvalidArgumentException('non-nullable team_keys cannot be null');
        }
