...
/**
 * BulkEditTeamsRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class BulkEditTeamsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkEditTeamsRep';
    ...
    */
     ...
     * Sets member_ids
     *
     * @param string[]|null $member_ids A list of member IDs of the members who were added to the teams.
     *
     * @return self
     */
     ...
     * Sets team_keys
     *
     * @param string[]|null $team_keys A list of team keys of the teams that were successfully updated.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param array<string,string>[]|null $errors A list of team keys and errors for the teams whose updates failed.
     *
     * @return self
     */
