...
/**
 * ClientSideAvailabilityPost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ClientSideAvailabilityPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientSideAvailabilityPost';
    ...
    {
        $this->setIfExists('using_environment_id', $data ?? [], null);
        $this->setIfExists('using_mobile_key', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['using_environment_id'] === null) {
            $invalidProperties[] = "'using_environment_id' can't be null";
        }
        if ($this->container['using_mobile_key'] === null) {
            $invalidProperties[] = "'using_mobile_key' can't be null";
        }
     ...
     *
     * @param bool $using_environment_id Whether to enable availability for client-side SDKs. Defaults to <code>false</code>.
     *
     * @return self
     */
    public function setUsingEnvironmentId($using_environment_id)
    {
        if (is_null($using_environment_id)) {
            throw new \InvalidArgumentException('non-nullable using_environment_id cannot be null');
        }
     ...
     *
     * @param bool $using_mobile_key Whether to enable availability for mobile SDKs. Defaults to <code>true</code>.
     *
     * @return self
     */
    public function setUsingMobileKey($using_mobile_key)
    {
        if (is_null($using_mobile_key)) {
            throw new \InvalidArgumentException('non-nullable using_mobile_key cannot be null');
        }
