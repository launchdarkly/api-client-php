...
/**
 * ExperimentTotalsRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ExperimentTotalsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExperimentTotalsRep';
    ...
    protected static $openAPITypes = [
        ...
        'cumulative_impression_count' => 'int',
        'cumulative_conversion_rate' => 'float',
        'cumulative_confidence_interval' => '\LaunchDarklyApi\Model\ConfidenceIntervalRep',
        'p_value' => 'float',
        'improvement' => 'float',
        'min_sample_size' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'cumulative_impression_count' => 'int64',
    ...
    protected static $setters = [
        'cumulative_value' => 'setCumulativeValue',
        'cumulative_count' => 'setCumulativeCount',
        'cumulative_impression_count' => 'setCumulativeImpressionCount',
        'cumulative_conversion_rate' => 'setCumulativeConversionRate',
        'cumulative_confidence_interval' => 'setCumulativeConfidenceInterval',
        'p_value' => 'setPValue',
    ...
    protected static $getters = [
        'cumulative_value' => 'getCumulativeValue',
        'cumulative_count' => 'getCumulativeCount',
        'cumulative_impression_count' => 'getCumulativeImpressionCount',
        'cumulative_conversion_rate' => 'getCumulativeConversionRate',
        'cumulative_confidence_interval' => 'getCumulativeConfidenceInterval',
        'p_value' => 'getPValue',
    ...
    {
        $this->container['cumulative_value'] = $data['cumulative_value'] ?? null;
        $this->container['cumulative_count'] = $data['cumulative_count'] ?? null;
        $this->container['cumulative_impression_count'] = $data['cumulative_impression_count'] ?? null;
        $this->container['cumulative_conversion_rate'] = $data['cumulative_conversion_rate'] ?? null;
        $this->container['cumulative_confidence_interval'] = $data['cumulative_confidence_interval'] ?? null;
        $this->container['p_value'] = $data['p_value'] ?? null;
        $this->container['improvement'] = $data['improvement'] ?? null;
        $this->container['min_sample_size'] = $data['min_sample_size'] ?? null;
    }
    ...
    /**
     * Gets cumulative_value
     *
     * @return float|null
     */
    public function getCumulativeValue()
    {
        return $this->container['cumulative_value'];
    }

    /**
     * Sets cumulative_value
     *
     * @param float|null $cumulative_value cumulative_value
     *
     * @return self
     */
    public function setCumulativeValue($cumulative_value)
    {
        $this->container['cumulative_value'] = $cumulative_value;

        return $this;
    }

    /**
     * Gets cumulative_count
     *
     * @return int|null
     */
    public function getCumulativeCount()
    {
        return $this->container['cumulative_count'];
    }

    /**
     * Sets cumulative_count
     *
     * @param int|null $cumulative_count cumulative_count
     *
     * @return self
     */
    public function setCumulativeCount($cumulative_count)
    {
        $this->container['cumulative_count'] = $cumulative_count;

        return $this;
    }

    /**
     * Gets cumulative_impression_count
     *
     * @return int|null
     */
    public function getCumulativeImpressionCount()
    {
        return $this->container['cumulative_impression_count'];
    }

    /**
     * Sets cumulative_impression_count
     *
     * @param int|null $cumulative_impression_count cumulative_impression_count
     *
     * @return self
     */
    public function setCumulativeImpressionCount($cumulative_impression_count)
    {
        $this->container['cumulative_impression_count'] = $cumulative_impression_count;

        return $this;
    }

    /**
     * Gets cumulative_conversion_rate
     *
     * @return float|null
     */
    public function getCumulativeConversionRate()
    {
        return $this->container['cumulative_conversion_rate'];
    }

    /**
     * Sets cumulative_conversion_rate
     *
     * @param float|null $cumulative_conversion_rate cumulative_conversion_rate
     *
     * @return self
     */
    public function setCumulativeConversionRate($cumulative_conversion_rate)
    {
        $this->container['cumulative_conversion_rate'] = $cumulative_conversion_rate;

        return $this;
    }

    /**
     * Gets cumulative_confidence_interval
     *
     * @return \LaunchDarklyApi\Model\ConfidenceIntervalRep|null
     */
    public function getCumulativeConfidenceInterval()
    {
        return $this->container['cumulative_confidence_interval'];
    }

    /**
     * Sets cumulative_confidence_interval
     *
     * @param \LaunchDarklyApi\Model\ConfidenceIntervalRep|null $cumulative_confidence_interval cumulative_confidence_interval
     *
     * @return self
     */
    public function setCumulativeConfidenceInterval($cumulative_confidence_interval)
    {
        $this->container['cumulative_confidence_interval'] = $cumulative_confidence_interval;
    ...
    {
        return $this->container['improvement'];
    }

    /**
     * Sets improvement
     *
     * @param float|null $improvement improvement
     *
     * @return self
     */
    public function setImprovement($improvement)
    {
        $this->container['improvement'] = $improvement;
