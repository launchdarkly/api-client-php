...
class ContextInstanceSegmentMembership implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets unbounded
     *
     * @param bool $unbounded Whether this is an unbounded/big segment
     *
     * @return self
     */
     ...
     *
     * @param bool $is_rule_targeted Whether the context is captured by this segment's rules. The value of this field is undefined if the context is also explicitly included (isIndividuallyTargeted = true).
     *
     * @return self
     */
