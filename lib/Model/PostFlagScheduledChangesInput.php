...
/**
 * PostFlagScheduledChangesInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class PostFlagScheduledChangesInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostFlagScheduledChangesInput';
     ...
     * Sets comment
     *
     * @param string|null $comment Optional comment describing the scheduled changes
     *
     * @return self
     */
