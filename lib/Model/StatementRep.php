...
/**
 * StatementRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class StatementRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatementRep';
     ...
     * Sets resources
     *
     * @param object[]|null $resources Resource specifier strings
     *
     * @return self
     */
     ...
     * Sets not_resources
     *
     * @param object[]|null $not_resources Targeted resources are the resources NOT in this list. The \"resources\" field must be empty to use this field.
     *
     * @return self
     */
