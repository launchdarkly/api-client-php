...
/**
 * ContextInstanceEvaluationReason Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ContextInstanceEvaluationReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContextInstanceEvaluationReason';
    ...
    protected static $setters = [
        ...
        'rule_id' => 'setRuleId',
        'prerequisite_key' => 'setPrerequisiteKey',
        'in_experiment' => 'setInExperiment',
    ...
    protected static $getters = [
        ...
        'rule_id' => 'getRuleId',
        'prerequisite_key' => 'getPrerequisiteKey',
        'in_experiment' => 'getInExperiment',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('rule_index', $data ?? [], null);
        $this->setIfExists('rule_id', $data ?? [], null);
        $this->setIfExists('prerequisite_key', $data ?? [], null);
        $this->setIfExists('in_experiment', $data ?? [], null);
    ...
    */
     ...
     * Sets kind
     *
     * @param string $kind Describes the general reason that LaunchDarkly selected this variation.
     *
     * @return self
     */
     ...
     * Sets rule_index
     *
     * @param int|null $rule_index The positional index of the matching rule if the kind is 'RULE_MATCH'. The index is 0-based.
     *
     * @return self
     */
    public function setRuleIndex($rule_index)
    {
        if (is_null($rule_index)) {
            throw new \InvalidArgumentException('non-nullable rule_index cannot be null');
        }
     ...
     * Sets rule_id
     *
     * @param string|null $rule_id The unique identifier of the matching rule if the kind is 'RULE_MATCH'.
     *
     * @return self
     */
    ...
    /**
     * Gets prerequisite_key
     *
     * @return string|null
     */
    public function getPrerequisiteKey()
    {
        return $this->container['prerequisite_key'];
    }

    /**
     * Sets prerequisite_key
     *
     * @param string|null $prerequisite_key The key of the flag that failed if the kind is 'PREREQUISITE_FAILED'.
     *
     * @return self
     */
    public function setPrerequisiteKey($prerequisite_key)
    {
        if (is_null($prerequisite_key)) {
            throw new \InvalidArgumentException('non-nullable prerequisite_key cannot be null');
        }
        $this->container['prerequisite_key'] = $prerequisite_key;
     ...
     * @return bool|null
     */
    public function getInExperiment()
    {
        return $this->container['in_experiment'];
    }

    /**
     * Sets in_experiment
     *
     * @param bool|null $in_experiment Indicates whether the context was evaluated as part of an experiment.
     *
     * @return self
     */
    public function setInExperiment($in_experiment)
    {
        if (is_null($in_experiment)) {
            throw new \InvalidArgumentException('non-nullable in_experiment cannot be null');
        }
        $this->container['in_experiment'] = $in_experiment;
     ...
     * Sets error_kind
     *
     * @param string|null $error_kind The specific error type if the kind is 'ERROR'.
     *
     * @return self
     */
