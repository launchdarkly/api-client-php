...
class FeatureFlag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        '_maintainer_team' => '\LaunchDarklyApi\Model\MaintainerTeam',
        'goal_ids' => 'string[]',
        ...
        '_purpose' => 'string',
        'migration_settings' => '\LaunchDarklyApi\Model\FlagMigrationSettingsRep',
        'environments' => 'array<string,\LaunchDarklyApi\Model\FeatureFlagConfig>'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'client_side_availability' => false,
        'variations' => false,
        'temporary' => false,
        'tags' => false,
        '_links' => false,
    ...
    protected static $setters = [
        ...
        '_maintainer_team' => 'setMaintainerTeam',
        'goal_ids' => 'setGoalIds',
        ...
        'deprecated_date' => 'setDeprecatedDate',
    ...
    protected static $getters = [
        ...
        '_maintainer_team' => 'getMaintainerTeam',
        'goal_ids' => 'getGoalIds',
        ...
        'deprecated_date' => 'getDeprecatedDate',
    ...
    public const KIND_MULTIVARIATE = 'multivariate';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('include_in_snippet', $data ?? [], null);
        $this->setIfExists('client_side_availability', $data ?? [], null);
        ...
        $this->setIfExists('maintainer_team_key', $data ?? [], null);
        $this->setIfExists('_maintainer_team', $data ?? [], null);
        ...
        $this->setIfExists('deprecated_date', $data ?? [], null);
        $this->setIfExists('defaults', $data ?? [], null);
        $this->setIfExists('_purpose', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string $name A human-friendly name for the feature flag
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string $kind Kind of feature flag
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the feature flag
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string $key A unique key used to reference the flag in your code
     *
     * @return self
     */
     ...
     * Sets _version
     *
     * @param int $_version Version of the feature flag
     *
     * @return self
     */
     ...
     *
     * @param bool|null $include_in_snippet Deprecated, use <code>clientSideAvailability</code>. Whether this flag should be made available to the client-side JavaScript SDK
     *
     * @return self
     * @deprecated
     */
    ...
    {
        if (is_null($include_in_snippet)) {
            throw new \InvalidArgumentException('non-nullable include_in_snippet cannot be null');
        }
     ...
     *
     * @return \LaunchDarklyApi\Model\ClientSideAvailability|null
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\ClientSideAvailability|null $client_side_availability client_side_availability
     *
     * @return self
     */
    public function setClientSideAvailability($client_side_availability)
    {
        if (is_null($client_side_availability)) {
            throw new \InvalidArgumentException('non-nullable client_side_availability cannot be null');
        }
     ...
     * Sets maintainer_id
     *
     * @param string|null $maintainer_id Associated maintainerId for the feature flag
     *
     * @return self
     */
     ...
     *
     * @param string|null $maintainer_team_key The key of the associated team that maintains this feature flag
     *
     * @return self
     */
    public function setMaintainerTeamKey($maintainer_team_key)
    {
        if (is_null($maintainer_team_key)) {
            throw new \InvalidArgumentException('non-nullable maintainer_team_key cannot be null');
        }
    ...
    /**
     * Gets _maintainer_team
     *
     * @return \LaunchDarklyApi\Model\MaintainerTeam|null
     */
    public function getMaintainerTeam()
    {
        return $this->container['_maintainer_team'];
    }

    /**
     * Sets _maintainer_team
     *
     * @param \LaunchDarklyApi\Model\MaintainerTeam|null $_maintainer_team _maintainer_team
     *
     * @return self
     */
    public function setMaintainerTeam($_maintainer_team)
    {
        if (is_null($_maintainer_team)) {
            throw new \InvalidArgumentException('non-nullable _maintainer_team cannot be null');
        }
        $this->container['_maintainer_team'] = $_maintainer_team;
     ...
     * Sets goal_ids
     *
     * @param string[]|null $goal_ids Deprecated, use <code>experiments</code> instead
     *
     * @return self
     * @deprecated
     */
     ...
     * Gets experiments
     *
     * @return \LaunchDarklyApi\Model\ExperimentInfoRep
     */
     ...
     * Sets experiments
     *
     * @param \LaunchDarklyApi\Model\ExperimentInfoRep $experiments experiments
     *
     * @return self
     */
     ...
     *
     * @return array<string,\LaunchDarklyApi\Model\CustomProperty>
     */
     ...
     *
     * @param array<string,\LaunchDarklyApi\Model\CustomProperty> $custom_properties custom_properties
     *
     * @return self
     */
     ...
     * Sets archived_date
     *
     * @param int|null $archived_date archived_date
     *
     * @return self
     */
     ...
     * Sets deprecated
     *
     * @param bool|null $deprecated Boolean indicating if the feature flag is deprecated
     *
     * @return self
     */
    ...
    /**
     * Gets deprecated_date
     *
     * @return int|null
     */
    public function getDeprecatedDate()
    {
        return $this->container['deprecated_date'];
    }

    /**
     * Sets deprecated_date
     *
     * @param int|null $deprecated_date deprecated_date
     *
     * @return self
     */
    public function setDeprecatedDate($deprecated_date)
    {
        if (is_null($deprecated_date)) {
            throw new \InvalidArgumentException('non-nullable deprecated_date cannot be null');
        }
        $this->container['deprecated_date'] = $deprecated_date;
     ...
     * Gets defaults
     *
     * @return \LaunchDarklyApi\Model\Defaults|null
     */
     ...
     * Sets defaults
     *
     * @param \LaunchDarklyApi\Model\Defaults|null $defaults defaults
     *
     * @return self
     */
    ...
    {
        return $this->container['_purpose'];
    }

    /**
     * Sets _purpose
     *
     * @param string|null $_purpose _purpose
     *
     * @return self
     */
    ...
    {
        if (is_null($_purpose)) {
            throw new \InvalidArgumentException('non-nullable _purpose cannot be null');
        }
        $this->container['_purpose'] = $_purpose;
     ...
     *
     * @return \LaunchDarklyApi\Model\FlagMigrationSettingsRep|null
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\FlagMigrationSettingsRep|null $migration_settings migration_settings
     *
     * @return self
     */
     ...
     * Gets environments
     *
     * @return array<string,\LaunchDarklyApi\Model\FeatureFlagConfig>|null
     */
     ...
     * Sets environments
     *
     * @param array<string,\LaunchDarklyApi\Model\FeatureFlagConfig>|null $environments Details on the environments for this flag. Only returned if the request is filtered by environment, using the <code>filterEnv</code> query parameter.
     *
     * @return self
     */
