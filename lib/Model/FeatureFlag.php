...
class FeatureFlag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['include_in_snippet'] = $data['include_in_snippet'] ?? null;
        $this->container['client_side_availability'] = $data['client_side_availability'] ?? null;
        ...
        $this->container['_maintainer_team'] = $data['_maintainer_team'] ?? null;
        $this->container['goal_ids'] = $data['goal_ids'] ?? null;
        $this->container['experiments'] = $data['experiments'] ?? null;
        $this->container['custom_properties'] = $data['custom_properties'] ?? null;
        $this->container['archived'] = $data['archived'] ?? null;
        $this->container['archived_date'] = $data['archived_date'] ?? null;
        $this->container['deprecated'] = $data['deprecated'] ?? null;
        $this->container['deprecated_date'] = $data['deprecated_date'] ?? null;
        $this->container['defaults'] = $data['defaults'] ?? null;
        $this->container['_purpose'] = $data['_purpose'] ?? null;
