...
class FeatureFlag implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets environments
     *
     * @return array<string,\LaunchDarklyApi\Model\FeatureFlagConfig>
     */
     ...
     * Sets environments
     *
     * @param array<string,\LaunchDarklyApi\Model\FeatureFlagConfig> $environments Details on the environments for this flag. Only returned if the request is filtered by environment, using the <code>filterEnv</code> query parameter.
     *
     * @return self
     */
