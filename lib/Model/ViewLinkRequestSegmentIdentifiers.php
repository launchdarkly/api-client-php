...
/**
 * ViewLinkRequestSegmentIdentifiers Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ViewLinkRequestSegmentIdentifiers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViewLinkRequestSegmentIdentifiers';
    ...
    protected static $openAPITypes = [
        'segment_identifiers' => '\LaunchDarklyApi\Model\ViewLinkRequestSegmentIdentifier[]',
        'comment' => 'string'
    ];
    ...
    protected static $setters = [
        'segment_identifiers' => 'setSegmentIdentifiers',
        'comment' => 'setComment'
    ];
    ...
    protected static $getters = [
        'segment_identifiers' => 'getSegmentIdentifiers',
        'comment' => 'getComment'
    ];
    ...
    {
        $this->setIfExists('segment_identifiers', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['segment_identifiers'] === null) {
            $invalidProperties[] = "'segment_identifiers' can't be null";
        }
    ...
    /**
     * Gets segment_identifiers
     *
     * @return \LaunchDarklyApi\Model\ViewLinkRequestSegmentIdentifier[]
     */
    public function getSegmentIdentifiers()
    {
        return $this->container['segment_identifiers'];
    }

    /**
     * Sets segment_identifiers
     *
     * @param \LaunchDarklyApi\Model\ViewLinkRequestSegmentIdentifier[] $segment_identifiers Identifiers of the segments to link/unlink (environmentId and segmentKey)
     *
     * @return self
     */
    public function setSegmentIdentifiers($segment_identifiers)
    {
        if (is_null($segment_identifiers)) {
            throw new \InvalidArgumentException('non-nullable segment_identifiers cannot be null');
        }
        $this->container['segment_identifiers'] = $segment_identifiers;
     ...
     * Sets comment
     *
     * @param string|null $comment Optional comment for the link/unlink operation
     *
     * @return self
     */
