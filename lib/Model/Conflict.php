 ...
 */
class Conflict implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Conflict';
    ...
    protected static $openAPITypes = [
        'instruction' => 'array<string,mixed>',
        'reason' => 'string'
    ];
     ...
     * Sets instruction
     *
     * @param array<string,mixed>|null $instruction instruction
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason Reason why the conflict exists
     *
     * @return self
     */
