...
/**
 * ExpandedFlag Class Doc Comment
 *
 * @category Class
 ...
 */
class ExpandedFlag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpandedFlag';
    ...
    */
     ...
     * Sets key
     *
     * @param string $key A unique key used to reference the flag
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name A human-friendly name for the flag
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the flag
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int|null $version Version of the flag
     *
     * @return self
     */
     ...
     * Sets archived
     *
     * @param bool|null $archived Whether the flag is archived
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Tags for the flag
     *
     * @return self
     */
     ...
     * Sets temporary
     *
     * @param bool|null $temporary Whether the flag is temporary
     *
     * @return self
     */
     ...
     *
     * @param bool|null $include_in_snippet Whether to include in snippet
     *
     * @return self
     */
