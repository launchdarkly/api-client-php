...
/**
 * ContextInstances Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ContextInstances implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContextInstances';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\LaunchDarklyApi\Model\ContextInstanceRecord[]'
    ];
    ...
    protected static $setters = [
        ...
        '_environment_id' => 'setEnvironmentId',
    ...
    protected static $getters = [
        ...
        '_environment_id' => 'getEnvironmentId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_environment_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_environment_id'] === null) {
            $invalidProperties[] = "'_environment_id' can't be null";
        }
     ...
     * Sets total_count
     *
     * @param int|null $total_count The number of unique context instances
     *
     * @return self
     */
    ...
    /**
     * Gets _environment_id
     *
     * @return string
     */
    public function getEnvironmentId()
    {
        return $this->container['_environment_id'];
    }

    /**
     * Sets _environment_id
     *
     * @param string $_environment_id The environment ID
     *
     * @return self
     */
    public function setEnvironmentId($_environment_id)
    {
        if (is_null($_environment_id)) {
            throw new \InvalidArgumentException('non-nullable _environment_id cannot be null');
        }
        $this->container['_environment_id'] = $_environment_id;
     ...
     *
     * @param string|null $continuation_token An obfuscated string that references the last context instance on the previous page of results. You can use this for pagination, however, we recommend using the <code>next</code> link instead.
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\ContextInstanceRecord[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ContextInstanceRecord[] $items A collection of context instances. Can include multiple versions of context instances that have the same <code>id</code>, but different <code>applicationId</code>s.
     *
     * @return self
     */
