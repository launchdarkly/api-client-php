...
/**
 * ParentResourceRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ParentResourceRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParentResourceRep';
     ...
     * Sets name
     *
     * @param string|null $name The name of the parent resource
     *
     * @return self
     */
     ...
     * Sets resource
     *
     * @param string|null $resource The parent's resource specifier
     *
     * @return self
     */
