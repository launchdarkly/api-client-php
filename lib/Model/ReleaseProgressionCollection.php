...
/**
 * ReleaseProgressionCollection Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleaseProgressionCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleaseProgressionCollection';
    ...
    protected static $openAPITypes = [
        'active_count' => 'int',
        'completed_count' => 'int',
        'items' => '\LaunchDarklyApi\Model\ReleaseProgression[]',
        'phases' => '\LaunchDarklyApi\Model\PhaseInfo[]',
        'total_count' => 'int',
     ...
     * Sets active_count
     *
     * @param int $active_count The number of active releases
     *
     * @return self
     */
     ...
     *
     * @param int $completed_count The number of completed releases
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\ReleaseProgression[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\ReleaseProgression[] $items A list of details for each release, across all flags, for this release pipeline
     *
     * @return self
     */
     ...
     * Gets phases
     *
     * @return \LaunchDarklyApi\Model\PhaseInfo[]
     */
     ...
     * Sets phases
     *
     * @param \LaunchDarklyApi\Model\PhaseInfo[] $phases A list of details for each phase, across all releases, for this release pipeline
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int $total_count The total number of releases for this release pipeline
     *
     * @return self
     */
