...
/**
 * UpsertPayloadRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class UpsertPayloadRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'upsertPayloadRep';
    ...
    protected static $openAPITypes = [
        ...
        'tags' => 'string[]',
        'temporary' => 'bool',
        'boolean_defaults' => '\LaunchDarklyApi\Model\BooleanFlagDefaults',
        'default_client_side_availability' => '\LaunchDarklyApi\Model\DefaultClientSideAvailability'
    ];
    ...
    protected static $setters = [
        ...
        'boolean_defaults' => 'setBooleanDefaults',
    ...
    protected static $getters = [
        ...
        'boolean_defaults' => 'getBooleanDefaults',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('boolean_defaults', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['boolean_defaults'] === null) {
            $invalidProperties[] = "'boolean_defaults' can't be null";
        }
        if ($this->container['default_client_side_availability'] === null) {
            $invalidProperties[] = "'default_client_side_availability' can't be null";
        }
     ...
     * Sets tags
     *
     * @param string[] $tags A list of default tags for each flag
     *
     * @return self
     */
     ...
     * Sets temporary
     *
     * @param bool $temporary Whether the flag should be temporary by default
     *
     * @return self
     */
    ...
    /**
     * Gets boolean_defaults
     *
     * @return \LaunchDarklyApi\Model\BooleanFlagDefaults
     */
    public function getBooleanDefaults()
    {
        return $this->container['boolean_defaults'];
    }

    /**
     * Sets boolean_defaults
     *
     * @param \LaunchDarklyApi\Model\BooleanFlagDefaults $boolean_defaults boolean_defaults
     *
     * @return self
     */
    public function setBooleanDefaults($boolean_defaults)
    {
        if (is_null($boolean_defaults)) {
            throw new \InvalidArgumentException('non-nullable boolean_defaults cannot be null');
        }
        $this->container['boolean_defaults'] = $boolean_defaults;
     ...
     *
     * @return \LaunchDarklyApi\Model\DefaultClientSideAvailability
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\DefaultClientSideAvailability $default_client_side_availability default_client_side_availability
     *
     * @return self
     */
