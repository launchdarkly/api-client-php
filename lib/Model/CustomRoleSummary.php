...
/**
 * CustomRoleSummary Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CustomRoleSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomRoleSummary';
     ...
     * Sets _id
     *
     * @param string $_id The custom role's' ID
     *
     * @return self
     */
