...
/**
 * CreateReleaseInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateReleaseInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateReleaseInput';
    ...
    protected static $setters = [
        'release_variation_id' => 'setReleaseVariationId',
    ...
    protected static $getters = [
        'release_variation_id' => 'getReleaseVariationId',
    ...
    {
        $this->setIfExists('release_variation_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets release_variation_id
     *
     * @return string|null
     */
    public function getReleaseVariationId()
    {
        return $this->container['release_variation_id'];
    }

    /**
     * Sets release_variation_id
     *
     * @param string|null $release_variation_id The variation id to release to across all phases
     *
     * @return self
     */
    public function setReleaseVariationId($release_variation_id)
    {
        if (is_null($release_variation_id)) {
            throw new \InvalidArgumentException('non-nullable release_variation_id cannot be null');
        }
        $this->container['release_variation_id'] = $release_variation_id;
     ...
     *
     * @param string $release_pipeline_key The key of the release pipeline to attach the flag to
     *
     * @return self
     */
