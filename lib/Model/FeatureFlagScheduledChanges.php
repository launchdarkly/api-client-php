...
/**
 * FeatureFlagScheduledChanges Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FeatureFlagScheduledChanges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeatureFlagScheduledChanges';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\FeatureFlagScheduledChange[]',
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\FeatureFlagScheduledChange[] $items Array of scheduled changes
     *
     * @return self
     */
