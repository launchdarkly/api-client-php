...
/**
 * ReleasePolicy Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleasePolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleasePolicy';
    ...
    protected static $openAPITypes = [
        '_access' => '\LaunchDarklyApi\Model\ReleasePoliciesAccessRep',
        '_id' => 'string',
    ...
    protected static array $openAPINullables = [
        ...
        'scope' => false,
        'rank' => false,
        'release_method' => false,
        'guarded_release_config' => false,
        'progressive_release_config' => false,
        'name' => false,
        'key' => false
    ];
    ...
    protected static $setters = [
        ...
        'guarded_release_config' => 'setGuardedReleaseConfig',
        'progressive_release_config' => 'setProgressiveReleaseConfig',
        'name' => 'setName',
        'key' => 'setKey'
    ];
    ...
    protected static $getters = [
        ...
        'guarded_release_config' => 'getGuardedReleaseConfig',
        'progressive_release_config' => 'getProgressiveReleaseConfig',
        'name' => 'getName',
        'key' => 'getKey'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('release_method', $data ?? [], null);
        $this->setIfExists('guarded_release_config', $data ?? [], null);
        $this->setIfExists('progressive_release_config', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['release_method'] === null) {
            $invalidProperties[] = "'release_method' can't be null";
        }
     ...
     * Gets _access
     *
     * @return \LaunchDarklyApi\Model\ReleasePoliciesAccessRep|null
     */
     ...
     * Sets _access
     *
     * @param \LaunchDarklyApi\Model\ReleasePoliciesAccessRep|null $_access _access
     *
     * @return self
     */
     ...
     * Sets _id
     *
     * @param string $_id The unique identifier of the release policy
     *
     * @return self
     */
     ...
     * Gets scope
     *
     * @return \LaunchDarklyApi\Model\ReleasePolicyScope|null
     */
     ...
     * Sets scope
     *
     * @param \LaunchDarklyApi\Model\ReleasePolicyScope|null $scope scope
     *
     * @return self
     */
     ...
     * Sets rank
     *
     * @param int $rank The rank/priority of the release policy
     *
     * @return self
     */
     ...
     * Gets release_method
     *
     * @return \LaunchDarklyApi\Model\ReleaseMethod
     */
     ...
     * Sets release_method
     *
     * @param \LaunchDarklyApi\Model\ReleaseMethod $release_method release_method
     *
     * @return self
     */
    public function setReleaseMethod($release_method)
    {
        if (is_null($release_method)) {
            throw new \InvalidArgumentException('non-nullable release_method cannot be null');
        }
    ...
    /**
     * Gets guarded_release_config
     *
     * @return \LaunchDarklyApi\Model\GuardedReleaseConfig|null
     */
    public function getGuardedReleaseConfig()
    {
        return $this->container['guarded_release_config'];
    }

    /**
     * Sets guarded_release_config
     *
     * @param \LaunchDarklyApi\Model\GuardedReleaseConfig|null $guarded_release_config guarded_release_config
     *
     * @return self
     */
    public function setGuardedReleaseConfig($guarded_release_config)
    {
        if (is_null($guarded_release_config)) {
            throw new \InvalidArgumentException('non-nullable guarded_release_config cannot be null');
        }
        $this->container['guarded_release_config'] = $guarded_release_config;
    ...
    {
        return $this->container['progressive_release_config'];
    }
     ...
     * @return self
     */
    public function setProgressiveReleaseConfig($progressive_release_config)
    {
        if (is_null($progressive_release_config)) {
            throw new \InvalidArgumentException('non-nullable progressive_release_config cannot be null');
        }
        $this->container['progressive_release_config'] = $progressive_release_config;
     ...
     * Sets name
     *
     * @param string $name The name of the release policy
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ReleasePolicy., must be smaller than or equal to 256.');
        }
     ...
     * Sets key
     *
     * @param string $key The human-readable key of the release policy
     *
     * @return self
     */
