...
/**
 * ReleasePoliciesAccessDenied Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class ReleasePoliciesAccessDenied implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleasePoliciesAccessDenied';
    ...
    protected static $openAPITypes = [
        'action' => 'string',
        'reason' => '\LaunchDarklyApi\Model\ReleasePoliciesAccessDeniedReason'
    ];
    ...
    */
     ...
     * Gets reason
     *
     * @return \LaunchDarklyApi\Model\ReleasePoliciesAccessDeniedReason
     */
     ...
     * Sets reason
     *
     * @param \LaunchDarklyApi\Model\ReleasePoliciesAccessDeniedReason $reason reason
     *
     * @return self
     */
