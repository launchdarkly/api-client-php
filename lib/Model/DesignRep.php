 ...
 */
class DesignRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DesignRep';
     ...
     *
     * @param bool|null $can_reshuffle_traffic Whether the experiment can reassign traffic to different variations when you increase or decrease the traffic in your experiment audience (true) or keep all traffic assigned to its initial variation (false).
     *
     * @return self
     */
     ...
     *
     * @param \LaunchDarklyApi\Model\MetricV2Rep[]|null $secondary_metrics Details on the secondary metrics for this experiment
     *
     * @return self
     */
