...
class VariationSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'rules' => 'setRules',
        'null_rules' => 'setNullRules',
        'targets' => 'setTargets',
        'context_targets' => 'setContextTargets',
        'is_fallthrough' => 'setIsFallthrough',
        'is_off' => 'setIsOff',
        'rollout' => 'setRollout',
    ...
    protected static $getters = [
        'rules' => 'getRules',
        'null_rules' => 'getNullRules',
        'targets' => 'getTargets',
        'context_targets' => 'getContextTargets',
        'is_fallthrough' => 'getIsFallthrough',
        'is_off' => 'getIsOff',
        'rollout' => 'getRollout',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('null_rules', $data ?? [], null);
        $this->setIfExists('targets', $data ?? [], null);
        $this->setIfExists('context_targets', $data ?? [], null);
        $this->setIfExists('is_fallthrough', $data ?? [], null);
        $this->setIfExists('is_off', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['null_rules'] === null) {
            $invalidProperties[] = "'null_rules' can't be null";
        }
     ...
     * @return int
     */
    public function getNullRules()
    {
        return $this->container['null_rules'];
    }

    /**
     * Sets null_rules
     *
     * @param int $null_rules null_rules
     *
     * @return self
     */
    public function setNullRules($null_rules)
    {
        if (is_null($null_rules)) {
            throw new \InvalidArgumentException('non-nullable null_rules cannot be null');
        }
        $this->container['null_rules'] = $null_rules;
     ...
     *
     * @param int $context_targets context_targets
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getIsFallthrough()
    {
        return $this->container['is_fallthrough'];
    }

    /**
     * Sets is_fallthrough
     *
     * @param bool|null $is_fallthrough is_fallthrough
     *
     * @return self
     */
    public function setIsFallthrough($is_fallthrough)
    {
        if (is_null($is_fallthrough)) {
            throw new \InvalidArgumentException('non-nullable is_fallthrough cannot be null');
        }
        $this->container['is_fallthrough'] = $is_fallthrough;
    ...
    {
        return $this->container['is_off'];
    }

    /**
     * Sets is_off
     *
     * @param bool|null $is_off is_off
     *
     * @return self
     */
    public function setIsOff($is_off)
    {
        if (is_null($is_off)) {
            throw new \InvalidArgumentException('non-nullable is_off cannot be null');
        }
        $this->container['is_off'] = $is_off;
     ...
     * Sets rollout
     *
     * @param int|null $rollout rollout
     *
     * @return self
     */
