...
/**
 * SubjectDataRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class SubjectDataRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubjectDataRep';
     ...
     * Sets name
     *
     * @param string|null $name The subject's name
     *
     * @return self
     */
     ...
     * Sets avatar_url
     *
     * @param string|null $avatar_url The subject's avatar
     *
     * @return self
     */
