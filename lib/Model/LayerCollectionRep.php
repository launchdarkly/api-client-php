...
/**
 * LayerCollectionRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class LayerCollectionRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LayerCollectionRep';
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarklyApi\Model\LayerRep[]',
        'total_count' => 'int',
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\LayerRep[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\LayerRep[] $items The layers in the project
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int $total_count The total number of layers in the project
     *
     * @return self
     */
