...
/**
 * CreateReleasePipelineInput Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateReleasePipelineInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateReleasePipelineInput';
    ...
    protected static $openAPITypes = [
        ...
        'key' => 'string',
        'name' => 'string',
        'phases' => '\LaunchDarklyApi\Model\CreatePhaseInput[]',
        'tags' => 'string[]',
    ...
    */
     ...
     * Sets key
     *
     * @param string $key The unique identifier of this release pipeline
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The name of the release pipeline
     *
     * @return self
     */
     ...
     * Gets phases
     *
     * @return \LaunchDarklyApi\Model\CreatePhaseInput[]
     */
     ...
     * Sets phases
     *
     * @param \LaunchDarklyApi\Model\CreatePhaseInput[] $phases A logical grouping of one or more environments that share attributes for rolling out changes
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags A list of tags for this release pipeline
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_project_default Whether or not the newly created pipeline should be set as the default pipeline for this project
     *
     * @return self
     */
     ...
     * Sets is_legacy
     *
     * @param bool|null $is_legacy Whether or not the pipeline is enabled for Release Automation.
     *
     * @return self
     */
