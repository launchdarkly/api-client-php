...
/**
 * LastSeenMetadata Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class LastSeenMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LastSeenMetadata';
     ...
     * Sets token_id
     *
     * @param string|null $token_id The ID of the token used in the member's last session
     *
     * @return self
     */
