...
/**
 * DependentFlagEnvironment Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class DependentFlagEnvironment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DependentFlagEnvironment';
     ...
     * Sets name
     *
     * @param string|null $name The environment name
     *
     * @return self
     */
