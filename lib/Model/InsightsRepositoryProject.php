...
/**
 * InsightsRepositoryProject Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class InsightsRepositoryProject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsightsRepositoryProject';
    ...
    protected static $setters = [
        'repository_key' => 'setRepositoryKey',
    ...
    protected static $getters = [
        'repository_key' => 'getRepositoryKey',
    ...
    {
        $this->setIfExists('repository_key', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['repository_key'] === null) {
            $invalidProperties[] = "'repository_key' can't be null";
        }
    ...
    {
        return $this->container['repository_key'];
    }

    /**
     * Sets repository_key
     *
     * @param string $repository_key The repository key
     *
     * @return self
     */
    public function setRepositoryKey($repository_key)
    {
        if (is_null($repository_key)) {
            throw new \InvalidArgumentException('non-nullable repository_key cannot be null');
        }
        $this->container['repository_key'] = $repository_key;
