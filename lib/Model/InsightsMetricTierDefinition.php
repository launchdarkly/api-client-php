...
/**
 * InsightsMetricTierDefinition Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class InsightsMetricTierDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsightsMetricTierDefinition';
     ...
     * Sets description
     *
     * @param string $description Metric indicator description
     *
     * @return self
     */
