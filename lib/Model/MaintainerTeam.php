...
/**
 * MaintainerTeam Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class MaintainerTeam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaintainerTeam';
     ...
     * Sets key
     *
     * @param string|null $key The key of the maintainer team
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name A human-friendly name for the maintainer team
     *
     * @return self
     */
