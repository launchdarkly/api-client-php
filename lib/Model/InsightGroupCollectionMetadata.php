...
/**
 * InsightGroupCollectionMetadata Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class InsightGroupCollectionMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsightGroupCollectionMetadata';
    ...
    protected static $openAPITypes = [
        'count_by_indicator' => '\LaunchDarklyApi\Model\InsightGroupsCountByIndicator'
    ];
    ...
    protected static $setters = [
        'count_by_indicator' => 'setCountByIndicator'
    ];
    ...
    protected static $getters = [
        'count_by_indicator' => 'getCountByIndicator'
    ];
    ...
    {
        $this->setIfExists('count_by_indicator', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['count_by_indicator'] === null) {
            $invalidProperties[] = "'count_by_indicator' can't be null";
        }
    ...
    /**
     * Gets count_by_indicator
     *
     * @return \LaunchDarklyApi\Model\InsightGroupsCountByIndicator
     */
    public function getCountByIndicator()
    {
        return $this->container['count_by_indicator'];
    }

    /**
     * Sets count_by_indicator
     *
     * @param \LaunchDarklyApi\Model\InsightGroupsCountByIndicator $count_by_indicator count_by_indicator
     *
     * @return self
     */
    public function setCountByIndicator($count_by_indicator)
    {
        if (is_null($count_by_indicator)) {
            throw new \InvalidArgumentException('non-nullable count_by_indicator cannot be null');
        }
        $this->container['count_by_indicator'] = $count_by_indicator;
