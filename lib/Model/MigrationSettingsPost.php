...
/**
 * MigrationSettingsPost Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class MigrationSettingsPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MigrationSettingsPost';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('stage_count', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['stage_count'] === null) {
            $invalidProperties[] = "'stage_count' can't be null";
        }
     ...
     * Sets context_kind
     *
     * @param string|null $context_kind Context kind for a migration with 6 stages, where data is being moved
     *
     * @return self
     */
     ...
     * Sets stage_count
     *
     * @param int $stage_count stage_count
     *
     * @return self
     */
    public function setStageCount($stage_count)
    {
        if (is_null($stage_count)) {
            throw new \InvalidArgumentException('non-nullable stage_count cannot be null');
        }
