...
class RuleClause implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const OP_LESS_THAN = 'lessThan';
    public const OP_LESS_THAN_OR_EQUAL = 'lessThanOrEqual';
    public const OP_GREATER_THAN = 'greaterThan';
    public const OP_GREATER_THAN_OR_EQUAL = 'greaterThanOrEqual';
    public const OP_BEFORE = 'before';
    public const OP_AFTER = 'after';
    public const OP_SEGMENT_MATCH = 'segmentMatch';
    public const OP_SEM_VER_EQUAL = 'semVerEqual';
    public const OP_SEM_VER_LESS_THAN = 'semVerLessThan';
    public const OP_SEM_VER_GREATER_THAN = 'semVerGreaterThan';
    ...
    public function getOpAllowableValues()
    {
        return [
            ...
            self::OP_BEFORE,
            self::OP_AFTER,
            self::OP_SEGMENT_MATCH,
            self::OP_SEM_VER_EQUAL,
            self::OP_SEM_VER_LESS_THAN,
            self::OP_SEM_VER_GREATER_THAN,
        ];
    }
     ...
     * Sets attribute
     *
     * @param string|null $attribute The attribute the rule applies to, for example, last name or email address
     *
     * @return self
     */
     ...
     * Sets op
     *
     * @param string|null $op The operator to apply to the given attribute
     *
     * @return self
     */
     ...
     * Sets negate
     *
     * @param bool|null $negate Whether the operator should be negated
     *
     * @return self
     */
