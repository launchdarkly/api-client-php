...
/**
 * FeatureFlagStatusAcrossEnvironments Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FeatureFlagStatusAcrossEnvironments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeatureFlagStatusAcrossEnvironments';
    ...
    protected static $openAPITypes = [
        'environments' => 'array<string,\LaunchDarklyApi\Model\FeatureFlagStatus>',
        'key' => 'string',
     ...
     * Gets environments
     *
     * @return array<string,\LaunchDarklyApi\Model\FeatureFlagStatus>|null
     */
     ...
     * Sets environments
     *
     * @param array<string,\LaunchDarklyApi\Model\FeatureFlagStatus>|null $environments Flag status for environment.
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string|null $key feature flag key
     *
     * @return self
     */
