...
class FeatureFlagStatusAcrossEnvironments implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets environments
     *
     * @return array<string,\LaunchDarklyApi\Model\FeatureFlagStatus>
     */
     ...
     * Sets environments
     *
     * @param array<string,\LaunchDarklyApi\Model\FeatureFlagStatus> $environments Flag status for environment.
     *
     * @return self
     */
