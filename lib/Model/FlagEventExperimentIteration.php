...
/**
 * FlagEventExperimentIteration Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class FlagEventExperimentIteration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlagEventExperimentIteration';
     ...
     * Sets id
     *
     * @param string $id The experiment iteration ID
     *
     * @return self
     */
