...
/**
 * Integrations Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class Integrations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Integrations';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\LaunchDarklyApi\Model\Integration[]',
        'key' => 'string'
    ];
     ...
     * Gets items
     *
     * @return \LaunchDarklyApi\Model\Integration[]|null
     */
     ...
     * Sets items
     *
     * @param \LaunchDarklyApi\Model\Integration[]|null $items items
     *
     * @return self
     */
