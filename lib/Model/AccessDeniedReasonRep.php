...
/**
 * AccessDeniedReasonRep Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
 ...
 */
class AccessDeniedReasonRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccessDeniedReasonRep';
     ...
     * Sets not_resources
     *
     * @param object[]|null $not_resources not_resources
     *
     * @return self
     */
     ...
     * Sets not_actions
     *
     * @param string[]|null $not_actions not_actions
     *
     * @return self
     */
