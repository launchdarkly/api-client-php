...
class ExperimentsBetaApi
{
     ...
     */
    public function getExperiment($proj_key, $flag_key, $env_key, $metric_key, $from = null, $to = null)
    {
        list($response) = $this->getExperimentWithHttpInfo($proj_key, $flag_key, $env_key, $metric_key, $from, $to);
        return $response;
    }
     ...
     */
    public function getExperimentWithHttpInfo($proj_key, $flag_key, $env_key, $metric_key, $from = null, $to = null)
    {
        $request = $this->getExperimentRequest($proj_key, $flag_key, $env_key, $metric_key, $from, $to);
     ...
     */
    public function getExperimentAsync($proj_key, $flag_key, $env_key, $metric_key, $from = null, $to = null)
    {
        return $this->getExperimentAsyncWithHttpInfo($proj_key, $flag_key, $env_key, $metric_key, $from, $to)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentAsyncWithHttpInfo($proj_key, $flag_key, $env_key, $metric_key, $from = null, $to = null)
    {
        $returnType = '\LaunchDarklyApi\Model\ExperimentResultsRep';
        $request = $this->getExperimentRequest($proj_key, $flag_key, $env_key, $metric_key, $from, $to);
    ...
    public function getExperimentRequest($proj_key, $flag_key, $env_key, $metric_key, $from = null, $to = null)
    {
        ...
        $resourcePath = '/api/v2/flags/{projKey}/{flagKey}/experiments/{envKey}/{metricKey}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $proj_key The project key (required)
     * @param  string $flag_key The feature flag&#39;s key (required)
     * @param  string $env_key The environment key (required)
     ...
     * @return void
     */
    public function resetExperiment($proj_key, $flag_key, $env_key, $metric_key)
    {
        $this->resetExperimentWithHttpInfo($proj_key, $flag_key, $env_key, $metric_key);
    }
     ...
     */
    public function resetExperimentWithHttpInfo($proj_key, $flag_key, $env_key, $metric_key)
    {
        $request = $this->resetExperimentRequest($proj_key, $flag_key, $env_key, $metric_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetExperimentAsync($proj_key, $flag_key, $env_key, $metric_key)
    {
        return $this->resetExperimentAsyncWithHttpInfo($proj_key, $flag_key, $env_key, $metric_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetExperimentAsyncWithHttpInfo($proj_key, $flag_key, $env_key, $metric_key)
    {
        $returnType = '';
        $request = $this->resetExperimentRequest($proj_key, $flag_key, $env_key, $metric_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resetExperimentRequest($proj_key, $flag_key, $env_key, $metric_key)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling resetExperiment'
            );
        }
        // verify the required parameter 'flag_key' is set
        if ($flag_key === null || (is_array($flag_key) && count($flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $flag_key when calling resetExperiment'
            );
        }
        // verify the required parameter 'env_key' is set
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling resetExperiment'
            );
        }
        // verify the required parameter 'metric_key' is set
        if ($metric_key === null || (is_array($metric_key) && count($metric_key) === 0)) {
        ...
        $resourcePath = '/api/v2/flags/{projKey}/{flagKey}/experiments/{envKey}/{metricKey}/results';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
