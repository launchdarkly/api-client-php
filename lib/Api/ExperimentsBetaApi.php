...
class ExperimentsBetaApi
{
     ...
     */
    public function getExperimentResults($project_key, $environment_key, $experiment_key, $metric_key, $iteration_id = null)
    {
        list($response) = $this->getExperimentResultsWithHttpInfo($project_key, $environment_key, $experiment_key, $metric_key, $iteration_id);
        return $response;
    }
     ...
     */
    public function getExperimentResultsWithHttpInfo($project_key, $environment_key, $experiment_key, $metric_key, $iteration_id = null)
    {
        $request = $this->getExperimentResultsRequest($project_key, $environment_key, $experiment_key, $metric_key, $iteration_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentResultsAsync($project_key, $environment_key, $experiment_key, $metric_key, $iteration_id = null)
    {
        return $this->getExperimentResultsAsyncWithHttpInfo($project_key, $environment_key, $experiment_key, $metric_key, $iteration_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentResultsAsyncWithHttpInfo($project_key, $environment_key, $experiment_key, $metric_key, $iteration_id = null)
    {
        $returnType = '\LaunchDarklyApi\Model\ExperimentBayesianResultsRep';
        $request = $this->getExperimentResultsRequest($project_key, $environment_key, $experiment_key, $metric_key, $iteration_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExperimentResultsRequest($project_key, $environment_key, $experiment_key, $metric_key, $iteration_id = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
