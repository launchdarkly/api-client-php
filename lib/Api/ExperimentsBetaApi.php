...
class ExperimentsBetaApi
{
     ...
     */
    public function getExperiments($project_key, $environment_key, $limit = null, $offset = null, $filter = null, $expand = null)
    {
        list($response) = $this->getExperimentsWithHttpInfo($project_key, $environment_key, $limit, $offset, $filter, $expand);
        return $response;
    }
     ...
     */
    public function getExperimentsWithHttpInfo($project_key, $environment_key, $limit = null, $offset = null, $filter = null, $expand = null)
    {
        $request = $this->getExperimentsRequest($project_key, $environment_key, $limit, $offset, $filter, $expand);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentsAsync($project_key, $environment_key, $limit = null, $offset = null, $filter = null, $expand = null)
    {
        return $this->getExperimentsAsyncWithHttpInfo($project_key, $environment_key, $limit, $offset, $filter, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentsAsyncWithHttpInfo($project_key, $environment_key, $limit = null, $offset = null, $filter = null, $expand = null)
    {
        $returnType = '\LaunchDarklyApi\Model\ExperimentCollectionRep';
        $request = $this->getExperimentsRequest($project_key, $environment_key, $limit, $offset, $filter, $expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExperimentsRequest($project_key, $environment_key, $limit = null, $offset = null, $filter = null, $expand = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
