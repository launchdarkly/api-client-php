...
class ExperimentsBetaApi
{
     ...
     * @return \LaunchDarklyApi\Model\ExperimentResultsRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function getExperiment($project_key, $feature_flag_key, $environment_key, $metric_key, $from = null, $to = null)
    {
        list($response) = $this->getExperimentWithHttpInfo($project_key, $feature_flag_key, $environment_key, $metric_key, $from, $to);
        return $response;
    }
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\ExperimentResultsRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExperimentWithHttpInfo($project_key, $feature_flag_key, $environment_key, $metric_key, $from = null, $to = null)
    {
        $request = $this->getExperimentRequest($project_key, $feature_flag_key, $environment_key, $metric_key, $from, $to);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\ExperimentResultsRep' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\ExperimentResultsRep', []),
            ...
            $returnType = '\LaunchDarklyApi\Model\ExperimentResultsRep';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\ExperimentResultsRep',
     ...
     */
    public function getExperimentAsync($project_key, $feature_flag_key, $environment_key, $metric_key, $from = null, $to = null)
    {
        return $this->getExperimentAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $metric_key, $from, $to)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $metric_key, $from = null, $to = null)
    {
        $returnType = '\LaunchDarklyApi\Model\ExperimentResultsRep';
        $request = $this->getExperimentRequest($project_key, $feature_flag_key, $environment_key, $metric_key, $from, $to);
     ...
     */
    public function getExperimentRequest($project_key, $feature_flag_key, $environment_key, $metric_key, $from = null, $to = null)
    {
        ...
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling getExperiment'
            );
        }
        ...
        if ($metric_key === null || (is_array($metric_key) && count($metric_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $metric_key when calling getExperiment'
            );
        }
