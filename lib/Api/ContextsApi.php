...
class ContextsApi
{
     ...
     */
    public function getContextAttributeNames($project_key, $environment_key, $filter = null, $limit = null)
    {
        list($response) = $this->getContextAttributeNamesWithHttpInfo($project_key, $environment_key, $filter, $limit);
        return $response;
    }
     ...
     */
    public function getContextAttributeNamesWithHttpInfo($project_key, $environment_key, $filter = null, $limit = null)
    {
        $request = $this->getContextAttributeNamesRequest($project_key, $environment_key, $filter, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContextAttributeNamesAsync($project_key, $environment_key, $filter = null, $limit = null)
    {
        return $this->getContextAttributeNamesAsyncWithHttpInfo($project_key, $environment_key, $filter, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContextAttributeNamesAsyncWithHttpInfo($project_key, $environment_key, $filter = null, $limit = null)
    {
        $returnType = '\LaunchDarklyApi\Model\ContextAttributeNamesCollection';
        $request = $this->getContextAttributeNamesRequest($project_key, $environment_key, $filter, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContextAttributeNamesRequest($project_key, $environment_key, $filter = null, $limit = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getContextAttributeValues($project_key, $environment_key, $attribute_name, $filter = null, $limit = null)
    {
        list($response) = $this->getContextAttributeValuesWithHttpInfo($project_key, $environment_key, $attribute_name, $filter, $limit);
        return $response;
    }
     ...
     */
    public function getContextAttributeValuesWithHttpInfo($project_key, $environment_key, $attribute_name, $filter = null, $limit = null)
    {
        $request = $this->getContextAttributeValuesRequest($project_key, $environment_key, $attribute_name, $filter, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContextAttributeValuesAsync($project_key, $environment_key, $attribute_name, $filter = null, $limit = null)
    {
        return $this->getContextAttributeValuesAsyncWithHttpInfo($project_key, $environment_key, $attribute_name, $filter, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContextAttributeValuesAsyncWithHttpInfo($project_key, $environment_key, $attribute_name, $filter = null, $limit = null)
    {
        $returnType = '\LaunchDarklyApi\Model\ContextAttributeValuesCollection';
        $request = $this->getContextAttributeValuesRequest($project_key, $environment_key, $attribute_name, $filter, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContextAttributeValuesRequest($project_key, $environment_key, $attribute_name, $filter = null, $limit = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
