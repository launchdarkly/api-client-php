...
class ContextSettingsApi
{
    ...
    /**
     * Operation putContextFlagSetting
     *
     ...
     * @param  string $context_kind The context kind (required)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['putContextFlagSetting'] to see the possible values for this operation
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function putContextFlagSetting($project_key, $environment_key, $context_kind, $context_key, $feature_flag_key, $value_put, string $contentType = self::contentTypes['putContextFlagSetting'][0])
    {
        $this->putContextFlagSettingWithHttpInfo($project_key, $environment_key, $context_kind, $context_key, $feature_flag_key, $value_put, $contentType);
    }

    /**
     * Operation putContextFlagSettingWithHttpInfo
     *
     * Update flag settings for context
     *
     * @param  string $project_key The project key (required)
     ...
     */
    public function putContextFlagSettingWithHttpInfo($project_key, $environment_key, $context_kind, $context_key, $feature_flag_key, $value_put, string $contentType = self::contentTypes['putContextFlagSetting'][0])
    {
        $request = $this->putContextFlagSettingRequest($project_key, $environment_key, $context_kind, $context_key, $feature_flag_key, $value_put, $contentType);
    ...
    /**
     * Operation putContextFlagSettingAsync
     *
     * Update flag settings for context
     *
     * @param  string $project_key The project key (required)
     ...
     */
    public function putContextFlagSettingAsync($project_key, $environment_key, $context_kind, $context_key, $feature_flag_key, $value_put, string $contentType = self::contentTypes['putContextFlagSetting'][0])
    {
        return $this->putContextFlagSettingAsyncWithHttpInfo($project_key, $environment_key, $context_kind, $context_key, $feature_flag_key, $value_put, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putContextFlagSettingAsyncWithHttpInfo
     *
     * Update flag settings for context
     *
     * @param  string $project_key The project key (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putContextFlagSettingAsyncWithHttpInfo($project_key, $environment_key, $context_kind, $context_key, $feature_flag_key, $value_put, string $contentType = self::contentTypes['putContextFlagSetting'][0])
    {
        $returnType = '';
        $request = $this->putContextFlagSettingRequest($project_key, $environment_key, $context_kind, $context_key, $feature_flag_key, $value_put, $contentType);
    ...
    /**
     * Create request for operation 'putContextFlagSetting'
     *
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  string $context_kind The context kind (required)
     ...
     */
    public function putContextFlagSettingRequest($project_key, $environment_key, $context_kind, $context_key, $feature_flag_key, $value_put, string $contentType = self::contentTypes['putContextFlagSetting'][0])
    {

        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling putContextFlagSetting'
            );
        }
        ...
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling putContextFlagSetting'
            );
        }

        // verify the required parameter 'context_kind' is set
        if ($context_kind === null || (is_array($context_kind) && count($context_kind) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $context_kind when calling putContextFlagSetting'
            );
        }
        ...
        if ($context_key === null || (is_array($context_key) && count($context_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $context_key when calling putContextFlagSetting'
            );
        }
        ...
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling putContextFlagSetting'
            );
        }
        ...
        if ($value_put === null || (is_array($value_put) && count($value_put) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $value_put when calling putContextFlagSetting'
            );
        }


        $resourcePath = '/api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/{contextKind}/{contextKey}/flags/{featureFlagKey}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($context_kind !== null) {
            $resourcePath = str_replace(
                '{' . 'contextKind' . '}',
                ObjectSerializer::toPathValue($context_kind),
                $resourcePath
            );
        }
        // path params
