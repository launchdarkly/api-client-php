...
class AccountUsageBetaApi
{
     ...
     * @return \LaunchDarklyApi\Model\SeriesListRep
     */
    public function getEvaluationsUsage($proj_key, $env_key, $flag_key, $from = null, $to = null, $tz = null)
    {
        list($response) = $this->getEvaluationsUsageWithHttpInfo($proj_key, $env_key, $flag_key, $from, $to, $tz);
        return $response;
    }
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\SeriesListRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEvaluationsUsageWithHttpInfo($proj_key, $env_key, $flag_key, $from = null, $to = null, $tz = null)
    {
        $request = $this->getEvaluationsUsageRequest($proj_key, $env_key, $flag_key, $from, $to, $tz);
     ...
     */
    public function getEvaluationsUsageAsync($proj_key, $env_key, $flag_key, $from = null, $to = null, $tz = null)
    {
        return $this->getEvaluationsUsageAsyncWithHttpInfo($proj_key, $env_key, $flag_key, $from, $to, $tz)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEvaluationsUsageAsyncWithHttpInfo($proj_key, $env_key, $flag_key, $from = null, $to = null, $tz = null)
    {
        $returnType = '\LaunchDarklyApi\Model\SeriesListRep';
        $request = $this->getEvaluationsUsageRequest($proj_key, $env_key, $flag_key, $from, $to, $tz);
     ...
     */
    public function getEvaluationsUsageRequest($proj_key, $env_key, $flag_key, $from = null, $to = null, $tz = null)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling getEvaluationsUsage'
            );
        }
        // verify the required parameter 'env_key' is set
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling getEvaluationsUsage'
            );
        }
        // verify the required parameter 'flag_key' is set
        if ($flag_key === null || (is_array($flag_key) && count($flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $flag_key when calling getEvaluationsUsage'
            );
        }

        $resourcePath = '/api/v2/usage/evaluations/{projKey}/{envKey}/{flagKey}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\SdkListRep
     */
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\SdkListRep, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\SdkVersionListRep
     */
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\SdkVersionListRep, HTTP status code, HTTP response headers (array of strings)
     */
