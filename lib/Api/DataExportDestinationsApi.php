...
class DataExportDestinationsApi
{
     ...
     * @return void
     */
    public function deleteDestination($proj_key, $env_key, $id)
    {
        $this->deleteDestinationWithHttpInfo($proj_key, $env_key, $id);
    }
     ...
     */
    public function deleteDestinationWithHttpInfo($proj_key, $env_key, $id)
    {
        $request = $this->deleteDestinationRequest($proj_key, $env_key, $id);
     ...
     */
    public function deleteDestinationAsync($proj_key, $env_key, $id)
    {
        return $this->deleteDestinationAsyncWithHttpInfo($proj_key, $env_key, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDestinationAsyncWithHttpInfo($proj_key, $env_key, $id)
    {
        $returnType = '';
        $request = $this->deleteDestinationRequest($proj_key, $env_key, $id);
     ...
     */
    public function deleteDestinationRequest($proj_key, $env_key, $id)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling deleteDestination'
            );
        }
        // verify the required parameter 'env_key' is set
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling deleteDestination'
            );
        }
        ...
        $resourcePath = '/api/v2/destinations/{projKey}/{envKey}/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getDestination($proj_key, $env_key, $id)
    {
        list($response) = $this->getDestinationWithHttpInfo($proj_key, $env_key, $id);
        return $response;
    }
     ...
     */
    public function getDestinationWithHttpInfo($proj_key, $env_key, $id)
    {
        $request = $this->getDestinationRequest($proj_key, $env_key, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDestinationAsync($proj_key, $env_key, $id)
    {
        return $this->getDestinationAsyncWithHttpInfo($proj_key, $env_key, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDestinationAsyncWithHttpInfo($proj_key, $env_key, $id)
    {
        $returnType = '\LaunchDarklyApi\Model\Destination';
        $request = $this->getDestinationRequest($proj_key, $env_key, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDestinationRequest($proj_key, $env_key, $id)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling getDestination'
            );
        }
        // verify the required parameter 'env_key' is set
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling getDestination'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
     ...
     * @return \LaunchDarklyApi\Model\Destination
     */
    public function patchDestination($proj_key, $env_key, $id, $patch_operation)
    {
        list($response) = $this->patchDestinationWithHttpInfo($proj_key, $env_key, $id, $patch_operation);
        return $response;
    }
     ...
     * @return array of \LaunchDarklyApi\Model\Destination, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchDestinationWithHttpInfo($proj_key, $env_key, $id, $patch_operation)
    {
        $request = $this->patchDestinationRequest($proj_key, $env_key, $id, $patch_operation);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchDestinationAsync($proj_key, $env_key, $id, $patch_operation)
    {
        return $this->patchDestinationAsyncWithHttpInfo($proj_key, $env_key, $id, $patch_operation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchDestinationAsyncWithHttpInfo($proj_key, $env_key, $id, $patch_operation)
    {
        $returnType = '\LaunchDarklyApi\Model\Destination';
        $request = $this->patchDestinationRequest($proj_key, $env_key, $id, $patch_operation);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchDestinationRequest($proj_key, $env_key, $id, $patch_operation)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling patchDestination'
            );
        }
        // verify the required parameter 'env_key' is set
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling patchDestination'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
     ...
     * @return \LaunchDarklyApi\Model\Destination
     */
    public function postDestination($proj_key, $env_key, $destination_post)
    {
        list($response) = $this->postDestinationWithHttpInfo($proj_key, $env_key, $destination_post);
        return $response;
    }
     ...
     * @return array of \LaunchDarklyApi\Model\Destination, HTTP status code, HTTP response headers (array of strings)
     */
    public function postDestinationWithHttpInfo($proj_key, $env_key, $destination_post)
    {
        $request = $this->postDestinationRequest($proj_key, $env_key, $destination_post);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postDestinationAsync($proj_key, $env_key, $destination_post)
    {
        return $this->postDestinationAsyncWithHttpInfo($proj_key, $env_key, $destination_post)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postDestinationAsyncWithHttpInfo($proj_key, $env_key, $destination_post)
    {
        $returnType = '\LaunchDarklyApi\Model\Destination';
        $request = $this->postDestinationRequest($proj_key, $env_key, $destination_post);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postDestinationRequest($proj_key, $env_key, $destination_post)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling postDestination'
            );
        }
        // verify the required parameter 'env_key' is set
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling postDestination'
            );
        }
        ...
        $resourcePath = '/api/v2/destinations/{projKey}/{envKey}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
