...
class InsightsFlagEventsBetaApi
{
     ...
     * @param  string $query Filter events by flag key (optional)
     * @param  string $impact_size Filter events by impact size. A small impact created a less than 20% change in the proportion of end users receiving one or more flag variations. A medium impact created between a 20%-80% change. A large impact created a more than 80% change. Options: &#x60;none&#x60;, &#x60;small&#x60;, &#x60;medium&#x60;, &#x60;large&#x60; (optional)
     ...
     * @param  string $expand Expand properties in response. Options: &#x60;experiments&#x60; (optional)
    ...
    public function getFlagEventsWithHttpInfo($project_key, $environment_key, $application_key = null, $query = null, $impact_size = null, $has_experiments = null, $global = null, $expand = null, $limit = null, $from = null, $to = null, $after = null, $before = null, string $contentType = self::contentTypes['getFlagEvents'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\FlagEventCollectionRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\FlagEventCollectionRep' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\FlagEventCollectionRep', []),
