...
class InsightsDeploymentsBetaApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDeploymentEvent'] to see the possible values for this operation
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function createDeploymentEvent($post_deployment_event_input, string $contentType = self::contentTypes['createDeploymentEvent'][0])
    {
        $this->createDeploymentEventWithHttpInfo($post_deployment_event_input, $contentType);
    }
     ...
     */
    public function createDeploymentEventWithHttpInfo($post_deployment_event_input, string $contentType = self::contentTypes['createDeploymentEvent'][0])
    {
        $request = $this->createDeploymentEventRequest($post_deployment_event_input, $contentType);
     ...
     */
    public function createDeploymentEventAsync($post_deployment_event_input, string $contentType = self::contentTypes['createDeploymentEvent'][0])
    {
        return $this->createDeploymentEventAsyncWithHttpInfo($post_deployment_event_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createDeploymentEventAsyncWithHttpInfo($post_deployment_event_input, string $contentType = self::contentTypes['createDeploymentEvent'][0])
    {
        $returnType = '';
        $request = $this->createDeploymentEventRequest($post_deployment_event_input, $contentType);
     ...
     */
    public function createDeploymentEventRequest($post_deployment_event_input, string $contentType = self::contentTypes['createDeploymentEvent'][0])
    {
        ...
        if (isset($post_deployment_event_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($post_deployment_event_input));
            } else {
     ...
     * @param  string|null $expand Expand properties in response. Options: &#x60;pullRequests&#x60;, &#x60;flagReferences&#x60; (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDeployment'] to see the possible values for this operation
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function getDeployment($deployment_id, $expand = null, string $contentType = self::contentTypes['getDeployment'][0])
    {
        list($response) = $this->getDeploymentWithHttpInfo($deployment_id, $expand, $contentType);
        return $response;
    }
     ...
     */
    public function getDeploymentWithHttpInfo($deployment_id, $expand = null, string $contentType = self::contentTypes['getDeployment'][0])
    {
        $request = $this->getDeploymentRequest($deployment_id, $expand, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDeploymentAsync($deployment_id, $expand = null, string $contentType = self::contentTypes['getDeployment'][0])
    {
        return $this->getDeploymentAsyncWithHttpInfo($deployment_id, $expand, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDeploymentAsyncWithHttpInfo($deployment_id, $expand = null, string $contentType = self::contentTypes['getDeployment'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDeploymentRequest($deployment_id, $expand = null, string $contentType = self::contentTypes['getDeployment'][0])
    {
     ...
     * @param  int|null $limit The number of deployments to return. Default is 20. Maximum allowed is 100. (optional)
     * @param  string|null $expand Expand properties in response. Options: &#x60;pullRequests&#x60;, &#x60;flagReferences&#x60; (optional)
     ...
     * @param  string|null $after Identifier used for pagination (optional)
     * @param  string|null $before Identifier used for pagination (optional)
     * @param  string|null $kind The deployment kind (optional)
     * @param  string|null $status The deployment status (optional)
     ...
     */
    public function getDeployments($project_key, $environment_key, $application_key = null, $limit = null, $expand = null, $from = null, $to = null, $after = null, $before = null, $kind = null, $status = null, string $contentType = self::contentTypes['getDeployments'][0])
    {
        list($response) = $this->getDeploymentsWithHttpInfo($project_key, $environment_key, $application_key, $limit, $expand, $from, $to, $after, $before, $kind, $status, $contentType);
        return $response;
    }
     ...
     */
    public function getDeploymentsWithHttpInfo($project_key, $environment_key, $application_key = null, $limit = null, $expand = null, $from = null, $to = null, $after = null, $before = null, $kind = null, $status = null, string $contentType = self::contentTypes['getDeployments'][0])
    {
        $request = $this->getDeploymentsRequest($project_key, $environment_key, $application_key, $limit, $expand, $from, $to, $after, $before, $kind, $status, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDeploymentsAsync($project_key, $environment_key, $application_key = null, $limit = null, $expand = null, $from = null, $to = null, $after = null, $before = null, $kind = null, $status = null, string $contentType = self::contentTypes['getDeployments'][0])
    {
        return $this->getDeploymentsAsyncWithHttpInfo($project_key, $environment_key, $application_key, $limit, $expand, $from, $to, $after, $before, $kind, $status, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDeploymentsAsyncWithHttpInfo($project_key, $environment_key, $application_key = null, $limit = null, $expand = null, $from = null, $to = null, $after = null, $before = null, $kind = null, $status = null, string $contentType = self::contentTypes['getDeployments'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDeploymentsRequest($project_key, $environment_key, $application_key = null, $limit = null, $expand = null, $from = null, $to = null, $after = null, $before = null, $kind = null, $status = null, string $contentType = self::contentTypes['getDeployments'][0])
    {
     ...
     * @return \LaunchDarklyApi\Model\DeploymentRep|\LaunchDarklyApi\Model\ValidationFailedErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function updateDeployment($deployment_id, $patch_operation, string $contentType = self::contentTypes['updateDeployment'][0])
    {
        list($response) = $this->updateDeploymentWithHttpInfo($deployment_id, $patch_operation, $contentType);
        return $response;
    }
     ...
     * @return array of \LaunchDarklyApi\Model\DeploymentRep|\LaunchDarklyApi\Model\ValidationFailedErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateDeploymentWithHttpInfo($deployment_id, $patch_operation, string $contentType = self::contentTypes['updateDeployment'][0])
    {
        $request = $this->updateDeploymentRequest($deployment_id, $patch_operation, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDeploymentAsync($deployment_id, $patch_operation, string $contentType = self::contentTypes['updateDeployment'][0])
    {
        return $this->updateDeploymentAsyncWithHttpInfo($deployment_id, $patch_operation, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDeploymentAsyncWithHttpInfo($deployment_id, $patch_operation, string $contentType = self::contentTypes['updateDeployment'][0])
    {
        $returnType = '\LaunchDarklyApi\Model\DeploymentRep';
        $request = $this->updateDeploymentRequest($deployment_id, $patch_operation, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateDeploymentRequest($deployment_id, $patch_operation, string $contentType = self::contentTypes['updateDeployment'][0])
    {
