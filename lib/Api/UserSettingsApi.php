...
class UserSettingsApi
{
     ...
     */
    public function getExpiringFlagsForUser($proj_key, $user_key, $env_key)
    {
        list($response) = $this->getExpiringFlagsForUserWithHttpInfo($proj_key, $user_key, $env_key);
        return $response;
    }
     ...
     */
    public function getExpiringFlagsForUserWithHttpInfo($proj_key, $user_key, $env_key)
    {
        $request = $this->getExpiringFlagsForUserRequest($proj_key, $user_key, $env_key);
     ...
     */
    public function getExpiringFlagsForUserAsync($proj_key, $user_key, $env_key)
    {
        return $this->getExpiringFlagsForUserAsyncWithHttpInfo($proj_key, $user_key, $env_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiringFlagsForUserAsyncWithHttpInfo($proj_key, $user_key, $env_key)
    {
        $returnType = '\LaunchDarklyApi\Model\ExpiringUserTargetGetResponse';
        $request = $this->getExpiringFlagsForUserRequest($proj_key, $user_key, $env_key);
     ...
     */
    public function getExpiringFlagsForUserRequest($proj_key, $user_key, $env_key)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling getExpiringFlagsForUser'
            );
        }
        ...
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling getExpiringFlagsForUser'
            );
        }

        $resourcePath = '/api/v2/users/{projKey}/{userKey}/expiring-user-targets/{envKey}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $proj_key The project key (required)
     * @param  string $env_key The environment key (required)
     * @param  string $key The user key (required)
     * @param  string $feature_key The feature flag key (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getUserFlagSetting($proj_key, $env_key, $key, $feature_key)
    {
        list($response) = $this->getUserFlagSettingWithHttpInfo($proj_key, $env_key, $key, $feature_key);
        return $response;
    }
     ...
     */
    public function getUserFlagSettingWithHttpInfo($proj_key, $env_key, $key, $feature_key)
    {
        $request = $this->getUserFlagSettingRequest($proj_key, $env_key, $key, $feature_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserFlagSettingAsync($proj_key, $env_key, $key, $feature_key)
    {
        return $this->getUserFlagSettingAsyncWithHttpInfo($proj_key, $env_key, $key, $feature_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserFlagSettingAsyncWithHttpInfo($proj_key, $env_key, $key, $feature_key)
    {
        $returnType = '\LaunchDarklyApi\Model\UserFlagSetting';
        $request = $this->getUserFlagSettingRequest($proj_key, $env_key, $key, $feature_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUserFlagSettingRequest($proj_key, $env_key, $key, $feature_key)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling getUserFlagSetting'
            );
        }
        // verify the required parameter 'env_key' is set
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling getUserFlagSetting'
            );
        }
        // verify the required parameter 'key' is set
        if ($key === null || (is_array($key) && count($key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $key when calling getUserFlagSetting'
            );
        }
        // verify the required parameter 'feature_key' is set
        if ($feature_key === null || (is_array($feature_key) && count($feature_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_key when calling getUserFlagSetting'
            );
        }

        $resourcePath = '/api/v2/users/{projKey}/{envKey}/{key}/flags/{featureKey}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getUserFlagSettings($proj_key, $env_key, $key)
    {
        list($response) = $this->getUserFlagSettingsWithHttpInfo($proj_key, $env_key, $key);
        return $response;
    }
     ...
     */
    public function getUserFlagSettingsWithHttpInfo($proj_key, $env_key, $key)
    {
        $request = $this->getUserFlagSettingsRequest($proj_key, $env_key, $key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserFlagSettingsAsync($proj_key, $env_key, $key)
    {
        return $this->getUserFlagSettingsAsyncWithHttpInfo($proj_key, $env_key, $key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserFlagSettingsAsyncWithHttpInfo($proj_key, $env_key, $key)
    {
        $returnType = '\LaunchDarklyApi\Model\UserFlagSettings';
        $request = $this->getUserFlagSettingsRequest($proj_key, $env_key, $key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUserFlagSettingsRequest($proj_key, $env_key, $key)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling getUserFlagSettings'
            );
        }
        // verify the required parameter 'env_key' is set
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling getUserFlagSettings'
            );
        }
        // verify the required parameter 'key' is set
        if ($key === null || (is_array($key) && count($key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $key when calling getUserFlagSettings'
            );
        }

        $resourcePath = '/api/v2/users/{projKey}/{envKey}/{key}/flags';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function patchExpiringFlagsForUser($proj_key, $user_key, $env_key, $patch_with_comment)
    {
        list($response) = $this->patchExpiringFlagsForUserWithHttpInfo($proj_key, $user_key, $env_key, $patch_with_comment);
        return $response;
    }
     ...
     */
    public function patchExpiringFlagsForUserWithHttpInfo($proj_key, $user_key, $env_key, $patch_with_comment)
    {
        $request = $this->patchExpiringFlagsForUserRequest($proj_key, $user_key, $env_key, $patch_with_comment);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringFlagsForUserAsync($proj_key, $user_key, $env_key, $patch_with_comment)
    {
        return $this->patchExpiringFlagsForUserAsyncWithHttpInfo($proj_key, $user_key, $env_key, $patch_with_comment)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringFlagsForUserAsyncWithHttpInfo($proj_key, $user_key, $env_key, $patch_with_comment)
    {
        $returnType = '\LaunchDarklyApi\Model\ExpiringUserTargetPatchResponse';
        $request = $this->patchExpiringFlagsForUserRequest($proj_key, $user_key, $env_key, $patch_with_comment);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchExpiringFlagsForUserRequest($proj_key, $user_key, $env_key, $patch_with_comment)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling patchExpiringFlagsForUser'
            );
        }
        // verify the required parameter 'user_key' is set
        if ($user_key === null || (is_array($user_key) && count($user_key) === 0)) {
        ...
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling patchExpiringFlagsForUser'
            );
        }
     ...
     * @return void
     */
    public function putFlagSetting($proj_key, $env_key, $key, $feature_key, $value_put)
    {
        $this->putFlagSettingWithHttpInfo($proj_key, $env_key, $key, $feature_key, $value_put);
    }
     ...
     */
    public function putFlagSettingWithHttpInfo($proj_key, $env_key, $key, $feature_key, $value_put)
    {
        $request = $this->putFlagSettingRequest($proj_key, $env_key, $key, $feature_key, $value_put);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putFlagSettingAsync($proj_key, $env_key, $key, $feature_key, $value_put)
    {
        return $this->putFlagSettingAsyncWithHttpInfo($proj_key, $env_key, $key, $feature_key, $value_put)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putFlagSettingAsyncWithHttpInfo($proj_key, $env_key, $key, $feature_key, $value_put)
    {
        $returnType = '';
        $request = $this->putFlagSettingRequest($proj_key, $env_key, $key, $feature_key, $value_put);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putFlagSettingRequest($proj_key, $env_key, $key, $feature_key, $value_put)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling putFlagSetting'
            );
        }
        // verify the required parameter 'env_key' is set
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling putFlagSetting'
            );
        }
        // verify the required parameter 'key' is set
        if ($key === null || (is_array($key) && count($key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $key when calling putFlagSetting'
            );
        }
        // verify the required parameter 'feature_key' is set
        if ($feature_key === null || (is_array($feature_key) && count($feature_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_key when calling putFlagSetting'
            );
        }
