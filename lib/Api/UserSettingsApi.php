...
class UserSettingsApi
{
     ...
     */
    public function patchExpiringFlagsForUser($project_key, $user_key, $environment_key, $patch_with_comment)
    {
        list($response) = $this->patchExpiringFlagsForUserWithHttpInfo($project_key, $user_key, $environment_key, $patch_with_comment);
        return $response;
    }
     ...
     */
    public function patchExpiringFlagsForUserWithHttpInfo($project_key, $user_key, $environment_key, $patch_with_comment)
    {
        $request = $this->patchExpiringFlagsForUserRequest($project_key, $user_key, $environment_key, $patch_with_comment);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringFlagsForUserAsync($project_key, $user_key, $environment_key, $patch_with_comment)
    {
        return $this->patchExpiringFlagsForUserAsyncWithHttpInfo($project_key, $user_key, $environment_key, $patch_with_comment)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringFlagsForUserAsyncWithHttpInfo($project_key, $user_key, $environment_key, $patch_with_comment)
    {
        $returnType = '\LaunchDarklyApi\Model\ExpiringUserTargetPatchResponse';
        $request = $this->patchExpiringFlagsForUserRequest($project_key, $user_key, $environment_key, $patch_with_comment);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchExpiringFlagsForUserRequest($project_key, $user_key, $environment_key, $patch_with_comment)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($patch_with_comment === null || (is_array($patch_with_comment) && count($patch_with_comment) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $patch_with_comment when calling patchExpiringFlagsForUser'
            );
        }
