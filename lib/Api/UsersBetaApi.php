...
/**
 * UsersBetaApi Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
...
class UsersBetaApi
{
    ...
    /**
     * Operation getUserAttributeNames
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getUserAttributeNames'] to see the possible values for this operation
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\UserAttributeNamesRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep
     * @deprecated
     */
    public function getUserAttributeNames($project_key, $environment_key, string $contentType = self::contentTypes['getUserAttributeNames'][0])
    {
        list($response) = $this->getUserAttributeNamesWithHttpInfo($project_key, $environment_key, $contentType);
        return $response;
    }

    /**
     * Operation getUserAttributeNamesWithHttpInfo
     *
     * Get user attribute names
     *
     * @param  string $project_key The project key (required)
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\UserAttributeNamesRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getUserAttributeNamesWithHttpInfo($project_key, $environment_key, string $contentType = self::contentTypes['getUserAttributeNames'][0])
    {
        $request = $this->getUserAttributeNamesRequest($project_key, $environment_key, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\UserAttributeNamesRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\UserAttributeNamesRep' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\UserAttributeNamesRep', []),
            ...
            $returnType = '\LaunchDarklyApi\Model\UserAttributeNamesRep';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\UserAttributeNamesRep',
    ...
    /**
     * Operation getUserAttributeNamesAsync
     *
     * Get user attribute names
     *
     * @param  string $project_key The project key (required)
     ...
     * @deprecated
     */
    public function getUserAttributeNamesAsync($project_key, $environment_key, string $contentType = self::contentTypes['getUserAttributeNames'][0])
    {
        return $this->getUserAttributeNamesAsyncWithHttpInfo($project_key, $environment_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getUserAttributeNamesAsyncWithHttpInfo
     *
     * Get user attribute names
     *
     * @param  string $project_key The project key (required)
     ...
     * @deprecated
     */
    public function getUserAttributeNamesAsyncWithHttpInfo($project_key, $environment_key, string $contentType = self::contentTypes['getUserAttributeNames'][0])
    {
        $returnType = '\LaunchDarklyApi\Model\UserAttributeNamesRep';
        $request = $this->getUserAttributeNamesRequest($project_key, $environment_key, $contentType);
    ...
    /**
     * Create request for operation 'getUserAttributeNames'
     *
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getUserAttributeNames'] to see the possible values for this operation
     ...
     * @deprecated
     */
    public function getUserAttributeNamesRequest($project_key, $environment_key, string $contentType = self::contentTypes['getUserAttributeNames'][0])
    {

        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling getUserAttributeNames'
            );
        }
        ...
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling getUserAttributeNames'
            );
        }


        $resourcePath = '/api/v2/user-attributes/{projectKey}/{environmentKey}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
