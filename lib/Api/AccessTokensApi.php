...
class AccessTokensApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTokensRequest($show_all = null)
    {
        ...
        // query params
        if ($show_all !== null) {
            if('form' === 'form' && is_array($show_all)) {
                foreach($show_all as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['showAll'] = $show_all;
            }
        }
