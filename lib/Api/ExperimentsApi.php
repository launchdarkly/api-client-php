...
class ExperimentsApi
{
     ...
     */
    public function createExperiment($project_key, $environment_key, $experiment_post, string $contentType = self::contentTypes['createExperiment'][0])
    {
        list($response) = $this->createExperimentWithHttpInfo($project_key, $environment_key, $experiment_post, $contentType);
        return $response;
    }
     ...
     */
    public function createExperimentWithHttpInfo($project_key, $environment_key, $experiment_post, string $contentType = self::contentTypes['createExperiment'][0])
    {
        $request = $this->createExperimentRequest($project_key, $environment_key, $experiment_post, $contentType);
     ...
     */
    public function createExperimentAsync($project_key, $environment_key, $experiment_post, string $contentType = self::contentTypes['createExperiment'][0])
    {
        return $this->createExperimentAsyncWithHttpInfo($project_key, $environment_key, $experiment_post, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createExperimentAsyncWithHttpInfo($project_key, $environment_key, $experiment_post, string $contentType = self::contentTypes['createExperiment'][0])
    {
     ...
     */
    public function createExperimentRequest($project_key, $environment_key, $experiment_post, string $contentType = self::contentTypes['createExperiment'][0])
    {
        ...
        if (isset($experiment_post)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($experiment_post));
            } else {
     ...
     */
    public function createIteration($project_key, $environment_key, $experiment_key, $iteration_input, string $contentType = self::contentTypes['createIteration'][0])
    {
        list($response) = $this->createIterationWithHttpInfo($project_key, $environment_key, $experiment_key, $iteration_input, $contentType);
        return $response;
    }
     ...
     */
    public function createIterationWithHttpInfo($project_key, $environment_key, $experiment_key, $iteration_input, string $contentType = self::contentTypes['createIteration'][0])
    {
        $request = $this->createIterationRequest($project_key, $environment_key, $experiment_key, $iteration_input, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createIterationAsync($project_key, $environment_key, $experiment_key, $iteration_input, string $contentType = self::contentTypes['createIteration'][0])
    {
        return $this->createIterationAsyncWithHttpInfo($project_key, $environment_key, $experiment_key, $iteration_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createIterationAsyncWithHttpInfo($project_key, $environment_key, $experiment_key, $iteration_input, string $contentType = self::contentTypes['createIteration'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createIterationRequest($project_key, $environment_key, $experiment_key, $iteration_input, string $contentType = self::contentTypes['createIteration'][0])
    {
        ...
        if (isset($iteration_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($iteration_input));
            } else {
     ...
     */
    public function getExperiment($project_key, $environment_key, $experiment_key, $expand = null, string $contentType = self::contentTypes['getExperiment'][0])
    {
        list($response) = $this->getExperimentWithHttpInfo($project_key, $environment_key, $experiment_key, $expand, $contentType);
        return $response;
    }
     ...
     */
    public function getExperimentWithHttpInfo($project_key, $environment_key, $experiment_key, $expand = null, string $contentType = self::contentTypes['getExperiment'][0])
    {
        $request = $this->getExperimentRequest($project_key, $environment_key, $experiment_key, $expand, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentAsync($project_key, $environment_key, $experiment_key, $expand = null, string $contentType = self::contentTypes['getExperiment'][0])
    {
        return $this->getExperimentAsyncWithHttpInfo($project_key, $environment_key, $experiment_key, $expand, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentAsyncWithHttpInfo($project_key, $environment_key, $experiment_key, $expand = null, string $contentType = self::contentTypes['getExperiment'][0])
    {
        $returnType = '\LaunchDarklyApi\Model\Experiment';
        $request = $this->getExperimentRequest($project_key, $environment_key, $experiment_key, $expand, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExperimentRequest($project_key, $environment_key, $experiment_key, $expand = null, string $contentType = self::contentTypes['getExperiment'][0])
    {
     ...
     *
     * @param  string $project_key The project key (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getExperimentationSettings'] to see the possible values for this operation
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\RandomizationSettingsRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\MethodNotAllowedErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function getExperimentationSettings($project_key, string $contentType = self::contentTypes['getExperimentationSettings'][0])
    {
        list($response) = $this->getExperimentationSettingsWithHttpInfo($project_key, $contentType);
        return $response;
    }
     ...
     */
    public function getExperimentationSettingsWithHttpInfo($project_key, string $contentType = self::contentTypes['getExperimentationSettings'][0])
    {
        $request = $this->getExperimentationSettingsRequest($project_key, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentationSettingsAsync($project_key, string $contentType = self::contentTypes['getExperimentationSettings'][0])
    {
        return $this->getExperimentationSettingsAsyncWithHttpInfo($project_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentationSettingsAsyncWithHttpInfo($project_key, string $contentType = self::contentTypes['getExperimentationSettings'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExperimentationSettingsRequest($project_key, string $contentType = self::contentTypes['getExperimentationSettings'][0])
    {
     ...
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  int|null $limit The maximum number of experiments to return. Defaults to 20. (optional)
     ...
     * @param  string|null $expand A comma-separated list of properties that can reveal additional information in the response. Supported fields are explained above. (optional)
     * @param  string|null $lifecycle_state A comma-separated list of experiment archived states. Supports &#x60;archived&#x60;, &#x60;active&#x60;, or both. Defaults to &#x60;active&#x60; experiments. (optional)
     ...
     */
    public function getExperiments($project_key, $environment_key, $limit = null, $offset = null, $filter = null, $expand = null, $lifecycle_state = null, string $contentType = self::contentTypes['getExperiments'][0])
    {
        list($response) = $this->getExperimentsWithHttpInfo($project_key, $environment_key, $limit, $offset, $filter, $expand, $lifecycle_state, $contentType);
        return $response;
    }
     ...
     */
    public function getExperimentsWithHttpInfo($project_key, $environment_key, $limit = null, $offset = null, $filter = null, $expand = null, $lifecycle_state = null, string $contentType = self::contentTypes['getExperiments'][0])
    {
        $request = $this->getExperimentsRequest($project_key, $environment_key, $limit, $offset, $filter, $expand, $lifecycle_state, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentsAsync($project_key, $environment_key, $limit = null, $offset = null, $filter = null, $expand = null, $lifecycle_state = null, string $contentType = self::contentTypes['getExperiments'][0])
    {
        return $this->getExperimentsAsyncWithHttpInfo($project_key, $environment_key, $limit, $offset, $filter, $expand, $lifecycle_state, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentsAsyncWithHttpInfo($project_key, $environment_key, $limit = null, $offset = null, $filter = null, $expand = null, $lifecycle_state = null, string $contentType = self::contentTypes['getExperiments'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExperimentsRequest($project_key, $environment_key, $limit = null, $offset = null, $filter = null, $expand = null, $lifecycle_state = null, string $contentType = self::contentTypes['getExperiments'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchExperiment'] to see the possible values for this operation
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function patchExperiment($project_key, $environment_key, $experiment_key, $experiment_patch_input, string $contentType = self::contentTypes['patchExperiment'][0])
    {
        list($response) = $this->patchExperimentWithHttpInfo($project_key, $environment_key, $experiment_key, $experiment_patch_input, $contentType);
        return $response;
    }
     ...
     */
    public function patchExperimentWithHttpInfo($project_key, $environment_key, $experiment_key, $experiment_patch_input, string $contentType = self::contentTypes['patchExperiment'][0])
    {
        $request = $this->patchExperimentRequest($project_key, $environment_key, $experiment_key, $experiment_patch_input, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExperimentAsync($project_key, $environment_key, $experiment_key, $experiment_patch_input, string $contentType = self::contentTypes['patchExperiment'][0])
    {
        return $this->patchExperimentAsyncWithHttpInfo($project_key, $environment_key, $experiment_key, $experiment_patch_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExperimentAsyncWithHttpInfo($project_key, $environment_key, $experiment_key, $experiment_patch_input, string $contentType = self::contentTypes['patchExperiment'][0])
    {
        $returnType = '\LaunchDarklyApi\Model\Experiment';
        $request = $this->patchExperimentRequest($project_key, $environment_key, $experiment_key, $experiment_patch_input, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchExperimentRequest($project_key, $environment_key, $experiment_key, $experiment_patch_input, string $contentType = self::contentTypes['patchExperiment'][0])
    {
        ...
        if (isset($experiment_patch_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($experiment_patch_input));
            } else {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['putExperimentationSettings'] to see the possible values for this operation
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\RandomizationSettingsRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\MethodNotAllowedErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function putExperimentationSettings($project_key, $randomization_settings_put, string $contentType = self::contentTypes['putExperimentationSettings'][0])
    {
        list($response) = $this->putExperimentationSettingsWithHttpInfo($project_key, $randomization_settings_put, $contentType);
        return $response;
    }
     ...
     * @return array of \LaunchDarklyApi\Model\RandomizationSettingsRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\MethodNotAllowedErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function putExperimentationSettingsWithHttpInfo($project_key, $randomization_settings_put, string $contentType = self::contentTypes['putExperimentationSettings'][0])
    {
        $request = $this->putExperimentationSettingsRequest($project_key, $randomization_settings_put, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putExperimentationSettingsAsync($project_key, $randomization_settings_put, string $contentType = self::contentTypes['putExperimentationSettings'][0])
    {
        return $this->putExperimentationSettingsAsyncWithHttpInfo($project_key, $randomization_settings_put, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putExperimentationSettingsAsyncWithHttpInfo($project_key, $randomization_settings_put, string $contentType = self::contentTypes['putExperimentationSettings'][0])
    {
        $returnType = '\LaunchDarklyApi\Model\RandomizationSettingsRep';
        $request = $this->putExperimentationSettingsRequest($project_key, $randomization_settings_put, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putExperimentationSettingsRequest($project_key, $randomization_settings_put, string $contentType = self::contentTypes['putExperimentationSettings'][0])
    {
        ...
        if (isset($randomization_settings_put)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($randomization_settings_put));
            } else {
