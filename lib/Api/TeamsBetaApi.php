...
class TeamsBetaApi
{
    ...
    /**
     * Operation patchTeams
     *
     * Update teams
     *
     * @param  \LaunchDarklyApi\Model\TeamsPatchInput $teams_patch_input teams_patch_input (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchTeams'] to see the possible values for this operation
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\BulkEditTeamsRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\StatusConflictErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function patchTeams($teams_patch_input, string $contentType = self::contentTypes['patchTeams'][0])
    {
        list($response) = $this->patchTeamsWithHttpInfo($teams_patch_input, $contentType);
        return $response;
    }

    /**
     * Operation patchTeamsWithHttpInfo
     *
     * Update teams
     *
     * @param  \LaunchDarklyApi\Model\TeamsPatchInput $teams_patch_input (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchTeams'] to see the possible values for this operation
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\BulkEditTeamsRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\StatusConflictErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchTeamsWithHttpInfo($teams_patch_input, string $contentType = self::contentTypes['patchTeams'][0])
    {
        $request = $this->patchTeamsRequest($teams_patch_input, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\BulkEditTeamsRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\BulkEditTeamsRep' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\BulkEditTeamsRep', []),
            ...
            $returnType = '\LaunchDarklyApi\Model\BulkEditTeamsRep';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\BulkEditTeamsRep',
     ...
     */
    public function patchTeamsAsync($teams_patch_input, string $contentType = self::contentTypes['patchTeams'][0])
    {
        return $this->patchTeamsAsyncWithHttpInfo($teams_patch_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation patchTeamsAsyncWithHttpInfo
     *
     * Update teams
     *
     * @param  \LaunchDarklyApi\Model\TeamsPatchInput $teams_patch_input (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchTeamsAsyncWithHttpInfo($teams_patch_input, string $contentType = self::contentTypes['patchTeams'][0])
    {
        $returnType = '\LaunchDarklyApi\Model\BulkEditTeamsRep';
        $request = $this->patchTeamsRequest($teams_patch_input, $contentType);
    ...
    /**
     * Create request for operation 'patchTeams'
     *
     * @param  \LaunchDarklyApi\Model\TeamsPatchInput $teams_patch_input (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchTeams'] to see the possible values for this operation
     *
     ...
     */
    public function patchTeamsRequest($teams_patch_input, string $contentType = self::contentTypes['patchTeams'][0])
    {

        // verify the required parameter 'teams_patch_input' is set
        if ($teams_patch_input === null || (is_array($teams_patch_input) && count($teams_patch_input) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $teams_patch_input when calling patchTeams'
            );
        }
        ...
        // for model (json/xml)
        if (isset($teams_patch_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($teams_patch_input));
            } else {
                $httpBody = $teams_patch_input;
            }
