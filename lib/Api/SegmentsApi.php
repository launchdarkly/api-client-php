...
class SegmentsApi
{
    ...
    /**
     * Operation getExpiringTargetsForSegmentWithHttpInfo
     *
     * Get expiring targets for segment
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation getExpiringTargetsForSegmentAsync
     *
     * Get expiring targets for segment
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation getExpiringTargetsForSegmentAsyncWithHttpInfo
     *
     * Get expiring targets for segment
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Create request for operation 'getExpiringTargetsForSegment'
     *
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
    ...
    /**
     * Operation getSegmentMembershipForContext
     *
    ...
    /**
     * Operation getSegmentMembershipForContextWithHttpInfo
     *
     * Get Big Segment membership for context
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation getSegmentMembershipForContextAsync
     *
     * Get Big Segment membership for context
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation getSegmentMembershipForContextAsyncWithHttpInfo
     *
     * Get Big Segment membership for context
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Create request for operation 'getSegmentMembershipForContext'
     *
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
    ...
    public function getSegmentMembershipForContextRequest($project_key, $environment_key, $segment_key, $context_key)
    {
        ...
        if ($context_key !== null) {
            $resourcePath = str_replace(
                '{' . 'contextKey' . '}',
                ObjectSerializer::toPathValue($context_key),
                $resourcePath
            );
        }
     ...
     */
    public function getSegments($project_key, $environment_key)
    {
        list($response) = $this->getSegmentsWithHttpInfo($project_key, $environment_key);
        return $response;
    }
     ...
     */
    public function getSegmentsWithHttpInfo($project_key, $environment_key)
    {
        $request = $this->getSegmentsRequest($project_key, $environment_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentsAsync($project_key, $environment_key)
    {
        return $this->getSegmentsAsyncWithHttpInfo($project_key, $environment_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentsAsyncWithHttpInfo($project_key, $environment_key)
    {
        $returnType = '\LaunchDarklyApi\Model\UserSegments';
        $request = $this->getSegmentsRequest($project_key, $environment_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSegmentsRequest($project_key, $environment_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
    ...
    /**
     * Operation patchExpiringTargetsForSegment
     *
     ...
     */
    public function patchExpiringTargetsForSegment($project_key, $environment_key, $segment_key, $patch_segment_request)
    {
        list($response) = $this->patchExpiringTargetsForSegmentWithHttpInfo($project_key, $environment_key, $segment_key, $patch_segment_request);
        return $response;
    }

    /**
     * Operation patchExpiringTargetsForSegmentWithHttpInfo
     *
     * Update expiring targets for segment
     *
     * @param  string $project_key The project key (required)
     ...
     */
    public function patchExpiringTargetsForSegmentWithHttpInfo($project_key, $environment_key, $segment_key, $patch_segment_request)
    {
        $request = $this->patchExpiringTargetsForSegmentRequest($project_key, $environment_key, $segment_key, $patch_segment_request);
    ...
    /**
     * Operation patchExpiringTargetsForSegmentAsync
     *
     * Update expiring targets for segment
     *
     * @param  string $project_key The project key (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringTargetsForSegmentAsync($project_key, $environment_key, $segment_key, $patch_segment_request)
    {
        return $this->patchExpiringTargetsForSegmentAsyncWithHttpInfo($project_key, $environment_key, $segment_key, $patch_segment_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation patchExpiringTargetsForSegmentAsyncWithHttpInfo
     *
     * Update expiring targets for segment
     *
     * @param  string $project_key The project key (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringTargetsForSegmentAsyncWithHttpInfo($project_key, $environment_key, $segment_key, $patch_segment_request)
    {
        $returnType = '\LaunchDarklyApi\Model\ExpiringTargetPatchResponse';
        $request = $this->patchExpiringTargetsForSegmentRequest($project_key, $environment_key, $segment_key, $patch_segment_request);
    ...
    /**
     * Create request for operation 'patchExpiringTargetsForSegment'
     *
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchExpiringTargetsForSegmentRequest($project_key, $environment_key, $segment_key, $patch_segment_request)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($patch_segment_request === null || (is_array($patch_segment_request) && count($patch_segment_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $patch_segment_request when calling patchExpiringTargetsForSegment'
            );
        }
    ...
    /**
     * Operation updateBigSegmentContextTargets
     *
    ...
    /**
     * Operation updateBigSegmentContextTargetsWithHttpInfo
     *
     * Update context targets on a Big Segment
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation updateBigSegmentContextTargetsAsync
     *
     * Update context targets on a Big Segment
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation updateBigSegmentContextTargetsAsyncWithHttpInfo
     *
     * Update context targets on a Big Segment
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Create request for operation 'updateBigSegmentContextTargets'
     *
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
