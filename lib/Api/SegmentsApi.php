...
class SegmentsApi
{
    ...
    /**
     * Operation createBigSegmentExport
     *
    ...
    /**
     * Operation createBigSegmentExportWithHttpInfo
     *
     * Create big segment export
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation createBigSegmentExportAsync
     *
     * Create big segment export
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation createBigSegmentExportAsyncWithHttpInfo
     *
     * Create big segment export
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Create request for operation 'createBigSegmentExport'
     *
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
    ...
    /**
     * Operation createBigSegmentImport
     *
    ...
    /**
     * Operation createBigSegmentImportWithHttpInfo
     *
     * Create big segment import
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation createBigSegmentImportAsync
     *
     * Create big segment import
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation createBigSegmentImportAsyncWithHttpInfo
     *
     * Create big segment import
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Create request for operation 'createBigSegmentImport'
     *
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
    ...
    /**
     * Operation getBigSegmentExportWithHttpInfo
     *
     * Get big segment export
     *
     * @param  string $project_key The project key (required)
    ...
    public function getBigSegmentExportWithHttpInfo($project_key, $environment_key, $segment_key, $export_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\Export' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\Export', []),
    ...
    /**
     * Operation getBigSegmentExportAsync
     *
     * Get big segment export
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation getBigSegmentExportAsyncWithHttpInfo
     *
     * Get big segment export
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Create request for operation 'getBigSegmentExport'
     *
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
    ...
    /**
     * Operation getBigSegmentImportWithHttpInfo
     *
     * Get big segment import
     *
     * @param  string $project_key The project key (required)
    ...
    public function getBigSegmentImportWithHttpInfo($project_key, $environment_key, $segment_key, $import_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\Import' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\Import', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
    ...
    /**
     * Operation getBigSegmentImportAsync
     *
     * Get big segment import
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation getBigSegmentImportAsyncWithHttpInfo
     *
     * Get big segment import
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Create request for operation 'getBigSegmentImport'
     *
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
