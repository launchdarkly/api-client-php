            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\BranchRep' === '\SplFileObject') {
                        ...
                        if ('\LaunchDarklyApi\Model\BranchRep' !== 'string') {
                            try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\BranchCollectionRep' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\BranchCollectionRep' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\ExtinctionCollectionRep' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\ExtinctionCollectionRep' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\RepositoryCollectionRep' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\RepositoryCollectionRep' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\RepositoryRep' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\RepositoryRep' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\StatisticsRoot' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\StatisticsRoot' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\StatisticCollectionRep' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\StatisticCollectionRep' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
