...
/**
 * OAuth2ClientsBetaApi Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
...
class OAuth2ClientsBetaApi
{
     ...
     */
    public function createOAuth2Client($oauth_client_post)
    {
        list($response) = $this->createOAuth2ClientWithHttpInfo($oauth_client_post);
        return $response;
    }
     ...
     */
    public function createOAuth2ClientWithHttpInfo($oauth_client_post)
    {
        $request = $this->createOAuth2ClientRequest($oauth_client_post);
     ...
     */
    public function createOAuth2ClientAsync($oauth_client_post)
    {
        return $this->createOAuth2ClientAsyncWithHttpInfo($oauth_client_post)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOAuth2ClientAsyncWithHttpInfo($oauth_client_post)
    {
        $returnType = '\LaunchDarklyApi\Model\Client';
        $request = $this->createOAuth2ClientRequest($oauth_client_post);
     ...
     */
    public function createOAuth2ClientRequest($oauth_client_post)
    {
        ...
        if (isset($oauth_client_post)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($oauth_client_post));
            } else {
     ...
     * @return void
     */
    public function deleteOAuthClient($client_id)
    {
        $this->deleteOAuthClientWithHttpInfo($client_id);
    }
     ...
     */
    public function deleteOAuthClientWithHttpInfo($client_id)
    {
        $request = $this->deleteOAuthClientRequest($client_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteOAuthClientAsync($client_id)
    {
        return $this->deleteOAuthClientAsyncWithHttpInfo($client_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteOAuthClientAsyncWithHttpInfo($client_id)
    {
        $returnType = '';
        $request = $this->deleteOAuthClientRequest($client_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteOAuthClientRequest($client_id)
    {
     ...
     */
    public function getOAuthClientById($client_id)
    {
        list($response) = $this->getOAuthClientByIdWithHttpInfo($client_id);
        return $response;
    }
     ...
     */
    public function getOAuthClientByIdWithHttpInfo($client_id)
    {
        $request = $this->getOAuthClientByIdRequest($client_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOAuthClientByIdAsync($client_id)
    {
        return $this->getOAuthClientByIdAsyncWithHttpInfo($client_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOAuthClientByIdAsyncWithHttpInfo($client_id)
    {
        $returnType = '\LaunchDarklyApi\Model\Client';
        $request = $this->getOAuthClientByIdRequest($client_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOAuthClientByIdRequest($client_id)
    {
        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOAuthClientsRequest()
    {
     ...
     * @return \LaunchDarklyApi\Model\Client|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep
     */
    public function patchOAuthClient($client_id, $patch_operation)
    {
        list($response) = $this->patchOAuthClientWithHttpInfo($client_id, $patch_operation);
        return $response;
    }
     ...
     * @return array of \LaunchDarklyApi\Model\Client|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchOAuthClientWithHttpInfo($client_id, $patch_operation)
    {
        $request = $this->patchOAuthClientRequest($client_id, $patch_operation);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchOAuthClientAsync($client_id, $patch_operation)
    {
        return $this->patchOAuthClientAsyncWithHttpInfo($client_id, $patch_operation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchOAuthClientAsyncWithHttpInfo($client_id, $patch_operation)
    {
        $returnType = '\LaunchDarklyApi\Model\Client';
        $request = $this->patchOAuthClientRequest($client_id, $patch_operation);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchOAuthClientRequest($client_id, $patch_operation)
    {
        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
