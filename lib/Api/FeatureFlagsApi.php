...
class FeatureFlagsApi
{
     ...
     */
    public function copyFeatureFlag($project_key, $feature_flag_key, $flag_copy_config_post)
    {
        list($response) = $this->copyFeatureFlagWithHttpInfo($project_key, $feature_flag_key, $flag_copy_config_post);
        return $response;
    }
     ...
     */
    public function copyFeatureFlagWithHttpInfo($project_key, $feature_flag_key, $flag_copy_config_post)
    {
        $request = $this->copyFeatureFlagRequest($project_key, $feature_flag_key, $flag_copy_config_post);
     ...
     */
    public function copyFeatureFlagAsync($project_key, $feature_flag_key, $flag_copy_config_post)
    {
        return $this->copyFeatureFlagAsyncWithHttpInfo($project_key, $feature_flag_key, $flag_copy_config_post)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function copyFeatureFlagAsyncWithHttpInfo($project_key, $feature_flag_key, $flag_copy_config_post)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlag';
        $request = $this->copyFeatureFlagRequest($project_key, $feature_flag_key, $flag_copy_config_post);
     ...
     */
    public function copyFeatureFlagRequest($project_key, $feature_flag_key, $flag_copy_config_post)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteFeatureFlagRequest($project_key, $feature_flag_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getExpiringContextTargets($project_key, $environment_key, $feature_flag_key)
    {
        list($response) = $this->getExpiringContextTargetsWithHttpInfo($project_key, $environment_key, $feature_flag_key);
        return $response;
    }
     ...
     */
    public function getExpiringContextTargetsWithHttpInfo($project_key, $environment_key, $feature_flag_key)
    {
        $request = $this->getExpiringContextTargetsRequest($project_key, $environment_key, $feature_flag_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiringContextTargetsAsync($project_key, $environment_key, $feature_flag_key)
    {
        return $this->getExpiringContextTargetsAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiringContextTargetsAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key)
    {
        $returnType = '\LaunchDarklyApi\Model\ExpiringTargetGetResponse';
        $request = $this->getExpiringContextTargetsRequest($project_key, $environment_key, $feature_flag_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExpiringContextTargetsRequest($project_key, $environment_key, $feature_flag_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExpiringUserTargetsRequest($project_key, $environment_key, $feature_flag_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getFeatureFlag($project_key, $feature_flag_key, $env = null, $expand = null)
    {
        list($response) = $this->getFeatureFlagWithHttpInfo($project_key, $feature_flag_key, $env, $expand);
        return $response;
    }
     ...
     */
    public function getFeatureFlagWithHttpInfo($project_key, $feature_flag_key, $env = null, $expand = null)
    {
        $request = $this->getFeatureFlagRequest($project_key, $feature_flag_key, $env, $expand);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagAsync($project_key, $feature_flag_key, $env = null, $expand = null)
    {
        return $this->getFeatureFlagAsyncWithHttpInfo($project_key, $feature_flag_key, $env, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagAsyncWithHttpInfo($project_key, $feature_flag_key, $env = null, $expand = null)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlag';
        $request = $this->getFeatureFlagRequest($project_key, $feature_flag_key, $env, $expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFeatureFlagRequest($project_key, $feature_flag_key, $env = null, $expand = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFeatureFlagStatusRequest($project_key, $environment_key, $feature_flag_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getFeatureFlagStatusAcrossEnvironments($project_key, $feature_flag_key, $env = null)
    {
        list($response) = $this->getFeatureFlagStatusAcrossEnvironmentsWithHttpInfo($project_key, $feature_flag_key, $env);
        return $response;
    }
     ...
     */
    public function getFeatureFlagStatusAcrossEnvironmentsWithHttpInfo($project_key, $feature_flag_key, $env = null)
    {
        $request = $this->getFeatureFlagStatusAcrossEnvironmentsRequest($project_key, $feature_flag_key, $env);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagStatusAcrossEnvironmentsAsync($project_key, $feature_flag_key, $env = null)
    {
        return $this->getFeatureFlagStatusAcrossEnvironmentsAsyncWithHttpInfo($project_key, $feature_flag_key, $env)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagStatusAcrossEnvironmentsAsyncWithHttpInfo($project_key, $feature_flag_key, $env = null)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagStatusAcrossEnvironments';
        $request = $this->getFeatureFlagStatusAcrossEnvironmentsRequest($project_key, $feature_flag_key, $env);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFeatureFlagStatusAcrossEnvironmentsRequest($project_key, $feature_flag_key, $env = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFeatureFlagStatusesRequest($project_key, $environment_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getFeatureFlags($project_key, $env = null, $tag = null, $limit = null, $offset = null, $archived = null, $summary = null, $filter = null, $sort = null, $compare = null, $expand = null)
    {
        list($response) = $this->getFeatureFlagsWithHttpInfo($project_key, $env, $tag, $limit, $offset, $archived, $summary, $filter, $sort, $compare, $expand);
        return $response;
    }
     ...
     */
    public function getFeatureFlagsWithHttpInfo($project_key, $env = null, $tag = null, $limit = null, $offset = null, $archived = null, $summary = null, $filter = null, $sort = null, $compare = null, $expand = null)
    {
        $request = $this->getFeatureFlagsRequest($project_key, $env, $tag, $limit, $offset, $archived, $summary, $filter, $sort, $compare, $expand);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagsAsync($project_key, $env = null, $tag = null, $limit = null, $offset = null, $archived = null, $summary = null, $filter = null, $sort = null, $compare = null, $expand = null)
    {
        return $this->getFeatureFlagsAsyncWithHttpInfo($project_key, $env, $tag, $limit, $offset, $archived, $summary, $filter, $sort, $compare, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagsAsyncWithHttpInfo($project_key, $env = null, $tag = null, $limit = null, $offset = null, $archived = null, $summary = null, $filter = null, $sort = null, $compare = null, $expand = null)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlags';
        $request = $this->getFeatureFlagsRequest($project_key, $env, $tag, $limit, $offset, $archived, $summary, $filter, $sort, $compare, $expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFeatureFlagsRequest($project_key, $env = null, $tag = null, $limit = null, $offset = null, $archived = null, $summary = null, $filter = null, $sort = null, $compare = null, $expand = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function patchExpiringTargets($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
    {
        list($response) = $this->patchExpiringTargetsWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_flags_request);
        return $response;
    }
     ...
     */
    public function patchExpiringTargetsWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
    {
        $request = $this->patchExpiringTargetsRequest($project_key, $environment_key, $feature_flag_key, $patch_flags_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringTargetsAsync($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
    {
        return $this->patchExpiringTargetsAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringTargetsAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
    {
        $returnType = '\LaunchDarklyApi\Model\ExpiringTargetPatchResponse';
        $request = $this->patchExpiringTargetsRequest($project_key, $environment_key, $feature_flag_key, $patch_flags_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchExpiringTargetsRequest($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($patch_flags_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($patch_flags_request));
            } else {
     ...
     */
    public function patchExpiringUserTargets($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
    {
        list($response) = $this->patchExpiringUserTargetsWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_flags_request);
        return $response;
    }
     ...
     */
    public function patchExpiringUserTargetsWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
    {
        $request = $this->patchExpiringUserTargetsRequest($project_key, $environment_key, $feature_flag_key, $patch_flags_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringUserTargetsAsync($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
    {
        return $this->patchExpiringUserTargetsAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringUserTargetsAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
    {
        $returnType = '\LaunchDarklyApi\Model\ExpiringUserTargetPatchResponse';
        $request = $this->patchExpiringUserTargetsRequest($project_key, $environment_key, $feature_flag_key, $patch_flags_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchExpiringUserTargetsRequest($project_key, $environment_key, $feature_flag_key, $patch_flags_request)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function patchFeatureFlag($project_key, $feature_flag_key, $patch_with_comment, $ignore_conflicts = null)
    {
        list($response) = $this->patchFeatureFlagWithHttpInfo($project_key, $feature_flag_key, $patch_with_comment, $ignore_conflicts);
        return $response;
    }
     ...
     * @return array of \LaunchDarklyApi\Model\FeatureFlag|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\MethodNotAllowedErrorRep|\LaunchDarklyApi\Model\StatusConflictErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchFeatureFlagWithHttpInfo($project_key, $feature_flag_key, $patch_with_comment, $ignore_conflicts = null)
    {
        $request = $this->patchFeatureFlagRequest($project_key, $feature_flag_key, $patch_with_comment, $ignore_conflicts);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchFeatureFlagAsync($project_key, $feature_flag_key, $patch_with_comment, $ignore_conflicts = null)
    {
        return $this->patchFeatureFlagAsyncWithHttpInfo($project_key, $feature_flag_key, $patch_with_comment, $ignore_conflicts)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchFeatureFlagAsyncWithHttpInfo($project_key, $feature_flag_key, $patch_with_comment, $ignore_conflicts = null)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlag';
        $request = $this->patchFeatureFlagRequest($project_key, $feature_flag_key, $patch_with_comment, $ignore_conflicts);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchFeatureFlagRequest($project_key, $feature_flag_key, $patch_with_comment, $ignore_conflicts = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postFeatureFlagRequest($project_key, $feature_flag_body, $clone = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function postMigrationSafetyIssues($project_key, $flag_key, $environment_key, $flag_sempatch)
    {
        list($response) = $this->postMigrationSafetyIssuesWithHttpInfo($project_key, $flag_key, $environment_key, $flag_sempatch);
        return $response;
    }
     ...
     */
    public function postMigrationSafetyIssuesWithHttpInfo($project_key, $flag_key, $environment_key, $flag_sempatch)
    {
        $request = $this->postMigrationSafetyIssuesRequest($project_key, $flag_key, $environment_key, $flag_sempatch);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postMigrationSafetyIssuesAsync($project_key, $flag_key, $environment_key, $flag_sempatch)
    {
        return $this->postMigrationSafetyIssuesAsyncWithHttpInfo($project_key, $flag_key, $environment_key, $flag_sempatch)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postMigrationSafetyIssuesAsyncWithHttpInfo($project_key, $flag_key, $environment_key, $flag_sempatch)
    {
        $returnType = '\LaunchDarklyApi\Model\MigrationSafetyIssueRep[]';
        $request = $this->postMigrationSafetyIssuesRequest($project_key, $flag_key, $environment_key, $flag_sempatch);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postMigrationSafetyIssuesRequest($project_key, $flag_key, $environment_key, $flag_sempatch)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($flag_sempatch)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($flag_sempatch));
            } else {
