...
class FeatureFlagsApi
{
     ...
     * @param  bool $compare A boolean to filter results by only flags that have differences between environments (optional)
     * @param  string $expand A comma-separated list of fields to expand in the response. Supported fields are explained above. (optional)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function patchFeatureFlag($project_key, $feature_flag_key, $patch_with_comment)
    {
        list($response) = $this->patchFeatureFlagWithHttpInfo($project_key, $feature_flag_key, $patch_with_comment);
        return $response;
    }
     ...
     * @return array of \LaunchDarklyApi\Model\FeatureFlag|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\MethodNotAllowedErrorRep|\LaunchDarklyApi\Model\StatusConflictErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchFeatureFlagWithHttpInfo($project_key, $feature_flag_key, $patch_with_comment)
    {
        $request = $this->patchFeatureFlagRequest($project_key, $feature_flag_key, $patch_with_comment);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchFeatureFlagAsync($project_key, $feature_flag_key, $patch_with_comment)
    {
        return $this->patchFeatureFlagAsyncWithHttpInfo($project_key, $feature_flag_key, $patch_with_comment)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchFeatureFlagAsyncWithHttpInfo($project_key, $feature_flag_key, $patch_with_comment)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlag';
        $request = $this->patchFeatureFlagRequest($project_key, $feature_flag_key, $patch_with_comment);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchFeatureFlagRequest($project_key, $feature_flag_key, $patch_with_comment)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
