...
class FeatureFlagsApi
{
     ...
     */
    public function patchExpiringUserTargets($project_key, $environment_key, $feature_flag_key, $patch_with_comment)
    {
        list($response) = $this->patchExpiringUserTargetsWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_with_comment);
        return $response;
    }
     ...
     */
    public function patchExpiringUserTargetsWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_with_comment)
    {
        $request = $this->patchExpiringUserTargetsRequest($project_key, $environment_key, $feature_flag_key, $patch_with_comment);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringUserTargetsAsync($project_key, $environment_key, $feature_flag_key, $patch_with_comment)
    {
        return $this->patchExpiringUserTargetsAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_with_comment)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchExpiringUserTargetsAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key, $patch_with_comment)
    {
        $returnType = '\LaunchDarklyApi\Model\ExpiringUserTargetPatchResponse';
        $request = $this->patchExpiringUserTargetsRequest($project_key, $environment_key, $feature_flag_key, $patch_with_comment);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchExpiringUserTargetsRequest($project_key, $environment_key, $feature_flag_key, $patch_with_comment)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
