...
class FeatureFlagsApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFeatureFlagRequest($project_key, $feature_flag_key, $env = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getFeatureFlags($project_key, $env = null, $tag = null, $limit = null, $offset = null, $archived = null, $summary = null, $filter = null, $sort = null, $compare = null)
    {
        list($response) = $this->getFeatureFlagsWithHttpInfo($project_key, $env, $tag, $limit, $offset, $archived, $summary, $filter, $sort, $compare);
        return $response;
    }
     ...
     */
    public function getFeatureFlagsWithHttpInfo($project_key, $env = null, $tag = null, $limit = null, $offset = null, $archived = null, $summary = null, $filter = null, $sort = null, $compare = null)
    {
        $request = $this->getFeatureFlagsRequest($project_key, $env, $tag, $limit, $offset, $archived, $summary, $filter, $sort, $compare);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagsAsync($project_key, $env = null, $tag = null, $limit = null, $offset = null, $archived = null, $summary = null, $filter = null, $sort = null, $compare = null)
    {
        return $this->getFeatureFlagsAsyncWithHttpInfo($project_key, $env, $tag, $limit, $offset, $archived, $summary, $filter, $sort, $compare)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagsAsyncWithHttpInfo($project_key, $env = null, $tag = null, $limit = null, $offset = null, $archived = null, $summary = null, $filter = null, $sort = null, $compare = null)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlags';
        $request = $this->getFeatureFlagsRequest($project_key, $env, $tag, $limit, $offset, $archived, $summary, $filter, $sort, $compare);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFeatureFlagsRequest($project_key, $env = null, $tag = null, $limit = null, $offset = null, $archived = null, $summary = null, $filter = null, $sort = null, $compare = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
