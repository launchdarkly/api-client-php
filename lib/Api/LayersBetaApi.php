...
/**
 * LayersBetaApi Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
...
class LayersBetaApi
{
     ...
     */
    public function createLayer($project_key, $layer_post)
    {
        list($response) = $this->createLayerWithHttpInfo($project_key, $layer_post);
        return $response;
    }
     ...
     */
    public function createLayerWithHttpInfo($project_key, $layer_post)
    {
        $request = $this->createLayerRequest($project_key, $layer_post);
     ...
     */
    public function createLayerAsync($project_key, $layer_post)
    {
        return $this->createLayerAsyncWithHttpInfo($project_key, $layer_post)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createLayerAsyncWithHttpInfo($project_key, $layer_post)
    {
        $returnType = '\LaunchDarklyApi\Model\LayerRep';
        $request = $this->createLayerRequest($project_key, $layer_post);
     ...
     */
    public function createLayerRequest($project_key, $layer_post)
    {
        ...
        if (isset($layer_post)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($layer_post));
            } else {
                $httpBody = $layer_post;
            }
     ...
     */
    public function getLayers($project_key, $filter = null)
    {
        list($response) = $this->getLayersWithHttpInfo($project_key, $filter);
        return $response;
    }
     ...
     */
    public function getLayersWithHttpInfo($project_key, $filter = null)
    {
        $request = $this->getLayersRequest($project_key, $filter);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLayersAsync($project_key, $filter = null)
    {
        return $this->getLayersAsyncWithHttpInfo($project_key, $filter)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLayersAsyncWithHttpInfo($project_key, $filter = null)
    {
        $returnType = '\LaunchDarklyApi\Model\LayerCollectionRep';
        $request = $this->getLayersRequest($project_key, $filter);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getLayersRequest($project_key, $filter = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \LaunchDarklyApi\Model\LayerRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function updateLayer($project_key, $layer_key, $layer_patch_input)
    {
        list($response) = $this->updateLayerWithHttpInfo($project_key, $layer_key, $layer_patch_input);
        return $response;
    }
     ...
     * @return array of \LaunchDarklyApi\Model\LayerRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateLayerWithHttpInfo($project_key, $layer_key, $layer_patch_input)
    {
        $request = $this->updateLayerRequest($project_key, $layer_key, $layer_patch_input);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLayerAsync($project_key, $layer_key, $layer_patch_input)
    {
        return $this->updateLayerAsyncWithHttpInfo($project_key, $layer_key, $layer_patch_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLayerAsyncWithHttpInfo($project_key, $layer_key, $layer_patch_input)
    {
        $returnType = '\LaunchDarklyApi\Model\LayerRep';
        $request = $this->updateLayerRequest($project_key, $layer_key, $layer_patch_input);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateLayerRequest($project_key, $layer_key, $layer_patch_input)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($layer_patch_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($layer_patch_input));
            } else {
