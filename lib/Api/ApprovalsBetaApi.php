...
class ApprovalsBetaApi
{
     ...
     */
    public function patchApprovalRequest($project_key, $feature_flag_key, $environment_key, $id)
    {
        list($response) = $this->patchApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $id);
        return $response;
    }
     ...
     */
    public function patchApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $id)
    {
        $request = $this->patchApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $id);
     ...
     */
    public function patchApprovalRequestAsync($project_key, $feature_flag_key, $environment_key, $id)
    {
        return $this->patchApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $id)
    {
        $returnType = '\LaunchDarklyApi\Model\FlagConfigApprovalRequestResponse';
        $request = $this->patchApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $id);
     ...
     */
    public function patchApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $id)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling patchApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling patchApprovalRequest'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling patchApprovalRequest'
            );
        }
