...
class ApprovalsBetaApi
{
     ...
     */
    public function patchApprovalRequest($id)
    {
        list($response) = $this->patchApprovalRequestWithHttpInfo($id);
        return $response;
    }
     ...
     */
    public function patchApprovalRequestWithHttpInfo($id)
    {
        $request = $this->patchApprovalRequestRequest($id);
     ...
     */
    public function patchApprovalRequestAsync($id)
    {
        return $this->patchApprovalRequestAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchApprovalRequestAsyncWithHttpInfo($id)
    {
        $returnType = '\LaunchDarklyApi\Model\FlagConfigApprovalRequestResponse';
        $request = $this->patchApprovalRequestRequest($id);
     ...
     */
    public function patchApprovalRequestRequest($id)
    {
     ...
     * @return \LaunchDarklyApi\Model\FlagConfigApprovalRequestResponse|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function patchFlagConfigApprovalRequest($project_key, $feature_flag_key, $environment_key, $id)
    {
        list($response) = $this->patchFlagConfigApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $id);
        return $response;
    }
     ...
     * @return array of \LaunchDarklyApi\Model\FlagConfigApprovalRequestResponse|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchFlagConfigApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $id)
    {
        $request = $this->patchFlagConfigApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchFlagConfigApprovalRequestAsync($project_key, $feature_flag_key, $environment_key, $id)
    {
        return $this->patchFlagConfigApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchFlagConfigApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $id)
    {
        $returnType = '\LaunchDarklyApi\Model\FlagConfigApprovalRequestResponse';
        $request = $this->patchFlagConfigApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchFlagConfigApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $id)
    {
