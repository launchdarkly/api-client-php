...
class ApplicationsBetaApi
{
     ...
     * Post application
     *
     * @param  \LaunchDarklyApi\Model\CreateApplicationInput $create_application_input create_application_input (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\ApplicationRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function createApplication($create_application_input)
    {
        list($response) = $this->createApplicationWithHttpInfo($create_application_input);
        return $response;
    }
     ...
     * Post application
     *
     * @param  \LaunchDarklyApi\Model\CreateApplicationInput $create_application_input (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\ApplicationRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function createApplicationWithHttpInfo($create_application_input)
    {
        $request = $this->createApplicationRequest($create_application_input);
     ...
     */
    public function createApplicationAsync($create_application_input)
    {
        return $this->createApplicationAsyncWithHttpInfo($create_application_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createApplicationAsyncWithHttpInfo($create_application_input)
    {
        $returnType = '\LaunchDarklyApi\Model\ApplicationRep';
        $request = $this->createApplicationRequest($create_application_input);
     ...
     */
    public function createApplicationRequest($create_application_input)
    {
        // verify the required parameter 'create_application_input' is set
        if ($create_application_input === null || (is_array($create_application_input) && count($create_application_input) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_application_input when calling createApplication'
            );
        }
        ...
        // for model (json/xml)
        if (isset($create_application_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_application_input));
            } else {
                $httpBody = $create_application_input;
            }
    ...
    /**
     * Operation postApplicationVersion
     *
     * Post application version
     *
     * @param  string $application_key The application key (required)
     * @param  \LaunchDarklyApi\Model\CreateApplicationVersionInput $create_application_version_input create_application_version_input (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\ApplicationVersionRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function postApplicationVersion($application_key, $create_application_version_input)
    {
        list($response) = $this->postApplicationVersionWithHttpInfo($application_key, $create_application_version_input);
        return $response;
    }

    /**
     * Operation postApplicationVersionWithHttpInfo
     *
     * Post application version
     *
     * @param  string $application_key The application key (required)
     * @param  \LaunchDarklyApi\Model\CreateApplicationVersionInput $create_application_version_input (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\ApplicationVersionRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApplicationVersionWithHttpInfo($application_key, $create_application_version_input)
    {
        $request = $this->postApplicationVersionRequest($application_key, $create_application_version_input);
    ...
    /**
     * Operation postApplicationVersionAsync
     *
     * Post application version
     *
     * @param  string $application_key The application key (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApplicationVersionAsync($application_key, $create_application_version_input)
    {
        return $this->postApplicationVersionAsyncWithHttpInfo($application_key, $create_application_version_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postApplicationVersionAsyncWithHttpInfo
     *
     * Post application version
     *
     * @param  string $application_key The application key (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApplicationVersionAsyncWithHttpInfo($application_key, $create_application_version_input)
    {
        $returnType = '\LaunchDarklyApi\Model\ApplicationVersionRep';
        $request = $this->postApplicationVersionRequest($application_key, $create_application_version_input);
    ...
    /**
     * Create request for operation 'postApplicationVersion'
     *
     * @param  string $application_key The application key (required)
     * @param  \LaunchDarklyApi\Model\CreateApplicationVersionInput $create_application_version_input (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postApplicationVersionRequest($application_key, $create_application_version_input)
    {
        // verify the required parameter 'application_key' is set
        if ($application_key === null || (is_array($application_key) && count($application_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $application_key when calling postApplicationVersion'
            );
        }
        // verify the required parameter 'create_application_version_input' is set
        if ($create_application_version_input === null || (is_array($create_application_version_input) && count($create_application_version_input) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_application_version_input when calling postApplicationVersion'
            );
        }
        ...
        // for model (json/xml)
        if (isset($create_application_version_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_application_version_input));
            } else {
                $httpBody = $create_application_version_input;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
