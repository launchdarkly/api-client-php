...
class MetricsApi
{
     ...
     * @param  string $key The metric key (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteMetric($project_key, $key)
    {
        $this->deleteMetricWithHttpInfo($project_key, $key);
    }
     ...
     */
    public function deleteMetricWithHttpInfo($project_key, $key)
    {
        $request = $this->deleteMetricRequest($project_key, $key);
     ...
     */
    public function deleteMetricAsync($project_key, $key)
    {
        return $this->deleteMetricAsyncWithHttpInfo($project_key, $key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteMetricAsyncWithHttpInfo($project_key, $key)
    {
        $returnType = '';
        $request = $this->deleteMetricRequest($project_key, $key);
     ...
     */
    public function deleteMetricRequest($project_key, $key)
    {
        ...
        if ($key === null || (is_array($key) && count($key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $key when calling deleteMetric'
            );
        }

        $resourcePath = '/api/v2/metrics/{projectKey}/{key}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getMetric($project_key, $key)
    {
        list($response) = $this->getMetricWithHttpInfo($project_key, $key);
        return $response;
    }
     ...
     */
    public function getMetricWithHttpInfo($project_key, $key)
    {
        $request = $this->getMetricRequest($project_key, $key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricAsync($project_key, $key)
    {
        return $this->getMetricAsyncWithHttpInfo($project_key, $key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricAsyncWithHttpInfo($project_key, $key)
    {
        $returnType = '\LaunchDarklyApi\Model\MetricRep';
        $request = $this->getMetricRequest($project_key, $key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMetricRequest($project_key, $key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($key === null || (is_array($key) && count($key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $key when calling getMetric'
            );
        }
     ...
     */
    public function patchMetric($project_key, $key, $patch_operation)
    {
        list($response) = $this->patchMetricWithHttpInfo($project_key, $key, $patch_operation);
        return $response;
    }
     ...
     */
    public function patchMetricWithHttpInfo($project_key, $key, $patch_operation)
    {
        $request = $this->patchMetricRequest($project_key, $key, $patch_operation);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchMetricAsync($project_key, $key, $patch_operation)
    {
        return $this->patchMetricAsyncWithHttpInfo($project_key, $key, $patch_operation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchMetricAsyncWithHttpInfo($project_key, $key, $patch_operation)
    {
        $returnType = '\LaunchDarklyApi\Model\MetricRep';
        $request = $this->patchMetricRequest($project_key, $key, $patch_operation);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchMetricRequest($project_key, $key, $patch_operation)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($key === null || (is_array($key) && count($key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $key when calling patchMetric'
            );
        }
