...
class MetricsApi
{
     ...
     */
    public function getMetrics($project_key, $expand = null)
    {
        list($response) = $this->getMetricsWithHttpInfo($project_key, $expand);
        return $response;
    }
     ...
     */
    public function getMetricsWithHttpInfo($project_key, $expand = null)
    {
        $request = $this->getMetricsRequest($project_key, $expand);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricsAsync($project_key, $expand = null)
    {
        return $this->getMetricsAsyncWithHttpInfo($project_key, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricsAsyncWithHttpInfo($project_key, $expand = null)
    {
        $returnType = '\LaunchDarklyApi\Model\MetricCollectionRep';
        $request = $this->getMetricsRequest($project_key, $expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMetricsRequest($project_key, $expand = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
