...
class MetricsApi
{
     ...
     */
    public function getMetric($project_key, $metric_key)
    {
        list($response) = $this->getMetricWithHttpInfo($project_key, $metric_key);
        return $response;
    }
     ...
     */
    public function getMetricWithHttpInfo($project_key, $metric_key)
    {
        $request = $this->getMetricRequest($project_key, $metric_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricAsync($project_key, $metric_key)
    {
        return $this->getMetricAsyncWithHttpInfo($project_key, $metric_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricAsyncWithHttpInfo($project_key, $metric_key)
    {
        $returnType = '\LaunchDarklyApi\Model\MetricRep';
        $request = $this->getMetricRequest($project_key, $metric_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMetricRequest($project_key, $metric_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getMetrics($project_key)
    {
        list($response) = $this->getMetricsWithHttpInfo($project_key);
        return $response;
    }
     ...
     */
    public function getMetricsWithHttpInfo($project_key)
    {
        $request = $this->getMetricsRequest($project_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricsAsync($project_key)
    {
        return $this->getMetricsAsyncWithHttpInfo($project_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricsAsyncWithHttpInfo($project_key)
    {
        $returnType = '\LaunchDarklyApi\Model\MetricCollectionRep';
        $request = $this->getMetricsRequest($project_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMetricsRequest($project_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
