...
class MetricsApi
{
     ...
     */
    public function getMetric($project_key, $metric_key, $expand = null)
    {
        list($response) = $this->getMetricWithHttpInfo($project_key, $metric_key, $expand);
        return $response;
    }
     ...
     */
    public function getMetricWithHttpInfo($project_key, $metric_key, $expand = null)
    {
        $request = $this->getMetricRequest($project_key, $metric_key, $expand);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricAsync($project_key, $metric_key, $expand = null)
    {
        return $this->getMetricAsyncWithHttpInfo($project_key, $metric_key, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricAsyncWithHttpInfo($project_key, $metric_key, $expand = null)
    {
        $returnType = '\LaunchDarklyApi\Model\MetricRep';
        $request = $this->getMetricRequest($project_key, $metric_key, $expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMetricRequest($project_key, $metric_key, $expand = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
