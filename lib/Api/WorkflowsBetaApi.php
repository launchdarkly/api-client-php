...
class WorkflowsBetaApi
{
     ...
     */
    public function postWorkflow($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key = null)
    {
        list($response) = $this->postWorkflowWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key);
        return $response;
    }
     ...
     */
    public function postWorkflowWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key = null)
    {
        $request = $this->postWorkflowRequest($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postWorkflowAsync($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key = null)
    {
        return $this->postWorkflowAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postWorkflowAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key = null)
    {
        $returnType = '\LaunchDarklyApi\Model\CustomWorkflowOutput';
        $request = $this->postWorkflowRequest($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postWorkflowRequest($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
