...
/**
 * WorkflowsBetaApi Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
...
class WorkflowsBetaApi
{
     ...
     * @return void
     */
    public function deleteWorkflow($project_key, $feature_flag_key, $environment_key, $workflow_id)
    {
        $this->deleteWorkflowWithHttpInfo($project_key, $feature_flag_key, $environment_key, $workflow_id);
    }
     ...
     */
    public function deleteWorkflowWithHttpInfo($project_key, $feature_flag_key, $environment_key, $workflow_id)
    {
        $request = $this->deleteWorkflowRequest($project_key, $feature_flag_key, $environment_key, $workflow_id);
     ...
     */
    public function deleteWorkflowAsync($project_key, $feature_flag_key, $environment_key, $workflow_id)
    {
        return $this->deleteWorkflowAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $workflow_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteWorkflowAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $workflow_id)
    {
        $returnType = '';
        $request = $this->deleteWorkflowRequest($project_key, $feature_flag_key, $environment_key, $workflow_id);
     ...
     */
    public function deleteWorkflowRequest($project_key, $feature_flag_key, $environment_key, $workflow_id)
    {
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\CustomWorkflowOutputRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function getCustomWorkflow($project_key, $feature_flag_key, $environment_key, $workflow_id)
    {
        list($response) = $this->getCustomWorkflowWithHttpInfo($project_key, $feature_flag_key, $environment_key, $workflow_id);
        return $response;
    }
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\CustomWorkflowOutputRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomWorkflowWithHttpInfo($project_key, $feature_flag_key, $environment_key, $workflow_id)
    {
        $request = $this->getCustomWorkflowRequest($project_key, $feature_flag_key, $environment_key, $workflow_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\CustomWorkflowOutputRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\CustomWorkflowOutputRep' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\CustomWorkflowOutputRep', []),
            ...
            $returnType = '\LaunchDarklyApi\Model\CustomWorkflowOutputRep';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\CustomWorkflowOutputRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomWorkflowAsync($project_key, $feature_flag_key, $environment_key, $workflow_id)
    {
        return $this->getCustomWorkflowAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $workflow_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomWorkflowAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $workflow_id)
    {
        $returnType = '\LaunchDarklyApi\Model\CustomWorkflowOutputRep';
        $request = $this->getCustomWorkflowRequest($project_key, $feature_flag_key, $environment_key, $workflow_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCustomWorkflowRequest($project_key, $feature_flag_key, $environment_key, $workflow_id)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\CustomWorkflowsListingOutputRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function getWorkflows($project_key, $feature_flag_key, $environment_key)
    {
        list($response) = $this->getWorkflowsWithHttpInfo($project_key, $feature_flag_key, $environment_key);
        return $response;
    }
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\CustomWorkflowsListingOutputRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWorkflowsWithHttpInfo($project_key, $feature_flag_key, $environment_key)
    {
        $request = $this->getWorkflowsRequest($project_key, $feature_flag_key, $environment_key);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\CustomWorkflowsListingOutputRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\CustomWorkflowsListingOutputRep' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\CustomWorkflowsListingOutputRep', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\LaunchDarklyApi\Model\CustomWorkflowsListingOutputRep';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\CustomWorkflowsListingOutputRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkflowsAsync($project_key, $feature_flag_key, $environment_key)
    {
        return $this->getWorkflowsAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkflowsAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key)
    {
        $returnType = '\LaunchDarklyApi\Model\CustomWorkflowsListingOutputRep';
        $request = $this->getWorkflowsRequest($project_key, $feature_flag_key, $environment_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWorkflowsRequest($project_key, $feature_flag_key, $environment_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string $feature_flag_key The feature flag key (required)
     * @param  string $environment_key The environment key (required)
     * @param  \LaunchDarklyApi\Model\CustomWorkflowInputRep $custom_workflow_input_rep custom_workflow_input_rep (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\CustomWorkflowOutputRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function postWorkflow($project_key, $feature_flag_key, $environment_key, $custom_workflow_input_rep)
    {
        list($response) = $this->postWorkflowWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input_rep);
        return $response;
    }
     ...
     * @param  string $feature_flag_key The feature flag key (required)
     * @param  string $environment_key The environment key (required)
     * @param  \LaunchDarklyApi\Model\CustomWorkflowInputRep $custom_workflow_input_rep (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\CustomWorkflowOutputRep|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function postWorkflowWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input_rep)
    {
        $request = $this->postWorkflowRequest($project_key, $feature_flag_key, $environment_key, $custom_workflow_input_rep);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postWorkflowAsync($project_key, $feature_flag_key, $environment_key, $custom_workflow_input_rep)
    {
        return $this->postWorkflowAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input_rep)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postWorkflowAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input_rep)
    {
        $returnType = '\LaunchDarklyApi\Model\CustomWorkflowOutputRep';
        $request = $this->postWorkflowRequest($project_key, $feature_flag_key, $environment_key, $custom_workflow_input_rep);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postWorkflowRequest($project_key, $feature_flag_key, $environment_key, $custom_workflow_input_rep)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($custom_workflow_input_rep === null || (is_array($custom_workflow_input_rep) && count($custom_workflow_input_rep) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $custom_workflow_input_rep when calling postWorkflow'
            );
        }
        ...
        // for model (json/xml)
        if (isset($custom_workflow_input_rep)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($custom_workflow_input_rep));
            } else {
                $httpBody = $custom_workflow_input_rep;
            }
