...
class WorkflowsBetaApi
{
     ...
     */
    public function getWorkflows($project_key, $feature_flag_key, $environment_key, $status = null, $sort = null)
    {
        list($response) = $this->getWorkflowsWithHttpInfo($project_key, $feature_flag_key, $environment_key, $status, $sort);
        return $response;
    }
     ...
     */
    public function getWorkflowsWithHttpInfo($project_key, $feature_flag_key, $environment_key, $status = null, $sort = null)
    {
        $request = $this->getWorkflowsRequest($project_key, $feature_flag_key, $environment_key, $status, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkflowsAsync($project_key, $feature_flag_key, $environment_key, $status = null, $sort = null)
    {
        return $this->getWorkflowsAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $status, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkflowsAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $status = null, $sort = null)
    {
        $returnType = '\LaunchDarklyApi\Model\CustomWorkflowsListingOutput';
        $request = $this->getWorkflowsRequest($project_key, $feature_flag_key, $environment_key, $status, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWorkflowsRequest($project_key, $feature_flag_key, $environment_key, $status = null, $sort = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
