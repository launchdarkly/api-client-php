...
class MetricsBetaApi
{
     ...
     */
    public function getMetricGroups($project_key, $expand = null)
    {
        list($response) = $this->getMetricGroupsWithHttpInfo($project_key, $expand);
        return $response;
    }
     ...
     */
    public function getMetricGroupsWithHttpInfo($project_key, $expand = null)
    {
        $request = $this->getMetricGroupsRequest($project_key, $expand);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricGroupsAsync($project_key, $expand = null)
    {
        return $this->getMetricGroupsAsyncWithHttpInfo($project_key, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricGroupsAsyncWithHttpInfo($project_key, $expand = null)
    {
        $returnType = '\LaunchDarklyApi\Model\MetricGroupCollectionRep';
        $request = $this->getMetricGroupsRequest($project_key, $expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMetricGroupsRequest($project_key, $expand = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
