...
class WorkflowTemplatesBetaApi
{
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\WorkflowTemplatesListingOutputRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function getWorkflowTemplates($search = null)
    {
        list($response) = $this->getWorkflowTemplatesWithHttpInfo($search);
        return $response;
    }
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\WorkflowTemplatesListingOutputRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWorkflowTemplatesWithHttpInfo($search = null)
    {
        $request = $this->getWorkflowTemplatesRequest($search);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkflowTemplatesAsync($search = null)
    {
        return $this->getWorkflowTemplatesAsyncWithHttpInfo($search)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkflowTemplatesAsyncWithHttpInfo($search = null)
    {
        $returnType = '\LaunchDarklyApi\Model\WorkflowTemplatesListingOutputRep';
        $request = $this->getWorkflowTemplatesRequest($search);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWorkflowTemplatesRequest($search = null)
    {
