...
class WorkflowsApi
{
    ...
    public function getCustomWorkflowWithHttpInfo($project_key, $feature_flag_key, $environment_key, $workflow_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\CustomWorkflowOutput' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\CustomWorkflowOutput' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\CustomWorkflowOutput', []),
     ...
     * @param  string $feature_flag_key The feature flag key (required)
     * @param  string $environment_key The environment key (required)
     * @param  string $status Filter results by workflow status. Valid status filters are &#x60;active&#x60;, &#x60;completed&#x60;, and &#x60;failed&#x60;. (optional)
     * @param  string $sort A field to sort the items by. Prefix field by a dash ( - ) to sort in descending order. This endpoint supports sorting by &#x60;creationDate&#x60; or &#x60;stopDate&#x60;. (optional)
     * @param  int $limit The maximum number of workflows to return. Defaults to 20. (optional)
     ...
     */
    public function getWorkflows($project_key, $feature_flag_key, $environment_key, $status = null, $sort = null, $limit = null, $offset = null)
    {
        list($response) = $this->getWorkflowsWithHttpInfo($project_key, $feature_flag_key, $environment_key, $status, $sort, $limit, $offset);
        return $response;
    }
     ...
     */
    public function getWorkflowsWithHttpInfo($project_key, $feature_flag_key, $environment_key, $status = null, $sort = null, $limit = null, $offset = null)
    {
        $request = $this->getWorkflowsRequest($project_key, $feature_flag_key, $environment_key, $status, $sort, $limit, $offset);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\CustomWorkflowsListingOutput' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\CustomWorkflowsListingOutput' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\CustomWorkflowsListingOutput', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkflowsAsync($project_key, $feature_flag_key, $environment_key, $status = null, $sort = null, $limit = null, $offset = null)
    {
        return $this->getWorkflowsAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $status, $sort, $limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkflowsAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $status = null, $sort = null, $limit = null, $offset = null)
    {
        $returnType = '\LaunchDarklyApi\Model\CustomWorkflowsListingOutput';
        $request = $this->getWorkflowsRequest($project_key, $feature_flag_key, $environment_key, $status, $sort, $limit, $offset);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWorkflowsRequest($project_key, $feature_flag_key, $environment_key, $status = null, $sort = null, $limit = null, $offset = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string $template_key The template key to apply as a starting point for the new workflow (optional)
     * @param  bool $dry_run Whether to call the endpoint in dry-run mode (optional)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postWorkflow($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key = null, $dry_run = null)
    {
        list($response) = $this->postWorkflowWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key, $dry_run);
        return $response;
    }
     ...
     */
    public function postWorkflowWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key = null, $dry_run = null)
    {
        $request = $this->postWorkflowRequest($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key, $dry_run);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postWorkflowAsync($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key = null, $dry_run = null)
    {
        return $this->postWorkflowAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key, $dry_run)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postWorkflowAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key = null, $dry_run = null)
    {
        $returnType = '\LaunchDarklyApi\Model\CustomWorkflowOutput';
        $request = $this->postWorkflowRequest($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key, $dry_run);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postWorkflowRequest($project_key, $feature_flag_key, $environment_key, $custom_workflow_input, $template_key = null, $dry_run = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($custom_workflow_input)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($custom_workflow_input));
            } else {
