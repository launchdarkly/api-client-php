...
class FeatureFlagsBetaApi
{
     ...
     */
    public function getDependentFlags($proj_key, $flag_key)
    {
        list($response) = $this->getDependentFlagsWithHttpInfo($proj_key, $flag_key);
        return $response;
    }
     ...
     */
    public function getDependentFlagsWithHttpInfo($proj_key, $flag_key)
    {
        $request = $this->getDependentFlagsRequest($proj_key, $flag_key);
     ...
     */
    public function getDependentFlagsAsync($proj_key, $flag_key)
    {
        return $this->getDependentFlagsAsyncWithHttpInfo($proj_key, $flag_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDependentFlagsAsyncWithHttpInfo($proj_key, $flag_key)
    {
        $returnType = '\LaunchDarklyApi\Model\MultiEnvironmentDependentFlags';
        $request = $this->getDependentFlagsRequest($proj_key, $flag_key);
     ...
     */
    public function getDependentFlagsRequest($proj_key, $flag_key)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling getDependentFlags'
            );
        }
        // verify the required parameter 'flag_key' is set
        if ($flag_key === null || (is_array($flag_key) && count($flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $flag_key when calling getDependentFlags'
            );
        }

        $resourcePath = '/api/v2/flags/{projKey}/{flagKey}/dependent-flags';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getDependentFlagsByEnv($proj_key, $env_key, $flag_key)
    {
        list($response) = $this->getDependentFlagsByEnvWithHttpInfo($proj_key, $env_key, $flag_key);
        return $response;
    }
     ...
     */
    public function getDependentFlagsByEnvWithHttpInfo($proj_key, $env_key, $flag_key)
    {
        $request = $this->getDependentFlagsByEnvRequest($proj_key, $env_key, $flag_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDependentFlagsByEnvAsync($proj_key, $env_key, $flag_key)
    {
        return $this->getDependentFlagsByEnvAsyncWithHttpInfo($proj_key, $env_key, $flag_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDependentFlagsByEnvAsyncWithHttpInfo($proj_key, $env_key, $flag_key)
    {
        $returnType = '\LaunchDarklyApi\Model\DependentFlagsByEnvironment';
        $request = $this->getDependentFlagsByEnvRequest($proj_key, $env_key, $flag_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDependentFlagsByEnvRequest($proj_key, $env_key, $flag_key)
    {
        // verify the required parameter 'proj_key' is set
        if ($proj_key === null || (is_array($proj_key) && count($proj_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $proj_key when calling getDependentFlagsByEnv'
            );
        }
        // verify the required parameter 'env_key' is set
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling getDependentFlagsByEnv'
            );
        }
        // verify the required parameter 'flag_key' is set
        if ($flag_key === null || (is_array($flag_key) && count($flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $flag_key when calling getDependentFlagsByEnv'
            );
        }

        $resourcePath = '/api/v2/flags/{projKey}/{envKey}/{flagKey}/dependent-flags';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
