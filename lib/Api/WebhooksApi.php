...
class WebhooksApi
{
    ...
    {
        list($response) = $this->getAllWebhooksWithHttpInfo();
        return $response;
    }
     ...
     */
    public function getAllWebhooksWithHttpInfo()
    {
        $request = $this->getAllWebhooksRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsync()
    {
        return $this->getAllWebhooksAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsyncWithHttpInfo()
    {
        $returnType = '\LaunchDarklyApi\Model\Webhooks';
        $request = $this->getAllWebhooksRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllWebhooksRequest()
    {
     ...
     */
    public function patchWebhook($id, $patch_operation)
    {
        list($response) = $this->patchWebhookWithHttpInfo($id, $patch_operation);
        return $response;
    }
     ...
     */
    public function patchWebhookWithHttpInfo($id, $patch_operation)
    {
        $request = $this->patchWebhookRequest($id, $patch_operation);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchWebhookAsync($id, $patch_operation)
    {
        return $this->patchWebhookAsyncWithHttpInfo($id, $patch_operation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchWebhookAsyncWithHttpInfo($id, $patch_operation)
    {
        $returnType = '\LaunchDarklyApi\Model\Webhook';
        $request = $this->patchWebhookRequest($id, $patch_operation);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchWebhookRequest($id, $patch_operation)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        $request = $this->postWebhookRequest($webhook_post);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postWebhookAsync($webhook_post)
    {
        return $this->postWebhookAsyncWithHttpInfo($webhook_post)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postWebhookAsyncWithHttpInfo($webhook_post)
    {
        $returnType = '\LaunchDarklyApi\Model\Webhook';
        $request = $this->postWebhookRequest($webhook_post);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postWebhookRequest($webhook_post)
    {
        ...
        if (isset($webhook_post)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($webhook_post));
            } else {
