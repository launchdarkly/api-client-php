...
class WebhooksApi
{
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\Webhooks|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\Webhooks|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllWebhooksWithHttpInfo(string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\Webhooks' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\Webhooks' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\Webhooks', []),
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\Webhook|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\Webhook|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebhookWithHttpInfo($id, string $contentType = self::contentTypes['getWebhook'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\Webhook' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\Webhook' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\Webhook', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchWebhook'] to see the possible values for this operation
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\Webhook|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function patchWebhook($id, $patch_operation, string $contentType = self::contentTypes['patchWebhook'][0])
    {
        list($response) = $this->patchWebhookWithHttpInfo($id, $patch_operation, $contentType);
        return $response;
    }
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\Webhook|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchWebhookWithHttpInfo($id, $patch_operation, string $contentType = self::contentTypes['patchWebhook'][0])
    {
        $request = $this->patchWebhookRequest($id, $patch_operation, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchWebhookAsync($id, $patch_operation, string $contentType = self::contentTypes['patchWebhook'][0])
    {
        return $this->patchWebhookAsyncWithHttpInfo($id, $patch_operation, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchWebhookAsyncWithHttpInfo($id, $patch_operation, string $contentType = self::contentTypes['patchWebhook'][0])
    {
        $returnType = '\LaunchDarklyApi\Model\Webhook';
        $request = $this->patchWebhookRequest($id, $patch_operation, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchWebhookRequest($id, $patch_operation, string $contentType = self::contentTypes['patchWebhook'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling patchWebhook'
            );
        }
        ...
        if ($patch_operation === null || (is_array($patch_operation) && count($patch_operation) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $patch_operation when calling patchWebhook'
            );
        }
     ...
     * Creates a webhook
     *
     * @param  \LaunchDarklyApi\Model\WebhookPost $webhook_post webhook_post (required)
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\Webhook|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function postWebhook($webhook_post, string $contentType = self::contentTypes['postWebhook'][0])
    {
        list($response) = $this->postWebhookWithHttpInfo($webhook_post, $contentType);
        return $response;
    }
     ...
     * Creates a webhook
     *
     * @param  \LaunchDarklyApi\Model\WebhookPost $webhook_post (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postWebhook'] to see the possible values for this operation
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\Webhook|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function postWebhookWithHttpInfo($webhook_post, string $contentType = self::contentTypes['postWebhook'][0])
    {
        $request = $this->postWebhookRequest($webhook_post, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postWebhookAsync($webhook_post, string $contentType = self::contentTypes['postWebhook'][0])
    {
        return $this->postWebhookAsyncWithHttpInfo($webhook_post, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postWebhookAsyncWithHttpInfo($webhook_post, string $contentType = self::contentTypes['postWebhook'][0])
    {
        $returnType = '\LaunchDarklyApi\Model\Webhook';
        $request = $this->postWebhookRequest($webhook_post, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postWebhookRequest($webhook_post, string $contentType = self::contentTypes['postWebhook'][0])
    {

        // verify the required parameter 'webhook_post' is set
        if ($webhook_post === null || (is_array($webhook_post) && count($webhook_post) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webhook_post when calling postWebhook'
            );
        }
        ...
        if (isset($webhook_post)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_post));
            } else {
                $httpBody = $webhook_post;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
