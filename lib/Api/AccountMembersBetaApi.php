...
/**
 * AccountMembersBetaApi Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
...
class AccountMembersBetaApi
{
    ...
    public function patchMembersWithHttpInfo($members_patch_input, string $contentType = self::contentTypes['patchMembers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\BulkEditMembersRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\BulkEditMembersRep' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\BulkEditMembersRep', []),
