...
class ProjectsApi
{
    ...
    /**
     * Operation getFlagDefaultsByProject
     *
    ...
    /**
     * Operation getFlagDefaultsByProjectWithHttpInfo
     *
     * Get flag defaults for project
     *
     * @param  string $project_key The project key (required)
    ...
    public function getFlagDefaultsByProjectWithHttpInfo($project_key)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\FlagDefaultsRep' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\FlagDefaultsRep', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\FlagDefaultsRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getFlagDefaultsByProjectAsync
     *
     * Get flag defaults for project
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation getFlagDefaultsByProjectAsyncWithHttpInfo
     *
     * Get flag defaults for project
     *
     * @param  string $project_key The project key (required)
     ...
     * List projects
     *
     * @param  int $limit The number of projects to return in the response. Defaults to 20. (optional)
    ...
    /**
     * Operation patchFlagDefaultsByProject
     *
    ...
    /**
     * Operation patchFlagDefaultsByProjectWithHttpInfo
     *
     * Update flag default for project
     *
     * @param  string $project_key The project key (required)
    ...
    public function patchFlagDefaultsByProjectWithHttpInfo($project_key, $patch_operation)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\UpsertPayloadRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\UpsertPayloadRep', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\UpsertPayloadRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation patchFlagDefaultsByProjectAsync
     *
     * Update flag default for project
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation patchFlagDefaultsByProjectAsyncWithHttpInfo
     *
     * Update flag default for project
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Create request for operation 'patchFlagDefaultsByProject'
     *
     * @param  string $project_key The project key (required)
     * @param  \LaunchDarklyApi\Model\PatchOperation[] $patch_operation (required)
     *
    ...
    public function patchProjectWithHttpInfo($project_key, $patch_operation)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\ProjectRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\ProjectRep', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\ProjectRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation putFlagDefaultsByProject
     *
    ...
    /**
     * Operation putFlagDefaultsByProjectWithHttpInfo
     *
     * Create or update flag defaults for project
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation putFlagDefaultsByProjectAsync
     *
     * Create or update flag defaults for project
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Operation putFlagDefaultsByProjectAsyncWithHttpInfo
     *
     * Create or update flag defaults for project
     *
     * @param  string $project_key The project key (required)
    ...
    /**
     * Create request for operation 'putFlagDefaultsByProject'
     *
     * @param  string $project_key The project key (required)
     * @param  \LaunchDarklyApi\Model\UpsertFlagDefaultsPayload $upsert_flag_defaults_payload (required)
     *
