...
class ProjectsApi
{
     ...
     */
    public function getProjects($limit = null, $offset = null, $filter = null, $expand = null)
    {
        list($response) = $this->getProjectsWithHttpInfo($limit, $offset, $filter, $expand);
        return $response;
    }
     ...
     */
    public function getProjectsWithHttpInfo($limit = null, $offset = null, $filter = null, $expand = null)
    {
        $request = $this->getProjectsRequest($limit, $offset, $filter, $expand);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProjectsAsync($limit = null, $offset = null, $filter = null, $expand = null)
    {
        return $this->getProjectsAsyncWithHttpInfo($limit, $offset, $filter, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProjectsAsyncWithHttpInfo($limit = null, $offset = null, $filter = null, $expand = null)
    {
        $returnType = '\LaunchDarklyApi\Model\Projects';
        $request = $this->getProjectsRequest($limit, $offset, $filter, $expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getProjectsRequest($limit = null, $offset = null, $filter = null, $expand = null)
    {
