...
class AccountMembersApi
{
    ...
    {
        list($response) = $this->getMemberWithHttpInfo($id);
        return $response;
    }
     ...
     */
    public function getMemberWithHttpInfo($id)
    {
        $request = $this->getMemberRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMemberAsync($id)
    {
        return $this->getMemberAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMemberAsyncWithHttpInfo($id)
    {
        $returnType = '\LaunchDarklyApi\Model\Member';
        $request = $this->getMemberRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMemberRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMembersRequest($limit = null, $offset = null, $filter = null, $sort = null)
    {
