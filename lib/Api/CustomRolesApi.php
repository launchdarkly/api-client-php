...
class CustomRolesApi
{
     ...
     * Delete custom role
     *
     * @param  string $key The key of the custom role to delete (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteCustomRole($key)
    {
        $this->deleteCustomRoleWithHttpInfo($key);
    }
     ...
     */
    public function deleteCustomRoleWithHttpInfo($key)
    {
        $request = $this->deleteCustomRoleRequest($key);
     ...
     */
    public function deleteCustomRoleAsync($key)
    {
        return $this->deleteCustomRoleAsyncWithHttpInfo($key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteCustomRoleAsyncWithHttpInfo($key)
    {
        $returnType = '';
        $request = $this->deleteCustomRoleRequest($key);
     ...
     */
    public function deleteCustomRoleRequest($key)
    {
        // verify the required parameter 'key' is set
        if ($key === null || (is_array($key) && count($key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $key when calling deleteCustomRole'
            );
        }

        $resourcePath = '/api/v2/roles/{key}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Get custom role
     *
     * @param  string $key The custom role&#39;s key or ID (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getCustomRole($key)
    {
        list($response) = $this->getCustomRoleWithHttpInfo($key);
        return $response;
    }
     ...
     */
    public function getCustomRoleWithHttpInfo($key)
    {
        $request = $this->getCustomRoleRequest($key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomRoleAsync($key)
    {
        return $this->getCustomRoleAsyncWithHttpInfo($key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomRoleAsyncWithHttpInfo($key)
    {
        $returnType = '\LaunchDarklyApi\Model\CustomRole';
        $request = $this->getCustomRoleRequest($key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCustomRoleRequest($key)
    {
        // verify the required parameter 'key' is set
        if ($key === null || (is_array($key) && count($key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $key when calling getCustomRole'
            );
        }
     ...
     * Update custom role
     *
     * @param  string $key The key of the custom role to update (required)
     ...
     */
    public function patchCustomRole($key, $patch_with_comment)
    {
        list($response) = $this->patchCustomRoleWithHttpInfo($key, $patch_with_comment);
        return $response;
    }
     ...
     */
    public function patchCustomRoleWithHttpInfo($key, $patch_with_comment)
    {
        $request = $this->patchCustomRoleRequest($key, $patch_with_comment);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchCustomRoleAsync($key, $patch_with_comment)
    {
        return $this->patchCustomRoleAsyncWithHttpInfo($key, $patch_with_comment)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchCustomRoleAsyncWithHttpInfo($key, $patch_with_comment)
    {
        $returnType = '\LaunchDarklyApi\Model\CustomRole';
        $request = $this->patchCustomRoleRequest($key, $patch_with_comment);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchCustomRoleRequest($key, $patch_with_comment)
    {
        // verify the required parameter 'key' is set
        if ($key === null || (is_array($key) && count($key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $key when calling patchCustomRole'
            );
        }
