...
class InsightsPullRequestsBetaApi
{
     ...
     * @param  string $environment_key Required if you are using the &lt;code&gt;sort&lt;/code&gt; parameter&#39;s &lt;code&gt;leadTime&lt;/code&gt; option to sort pull requests. (optional)
     * @param  string $application_key Filter the results to pull requests deployed to a comma separated list of applications (optional)
     * @param  string $status Filter results to pull requests with the given status. Options: &#x60;open&#x60;, &#x60;merged&#x60;, &#x60;closed&#x60;, &#x60;deployed&#x60;. (optional)
     * @param  string $query Filter list of pull requests by title or author (optional)
     * @param  int $limit The number of pull requests to return. Default is 20. Maximum allowed is 100. (optional)
     * @param  string $expand Expand properties in response. Options: &#x60;deployments&#x60;, &#x60;flagReferences&#x60;, &#x60;leadTime&#x60;. (optional)
     * @param  string $sort Sort results. Requires the &#x60;environmentKey&#x60; to be set. Options: &#x60;leadTime&#x60; (asc) and &#x60;-leadTime&#x60; (desc). When query option is excluded, default sort is by created or merged date. (optional)
    ...
    public function getPullRequestsWithHttpInfo($project_key, $environment_key = null, $application_key = null, $status = null, $query = null, $limit = null, $expand = null, $sort = null, $from = null, $to = null, $after = null, $before = null, string $contentType = self::contentTypes['getPullRequests'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\PullRequestCollectionRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\PullRequestCollectionRep' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\PullRequestCollectionRep', []),
