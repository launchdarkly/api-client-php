...
class TagsApi
{
     ...
     * List tags
     *
     * @param  string[] $kind Fetch tags associated with the specified resource type. Options are &#x60;flag&#x60;, &#x60;project&#x60;, &#x60;environment&#x60;, &#x60;segment&#x60;, &#x60;metric&#x60;, &#x60;aiconfig&#x60;, and &#x60;view&#x60;. Returns all types by default. (optional)
     * @param  string $pre Return tags with the specified prefix (optional)
     * @param  bool $archived Whether or not to return archived flags (optional)
     * @param  int $limit The number of tags to return. Maximum is 1000. (optional)
     * @param  int $offset The index of the first tag to return. Default is 0. (optional)
     * @param  string $as_of The time to retrieve tags as of. Default is the current time. (optional)
     ...
     * @return \LaunchDarklyApi\Model\TagsCollection|\LaunchDarklyApi\Model\Error|\LaunchDarklyApi\Model\Error|\LaunchDarklyApi\Model\Error|\LaunchDarklyApi\Model\Error|\LaunchDarklyApi\Model\Error
     */
    public function getTags($kind = null, $pre = null, $archived = null, $limit = null, $offset = null, $as_of = null, string $contentType = self::contentTypes['getTags'][0])
    {
        list($response) = $this->getTagsWithHttpInfo($kind, $pre, $archived, $limit, $offset, $as_of, $contentType);
        return $response;
    }
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\TagsCollection|\LaunchDarklyApi\Model\Error|\LaunchDarklyApi\Model\Error|\LaunchDarklyApi\Model\Error|\LaunchDarklyApi\Model\Error|\LaunchDarklyApi\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTagsWithHttpInfo($kind = null, $pre = null, $archived = null, $limit = null, $offset = null, $as_of = null, string $contentType = self::contentTypes['getTags'][0])
    {
        $request = $this->getTagsRequest($kind, $pre, $archived, $limit, $offset, $as_of, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\TagsCollection' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\TagsCollection' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\TagsCollection', []),
            ...
            $returnType = '\LaunchDarklyApi\Model\TagsCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\TagsCollection',
     ...
     */
    public function getTagsAsync($kind = null, $pre = null, $archived = null, $limit = null, $offset = null, $as_of = null, string $contentType = self::contentTypes['getTags'][0])
    {
        return $this->getTagsAsyncWithHttpInfo($kind, $pre, $archived, $limit, $offset, $as_of, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsyncWithHttpInfo($kind = null, $pre = null, $archived = null, $limit = null, $offset = null, $as_of = null, string $contentType = self::contentTypes['getTags'][0])
    {
        $returnType = '\LaunchDarklyApi\Model\TagsCollection';
        $request = $this->getTagsRequest($kind, $pre, $archived, $limit, $offset, $as_of, $contentType);
     ...
     */
    public function getTagsRequest($kind = null, $pre = null, $archived = null, $limit = null, $offset = null, $as_of = null, string $contentType = self::contentTypes['getTags'][0])
    {
