...
class TagsApi
{
     ...
     * @return \LaunchDarklyApi\Model\TagCollection|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function getTags($kind = null, $pre = null, $archived = null)
    {
        list($response) = $this->getTagsWithHttpInfo($kind, $pre, $archived);
        return $response;
    }
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\TagCollection|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTagsWithHttpInfo($kind = null, $pre = null, $archived = null)
    {
        $request = $this->getTagsRequest($kind, $pre, $archived);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarklyApi\Model\TagCollection' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarklyApi\Model\TagCollection' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarklyApi\Model\TagCollection', []),
            ...
            $returnType = '\LaunchDarklyApi\Model\TagCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\TagCollection',
     ...
     */
    public function getTagsAsync($kind = null, $pre = null, $archived = null)
    {
        return $this->getTagsAsyncWithHttpInfo($kind, $pre, $archived)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsyncWithHttpInfo($kind = null, $pre = null, $archived = null)
    {
        $returnType = '\LaunchDarklyApi\Model\TagCollection';
        $request = $this->getTagsRequest($kind, $pre, $archived);
     ...
     */
    public function getTagsRequest($kind = null, $pre = null, $archived = null)
    {
