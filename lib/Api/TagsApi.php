...
class TagsApi
{
     ...
     */
    public function getTags($kind = null, $pre = null)
    {
        list($response) = $this->getTagsWithHttpInfo($kind, $pre);
        return $response;
    }
     ...
     */
    public function getTagsWithHttpInfo($kind = null, $pre = null)
    {
        $request = $this->getTagsRequest($kind, $pre);
     ...
     */
    public function getTagsAsync($kind = null, $pre = null)
    {
        return $this->getTagsAsyncWithHttpInfo($kind, $pre)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsyncWithHttpInfo($kind = null, $pre = null)
    {
        $returnType = '\LaunchDarklyApi\Model\TagCollection';
        $request = $this->getTagsRequest($kind, $pre);
     ...
     */
    public function getTagsRequest($kind = null, $pre = null)
    {
