...
class TagsApi
{
     ...
     * @param  int|null $offset The index of the first tag to return. Default is 0. (optional)
     * @param  string|null $as_of The time to retrieve tags as of. Default is the current time. (optional)
