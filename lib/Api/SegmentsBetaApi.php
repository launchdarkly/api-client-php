...
class SegmentsBetaApi
{
     ...
     * @return void
     */
    public function createBigSegmentImport($project_key, $environment_key, $segment_key)
    {
        $this->createBigSegmentImportWithHttpInfo($project_key, $environment_key, $segment_key);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function createBigSegmentImportWithHttpInfo($project_key, $environment_key, $segment_key)
    {
        $request = $this->createBigSegmentImportRequest($project_key, $environment_key, $segment_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBigSegmentImportAsync($project_key, $environment_key, $segment_key)
    {
        return $this->createBigSegmentImportAsyncWithHttpInfo($project_key, $environment_key, $segment_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBigSegmentImportAsyncWithHttpInfo($project_key, $environment_key, $segment_key)
    {
        $returnType = '';
        $request = $this->createBigSegmentImportRequest($project_key, $environment_key, $segment_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createBigSegmentImportRequest($project_key, $environment_key, $segment_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
