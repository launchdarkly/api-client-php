...
/**
 * SegmentsBetaApi Class Doc Comment
 *
 * @category Class
 * @package  LaunchDarklyApi
 * @author   OpenAPI Generator team
...
class SegmentsBetaApi
{
     ...
     * @return void
     */
    public function createBigSegmentImport($project_key, $environment_key, $segment_key, $file = null, $mode = null)
    {
        $this->createBigSegmentImportWithHttpInfo($project_key, $environment_key, $segment_key, $file, $mode);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function createBigSegmentImportWithHttpInfo($project_key, $environment_key, $segment_key, $file = null, $mode = null)
    {
        $request = $this->createBigSegmentImportRequest($project_key, $environment_key, $segment_key, $file, $mode);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBigSegmentImportAsync($project_key, $environment_key, $segment_key, $file = null, $mode = null)
    {
        return $this->createBigSegmentImportAsyncWithHttpInfo($project_key, $environment_key, $segment_key, $file, $mode)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBigSegmentImportAsyncWithHttpInfo($project_key, $environment_key, $segment_key, $file = null, $mode = null)
    {
        $returnType = '';
        $request = $this->createBigSegmentImportRequest($project_key, $environment_key, $segment_key, $file, $mode);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createBigSegmentImportRequest($project_key, $environment_key, $segment_key, $file = null, $mode = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
