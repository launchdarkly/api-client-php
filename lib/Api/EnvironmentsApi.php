...
class EnvironmentsApi
{
     ...
     */
    public function deleteEnvironmentRequest($project_key, $environment_key)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEnvironmentRequest($project_key, $environment_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getEnvironmentsByProject($project_key, $limit = null, $offset = null, $filter = null, $sort = null)
    {
        list($response) = $this->getEnvironmentsByProjectWithHttpInfo($project_key, $limit, $offset, $filter, $sort);
        return $response;
    }
     ...
     */
    public function getEnvironmentsByProjectWithHttpInfo($project_key, $limit = null, $offset = null, $filter = null, $sort = null)
    {
        $request = $this->getEnvironmentsByProjectRequest($project_key, $limit, $offset, $filter, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnvironmentsByProjectAsync($project_key, $limit = null, $offset = null, $filter = null, $sort = null)
    {
        return $this->getEnvironmentsByProjectAsyncWithHttpInfo($project_key, $limit, $offset, $filter, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEnvironmentsByProjectAsyncWithHttpInfo($project_key, $limit = null, $offset = null, $filter = null, $sort = null)
    {
        $returnType = '\LaunchDarklyApi\Model\Environments';
        $request = $this->getEnvironmentsByProjectRequest($project_key, $limit, $offset, $filter, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEnvironmentsByProjectRequest($project_key, $limit = null, $offset = null, $filter = null, $sort = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function patchEnvironment($project_key, $environment_key, $patch_operation)
    {
        list($response) = $this->patchEnvironmentWithHttpInfo($project_key, $environment_key, $patch_operation);
        return $response;
    }
     ...
     */
    public function patchEnvironmentWithHttpInfo($project_key, $environment_key, $patch_operation)
    {
        $request = $this->patchEnvironmentRequest($project_key, $environment_key, $patch_operation);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchEnvironmentAsync($project_key, $environment_key, $patch_operation)
    {
        return $this->patchEnvironmentAsyncWithHttpInfo($project_key, $environment_key, $patch_operation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchEnvironmentAsyncWithHttpInfo($project_key, $environment_key, $patch_operation)
    {
        $returnType = '\LaunchDarklyApi\Model\Environment';
        $request = $this->patchEnvironmentRequest($project_key, $environment_key, $patch_operation);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchEnvironmentRequest($project_key, $environment_key, $patch_operation)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function postEnvironment($project_key, $environment_post)
    {
        list($response) = $this->postEnvironmentWithHttpInfo($project_key, $environment_post);
        return $response;
    }
     ...
     */
    public function postEnvironmentWithHttpInfo($project_key, $environment_post)
    {
        $request = $this->postEnvironmentRequest($project_key, $environment_post);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postEnvironmentAsync($project_key, $environment_post)
    {
        return $this->postEnvironmentAsyncWithHttpInfo($project_key, $environment_post)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postEnvironmentAsyncWithHttpInfo($project_key, $environment_post)
    {
        $returnType = '\LaunchDarklyApi\Model\Environment';
        $request = $this->postEnvironmentRequest($project_key, $environment_post);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postEnvironmentRequest($project_key, $environment_post)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($environment_post)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($environment_post));
            } else {
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\Environment|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function resetEnvironmentMobileKey($project_key, $environment_key)
    {
        list($response) = $this->resetEnvironmentMobileKeyWithHttpInfo($project_key, $environment_key);
        return $response;
    }
     ...
     */
    public function resetEnvironmentMobileKeyWithHttpInfo($project_key, $environment_key)
    {
        $request = $this->resetEnvironmentMobileKeyRequest($project_key, $environment_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetEnvironmentMobileKeyAsync($project_key, $environment_key)
    {
        return $this->resetEnvironmentMobileKeyAsyncWithHttpInfo($project_key, $environment_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetEnvironmentMobileKeyAsyncWithHttpInfo($project_key, $environment_key)
    {
        $returnType = '\LaunchDarklyApi\Model\Environment';
        $request = $this->resetEnvironmentMobileKeyRequest($project_key, $environment_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resetEnvironmentMobileKeyRequest($project_key, $environment_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  int $expiry The time at which you want the old SDK key to expire, in UNIX milliseconds. By default, the key expires immediately. (optional)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\Environment|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resetEnvironmentSDKKeyRequest($project_key, $environment_key, $expiry = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
