...
class EnvironmentsApi
{
     ...
     */
    public function resetEnvironmentMobileKey($project_key, $env_key)
    {
        list($response) = $this->resetEnvironmentMobileKeyWithHttpInfo($project_key, $env_key);
        return $response;
    }
     ...
     */
    public function resetEnvironmentMobileKeyWithHttpInfo($project_key, $env_key)
    {
        $request = $this->resetEnvironmentMobileKeyRequest($project_key, $env_key);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetEnvironmentMobileKeyAsync($project_key, $env_key)
    {
        return $this->resetEnvironmentMobileKeyAsyncWithHttpInfo($project_key, $env_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetEnvironmentMobileKeyAsyncWithHttpInfo($project_key, $env_key)
    {
        $returnType = '\LaunchDarklyApi\Model\Environment';
        $request = $this->resetEnvironmentMobileKeyRequest($project_key, $env_key);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resetEnvironmentMobileKeyRequest($project_key, $env_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling resetEnvironmentMobileKey'
            );
        }

        $resourcePath = '/api/v2/projects/{projectKey}/environments/{envKey}/mobileKey';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \LaunchDarklyApi\Model\Environment|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep
     */
    public function resetEnvironmentSDKKey($project_key, $env_key, $expiry = null)
    {
        list($response) = $this->resetEnvironmentSDKKeyWithHttpInfo($project_key, $env_key, $expiry);
        return $response;
    }
     ...
     * @return array of \LaunchDarklyApi\Model\Environment|\LaunchDarklyApi\Model\InvalidRequestErrorRep|\LaunchDarklyApi\Model\UnauthorizedErrorRep|\LaunchDarklyApi\Model\ForbiddenErrorRep|\LaunchDarklyApi\Model\NotFoundErrorRep|\LaunchDarklyApi\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function resetEnvironmentSDKKeyWithHttpInfo($project_key, $env_key, $expiry = null)
    {
        $request = $this->resetEnvironmentSDKKeyRequest($project_key, $env_key, $expiry);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetEnvironmentSDKKeyAsync($project_key, $env_key, $expiry = null)
    {
        return $this->resetEnvironmentSDKKeyAsyncWithHttpInfo($project_key, $env_key, $expiry)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetEnvironmentSDKKeyAsyncWithHttpInfo($project_key, $env_key, $expiry = null)
    {
        $returnType = '\LaunchDarklyApi\Model\Environment';
        $request = $this->resetEnvironmentSDKKeyRequest($project_key, $env_key, $expiry);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resetEnvironmentSDKKeyRequest($project_key, $env_key, $expiry = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($env_key === null || (is_array($env_key) && count($env_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $env_key when calling resetEnvironmentSDKKey'
            );
        }

        $resourcePath = '/api/v2/projects/{projectKey}/environments/{envKey}/apiKey';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
