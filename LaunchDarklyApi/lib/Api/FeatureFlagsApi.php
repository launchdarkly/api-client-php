...
class FeatureFlagsApi
{
     ...
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param  string $feature_flag_change_request_id The feature flag change request ID (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\FeatureFlagChangeRequests
     */
    public function getFeatureFlagChangeRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id)
    {
        list($response) = $this->getFeatureFlagChangeRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id);
        return $response;
    }

    /**
     * Operation getFeatureFlagChangeRequestWithHttpInfo
     *
     * Get a single change request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\FeatureFlagChangeRequests, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFeatureFlagChangeRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagChangeRequests';
        $request = $this->getFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\FeatureFlagChangeRequests',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getFeatureFlagChangeRequestAsync
     *
     * Get a single change request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagChangeRequestAsync($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id)
    {
        return $this->getFeatureFlagChangeRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFeatureFlagChangeRequestAsyncWithHttpInfo
     *
     * Get a single change request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagChangeRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagChangeRequests';
        $request = $this->getFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id);
    ...
    /**
     * Create request for operation 'getFeatureFlagChangeRequest'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling getFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling getFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling getFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'feature_flag_change_request_id' is set
        if ($feature_flag_change_request_id === null || (is_array($feature_flag_change_request_id) && count($feature_flag_change_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_change_request_id when calling getFeatureFlagChangeRequest'
            );
        }

        $resourcePath = '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($feature_flag_change_request_id !== null) {
            $resourcePath = str_replace(
                '{' . 'featureFlagChangeRequestId' . '}',
                ObjectSerializer::toPathValue($feature_flag_change_request_id),
                $resourcePath
            );
        }
     ...
     * @return \LaunchDarklyApi\Model\FeatureFlagChangeRequests
     */
    public function getFeatureFlagChangeRequests($project_key, $feature_flag_key, $environment_key)
    {
        list($response) = $this->getFeatureFlagChangeRequestsWithHttpInfo($project_key, $feature_flag_key, $environment_key);
        return $response;
    }

    /**
     * Operation getFeatureFlagChangeRequestsWithHttpInfo
     *
     * Get all change requests for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return array of \LaunchDarklyApi\Model\FeatureFlagChangeRequests, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFeatureFlagChangeRequestsWithHttpInfo($project_key, $feature_flag_key, $environment_key)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagChangeRequests';
        $request = $this->getFeatureFlagChangeRequestsRequest($project_key, $feature_flag_key, $environment_key);
    ...
    /**
     * Operation getFeatureFlagChangeRequestsAsync
     *
     * Get all change requests for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagChangeRequestsAsync($project_key, $feature_flag_key, $environment_key)
    {
        return $this->getFeatureFlagChangeRequestsAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFeatureFlagChangeRequestsAsyncWithHttpInfo
     *
     * Get all change requests for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagChangeRequestsAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagChangeRequests';
        $request = $this->getFeatureFlagChangeRequestsRequest($project_key, $feature_flag_key, $environment_key);
    ...
    /**
     * Create request for operation 'getFeatureFlagChangeRequests'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFeatureFlagChangeRequestsRequest($project_key, $feature_flag_key, $environment_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling getFeatureFlagChangeRequests'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling getFeatureFlagChangeRequests'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling getFeatureFlagChangeRequests'
            );
        }

        $resourcePath = '/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param  string $feature_flag_change_request_id The feature flag change request ID (required)
     * @param  \LaunchDarklyApi\Model\FeatureFlagChangeRequestApplyConfigBody $feature_flag_change_request_apply_config_body Apply a new feature flag change request (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\FeatureFlagChangeRequests
     */
    public function postApplyFeatureFlagChangeRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_apply_config_body)
    {
        list($response) = $this->postApplyFeatureFlagChangeRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_apply_config_body);
        return $response;
    }

    /**
     * Operation postApplyFeatureFlagChangeRequestWithHttpInfo
     *
     * Apply change request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return array of \LaunchDarklyApi\Model\FeatureFlagChangeRequests, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApplyFeatureFlagChangeRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_apply_config_body)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagChangeRequests';
        $request = $this->postApplyFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_apply_config_body);
    ...
    /**
     * Operation postApplyFeatureFlagChangeRequestAsync
     *
     * Apply change request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApplyFeatureFlagChangeRequestAsync($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_apply_config_body)
    {
        return $this->postApplyFeatureFlagChangeRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_apply_config_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postApplyFeatureFlagChangeRequestAsyncWithHttpInfo
     *
     * Apply change request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApplyFeatureFlagChangeRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_apply_config_body)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagChangeRequests';
        $request = $this->postApplyFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_apply_config_body);
    ...
    /**
     * Create request for operation 'postApplyFeatureFlagChangeRequest'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postApplyFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_apply_config_body)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling postApplyFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling postApplyFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling postApplyFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'feature_flag_change_request_id' is set
        if ($feature_flag_change_request_id === null || (is_array($feature_flag_change_request_id) && count($feature_flag_change_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_change_request_id when calling postApplyFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'feature_flag_change_request_apply_config_body' is set
        if ($feature_flag_change_request_apply_config_body === null || (is_array($feature_flag_change_request_apply_config_body) && count($feature_flag_change_request_apply_config_body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_change_request_apply_config_body when calling postApplyFeatureFlagChangeRequest'
            );
        }

        $resourcePath = '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId}/apply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($feature_flag_change_request_apply_config_body)) {
            $_tempBody = $feature_flag_change_request_apply_config_body;
        }
     ...
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param  \LaunchDarklyApi\Model\FeatureFlagChangeRequestConfigBody $feature_flag_change_request_config_body Create a new feature flag change request (optional)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\FeatureFlagChangeRequest
     */
    public function postFeatureFlagChangeRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_config_body = null)
    {
        list($response) = $this->postFeatureFlagChangeRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_config_body);
        return $response;
    }

    /**
     * Operation postFeatureFlagChangeRequestWithHttpInfo
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\FeatureFlagChangeRequest, HTTP status code, HTTP response headers (array of strings)
     */
    public function postFeatureFlagChangeRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_config_body = null)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagChangeRequest';
        $request = $this->postFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_config_body);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\FeatureFlagChangeRequest',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation postFeatureFlagChangeRequestAsync
     *
     * 
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postFeatureFlagChangeRequestAsync($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_config_body = null)
    {
        return $this->postFeatureFlagChangeRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_config_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postFeatureFlagChangeRequestAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postFeatureFlagChangeRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_config_body = null)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagChangeRequest';
        $request = $this->postFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_config_body);
    ...
    /**
     * Create request for operation 'postFeatureFlagChangeRequest'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_config_body = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling postFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling postFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling postFeatureFlagChangeRequest'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($feature_flag_change_request_config_body)) {
            $_tempBody = $feature_flag_change_request_config_body;
        }
     ...
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param  string $feature_flag_change_request_id The feature flag change request ID (required)
     * @param  \LaunchDarklyApi\Model\FeatureFlagChangeRequestReviewConfigBody $feature_flag_change_request_review_config_body Review a feature flag change request (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\FeatureFlagChangeRequests
     */
    public function postReviewFeatureFlagChangeRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_review_config_body)
    {
        list($response) = $this->postReviewFeatureFlagChangeRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_review_config_body);
        return $response;
    }

    /**
     * Operation postReviewFeatureFlagChangeRequestWithHttpInfo
     *
     * Review change request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return array of \LaunchDarklyApi\Model\FeatureFlagChangeRequests, HTTP status code, HTTP response headers (array of strings)
     */
    public function postReviewFeatureFlagChangeRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_review_config_body)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagChangeRequests';
        $request = $this->postReviewFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_review_config_body);
    ...
    /**
     * Operation postReviewFeatureFlagChangeRequestAsync
     *
     * Review change request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postReviewFeatureFlagChangeRequestAsync($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_review_config_body)
    {
        return $this->postReviewFeatureFlagChangeRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_review_config_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postReviewFeatureFlagChangeRequestAsyncWithHttpInfo
     *
     * Review change request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postReviewFeatureFlagChangeRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_review_config_body)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagChangeRequests';
        $request = $this->postReviewFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_review_config_body);
    ...
    /**
     * Create request for operation 'postReviewFeatureFlagChangeRequest'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postReviewFeatureFlagChangeRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_change_request_id, $feature_flag_change_request_review_config_body)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling postReviewFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling postReviewFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling postReviewFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'feature_flag_change_request_id' is set
        if ($feature_flag_change_request_id === null || (is_array($feature_flag_change_request_id) && count($feature_flag_change_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_change_request_id when calling postReviewFeatureFlagChangeRequest'
            );
        }
        // verify the required parameter 'feature_flag_change_request_review_config_body' is set
        if ($feature_flag_change_request_review_config_body === null || (is_array($feature_flag_change_request_review_config_body) && count($feature_flag_change_request_review_config_body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_change_request_review_config_body when calling postReviewFeatureFlagChangeRequest'
            );
        }

        $resourcePath = '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId}/review';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($feature_flag_change_request_review_config_body)) {
            $_tempBody = $feature_flag_change_request_review_config_body;
        }
