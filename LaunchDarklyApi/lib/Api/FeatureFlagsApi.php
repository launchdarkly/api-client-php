...
class FeatureFlagsApi
{
     ...
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $env By default, each feature will include configurations for each environment. You can filter environments with the env query parameter. For example, setting env&#x3D;production will restrict the returned configurations to just your production environment. (optional)
     * @param  string $summary By default in api version &gt;&#x3D; 1, flags will _not_ include their list of prerequisites, targets or rules.  Set summary&#x3D;0 to include these fields for each flag returned. (optional)
     * @param  string $archived When set to 1, archived flags will be included in the list of flags returned.  By default, archived flags are not included in the list of flags. (optional)
     ...
     */
    public function getFeatureFlags($project_key, $env = null, $summary = null, $archived = null, $tag = null)
    {
        list($response) = $this->getFeatureFlagsWithHttpInfo($project_key, $env, $summary, $archived, $tag);
        return $response;
    }
     ...
     */
    public function getFeatureFlagsWithHttpInfo($project_key, $env = null, $summary = null, $archived = null, $tag = null)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlags';
        $request = $this->getFeatureFlagsRequest($project_key, $env, $summary, $archived, $tag);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagsAsync($project_key, $env = null, $summary = null, $archived = null, $tag = null)
    {
        return $this->getFeatureFlagsAsyncWithHttpInfo($project_key, $env, $summary, $archived, $tag)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagsAsyncWithHttpInfo($project_key, $env = null, $summary = null, $archived = null, $tag = null)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlags';
        $request = $this->getFeatureFlagsRequest($project_key, $env, $summary, $archived, $tag);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFeatureFlagsRequest($project_key, $env = null, $summary = null, $archived = null, $tag = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
