...
class FeatureFlagsApi
{
     ...
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $feature_flag_approval_request_id The feature flag approval request ID (required)
     * @param  \LaunchDarklyApi\Model\FeatureFlagApprovalRequestConfigBody $feature_flag_approval_request_config_body Create a new feature flag approval request (optional)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteFeatureFlagApprovalRequest($project_key, $environment_key, $feature_flag_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body = null)
    {
        $this->deleteFeatureFlagApprovalRequestWithHttpInfo($project_key, $environment_key, $feature_flag_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body);
    }

    /**
     * Operation deleteFeatureFlagApprovalRequestWithHttpInfo
     *
     * Delete an approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteFeatureFlagApprovalRequestWithHttpInfo($project_key, $environment_key, $feature_flag_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body = null)
    {
        $returnType = '';
        $request = $this->deleteFeatureFlagApprovalRequestRequest($project_key, $environment_key, $feature_flag_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body);
    ...
    /**
     * Operation deleteFeatureFlagApprovalRequestAsync
     *
     * Delete an approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteFeatureFlagApprovalRequestAsync($project_key, $environment_key, $feature_flag_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body = null)
    {
        return $this->deleteFeatureFlagApprovalRequestAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteFeatureFlagApprovalRequestAsyncWithHttpInfo
     *
     * Delete an approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteFeatureFlagApprovalRequestAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body = null)
    {
        $returnType = '';
        $request = $this->deleteFeatureFlagApprovalRequestRequest($project_key, $environment_key, $feature_flag_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body);
    ...
    /**
     * Create request for operation 'deleteFeatureFlagApprovalRequest'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteFeatureFlagApprovalRequestRequest($project_key, $environment_key, $feature_flag_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling deleteFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling deleteFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling deleteFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_approval_request_id' is set
        if ($feature_flag_approval_request_id === null || (is_array($feature_flag_approval_request_id) && count($feature_flag_approval_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_approval_request_id when calling deleteFeatureFlagApprovalRequest'
            );
        }

        $resourcePath = '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($feature_flag_approval_request_id !== null) {
            $resourcePath = str_replace(
                '{' . 'featureFlagApprovalRequestId' . '}',
                ObjectSerializer::toPathValue($feature_flag_approval_request_id),
                $resourcePath
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($feature_flag_approval_request_config_body)) {
            $_tempBody = $feature_flag_approval_request_config_body;
        }
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\FeatureFlagApprovalRequests
     */
    public function getFeatureFlagApprovalRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id)
    {
        list($response) = $this->getFeatureFlagApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id);
        return $response;
    }

    /**
     * Operation getFeatureFlagApprovalRequestWithHttpInfo
     *
     * Get a single approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\FeatureFlagApprovalRequests, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFeatureFlagApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagApprovalRequests';
        $request = $this->getFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\FeatureFlagApprovalRequests',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getFeatureFlagApprovalRequestAsync
     *
     * Get a single approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagApprovalRequestAsync($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id)
    {
        return $this->getFeatureFlagApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFeatureFlagApprovalRequestAsyncWithHttpInfo
     *
     * Get a single approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagApprovalRequests';
        $request = $this->getFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id);
    ...
    /**
     * Create request for operation 'getFeatureFlagApprovalRequest'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling getFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling getFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling getFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_approval_request_id' is set
        if ($feature_flag_approval_request_id === null || (is_array($feature_flag_approval_request_id) && count($feature_flag_approval_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_approval_request_id when calling getFeatureFlagApprovalRequest'
            );
        }
     ...
     * @return \LaunchDarklyApi\Model\FeatureFlagApprovalRequests
     */
    public function getFeatureFlagApprovalRequests($project_key, $feature_flag_key, $environment_key)
    {
        list($response) = $this->getFeatureFlagApprovalRequestsWithHttpInfo($project_key, $feature_flag_key, $environment_key);
        return $response;
    }

    /**
     * Operation getFeatureFlagApprovalRequestsWithHttpInfo
     *
     * Get all approval requests for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return array of \LaunchDarklyApi\Model\FeatureFlagApprovalRequests, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFeatureFlagApprovalRequestsWithHttpInfo($project_key, $feature_flag_key, $environment_key)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagApprovalRequests';
        $request = $this->getFeatureFlagApprovalRequestsRequest($project_key, $feature_flag_key, $environment_key);
    ...
    /**
     * Operation getFeatureFlagApprovalRequestsAsync
     *
     * Get all approval requests for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagApprovalRequestsAsync($project_key, $feature_flag_key, $environment_key)
    {
        return $this->getFeatureFlagApprovalRequestsAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFeatureFlagApprovalRequestsAsyncWithHttpInfo
     *
     * Get all approval requests for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeatureFlagApprovalRequestsAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagApprovalRequests';
        $request = $this->getFeatureFlagApprovalRequestsRequest($project_key, $feature_flag_key, $environment_key);
    ...
    /**
     * Create request for operation 'getFeatureFlagApprovalRequests'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFeatureFlagApprovalRequestsRequest($project_key, $feature_flag_key, $environment_key)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling getFeatureFlagApprovalRequests'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling getFeatureFlagApprovalRequests'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling getFeatureFlagApprovalRequests'
            );
        }
     ...
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param  string $feature_flag_approval_request_id The feature flag approval request ID (required)
     * @param  \LaunchDarklyApi\Model\FeatureFlagApprovalRequestApplyConfigBody $feature_flag_approval_request_apply_config_body Apply a new feature flag approval request (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\FeatureFlagApprovalRequests
     */
    public function postApplyFeatureFlagApprovalRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_apply_config_body)
    {
        list($response) = $this->postApplyFeatureFlagApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_apply_config_body);
        return $response;
    }

    /**
     * Operation postApplyFeatureFlagApprovalRequestWithHttpInfo
     *
     * Apply approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return array of \LaunchDarklyApi\Model\FeatureFlagApprovalRequests, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApplyFeatureFlagApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_apply_config_body)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagApprovalRequests';
        $request = $this->postApplyFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_apply_config_body);
    ...
    /**
     * Operation postApplyFeatureFlagApprovalRequestAsync
     *
     * Apply approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApplyFeatureFlagApprovalRequestAsync($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_apply_config_body)
    {
        return $this->postApplyFeatureFlagApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_apply_config_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postApplyFeatureFlagApprovalRequestAsyncWithHttpInfo
     *
     * Apply approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postApplyFeatureFlagApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_apply_config_body)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagApprovalRequests';
        $request = $this->postApplyFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_apply_config_body);
    ...
    /**
     * Create request for operation 'postApplyFeatureFlagApprovalRequest'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postApplyFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_apply_config_body)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling postApplyFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling postApplyFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling postApplyFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_approval_request_id' is set
        if ($feature_flag_approval_request_id === null || (is_array($feature_flag_approval_request_id) && count($feature_flag_approval_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_approval_request_id when calling postApplyFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_approval_request_apply_config_body' is set
        if ($feature_flag_approval_request_apply_config_body === null || (is_array($feature_flag_approval_request_apply_config_body) && count($feature_flag_approval_request_apply_config_body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_approval_request_apply_config_body when calling postApplyFeatureFlagApprovalRequest'
            );
        }

        $resourcePath = '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}/apply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($feature_flag_approval_request_apply_config_body)) {
            $_tempBody = $feature_flag_approval_request_apply_config_body;
        }
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\FeatureFlagApprovalRequest
     */
    public function postFeatureFlagApprovalRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body = null)
    {
        list($response) = $this->postFeatureFlagApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body);
        return $response;
    }

    /**
     * Operation postFeatureFlagApprovalRequestWithHttpInfo
     *
     * Create an approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarklyApi\Model\FeatureFlagApprovalRequest, HTTP status code, HTTP response headers (array of strings)
     */
    public function postFeatureFlagApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body = null)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagApprovalRequest';
        $request = $this->postFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarklyApi\Model\FeatureFlagApprovalRequest',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation postFeatureFlagApprovalRequestAsync
     *
     * Create an approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postFeatureFlagApprovalRequestAsync($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body = null)
    {
        return $this->postFeatureFlagApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postFeatureFlagApprovalRequestAsyncWithHttpInfo
     *
     * Create an approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postFeatureFlagApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body = null)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagApprovalRequest';
        $request = $this->postFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body);
    ...
    /**
     * Create request for operation 'postFeatureFlagApprovalRequest'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_config_body = null)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling postFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling postFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling postFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_approval_request_id' is set
        if ($feature_flag_approval_request_id === null || (is_array($feature_flag_approval_request_id) && count($feature_flag_approval_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_approval_request_id when calling postFeatureFlagApprovalRequest'
            );
        }
     ...
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param  string $feature_flag_approval_request_id The feature flag approval request ID (required)
     * @param  \LaunchDarklyApi\Model\FeatureFlagApprovalRequestReviewConfigBody $feature_flag_approval_request_review_config_body Review a feature flag approval request (required)
     *
     * @throws \LaunchDarklyApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \LaunchDarklyApi\Model\FeatureFlagApprovalRequests
     */
    public function postReviewFeatureFlagApprovalRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_review_config_body)
    {
        list($response) = $this->postReviewFeatureFlagApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_review_config_body);
        return $response;
    }

    /**
     * Operation postReviewFeatureFlagApprovalRequestWithHttpInfo
     *
     * Review approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return array of \LaunchDarklyApi\Model\FeatureFlagApprovalRequests, HTTP status code, HTTP response headers (array of strings)
     */
    public function postReviewFeatureFlagApprovalRequestWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_review_config_body)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagApprovalRequests';
        $request = $this->postReviewFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_review_config_body);
    ...
    /**
     * Operation postReviewFeatureFlagApprovalRequestAsync
     *
     * Review approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postReviewFeatureFlagApprovalRequestAsync($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_review_config_body)
    {
        return $this->postReviewFeatureFlagApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_review_config_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postReviewFeatureFlagApprovalRequestAsyncWithHttpInfo
     *
     * Review approval request for a feature flag
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postReviewFeatureFlagApprovalRequestAsyncWithHttpInfo($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_review_config_body)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlagApprovalRequests';
        $request = $this->postReviewFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_review_config_body);
    ...
    /**
     * Create request for operation 'postReviewFeatureFlagApprovalRequest'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $feature_flag_key The feature flag&#39;s key. The key identifies the flag in your code. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postReviewFeatureFlagApprovalRequestRequest($project_key, $feature_flag_key, $environment_key, $feature_flag_approval_request_id, $feature_flag_approval_request_review_config_body)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling postReviewFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_key' is set
        if ($feature_flag_key === null || (is_array($feature_flag_key) && count($feature_flag_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_key when calling postReviewFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling postReviewFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_approval_request_id' is set
        if ($feature_flag_approval_request_id === null || (is_array($feature_flag_approval_request_id) && count($feature_flag_approval_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_approval_request_id when calling postReviewFeatureFlagApprovalRequest'
            );
        }
        // verify the required parameter 'feature_flag_approval_request_review_config_body' is set
        if ($feature_flag_approval_request_review_config_body === null || (is_array($feature_flag_approval_request_review_config_body) && count($feature_flag_approval_request_review_config_body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $feature_flag_approval_request_review_config_body when calling postReviewFeatureFlagApprovalRequest'
            );
        }

        $resourcePath = '/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}/review';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($feature_flag_approval_request_review_config_body)) {
            $_tempBody = $feature_flag_approval_request_review_config_body;
        }
