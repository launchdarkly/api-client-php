...
class FeatureFlagsApi
{
     ...
     */
    public function copyFeatureFlag($project_key, $environment_key, $feature_flag_key)
    {
        list($response) = $this->copyFeatureFlagWithHttpInfo($project_key, $environment_key, $feature_flag_key);
        return $response;
    }
     ...
     */
    public function copyFeatureFlagWithHttpInfo($project_key, $environment_key, $feature_flag_key)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlag';
        $request = $this->copyFeatureFlagRequest($project_key, $environment_key, $feature_flag_key);
     ...
     */
    public function copyFeatureFlagAsync($project_key, $environment_key, $feature_flag_key)
    {
        return $this->copyFeatureFlagAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function copyFeatureFlagAsyncWithHttpInfo($project_key, $environment_key, $feature_flag_key)
    {
        $returnType = '\LaunchDarklyApi\Model\FeatureFlag';
        $request = $this->copyFeatureFlagRequest($project_key, $environment_key, $feature_flag_key);
     ...
     */
    protected function copyFeatureFlagRequest($project_key, $environment_key, $feature_flag_key)
    {
        ...
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling copyFeatureFlag'
            );
        }
        ...
        $resourcePath = '/flags/{projectKey}/{environmentKey}/{featureFlagKey}/copy';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
