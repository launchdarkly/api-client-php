...
class UserSegmentsApi
{
     ...
     * @return void
     */
    public function updatedBigSegmentTargets($project_key, $environment_key, $user_segment_key, $big_segment_targets_body)
    {
        $this->updatedBigSegmentTargetsWithHttpInfo($project_key, $environment_key, $user_segment_key, $big_segment_targets_body);
    }

    /**
     * Operation updatedBigSegmentTargetsWithHttpInfo
     *
     * Update targets included or excluded in a big segment
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatedBigSegmentTargetsWithHttpInfo($project_key, $environment_key, $user_segment_key, $big_segment_targets_body)
    {
        $returnType = '';
        $request = $this->updatedBigSegmentTargetsRequest($project_key, $environment_key, $user_segment_key, $big_segment_targets_body);
    ...
    /**
     * Operation updatedBigSegmentTargetsAsync
     *
     * Update targets included or excluded in a big segment
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatedBigSegmentTargetsAsync($project_key, $environment_key, $user_segment_key, $big_segment_targets_body)
    {
        return $this->updatedBigSegmentTargetsAsyncWithHttpInfo($project_key, $environment_key, $user_segment_key, $big_segment_targets_body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updatedBigSegmentTargetsAsyncWithHttpInfo
     *
     * Update targets included or excluded in a big segment
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatedBigSegmentTargetsAsyncWithHttpInfo($project_key, $environment_key, $user_segment_key, $big_segment_targets_body)
    {
        $returnType = '';
        $request = $this->updatedBigSegmentTargetsRequest($project_key, $environment_key, $user_segment_key, $big_segment_targets_body);
    ...
    /**
     * Create request for operation 'updatedBigSegmentTargets'
     *
     * @param  string $project_key The project key, used to tie the flags together under one project so they can be managed together. (required)
     * @param  string $environment_key The environment key, used to tie together flag configuration and users under one environment so they can be managed together. (required)
     * @param  string $user_segment_key The user segment&#39;s key. The key identifies the user segment in your code. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updatedBigSegmentTargetsRequest($project_key, $environment_key, $user_segment_key, $big_segment_targets_body)
    {
        // verify the required parameter 'project_key' is set
        if ($project_key === null || (is_array($project_key) && count($project_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_key when calling updatedBigSegmentTargets'
            );
        }
        // verify the required parameter 'environment_key' is set
        if ($environment_key === null || (is_array($environment_key) && count($environment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_key when calling updatedBigSegmentTargets'
            );
        }
        // verify the required parameter 'user_segment_key' is set
        if ($user_segment_key === null || (is_array($user_segment_key) && count($user_segment_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_segment_key when calling updatedBigSegmentTargets'
            );
        }
        ...
        if ($big_segment_targets_body === null || (is_array($big_segment_targets_body) && count($big_segment_targets_body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $big_segment_targets_body when calling updatedBigSegmentTargets'
            );
        }
