...
*FeatureFlagsApi* | [**getFeatureFlagStatusAcrossEnvironments**](docs/Api/FeatureFlagsApi.md#getfeatureflagstatusacrossenvironments) | **GET** /flag-status/{projectKey}/{featureFlagKey} | [BETA] Get the status for a particular feature flag across environments
...
*UsageApi* | [**getEvaluations**](docs/Api/UsageApi.md#getevaluations) | **GET** /usage/evaluations/{envId}/{flagKey} | [BETA] Get events usage by event id and the feature flag key.
*UsageApi* | [**getEvent**](docs/Api/UsageApi.md#getevent) | **GET** /usage/events/{type} | [BETA] Get events usage by event type.
*UsageApi* | [**getEvents**](docs/Api/UsageApi.md#getevents) | **GET** /usage/events | [BETA] Get events usage endpoints.
*UsageApi* | [**getMAU**](docs/Api/UsageApi.md#getmau) | **GET** /usage/mau | [BETA] Get monthly active user data.
*UsageApi* | [**getMAUByCategory**](docs/Api/UsageApi.md#getmaubycategory) | **GET** /usage/mau/bycategory | [BETA] Get monthly active user data by category.
*UsageApi* | [**getStream**](docs/Api/UsageApi.md#getstream) | **GET** /usage/streams/{source} | [BETA] Get a stream endpoint and return timeseries data.
*UsageApi* | [**getStreamBySDK**](docs/Api/UsageApi.md#getstreambysdk) | **GET** /usage/streams/{source}/bysdkversion | [BETA] Get a stream timeseries data by source show sdk version metadata.
*UsageApi* | [**getStreamSDKVersion**](docs/Api/UsageApi.md#getstreamsdkversion) | **GET** /usage/streams/{source}/sdkversions | [BETA] Get a stream timeseries data by source and show all sdk version associated.
*UsageApi* | [**getStreams**](docs/Api/UsageApi.md#getstreams) | **GET** /usage/streams | [BETA] Returns a list of all streams.
*UsageApi* | [**getUsage**](docs/Api/UsageApi.md#getusage) | **GET** /usage | [BETA] Returns of the usage endpoints available.
