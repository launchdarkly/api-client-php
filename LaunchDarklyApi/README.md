...
*UserSegmentsApi* | [**updatedBigSegmentTargets**](docs/Api/UserSegmentsApi.md#updatedbigsegmenttargets) | **POST** /segments/{projectKey}/{environmentKey}/{userSegmentKey}/users | Update targets included or excluded in a big segment
