...
*AccessTokensApi* | [**patchToken**](docs/Api/AccessTokensApi.md#patchtoken) | **PATCH** /tokens/{tokenId} | Modify an access tokenby ID.
...
## Documentation For Models
 ...
 - [SemanticPatchOperationInstructions](docs/Model/SemanticPatchOperationInstructions.md)
