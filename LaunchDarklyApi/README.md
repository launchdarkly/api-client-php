...
*FeatureFlagsApi* | [**getFeatureFlagChangeRequest**](docs/Api/FeatureFlagsApi.md#getfeatureflagchangerequest) | **GET** /projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId} | Get a single change request for a feature flag
*FeatureFlagsApi* | [**getFeatureFlagChangeRequests**](docs/Api/FeatureFlagsApi.md#getfeatureflagchangerequests) | **GET** /{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests | Get all change requests for a feature flag
...
*FeatureFlagsApi* | [**postApplyFeatureFlagChangeRequest**](docs/Api/FeatureFlagsApi.md#postapplyfeatureflagchangerequest) | **POST** /projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId}/apply | Apply change request for a feature flag
...
*FeatureFlagsApi* | [**postFeatureFlagChangeRequest**](docs/Api/FeatureFlagsApi.md#postfeatureflagchangerequest) | **POST** /{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests | 
*FeatureFlagsApi* | [**postReviewFeatureFlagChangeRequest**](docs/Api/FeatureFlagsApi.md#postreviewfeatureflagchangerequest) | **POST** /projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId}/review | Review change request for a feature flag
...
## Documentation For Models
 ...
 - [FeatureFlagChangeRequest](docs/Model/FeatureFlagChangeRequest.md)
 - [FeatureFlagChangeRequestApplyConfigBody](docs/Model/FeatureFlagChangeRequestApplyConfigBody.md)
 - [FeatureFlagChangeRequestConfigBody](docs/Model/FeatureFlagChangeRequestConfigBody.md)
 - [FeatureFlagChangeRequestReview](docs/Model/FeatureFlagChangeRequestReview.md)
 - [FeatureFlagChangeRequestReviewConfigBody](docs/Model/FeatureFlagChangeRequestReviewConfigBody.md)
 - [FeatureFlagChangeRequestReviewStatus](docs/Model/FeatureFlagChangeRequestReviewStatus.md)
 - [FeatureFlagChangeRequests](docs/Model/FeatureFlagChangeRequests.md)
