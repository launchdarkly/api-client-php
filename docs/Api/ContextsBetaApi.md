...
try {
    ...
    echo 'Exception when calling ContextsBetaApi->deleteContextInstances: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ContextsBetaApi->evaluateContextInstance: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ContextsBetaApi->getContextAttributeNames: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ContextsBetaApi->getContextAttributeValues: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ContextsBetaApi->getContextInstances: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ContextsBetaApi->getContexts: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ContextsBetaApi->searchContextInstances: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ContextsBetaApi->searchContexts: ', $e->getMessage(), PHP_EOL;
}
```
